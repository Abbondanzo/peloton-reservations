...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="9ef9cbff-61c2-5863-b074-e3e6c8a5a986")}catch(e){}}();
const Ut=()=>{};var xe={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="FirebaseError";class L extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Jt,Object.setPrototypeOf(this,L.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Y.prototype.create)}}class Y{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,a=this.errors[e],o=a?Yt(a,r):"Error",i=`${this.serviceName}: ${o} (${s}).`;return new L(s,i,r)}}function Yt(t,e){return t.replace(Qt,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Qt=/\{\$([^}]+)}/g;function ue(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const a=t[s],o=e[s];if($e(a)&&$e(o)){if(!ue(a,o))return!1}else if(a!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function $e(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(yn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function yn(t){return t.getComponent()?.type==="VERSION"}const fe="@firebase/app",Me="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T=new on("@firebase/app"),_n="@firebase/app-compat",En="@firebase/analytics-compat",Cn="@firebase/analytics",Tn="@firebase/app-check-compat",Sn="@firebase/app-check",In="@firebase/auth",Rn="@firebase/auth-compat",vn="@firebase/database",kn="@firebase/data-connect",An="@firebase/database-compat",Nn="@firebase/functions",Dn="@firebase/functions-compat",xn="@firebase/installations",$n="@firebase/installations-compat",On="@firebase/messaging",Pn="@firebase/messaging-compat",Ln="@firebase/performance",Mn="@firebase/performance-compat",Un="@firebase/remote-config",Bn="@firebase/remote-config-compat",Fn="@firebase/storage",Hn="@firebase/storage-compat",qn="@firebase/firestore",jn="@firebase/ai",Kn="@firebase/firestore-compat",Wn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qn="firebase-heartbeat-database",Xn=1,F="firebase-heartbeat-store";let ne=null;function lt(){return ne||(ne=H(Qn,Xn,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(F)}catch(n){console.warn(n)}}}}).catch(t=>{throw I.create("idb-open",{originalErrorMessage:t.message})})),ne}async function Zn(t){try{const n=(await lt()).transaction(F),r=await n.objectStore(F).get(ut(t));return await n.done,r}catch(e){if(e instanceof L)T.warn(e.message);else{const n=I.create("idb-get",{originalErrorMessage:e?.message});T.warn(n.message)}}}async function Be(t,e){try{const r=(await lt()).transaction(F,"readwrite");await r.objectStore(F).put(e,ut(t)),await r.done}catch(n){if(n instanceof L)T.warn(n.message);else{const r=I.create("idb-set",{originalErrorMessage:n?.message});T.warn(r.message)}}}function ut(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function or(t){P(new A("platform-logger",e=>new bn(e),"PRIVATE")),P(new A("heartbeat",e=>new nr(e),"PRIVATE")),$(fe,Me,t),$(fe,Me,"esm2020"),$("fire-js","")}or("");const ht="@firebase/installations",Ee="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt=1e4,ft=`w:${Ee}`,pt="FIS_v2",ir="https://firebaseinstallations.googleapis.com/v1",cr=3600*1e3,lr="installations",ur="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gr({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const r=mt(t),s=yt(t),a=e.getImmediate({optional:!0});if(a){const u=await a.getHeartbeatsHeader();u&&s.append("x-firebase-client",u)}const o={fid:n,authVersion:pt,appId:t.appId,sdkVersion:ft},i={method:"POST",headers:s,body:JSON.stringify(o)},c=await _t(()=>fetch(r,i));if(c.ok){const u=await c.json();return{fid:u.fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:wt(u.authToken)}}else throw await bt("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr="firebase-installations-database",Sr=1,D="firebase-installations-store";let re=null;function Ce(){return re||(re=H(Tr,Sr,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(D)}}})),re}async function V(t,e){const n=Q(t),s=(await Ce()).transaction(D,"readwrite"),a=s.objectStore(D),o=await a.get(n);return await a.put(e,n),await s.done,(!o||o.fid!==e.fid)&&Tt(t,e.fid),e}async function It(t){const e=Q(t),r=(await Ce()).transaction(D,"readwrite");await r.objectStore(D).delete(e),await r.done}async function X(t,e){const n=Q(t),s=(await Ce()).transaction(D,"readwrite"),a=s.objectStore(D),o=await a.get(n),i=e(o);return i===void 0?await a.delete(n):await a.put(i,n),await s.done,i&&(!o||o.fid!==i.fid)&&Tt(t,i.fid),i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nr({appConfig:t,heartbeatServiceProvider:e},n){const r=Dr(t,n),s=dr(t,n),a=e.getImmediate({optional:!0});if(a){const u=await a.getHeartbeatsHeader();u&&s.append("x-firebase-client",u)}const o={installation:{sdkVersion:ft,appId:t.appId}},i={method:"POST",headers:s,body:JSON.stringify(o)},c=await _t(()=>fetch(r,i));if(c.ok){const u=await c.json();return wt(u)}else throw await bt("Generate Auth Token",c)}function Dr(t,{fid:e}){return`${mt(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ur(t){const e=t,{installationEntry:n,registrationPromise:r}=await Te(e);return r?r.catch(console.error):Se(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Br(t,e=!1){const n=t;return await Fr(n),(await Se(n,e)).token}async function Fr(t){const{registrationPromise:e}=await Te(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt="installations",qr="installations-internal",jr=t=>{const e=t.getProvider("app").getImmediate(),n=Hr(e),r=_e(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Kr=t=>{const e=t.getProvider("app").getImmediate(),n=_e(e,kt).getImmediate();return{getId:()=>Ur(n),getToken:s=>Br(n,s)}};function Wr(){P(new A(kt,jr,"PUBLIC")),P(new A(qr,Kr,"PRIVATE"))}Wr();$(ht,Ee);$(ht,Ee,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ae="fcm_token_details_db",Qr=5,Ke="fcm_token_object_Store";async function Xr(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(a=>a.name).includes(ae))return null;let e=null;return(await H(ae,Qr,{upgrade:async(r,s,a,o)=>{if(s<2||!r.objectStoreNames.contains(Ke))return;const i=o.objectStore(Ke),c=await i.index("fcmSenderId").get(t);if(await i.clear(),!!c){if(s===2){const u=c;if(!u.auth||!u.p256dh||!u.endpoint)return;e={token:u.fcmToken,createTime:u.createTime??Date.now(),subscriptionOptions:{auth:u.auth,p256dh:u.p256dh,endpoint:u.endpoint,swScope:u.swScope,vapidKey:typeof u.vapidKey=="string"?u.vapidKey:y(u.vapidKey)}}}else if(s===3){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:y(u.auth),p256dh:y(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:y(u.vapidKey)}}}else if(s===4){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:y(u.auth),p256dh:y(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:y(u.vapidKey)}}}}}})).close(),await K(ae),await K("fcm_vapid_details_db"),await K("undefined"),Zr(e)?e:null}function Zr(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="firebase-messaging-database",ts=1,x="firebase-messaging-store";let oe=null;function Ie(){return oe||(oe=H(es,ts,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(x)}}})),oe}async function Re(t){const e=ke(t),r=await(await Ie()).transaction(x).objectStore(x).get(e);if(r)return r;{const s=await Xr(t.appConfig.senderId);if(s)return await ve(t,s),s}}async function ve(t,e){const n=ke(t),s=(await Ie()).transaction(x,"readwrite");return await s.objectStore(x).put(e,n),await s.done,e}async function ns(t){const e=ke(t),r=(await Ie()).transaction(x,"readwrite");await r.objectStore(x).delete(e),await r.done}function ke({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ss(t,e){const n=await Ne(t),r=xt(e),s={method:"POST",headers:n,body:JSON.stringify(r)};let a;try{a=await(await fetch(Ae(t.appConfig),s)).json()}catch(o){throw b.create("token-subscribe-failed",{errorInfo:o?.toString()})}if(a.error){const o=a.error.message;throw b.create("token-subscribe-failed",{errorInfo:o})}if(!a.token)throw b.create("token-subscribe-no-token");return a.token}async function as(t,e){const n=await Ne(t),r=xt(e.subscriptionOptions),s={method:"PATCH",headers:n,body:JSON.stringify(r)};let a;try{a=await(await fetch(`${Ae(t.appConfig)}/${e.token}`,s)).json()}catch(o){throw b.create("token-update-failed",{errorInfo:o?.toString()})}if(a.error){const o=a.error.message;throw b.create("token-update-failed",{errorInfo:o})}if(!a.token)throw b.create("token-update-no-token");return a.token}async function Dt(t,e){const r={method:"DELETE",headers:await Ne(t)};try{const a=await(await fetch(`${Ae(t.appConfig)}/${e}`,r)).json();if(a.error){const o=a.error.message;throw b.create("token-unsubscribe-failed",{errorInfo:o})}}catch(s){throw b.create("token-unsubscribe-failed",{errorInfo:s?.toString()})}}function Ae({projectId:t}){return`${Vr}/projects/${t}/registrations`}async function Ne({appConfig:t,installations:e}){const n=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function xt({p256dh:t,auth:e,endpoint:n,vapidKey:r}){const s={web:{endpoint:n,auth:e,p256dh:t}};return r!==At&&(s.web.applicationPubKey=r),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const os=10080*60*1e3;async function is(t){const e=await ls(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:y(e.getKey("auth")),p256dh:y(e.getKey("p256dh"))},r=await Re(t.firebaseDependencies);if(r){if(us(r.subscriptionOptions,n))return Date.now()>=r.createTime+os?cs(t,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await Dt(t.firebaseDependencies,r.token)}catch(s){console.warn(s)}return Ve(t.firebaseDependencies,n)}else return Ve(t.firebaseDependencies,n)}async function We(t){const e=await Re(t.firebaseDependencies);e&&(await Dt(t.firebaseDependencies,e.token),await ns(t.firebaseDependencies));const n=await t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function cs(t,e){try{const n=await as(t.firebaseDependencies,e),r={...e,token:n,createTime:Date.now()};return await ve(t.firebaseDependencies,r),n}catch(n){throw n}}async function Ve(t,e){const r={token:await ss(t,e),createTime:Date.now(),subscriptionOptions:e};return await ve(t,r),r.token}async function ls(t,e){const n=await t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Yr(e)})}function us(t,e){const n=e.vapidKey===t.vapidKey,r=e.endpoint===t.endpoint,s=e.auth===t.auth,a=e.p256dh===t.p256dh;return n&&r&&s&&a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ls(t,e){if(self.document!==void 0)throw b.create("only-available-in-sw");return t.onBackgroundMessageHandler=e,()=>{t.onBackgroundMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ms(t=Yn()){return Ps().then(e=>{if(!e)throw b.create("unsupported-browser")},e=>{throw b.create("indexed-db-unsupported")}),_e(at(t),"messaging-sw").getImmediate()}function Us(t,e){return t=at(t),Ls(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$($a,Oa,"app");const Pa=t=>{try{return t()}catch(e){console.error(e)}},La={apiKey:"AIzaSyAMtG6b23AqO2WbJ2ad8SKMXD1X4tfALtc",authDomain:"peloton-alerts.firebaseapp.com",projectId:"peloton-alerts",storageBucket:"peloton-alerts.appspot.com",messagingSenderId:"331185140393",appId:"1:331185140393:web:5f49c5c60b8b162914efb8",measurementId:"G-R2QRE36WEQ",databaseURL:"https://peloton-alerts-default-rtdb.firebaseio.com/"},Xe=Pa(()=>ct(La));if(self.location.pathname.includes("/pr-preview/"))self.addEventListener("install",()=>self.skipWaiting()),self.addEventListener("activate",t=>{t.waitUntil(caches.keys().then(e=>Promise.all(e.map(n=>caches.delete(n)))).then(()=>self.registration.unregister()))});else{console.log("Running manifest v1"),Aa([{"revision":"9440992f25cc827a732b6de18186955c","url":"index.html"},{"revision":null,"url":"assets/index-DZCmobZK.css"},{"revision":null,"url":"assets/index-CnVxp9JL.js"},{"revision":"f404aa33159772b83b4157e6c60f70b0","url":"images/icon-128x128.png"},{"revision":"3fbcb69ff82cb057aacbde829fcac3d4","url":"images/icon-144x144.png"},{"revision":"39949bda1302596136fabed62326b345","url":"images/icon-152x152.png"},{"revision":"e79959ae56ff2009393ad140e0a72d50","url":"images/icon-192x192.png"},{"revision":"6fbbdcf26e7ab28e1aa14b9ee6e13a7c","url":"images/icon-384x384.png"},{"revision":"1a80b4ca483f9c7556030ce1b91811c0","url":"images/icon-48x48.png"},{"revision":"12af888af4f6a759d2486fe81235b801","url":"images/icon-512x512.png"},{"revision":"397913248c674925c6b0c9abe0af5c7f","url":"images/icon-72x72.png"},{"revision":"9c80cc49e5bba8f35cd85ad5c60c8d09","url":"images/icon-96x96.png"},{"revision":"3b7374831672e6cec408941e8262e53e","url":"manifest.webmanifest"}]),Ra();let e;if(be(new Na(va("index.html"),{allowlist:e})),be(({url:n})=>n.origin===self.location.origin&&n.pathname.endsWith(".png"),new xa({cacheName:"images",plugins:[new oa({maxEntries:50})]})),na(),Xe){const n=Ms(Xe),r=/iPhone|iPad|iPod/.test(self.navigator.userAgent);Us(n,async s=>{console.log("[messaging-sw] Received background message ",s);const a=s.notification?.title??s.data?.title,o=s.notification?.body??s.data?.body;a&&(s.notification||r&&(await self.clients.matchAll({type:"window",includeUncontrolled:!0})).some(c=>c.visibilityState==="visible")||self.registration.showNotification(a,{body:o,data:s.data}))}),self.addEventListener("notificationclick",s=>{s.notification.close();const a=self.location.pathname,o=a.substring(0,a.lastIndexOf("/")+1),i=s.notification.data??{};let c;if(i.changeType==="waitlist_changed"){const u=new URLSearchParams({classId:i.classId??"",studioId:i.studioId??"",startsAt:i.startsAt??"",waitingCount:i.waitingCount??""});c=`${o}#/waitlist-alert?${u}`}else c=i.classUrl?`${o}?classUrl=${encodeURIComponent(i.classUrl)}`:o;s.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(u=>{const m=u.find(g=>new URL(g.url).origin===self.location.origin);return m?(m.navigate(c),m.focus()):self.clients.openWindow(c)}))})}console.log("Service worker loaded :)")}
//# sourceMappingURL=messaging-sw.js.map

//# debugId=9ef9cbff-61c2-5863-b074-e3e6c8a5a986
