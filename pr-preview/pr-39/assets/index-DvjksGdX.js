...
`,lB=()=>v.jsx("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none","aria-hidden":"true",children:v.jsx("path",{d:"M3 5h14M3 10h14M3 15h14",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})}),cB=()=>{const[e,t]=C.useState(!1),n=ct(j_);return v.jsxs(v.Fragment,{children:[v.jsxs(nB,{children:[v.jsxs(rB,{to:rt.CLASS_LIST,children:[v.jsx(tI,{}),v.jsx(iB,{children:"Peloton Alerts"})]}),v.jsxs(sB,{children:[v.jsx(tf,{to:rt.CLASS_LIST,end:!0,children:"Classes"}),v.jsx(tf,{to:rt.ALERTS,children:"Alerts"}),v.jsx(tf,{to:rt.ABOUT,end:!0,children:"FAQ"}),n&&v.jsx(tf,{to:rt.STATS,children:"Stats"})]}),v.jsx(oB,{children:v.jsx(eB,{})}),v.jsx(aB,{type:"button","aria-label":"Open menu",onClick:()=>t(!0),children:v.jsx(lB,{})})]}),v.jsx(Y8,{open:e,onClose:()=>t(!1)})]})},uB=I.div`
  min-height: 100%;
  display: flex;
  flex-direction: column;
`,dB=I.div`
...
`,FB=({matchCount:e,nearMissCount:t})=>v.jsxs(HB,{children:[v.jsxs(Dx,{children:[v.jsx(Ox,{$color:"#2e7d32",children:e})," ",e===1?"class":"classes"," would have triggered"]}),v.jsxs(Dx,{children:[v.jsx(Ox,{$color:"#e65100",children:t})," near"," ",t===1?"miss":"misses"]})]}),qB=I.div`
  display: flex;
  flex-direction: column;
  gap: 0;
  ${bs}
...
`,Nx=({name:e,value:t,checked:n,onChange:i,label:o,hint:l,icon:u})=>{const f=C.useId();return v.jsxs(aH,{htmlFor:f,children:[v.jsx(dH,{type:"radio",id:f,name:e,value:t,checked:n,onChange:i}),u,v.jsxs(lH,{children:[v.jsx(cH,{children:o}),l&&v.jsx(uH,{children:l})]})]})},Mx=I.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,kx=I.legend`
...
`,jx=I.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,fH=Object.entries(ke.STUDIOS).map(([e,t])=>({id:e,label:t.location})),hH=[{status:"free",label:"Open spots only",hint:"Alert me when a class has available spots"},{status:"waitlist",label:"Open spots or waitlist",hint:"Alert me even if I'd join the waitlist"}],pH=({name:e,onNameChange:t,studioId:n,onStudioChange:i,maxStatus:o,onStatusChange:l})=>v.jsxs("div",{children:[v.jsx(oH,{label:"Alert name (optional)",hint:"Leave blank to auto-generate a name from your filters",placeholder:"e.g. Morning Cycling with Cody",value:e,onChange:t}),v.jsx(jx,{}),v.jsxs(Mx,{children:[v.jsx(kx,{children:"Which studio?"}),v.jsx(Lx,{children:"Pick the Peloton studio you want to monitor."}),v.jsx(Px,{children:fH.map(u=>v.jsx(Nx,{name:"studio",value:u.id,checked:n===u.id,onChange:()=>i(u.id),label:u.label},u.id))})]}),v.jsx(jx,{}),v.jsxs(Mx,{children:[v.jsx(kx,{children:"When should we alert you?"}),v.jsx(Lx,{children:"Choose whether to include waitlisted classes."}),v.jsx(Px,{children:hH.map(u=>v.jsx(Nx,{name:"status",value:u.status,checked:o===u.status,onChange:()=>l(u.status),label:u.label,hint:u.hint},u.status))})]})]}),Ux={Cardio:"#d8ec43",Cycling:"#bbd4f4",Meditation:"#e6d4ff",Rowing:"#cbf293","Outdoor Run":"#a8e6cf","Outdoor Run/Walk":"#94f3d0",Running:"#fde987",Strength:"#ffc0d5",Tread:"#fdbe9f",Walking:"#ffa8a9",Yoga:"#ceffdc"},zI=.2,ph=e=>Math.round(e*(1-zI*2)),mH=e=>Math.round(e*zI),gH=I.div`
...
`,p9=I.input`
  accent-color: ${e=>e.theme.colors.accent};
`,eD=({value:e,checked:t,onChange:n,label:i,icon:o})=>{const l=C.useId();return v.jsxs(f9,{$checked:t,htmlFor:l,children:[v.jsx(p9,{type:"checkbox",id:l,value:e,checked:t,onChange:n}),o,v.jsx(h9,{children:i})]})},eT=I.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,tT=I.legend`
...
`,yT=I.p`
  ...
  margin: 0;
  line-height: 1.5;
`,Wq=({classes:e,fulfilledTimeStamp:t})=>{const n=ct(u=>Iq(u,e)),i=ct(Eq),o=ct(u=>u.filters.selectedBookableStatuses.includes("free")),l=C.useMemo(()=>t?new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"}).format(t):void 0,[t]);return n.length===0?v.jsxs(Gq,{children:[v.jsx(Yq,{children:"No classes found"}),i&&v.jsx(yT,{children:"Try resetting your filters or selecting more options in the sidebar."}),o&&!i&&v.jsx(yT,{children:"New classes usually open at 12:00 pm on Mondays and Thursdays in your studio's timezone."})]}):v.jsx(Hq,{children:n.map((u,f)=>v.jsxs(Fq,{children:[v.jsxs(qq,{children:[v.jsx(Vq,{children:u.formattedDate}),f===0&&l&&v.jsxs(gT,{children:["Times in studio timezone · loaded ",l]}),f===0&&!l&&v.jsx(gT,{children:"All times in studio timezone"})]}),u.classes.map((h,p)=>v.jsx(Bq,{clazz:h},p))]},f))})},vT=I.div`
  background-color: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 32px 24px;
...
`,Xq=I.code`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,Zq=()=>{const e=ct(Do),{currentData:t,isLoading:n,error:i,fulfilledTimeStamp:o}=JI(e,{refetchOnMountOrArgChange:!0});return i&&!n?v.jsxs(vT,{children:[v.jsx(Kq,{children:"Failed to load classes"}),v.jsx(Xq,{children:d9(i)})]}):!t||n?v.jsx(vT,{children:v.jsx(Qq,{children:"Loading classes…"})}):v.jsx(Wq,{classes:t,fulfilledTimeStamp:o})},Jq=I.div``,pv=300,eV=I.aside`
  max-width: 100%;
  width: ${pv}px;
