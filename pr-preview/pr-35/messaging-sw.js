 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$($a,Oa,"app");const Pa=t=>{try{return t()}catch(e){console.error(e)}},Ma={apiKey:"AIzaSyAMtG6b23AqO2WbJ2ad8SKMXD1X4tfALtc",authDomain:"peloton-alerts.firebaseapp.com",projectId:"peloton-alerts",storageBucket:"peloton-alerts.appspot.com",messagingSenderId:"331185140393",appId:"1:331185140393:web:5f49c5c60b8b162914efb8",measurementId:"G-R2QRE36WEQ",databaseURL:"https://peloton-alerts-default-rtdb.firebaseio.com/"},Xe=Pa(()=>ct(Ma)),La=1;console.log(`Running manifest v${La}`);Aa([{"revision":"e665b9d2bfd239c3d008d95a892d5a1a","url":"index.html"},{"revision":null,"url":"assets/index-DDVPQvuI.css"},{"revision":null,"url":"assets/index-B4VVTW9T.js"},{"revision":"f404aa33159772b83b4157e6c60f70b0","url":"images/icon-128x128.png"},{"revision":"3fbcb69ff82cb057aacbde829fcac3d4","url":"images/icon-144x144.png"},{"revision":"39949bda1302596136fabed62326b345","url":"images/icon-152x152.png"},{"revision":"e79959ae56ff2009393ad140e0a72d50","url":"images/icon-192x192.png"},{"revision":"6fbbdcf26e7ab28e1aa14b9ee6e13a7c","url":"images/icon-384x384.png"},{"revision":"1a80b4ca483f9c7556030ce1b91811c0","url":"images/icon-48x48.png"},{"revision":"12af888af4f6a759d2486fe81235b801","url":"images/icon-512x512.png"},{"revision":"397913248c674925c6b0c9abe0af5c7f","url":"images/icon-72x72.png"},{"revision":"9c80cc49e5bba8f35cd85ad5c60c8d09","url":"images/icon-96x96.png"},{"revision":"f0c2b88d2d2cab5a6932e4ea96b96235","url":"manifest.webmanifest"}]);Ra();let Ua;De(new Na(va("index.html"),{allowlist:Ua}));De(({url:t})=>t.origin===self.location.origin&&t.pathname.endsWith(".png"),new xa({cacheName:"images",plugins:[new oa({maxEntries:50})]}));na();if(Xe){const t=Ls(Xe),e=/iPhone|iPad|iPod/.test(self.navigator.userAgent);Us(t,async n=>{console.log("[messaging-sw] Received background message ",n);const r=n.notification?.title??n.data?.title,s=n.notification?.body??n.data?.body;r&&(n.notification&&!e||e&&(await self.clients.matchAll({type:"window",includeUncontrolled:!0})).some(o=>o.visibilityState==="visible")||self.registration.showNotification(r,{body:s}))})}console.log("Service worker loaded :)");
