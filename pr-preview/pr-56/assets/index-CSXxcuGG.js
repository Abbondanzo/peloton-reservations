 ...
 */var Zx;function eN(){if(Zx)return tc;Zx=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(i,o,l){var u=null;if(l!==void 0&&(u=""+l),o.key!==void 0&&(u=""+o.key),"key"in o){l={};for(var f in o)f!=="key"&&(l[f]=o[f])}else l=o;return o=l.ref,{$$typeof:e,type:i,key:u,ref:o!==void 0?o:null,props:l}}return tc.Fragment=t,tc.jsx=n,tc.jsxs=n,tc}var Jx;function tN(){return Jx||(Jx=1,gg.exports=eN()),gg.exports}var g=tN(),yg={exports:{}},je={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var e1;function nN(){if(e1)return je;e1=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),u=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),v=Symbol.iterator;function _(M){return M===null||typeof M!="object"?null:(M=v&&M[v]||M["@@iterator"],typeof M=="function"?M:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},x=Object.assign,O={};function R(M,X,le){this.props=M,this.context=X,this.refs=O,this.updater=le||b}R.prototype.isReactComponent={},R.prototype.setState=function(M,X){if(typeof M!="object"&&typeof M!="function"&&M!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,M,X,"setState")},R.prototype.forceUpdate=function(M){this.updater.enqueueForceUpdate(this,M,"forceUpdate")};function D(){}D.prototype=R.prototype;function k(M,X,le){this.props=M,this.context=X,this.refs=O,this.updater=le||b}var C=k.prototype=new D;C.constructor=k,x(C,R.prototype),C.isPureReactComponent=!0;var A=Array.isArray,N={H:null,A:null,T:null,S:null,V:null},I=Object.prototype.hasOwnProperty;function P(M,X,le,ie,de,me){return le=me.ref,{$$typeof:e,type:M,key:X,ref:le!==void 0?le:null,props:me}}function F(M,X){return P(M.type,X,void 0,void 0,void 0,M.props)}function H(M){return typeof M=="object"&&M!==null&&M.$$typeof===e}function B(M){var X={"=":"=0",":":"=2"};return"$"+M.replace(/[=:]/g,function(le){return X[le]})}var z=/\/+/g;function G(M,X){return typeof M=="object"&&M!==null&&M.key!=null?B(""+M.key):X.toString(36)}function V(){}function te(M){switch(M.status){case"fulfilled":return M.value;case"rejected":throw M.reason;default:switch(typeof M.status=="string"?M.then(V,V):(M.status="pending",M.then(function(X){M.status==="pending"&&(M.status="fulfilled",M.value=X)},function(X){M.status==="pending"&&(M.status="rejected",M.reason=X)})),M.status){case"fulfilled":return M.value;case"rejected":throw M.reason}}throw M}function ue(M,X,le,ie,de){var me=typeof M;(me==="undefined"||me==="boolean")&&(M=null);var pe=!1;if(M===null)pe=!0;else switch(me){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(M.$$typeof){case e:case t:pe=!0;break;case y:return pe=M._init,ue(pe(M._payload),X,le,ie,de)}}if(pe)return de=de(M),pe=ie===""?"."+G(M,0):ie,A(de)?(le="",pe!=null&&(le=pe.replace(z,"$&/")+"/"),ue(de,X,le,"",function(Oe){return Oe})):de!=null&&(H(de)&&(de=F(de,le+(de.key==null||M&&M.key===de.key?"":(""+de.key).replace(z,"$&/")+"/")+pe)),X.push(de)),1;pe=0;var Ie=ie===""?".":ie+":";if(A(M))for(var be=0;be<M.length;be++)ie=M[be],me=Ie+G(ie,be),pe+=ue(ie,X,le,me,de);else if(be=_(M),typeof be=="function")for(M=be.call(M),be=0;!(ie=M.next()).done;)ie=ie.value,me=Ie+G(ie,be++),pe+=ue(ie,X,le,me,de);else if(me==="object"){if(typeof M.then=="function")return ue(te(M),X,le,ie,de);throw X=String(M),Error("Objects are not valid as a React child (found: "+(X==="[object Object]"?"object with keys {"+Object.keys(M).join(", ")+"}":X)+"). If you meant to render a collection of children, use an array instead.")}return pe}function j(M,X,le){if(M==null)return M;var ie=[],de=0;return ue(M,ie,"","",function(me){return X.call(le,me,de++)}),ie}function K(M){if(M._status===-1){var X=M._result;X=X(),X.then(function(le){(M._status===0||M._status===-1)&&(M._status=1,M._result=le)},function(le){(M._status===0||M._status===-1)&&(M._status=2,M._result=le)}),M._status===-1&&(M._status=0,M._result=X)}if(M._status===1)return M._result.default;throw M._result}var ne=typeof reportError=="function"?reportError:function(M){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var X=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof M=="object"&&M!==null&&typeof M.message=="string"?String(M.message):String(M),error:M});if(!window.dispatchEvent(X))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",M);return}console.error(M)};function ae(){}return je.Children={map:j,forEach:function(M,X,le){j(M,function(){X.apply(this,arguments)},le)},count:function(M){var X=0;return j(M,function(){X++}),X},toArray:function(M){return j(M,function(X){return X})||[]},only:function(M){if(!H(M))throw Error("React.Children.only expected to receive a single React element child.");return M}},je.Component=R,je.Fragment=n,je.Profiler=o,je.PureComponent=k,je.StrictMode=i,je.Suspense=p,je.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=N,je.__COMPILER_RUNTIME={__proto__:null,c:function(M){return N.H.useMemoCache(M)}},je.cache=function(M){return function(){return M.apply(null,arguments)}},je.cloneElement=function(M,X,le){if(M==null)throw Error("The argument must be a React element, but you passed "+M+".");var ie=x({},M.props),de=M.key,me=void 0;if(X!=null)for(pe in X.ref!==void 0&&(me=void 0),X.key!==void 0&&(de=""+X.key),X)!I.call(X,pe)||pe==="key"||pe==="__self"||pe==="__source"||pe==="ref"&&X.ref===void 0||(ie[pe]=X[pe]);var pe=arguments.length-2;if(pe===1)ie.children=le;else if(1<pe){for(var Ie=Array(pe),be=0;be<pe;be++)Ie[be]=arguments[be+2];ie.children=Ie}return P(M.type,de,void 0,void 0,me,ie)},je.createContext=function(M){return M={$$typeof:u,_currentValue:M,_currentValue2:M,_threadCount:0,Provider:null,Consumer:null},M.Provider=M,M.Consumer={$$typeof:l,_context:M},M},je.createElement=function(M,X,le){var ie,de={},me=null;if(X!=null)for(ie in X.key!==void 0&&(me=""+X.key),X)I.call(X,ie)&&ie!=="key"&&ie!=="__self"&&ie!=="__source"&&(de[ie]=X[ie]);var pe=arguments.length-2;if(pe===1)de.children=le;else if(1<pe){for(var Ie=Array(pe),be=0;be<pe;be++)Ie[be]=arguments[be+2];de.children=Ie}if(M&&M.defaultProps)for(ie in pe=M.defaultProps,pe)de[ie]===void 0&&(de[ie]=pe[ie]);return P(M,me,void 0,void 0,null,de)},je.createRef=function(){return{current:null}},je.forwardRef=function(M){return{$$typeof:f,render:M}},je.isValidElement=H,je.lazy=function(M){return{$$typeof:y,_payload:{_status:-1,_result:M},_init:K}},je.memo=function(M,X){return{$$typeof:h,type:M,compare:X===void 0?null:X}},je.startTransition=function(M){var X=N.T,le={};N.T=le;try{var ie=M(),de=N.S;de!==null&&de(le,ie),typeof ie=="object"&&ie!==null&&typeof ie.then=="function"&&ie.then(ae,ne)}catch(me){ne(me)}finally{N.T=X}},je.unstable_useCacheRefresh=function(){return N.H.useCacheRefresh()},je.use=function(M){return N.H.use(M)},je.useActionState=function(M,X,le){return N.H.useActionState(M,X,le)},je.useCallback=function(M,X){return N.H.useCallback(M,X)},je.useContext=function(M){return N.H.useContext(M)},je.useDebugValue=function(){},je.useDeferredValue=function(M,X){return N.H.useDeferredValue(M,X)},je.useEffect=function(M,X,le){var ie=N.H;if(typeof le=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return ie.useEffect(M,X)},je.useId=function(){return N.H.useId()},je.useImperativeHandle=function(M,X,le){return N.H.useImperativeHandle(M,X,le)},je.useInsertionEffect=function(M,X){return N.H.useInsertionEffect(M,X)},je.useLayoutEffect=function(M,X){return N.H.useLayoutEffect(M,X)},je.useMemo=function(M,X){return N.H.useMemo(M,X)},je.useOptimistic=function(M,X){return N.H.useOptimistic(M,X)},je.useReducer=function(M,X,le){return N.H.useReducer(M,X,le)},je.useRef=function(M){return N.H.useRef(M)},je.useState=function(M){return N.H.useState(M)},je.useSyncExternalStore=function(M,X,le){return N.H.useSyncExternalStore(M,X,le)},je.useTransition=function(){return N.H.useTransition()},je.version="19.1.1",je}var t1;function Th(){return t1||(t1=1,yg.exports=nN()),yg.exports}var E=Th();const dr=Jk(E);var vg={exports:{}},nc={},_g={exports:{}},bg={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var n1;function rN(){return n1||(n1=1,(function(e){function t(j,K){var ne=j.length;j.push(K);e:for(;0<ne;){var ae=ne-1>>>1,M=j[ae];if(0<o(M,K))j[ae]=K,j[ne]=M,ne=ae;else break e}}function n(j){return j.length===0?null:j[0]}function i(j){if(j.length===0)return null;var K=j[0],ne=j.pop();if(ne!==K){j[0]=ne;e:for(var ae=0,M=j.length,X=M>>>1;ae<X;){var le=2*(ae+1)-1,ie=j[le],de=le+1,me=j[de];if(0>o(ie,ne))de<M&&0>o(me,ie)?(j[ae]=me,j[de]=ne,ae=de):(j[ae]=ie,j[le]=ne,ae=le);else if(de<M&&0>o(me,ne))j[ae]=me,j[de]=ne,ae=de;else break e}}return K}function o(j,K){var ne=j.sortIndex-K.sortIndex;return ne!==0?ne:j.id-K.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var u=Date,f=u.now();e.unstable_now=function(){return u.now()-f}}var p=[],h=[],y=1,v=null,_=3,b=!1,x=!1,O=!1,R=!1,D=typeof setTimeout=="function"?setTimeout:null,k=typeof clearTimeout=="function"?clearTimeout:null,C=typeof setImmediate<"u"?setImmediate:null;function A(j){for(var K=n(h);K!==null;){if(K.callback===null)i(h);else if(K.startTime<=j)i(h),K.sortIndex=K.expirationTime,t(p,K);else break;K=n(h)}}function N(j){if(O=!1,A(j),!x)if(n(p)!==null)x=!0,I||(I=!0,G());else{var K=n(h);K!==null&&ue(N,K.startTime-j)}}var I=!1,P=-1,F=5,H=-1;function B(){return R?!0:!(e.unstable_now()-H<F)}function z(){if(R=!1,I){var j=e.unstable_now();H=j;var K=!0;try{e:{x=!1,O&&(O=!1,k(P),P=-1),b=!0;var ne=_;try{t:{for(A(j),v=n(p);v!==null&&!(v.expirationTime>j&&B());){var ae=v.callback;if(typeof ae=="function"){v.callback=null,_=v.priorityLevel;var M=ae(v.expirationTime<=j);if(j=e.unstable_now(),typeof M=="function"){v.callback=M,A(j),K=!0;break t}v===n(p)&&i(p),A(j)}else i(p);v=n(p)}if(v!==null)K=!0;else{var X=n(h);X!==null&&ue(N,X.startTime-j),K=!1}}break e}finally{v=null,_=ne,b=!1}K=void 0}}finally{K?G():I=!1}}}var G;if(typeof C=="function")G=function(){C(z)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,te=V.port2;V.port1.onmessage=z,G=function(){te.postMessage(null)}}else G=function(){D(z,0)};function ue(j,K){P=D(function(){j(e.unstable_now())},K)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return _},e.unstable_next=function(j){switch(_){case 1:case 2:case 3:var K=3;break;default:K=_}var ne=_;_=K;try{return j()}finally{_=ne}},e.unstable_requestPaint=function(){R=!0},e.unstable_runWithPriority=function(j,K){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var ne=_;_=j;try{return K()}finally{_=ne}},e.unstable_scheduleCallback=function(j,K,ne){var ae=e.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?ae+ne:ae):ne=ae,j){case 1:var M=-1;break;case 2:M=250;break;case 5:M=1073741823;break;case 4:M=1e4;break;default:M=5e3}return M=ne+M,j={id:y++,callback:K,priorityLevel:j,startTime:ne,expirationTime:M,sortIndex:-1},ne>ae?(j.sortIndex=ne,t(h,j),n(p)===null&&j===n(h)&&(O?(k(P),P=-1):O=!0,ue(N,ne-ae))):(j.sortIndex=M,t(p,j),x||b||(x=!0,I||(I=!0,G()))),j},e.unstable_shouldYield=B,e.unstable_wrapCallback=function(j){var K=_;return function(){var ne=_;_=K;try{return j.apply(this,arguments)}finally{_=ne}}}})(bg)),bg}var r1;function iN(){return r1||(r1=1,_g.exports=rN()),_g.exports}var Sg={exports:{}},on={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var l1;function cN(){if(l1)return wg;l1=1;var e=Th();function t(p,h){return p===h&&(p!==0||1/p===1/h)||p!==p&&h!==h}var n=typeof Object.is=="function"?Object.is:t,i=e.useSyncExternalStore,o=e.useRef,l=e.useEffect,u=e.useMemo,f=e.useDebugValue;return wg.useSyncExternalStoreWithSelector=function(p,h,y,v,_){var b=o(null);if(b.current===null){var x={hasValue:!1,value:null};b.current=x}else x=b.current;b=u(function(){function R(N){if(!D){if(D=!0,k=N,N=v(N),_!==void 0&&x.hasValue){var I=x.value;if(_(I,N))return C=I}return C=N}if(I=C,n(k,N))return I;var P=v(N);return _!==void 0&&_(I,P)?(k=N,I):(k=N,C=P)}var D=!1,k,C,A=y===void 0?null:y;return[function(){return R(h())},A===null?void 0:function(){return R(A())}]},[h,y,v,_]);var O=i(p,b[0],b[1]);return l(function(){x.hasValue=!0,x.value=O},[O]),f(O),O},wg}var c1;function uN(){return c1||(c1=1,xg.exports=cN()),xg.exports}var dN=uN();function tC(e){e()}function fN(){let e=null,t=null;return{clear(){e=null,t=null},notify(){tC(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let i=e;for(;i;)n.push(i),i=i.next;return n},subscribe(n){let i=!0;const o=t={callback:n,next:null,prev:t};return o.prev?o.prev.next=o:e=o,function(){!i||e===null||(i=!1,o.next?o.next.prev=o.prev:t=o.prev,o.prev?o.prev.next=o.next:e=o.next)}}}}var u1={notify(){},get:()=>[]};function hN(e,t){let n,i=u1,o=0,l=!1;function u(O){y();const R=i.subscribe(O);let D=!1;return()=>{D||(D=!0,R(),v())}}function f(){i.notify()}function p(){x.onStateChange&&x.onStateChange()}function h(){return l}function y(){o++,n||(n=e.subscribe(p),i=fN())}function v(){o--,n&&o===0&&(n(),n=void 0,i.clear(),i=u1)}function _(){l||(l=!0,y())}function b(){l&&(l=!1,v())}const x={addNestedSub:u,notifyNestedSubs:f,handleChangeWrapper:p,isSubscribed:h,trySubscribe:_,tryUnsubscribe:b,getListeners:()=>i};return x}var pN=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",mN=pN(),gN=()=>typeof navigator<"u"&&navigator.product==="ReactNative",yN=gN(),vN=()=>mN||yN?E.useLayoutEffect:E.useEffect,_N=vN();function d1(e,t){return e===t?e!==0||t!==0||1/e===1/t:e!==e&&t!==t}function Tc(e,t){if(d1(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;const n=Object.keys(e),i=Object.keys(t);if(n.length!==i.length)return!1;for(let o=0;o<n.length;o++)if(!Object.prototype.hasOwnProperty.call(t,n[o])||!d1(e[n[o]],t[n[o]]))return!1;return!0}var bN=Symbol.for("react-redux-context"),SN=typeof globalThis<"u"?globalThis:{};function xN(){if(!E.createContext)return{};const e=SN[bN]??=new Map;let t=e.get(E.createContext);return t||(t=E.createContext(null),e.set(E.createContext,t)),t}var ps=xN();function wN(e){const{children:t,context:n,serverState:i,store:o}=e,l=E.useMemo(()=>{const p=hN(o);return{store:o,subscription:p,getServerState:i?()=>i:void 0}},[o,i]),u=E.useMemo(()=>o.getState(),[o]);_N(()=>{const{subscription:p}=l;return p.onStateChange=p.notifyNestedSubs,p.trySubscribe(),u!==o.getState()&&p.notifyNestedSubs(),()=>{p.tryUnsubscribe(),p.onStateChange=void 0}},[l,u]);const f=n||ps;return E.createElement(f.Provider,{value:l},t)}var EN=wN;function Av(e=ps){return function(){return E.useContext(e)}}var nC=Av();function rC(e=ps){const t=e===ps?nC:Av(e),n=()=>{const{store:i}=t();return i};return Object.assign(n,{withTypes:()=>n}),n}var iC=rC();function TN(e=ps){const t=e===ps?iC:rC(e),n=()=>t().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var sC=TN(),CN=(e,t)=>e===t;function RN(e=ps){const t=e===ps?nC:Av(e),n=(i,o={})=>{const{equalityFn:l=CN}=typeof o=="function"?{equalityFn:o}:o,u=t(),{store:f,subscription:p,getServerState:h}=u;E.useRef(!0);const y=E.useCallback({[i.name](_){return i(_)}}[i.name],[i]),v=dN.useSyncExternalStoreWithSelector(p.addNestedSub,f.getState,h||f.getState,y,l);return E.useDebugValue(v),v};return Object.assign(n,{withTypes:()=>n}),n}var oC=RN(),AN=tC;/**
 * react-router v7.9.1
 *
 ...
 *
 * @license MIT
 */var aC=e=>{throw TypeError(e)},IN=(e,t,n)=>t.has(e)||aC("Cannot "+n),Eg=(e,t,n)=>(IN(e,t,"read from private field"),n?n.call(e):t.get(e)),DN=(e,t,n)=>t.has(e)?aC("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),f1="popstate";function ON(e={}){function t(o,l){let{pathname:u="/",search:f="",hash:p=""}=Si(o.location.hash.substring(1));return!u.startsWith("/")&&!u.startsWith(".")&&(u="/"+u),Uc("",{pathname:u,search:f,hash:p},l.state&&l.state.usr||null,l.state&&l.state.key||"default")}function n(o,l){let u=o.document.querySelector("base"),f="";if(u&&u.getAttribute("href")){let p=o.location.href,h=p.indexOf("#");f=h===-1?p:p.slice(0,h)}return f+"#"+(typeof l=="string"?l:ms(l))}function i(o,l){wt(o.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(l)})`)}return NN(t,n,i,e)}function $e(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function wt(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function kN(){return Math.random().toString(36).substring(2,10)}function h1(e,t){return{usr:e.state,key:e.key,idx:t}}function Uc(e,t,n=null,i){return{pathname:typeof e=="string"?e:e.pathname,search:"",hash:"",...typeof t=="string"?Si(t):t,state:n,key:t&&t.key||i||kN()}}function ms({pathname:e="/",search:t="",hash:n=""}){return t&&t!=="?"&&(e+=t.charAt(0)==="?"?t:"?"+t),n&&n!=="#"&&(e+=n.charAt(0)==="#"?n:"#"+n),e}function Si(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substring(n),e=e.substring(0,n));let i=e.indexOf("?");i>=0&&(t.search=e.substring(i),e=e.substring(0,i)),e&&(t.pathname=e)}return t}function NN(e,t,n,i={}){let{window:o=document.defaultView,v5Compat:l=!1}=i,u=o.history,f="POP",p=null,h=y();h==null&&(h=0,u.replaceState({...u.state,idx:h},""));function y(){return(u.state||{idx:null}).idx}function v(){f="POP";let R=y(),D=R==null?null:R-h;h=R,p&&p({action:f,location:O.location,delta:D})}function _(R,D){f="PUSH";let k=Uc(O.location,R,D);n&&n(k,R),h=y()+1;let C=h1(k,h),A=O.createHref(k);try{u.pushState(C,"",A)}catch(N){if(N instanceof DOMException&&N.name==="DataCloneError")throw N;o.location.assign(A)}l&&p&&p({action:f,location:O.location,delta:1})}function b(R,D){f="REPLACE";let k=Uc(O.location,R,D);n&&n(k,R),h=y();let C=h1(k,h),A=O.createHref(k);u.replaceState(C,"",A),l&&p&&p({action:f,location:O.location,delta:0})}function x(R){return lC(R)}let O={get action(){return f},get location(){return e(o,u)},listen(R){if(p)throw new Error("A history only accepts one active listener");return o.addEventListener(f1,v),p=R,()=>{o.removeEventListener(f1,v),p=null}},createHref(R){return t(o,R)},createURL:x,encodeLocation(R){let D=x(R);return{pathname:D.pathname,search:D.search,hash:D.hash}},push:_,replace:b,go(R){return u.go(R)}};return O}function lC(e,t=!1){let n="http://localhost";typeof window<"u"&&(n=window.location.origin!=="null"?window.location.origin:window.location.href),$e(n,"No window.location.(origin|href) available to create URL");let i=typeof e=="string"?e:ms(e);return i=i.replace(/ $/,"%20"),!t&&i.startsWith("//")&&(i=n+i),new URL(i,n)}var bc,p1=class{constructor(e){if(DN(this,bc,new Map),e)for(let[t,n]of e)this.set(t,n)}get(e){if(Eg(this,bc).has(e))return Eg(this,bc).get(e);if(e.defaultValue!==void 0)return e.defaultValue;throw new Error("No value found for context")}set(e,t){Eg(this,bc).set(e,t)}};bc=new WeakMap;var MN=new Set(["lazy","caseSensitive","path","id","index","children"]);function LN(e){return MN.has(e)}var PN=new Set(["lazy","caseSensitive","path","id","index","middleware","children"]);function jN(e){return PN.has(e)}function $N(e){return e.index===!0}function zc(e,t,n=[],i={},o=!1){return e.map((l,u)=>{let f=[...n,String(u)],p=typeof l.id=="string"?l.id:f.join("-");if($e(l.index!==!0||!l.children,"Cannot specify children on an index route"),$e(o||!i[p],`Found a route id collision on id "${p}".  Route id's must be globally unique within Data Router usages`),$N(l)){let h={...l,...t(l),id:p};return i[p]=h,h}else{let h={...l,...t(l),id:p,children:void 0};return i[p]=h,l.children&&(h.children=zc(l.children,t,f,i,o)),h}})}function ns(e,t,n="/"){return pf(e,t,n,!1)}function pf(e,t,n,i){let o=typeof t=="string"?Si(t):t,l=Jn(o.pathname||"/",n);if(l==null)return null;let u=cC(e);zN(u);let f=null;for(let p=0;f==null&&p<u.length;++p){let h=XN(l);f=QN(u[p],h,i)}return f}function UN(e,t){let{route:n,pathname:i,params:o}=e;return{id:n.id,pathname:i,params:o,data:t[n.id],loaderData:t[n.id],handle:n.handle}}function cC(e,t=[],n=[],i="",o=!1){let l=(u,f,p=o,h)=>{let y={relativePath:h===void 0?u.path||"":h,caseSensitive:u.caseSensitive===!0,childrenIndex:f,route:u};if(y.relativePath.startsWith("/")){if(!y.relativePath.startsWith(i)&&p)return;$e(y.relativePath.startsWith(i),`Absolute route path "${y.relativePath}" nested under path "${i}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),y.relativePath=y.relativePath.slice(i.length)}let v=Or([i,y.relativePath]),_=n.concat(y);u.children&&u.children.length>0&&($e(u.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${v}".`),cC(u.children,t,_,v,p)),!(u.path==null&&!u.index)&&t.push({path:v,score:WN(v,u.index),routesMeta:_})};return e.forEach((u,f)=>{if(u.path===""||!u.path?.includes("?"))l(u,f);else for(let p of uC(u.path))l(u,f,!0,p)}),t}function uC(e){let t=e.split("/");if(t.length===0)return[];let[n,...i]=t,o=n.endsWith("?"),l=n.replace(/\?$/,"");if(i.length===0)return o?[l,""]:[l];let u=uC(i.join("/")),f=[];return f.push(...u.map(p=>p===""?l:[l,p].join("/"))),o&&f.push(...u),f.map(p=>e.startsWith("/")&&p===""?"/":p)}function zN(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:YN(t.routesMeta.map(i=>i.childrenIndex),n.routesMeta.map(i=>i.childrenIndex)))}var BN=/^:[\w-]+$/,HN=3,FN=2,qN=1,VN=10,GN=-2,m1=e=>e==="*";function WN(e,t){let n=e.split("/"),i=n.length;return n.some(m1)&&(i+=GN),t&&(i+=FN),n.filter(o=>!m1(o)).reduce((o,l)=>o+(BN.test(l)?HN:l===""?qN:VN),i)}function YN(e,t){return e.length===t.length&&e.slice(0,-1).every((i,o)=>i===t[o])?e[e.length-1]-t[t.length-1]:0}function QN(e,t,n=!1){let{routesMeta:i}=e,o={},l="/",u=[];for(let f=0;f<i.length;++f){let p=i[f],h=f===i.length-1,y=l==="/"?t:t.slice(l.length)||"/",v=kf({path:p.relativePath,caseSensitive:p.caseSensitive,end:h},y),_=p.route;if(!v&&h&&n&&!i[i.length-1].route.index&&(v=kf({path:p.relativePath,caseSensitive:p.caseSensitive,end:!1},y)),!v)return null;Object.assign(o,v.params),u.push({params:o,pathname:Or([l,v.pathname]),pathnameBase:tM(Or([l,v.pathnameBase])),route:_}),v.pathnameBase!=="/"&&(l=Or([l,v.pathnameBase]))}return u}function kf(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,i]=KN(e.path,e.caseSensitive,e.end),o=t.match(n);if(!o)return null;let l=o[0],u=l.replace(/(.)\/+$/,"$1"),f=o.slice(1);return{params:i.reduce((h,{paramName:y,isOptional:v},_)=>{if(y==="*"){let x=f[_]||"";u=l.slice(0,l.length-x.length).replace(/(.)\/+$/,"$1")}const b=f[_];return v&&!b?h[y]=void 0:h[y]=(b||"").replace(/%2F/g,"/"),h},{}),pathname:l,pathnameBase:u,pattern:e}}function KN(e,t=!1,n=!0){wt(e==="*"||!e.endsWith("*")||e.endsWith("/*"),`Route path "${e}" will be treated as if it were "${e.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${e.replace(/\*$/,"/*")}".`);let i=[],o="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,f,p)=>(i.push({paramName:f,isOptional:p!=null}),p?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return e.endsWith("*")?(i.push({paramName:"*"}),o+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?o+="\\/*$":e!==""&&e!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),i]}function XN(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return wt(!1,`The URL path "${e}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),e}}function Jn(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,i=e.charAt(n);return i&&i!=="/"?null:e.slice(n)||"/"}function ZN({basename:e,pathname:t}){return t==="/"?e:Or([e,t])}function JN(e,t="/"){let{pathname:n,search:i="",hash:o=""}=typeof e=="string"?Si(e):e;return{pathname:n?n.startsWith("/")?n:eM(n,t):t,search:nM(i),hash:rM(o)}}function eM(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(o=>{o===".."?n.length>1&&n.pop():o!=="."&&n.push(o)}),n.length>1?n.join("/"):"/"}function Tg(e,t,n,i){return`Cannot include a '${e}' character in a manually specified \`to.${t}\` field [${JSON.stringify(i)}].  Please separate it out to the \`to.${n}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function dC(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function Ch(e){let t=dC(e);return t.map((n,i)=>i===t.length-1?n.pathname:n.pathnameBase)}function Rh(e,t,n,i=!1){let o;typeof e=="string"?o=Si(e):(o={...e},$e(!o.pathname||!o.pathname.includes("?"),Tg("?","pathname","search",o)),$e(!o.pathname||!o.pathname.includes("#"),Tg("#","pathname","hash",o)),$e(!o.search||!o.search.includes("#"),Tg("#","search","hash",o)));let l=e===""||o.pathname==="",u=l?"/":o.pathname,f;if(u==null)f=n;else{let v=t.length-1;if(!i&&u.startsWith("..")){let _=u.split("/");for(;_[0]==="..";)_.shift(),v-=1;o.pathname=_.join("/")}f=v>=0?t[v]:"/"}let p=JN(o,f),h=u&&u!=="/"&&u.endsWith("/"),y=(l||u===".")&&n.endsWith("/");return!p.pathname.endsWith("/")&&(h||y)&&(p.pathname+="/"),p}var Or=e=>e.join("/").replace(/\/\/+/g,"/"),tM=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),nM=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,rM=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e,Nf=class{constructor(e,t,n,i=!1){this.status=e,this.statusText=t||"",this.internal=i,n instanceof Error?(this.data=n.toString(),this.error=n):this.data=n}};function Bc(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}var fC=["POST","PUT","PATCH","DELETE"],iM=new Set(fC),sM=["GET",...fC],oM=new Set(sM),aM=new Set([301,302,303,307,308]),lM=new Set([307,308]),Cg={state:"idle",location:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},cM={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0},rc={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},uM=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Iv=e=>uM.test(e),dM=e=>({hasErrorBoundary:!!e.hasErrorBoundary}),hC="remix-router-transitions",pC=Symbol("ResetLoaderData");function fM(e){const t=e.window?e.window:typeof window<"u"?window:void 0,n=typeof t<"u"&&typeof t.document<"u"&&typeof t.document.createElement<"u";$e(e.routes.length>0,"You must provide a non-empty routes array to createRouter");let i=e.hydrationRouteProperties||[],o=e.mapRouteProperties||dM,l={},u=zc(e.routes,o,void 0,l),f,p=e.basename||"/";p.startsWith("/")||(p=`/${p}`);let h=e.dataStrategy||yM,y={...e.future},v=null,_=new Set,b=null,x=null,O=null,R=e.hydrationData!=null,D=ns(u,e.history.location,p),k=!1,C=null,A;if(D==null&&!e.patchRoutesOnNavigation){let $=Qn(404,{pathname:e.history.location.pathname}),{matches:W,route:ee}=Vd(u);A=!0,D=W,C={[ee.id]:$}}else if(D&&!e.hydrationData&&Ns(D,u,e.history.location.pathname).active&&(D=null),D)if(D.some($=>$.route.lazy))A=!1;else if(!D.some($=>$.route.loader))A=!0;else{let $=e.hydrationData?e.hydrationData.loaderData:null,W=e.hydrationData?e.hydrationData.errors:null;if(W){let ee=D.findIndex(ce=>W[ce.route.id]!==void 0);A=D.slice(0,ee+1).every(ce=>!Cy(ce.route,$,W))}else A=D.every(ee=>!Cy(ee.route,$,W))}else{A=!1,D=[];let $=Ns(null,u,e.history.location.pathname);$.active&&$.matches&&(k=!0,D=$.matches)}let N,I={historyAction:e.history.action,location:e.history.location,matches:D,initialized:A,navigation:Cg,restoreScrollPosition:e.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:e.hydrationData&&e.hydrationData.loaderData||{},actionData:e.hydrationData&&e.hydrationData.actionData||null,errors:e.hydrationData&&e.hydrationData.errors||C,fetchers:new Map,blockers:new Map},P="POP",F=!1,H,B=!1,z=new Map,G=null,V=!1,te=!1,ue=new Set,j=new Map,K=0,ne=-1,ae=new Map,M=new Set,X=new Map,le=new Map,ie=new Set,de=new Map,me,pe=null;function Ie(){if(v=e.history.listen(({action:$,location:W,delta:ee})=>{if(me){me(),me=void 0;return}wt(de.size===0||ee!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let ce=ku({currentLocation:I.location,nextLocation:W,historyAction:$});if(ce&&ee!=null){let fe=new Promise(ye=>{me=ye});e.history.go(ee*-1),wr(ce,{state:"blocked",location:W,proceed(){wr(ce,{state:"proceeding",proceed:void 0,reset:void 0,location:W}),fe.then(()=>e.history.go(ee))},reset(){let ye=new Map(I.blockers);ye.set(ce,rc),Ue({blockers:ye})}});return}return Et($,W)}),n){kM(t,z);let $=()=>NM(t,z);t.addEventListener("pagehide",$),G=()=>t.removeEventListener("pagehide",$)}return I.initialized||Et("POP",I.location,{initialHydration:!0}),N}function be(){v&&v(),G&&G(),_.clear(),H&&H.abort(),I.fetchers.forEach(($,W)=>Qt(W)),I.blockers.forEach(($,W)=>Os(W))}function Oe($){return _.add($),()=>_.delete($)}function Ue($,W={}){$.matches&&($.matches=$.matches.map(fe=>{let ye=l[fe.route.id],xe=fe.route;return xe.element!==ye.element||xe.errorElement!==ye.errorElement||xe.hydrateFallbackElement!==ye.hydrateFallbackElement?{...fe,route:ye}:fe})),I={...I,...$};let ee=[],ce=[];I.fetchers.forEach((fe,ye)=>{fe.state==="idle"&&(ie.has(ye)?ee.push(ye):ce.push(ye))}),ie.forEach(fe=>{!I.fetchers.has(fe)&&!j.has(fe)&&ee.push(fe)}),[..._].forEach(fe=>fe(I,{deletedFetchers:ee,viewTransitionOpts:W.viewTransitionOpts,flushSync:W.flushSync===!0})),ee.forEach(fe=>Qt(fe)),ce.forEach(fe=>I.fetchers.delete(fe))}function _t($,W,{flushSync:ee}={}){let ce=I.actionData!=null&&I.navigation.formMethod!=null&&_n(I.navigation.formMethod)&&I.navigation.state==="loading"&&$.state?._isRedirect!==!0,fe;W.actionData?Object.keys(W.actionData).length>0?fe=W.actionData:fe=null:ce?fe=I.actionData:fe=null;let ye=W.loaderData?T1(I.loaderData,W.loaderData,W.matches||[],W.errors):I.loaderData,xe=I.blockers;xe.size>0&&(xe=new Map(xe),xe.forEach((_e,Se)=>xe.set(Se,rc)));let ve=V?!1:Mu($,W.matches||I.matches),Ee=F===!0||I.navigation.formMethod!=null&&_n(I.navigation.formMethod)&&$.state?._isRedirect!==!0;f&&(u=f,f=void 0),V||P==="POP"||(P==="PUSH"?e.history.push($,$.state):P==="REPLACE"&&e.history.replace($,$.state));let Re;if(P==="POP"){let _e=z.get(I.location.pathname);_e&&_e.has($.pathname)?Re={currentLocation:I.location,nextLocation:$}:z.has($.pathname)&&(Re={currentLocation:$,nextLocation:I.location})}else if(B){let _e=z.get(I.location.pathname);_e?_e.add($.pathname):(_e=new Set([$.pathname]),z.set(I.location.pathname,_e)),Re={currentLocation:I.location,nextLocation:$}}Ue({...W,actionData:fe,loaderData:ye,historyAction:P,location:$,initialized:!0,navigation:Cg,revalidation:"idle",restoreScrollPosition:ve,preventScrollReset:Ee,blockers:xe},{viewTransitionOpts:Re,flushSync:ee===!0}),P="POP",F=!1,B=!1,V=!1,te=!1,pe?.resolve(),pe=null}async function gt($,W){if(typeof $=="number"){e.history.go($);return}let ee=Ty(I.location,I.matches,p,$,W?.fromRouteId,W?.relative),{path:ce,submission:fe,error:ye}=g1(!1,ee,W),xe=I.location,ve=Uc(I.location,ce,W&&W.state);ve={...ve,...e.history.encodeLocation(ve)};let Ee=W&&W.replace!=null?W.replace:void 0,Re="PUSH";Ee===!0?Re="REPLACE":Ee===!1||fe!=null&&_n(fe.formMethod)&&fe.formAction===I.location.pathname+I.location.search&&(Re="REPLACE");let _e=W&&"preventScrollReset"in W?W.preventScrollReset===!0:void 0,Se=(W&&W.flushSync)===!0,ze=ku({currentLocation:xe,nextLocation:ve,historyAction:Re});if(ze){wr(ze,{state:"blocked",location:ve,proceed(){wr(ze,{state:"proceeding",proceed:void 0,reset:void 0,location:ve}),gt($,W)},reset(){let Ze=new Map(I.blockers);Ze.set(ze,rc),Ue({blockers:Ze})}});return}await Et(Re,ve,{submission:fe,pendingError:ye,preventScrollReset:_e,replace:W&&W.replace,enableViewTransition:W&&W.viewTransition,flushSync:Se})}function Ln(){pe||(pe=MM()),ol(),Ue({revalidation:"loading"});let $=pe.promise;return I.navigation.state==="submitting"?$:I.navigation.state==="idle"?(Et(I.historyAction,I.location,{startUninterruptedRevalidation:!0}),$):(Et(P||I.historyAction,I.navigation.location,{overrideNavigation:I.navigation,enableViewTransition:B===!0}),$)}async function Et($,W,ee){H&&H.abort(),H=null,P=$,V=(ee&&ee.startUninterruptedRevalidation)===!0,ks(I.location,I.matches),F=(ee&&ee.preventScrollReset)===!0,B=(ee&&ee.enableViewTransition)===!0;let ce=f||u,fe=ee&&ee.overrideNavigation,ye=ee?.initialHydration&&I.matches&&I.matches.length>0&&!k?I.matches:ns(ce,W,p),xe=(ee&&ee.flushSync)===!0;if(ye&&I.initialized&&!te&&TM(I.location,W)&&!(ee&&ee.submission&&_n(ee.submission.formMethod))){_t(W,{matches:ye},{flushSync:xe});return}let ve=Ns(ye,ce,W.pathname);if(ve.active&&ve.matches&&(ye=ve.matches),!ye){let{error:Tt,notFoundMatches:Le,route:st}=No(W.pathname);_t(W,{matches:Le,loaderData:{},errors:{[st.id]:Tt}},{flushSync:xe});return}H=new AbortController;let Ee=ba(e.history,W,H.signal,ee&&ee.submission),Re=e.getContext?await e.getContext():new p1,_e;if(ee&&ee.pendingError)_e=[rs(ye).route.id,{type:"error",error:ee.pendingError}];else if(ee&&ee.submission&&_n(ee.submission.formMethod)){let Tt=await Pn(Ee,W,ee.submission,ye,Re,ve.active,ee&&ee.initialHydration===!0,{replace:ee.replace,flushSync:xe});if(Tt.shortCircuited)return;if(Tt.pendingActionResult){let[Le,st]=Tt.pendingActionResult;if(kn(st)&&Bc(st.error)&&st.error.status===404){H=null,_t(W,{matches:Tt.matches,loaderData:{},errors:{[Le]:st.error}});return}}ye=Tt.matches||ye,_e=Tt.pendingActionResult,fe=Rg(W,ee.submission),xe=!1,ve.active=!1,Ee=ba(e.history,Ee.url,Ee.signal)}let{shortCircuited:Se,matches:ze,loaderData:Ze,errors:yt}=await $r(Ee,W,ye,Re,ve.active,fe,ee&&ee.submission,ee&&ee.fetcherSubmission,ee&&ee.replace,ee&&ee.initialHydration===!0,xe,_e);Se||(H=null,_t(W,{matches:ze||ye,...C1(_e),loaderData:Ze,errors:yt}))}async function Pn($,W,ee,ce,fe,ye,xe,ve={}){ol();let Ee=DM(W,ee);if(Ue({navigation:Ee},{flushSync:ve.flushSync===!0}),ye){let Se=await Ms(ce,W.pathname,$.signal);if(Se.type==="aborted")return{shortCircuited:!0};if(Se.type==="error"){if(Se.partialMatches.length===0){let{matches:Ze,route:yt}=Vd(u);return{matches:Ze,pendingActionResult:[yt.id,{type:"error",error:Se.error}]}}let ze=rs(Se.partialMatches).route.id;return{matches:Se.partialMatches,pendingActionResult:[ze,{type:"error",error:Se.error}]}}else if(Se.matches)ce=Se.matches;else{let{notFoundMatches:ze,error:Ze,route:yt}=No(W.pathname);return{matches:ze,pendingActionResult:[yt.id,{type:"error",error:Ze}]}}}let Re,_e=mf(ce,W);if(!_e.route.action&&!_e.route.lazy)Re={type:"error",error:Qn(405,{method:$.method,pathname:W.pathname,routeId:_e.route.id})};else{let Se=Ea(o,l,$,ce,_e,xe?[]:i,fe),ze=await Ci($,Se,fe,null);if(Re=ze[_e.route.id],!Re){for(let Ze of ce)if(ze[Ze.route.id]){Re=ze[Ze.route.id];break}}if($.signal.aborted)return{shortCircuited:!0}}if(oo(Re)){let Se;return ve&&ve.replace!=null?Se=ve.replace:Se=x1(Re.response.headers.get("Location"),new URL($.url),p)===I.location.pathname+I.location.search,await Ur($,Re,!0,{submission:ee,replace:Se}),{shortCircuited:!0}}if(kn(Re)){let Se=rs(ce,_e.route.id);return(ve&&ve.replace)!==!0&&(P="PUSH"),{matches:ce,pendingActionResult:[Se.route.id,Re,_e.route.id]}}return{matches:ce,pendingActionResult:[_e.route.id,Re]}}async function $r($,W,ee,ce,fe,ye,xe,ve,Ee,Re,_e,Se){let ze=ye||Rg(W,xe),Ze=xe||ve||A1(ze),yt=!V&&!Re;if(fe){if(yt){let kt=Yt(Se);Ue({navigation:ze,...kt!==void 0?{actionData:kt}:{}},{flushSync:_e})}let Pe=await Ms(ee,W.pathname,$.signal);if(Pe.type==="aborted")return{shortCircuited:!0};if(Pe.type==="error"){if(Pe.partialMatches.length===0){let{matches:qr,route:pn}=Vd(u);return{matches:qr,loaderData:{},errors:{[pn.id]:Pe.error}}}let kt=rs(Pe.partialMatches).route.id;return{matches:Pe.partialMatches,loaderData:{},errors:{[kt]:Pe.error}}}else if(Pe.matches)ee=Pe.matches;else{let{error:kt,notFoundMatches:qr,route:pn}=No(W.pathname);return{matches:qr,loaderData:{},errors:{[pn.id]:kt}}}}let Tt=f||u,{dsMatches:Le,revalidatingFetchers:st}=y1($,ce,o,l,e.history,I,ee,Ze,W,Re?[]:i,Re===!0,te,ue,ie,X,M,Tt,p,e.patchRoutesOnNavigation!=null,Se);if(ne=++K,!e.dataStrategy&&!Le.some(Pe=>Pe.shouldLoad)&&!Le.some(Pe=>Pe.route.middleware)&&st.length===0){let Pe=Is();return _t(W,{matches:ee,loaderData:{},errors:Se&&kn(Se[1])?{[Se[0]]:Se[1].error}:null,...C1(Se),...Pe?{fetchers:new Map(I.fetchers)}:{}},{flushSync:_e}),{shortCircuited:!0}}if(yt){let Pe={};if(!fe){Pe.navigation=ze;let kt=Yt(Se);kt!==void 0&&(Pe.actionData=kt)}st.length>0&&(Pe.fetchers=sl(st)),Ue(Pe,{flushSync:_e})}st.forEach(Pe=>{xr(Pe.key),Pe.controller&&j.set(Pe.key,Pe.controller)});let Er=()=>st.forEach(Pe=>xr(Pe.key));H&&H.signal.addEventListener("abort",Er);let{loaderResults:wn,fetcherResults:ln}=await Du(Le,st,$,ce);if($.signal.aborted)return{shortCircuited:!0};H&&H.signal.removeEventListener("abort",Er),st.forEach(Pe=>j.delete(Pe.key));let jn=Gd(wn);if(jn)return await Ur($,jn.result,!0,{replace:Ee}),{shortCircuited:!0};if(jn=Gd(ln),jn)return M.add(jn.key),await Ur($,jn.result,!0,{replace:Ee}),{shortCircuited:!0};let{loaderData:Lo,errors:Ri}=E1(I,ee,wn,Se,st,ln);Re&&I.errors&&(Ri={...I.errors,...Ri});let Br=Is(),Hr=Ds(ne),Fr=Br||Hr||st.length>0;return{matches:ee,loaderData:Lo,errors:Ri,...Fr?{fetchers:new Map(I.fetchers)}:{}}}function Yt($){if($&&!kn($[1]))return{[$[0]]:$[1].data};if(I.actionData)return Object.keys(I.actionData).length===0?null:I.actionData}function sl($){return $.forEach(W=>{let ee=I.fetchers.get(W.key),ce=ic(void 0,ee?ee.data:void 0);I.fetchers.set(W.key,ce)}),new Map(I.fetchers)}async function As($,W,ee,ce){xr($);let fe=(ce&&ce.flushSync)===!0,ye=f||u,xe=Ty(I.location,I.matches,p,ee,W,ce?.relative),ve=ns(ye,xe,p),Ee=Ns(ve,ye,xe);if(Ee.active&&Ee.matches&&(ve=Ee.matches),!ve){bt($,W,Qn(404,{pathname:xe}),{flushSync:fe});return}let{path:Re,submission:_e,error:Se}=g1(!0,xe,ce);if(Se){bt($,W,Se,{flushSync:fe});return}let ze=e.getContext?await e.getContext():new p1,Ze=(ce&&ce.preventScrollReset)===!0;if(_e&&_n(_e.formMethod)){await Oo($,W,Re,ve,ze,Ee.active,fe,Ze,_e);return}X.set($,{routeId:W,path:Re}),await ko($,W,Re,ve,ze,Ee.active,fe,Ze,_e)}async function Oo($,W,ee,ce,fe,ye,xe,ve,Ee){ol(),X.delete($);let Re=I.fetchers.get($);hn($,OM(Ee,Re),{flushSync:xe});let _e=new AbortController,Se=ba(e.history,ee,_e.signal,Ee);if(ye){let St=await Ms(ce,new URL(Se.url).pathname,Se.signal,$);if(St.type==="aborted")return;if(St.type==="error"){bt($,W,St.error,{flushSync:xe});return}else if(St.matches)ce=St.matches;else{bt($,W,Qn(404,{pathname:ee}),{flushSync:xe});return}}let ze=mf(ce,ee);if(!ze.route.action&&!ze.route.lazy){let St=Qn(405,{method:Ee.formMethod,pathname:ee,routeId:W});bt($,W,St,{flushSync:xe});return}j.set($,_e);let Ze=K,yt=Ea(o,l,Se,ce,ze,i,fe),Le=(await Ci(Se,yt,fe,$))[ze.route.id];if(Se.signal.aborted){j.get($)===_e&&j.delete($);return}if(ie.has($)){if(oo(Le)||kn(Le)){hn($,es(void 0));return}}else{if(oo(Le))if(j.delete($),ne>Ze){hn($,es(void 0));return}else return M.add($),hn($,ic(Ee)),Ur(Se,Le,!1,{fetcherSubmission:Ee,preventScrollReset:ve});if(kn(Le)){bt($,W,Le.error);return}}let st=I.navigation.location||I.location,Er=ba(e.history,st,_e.signal),wn=f||u,ln=I.navigation.state!=="idle"?ns(wn,I.navigation.location,p):I.matches;$e(ln,"Didn't find any matches after fetcher action");let jn=++K;ae.set($,jn);let Lo=ic(Ee,Le.data);I.fetchers.set($,Lo);let{dsMatches:Ri,revalidatingFetchers:Br}=y1(Er,fe,o,l,e.history,I,ln,Ee,st,i,!1,te,ue,ie,X,M,wn,p,e.patchRoutesOnNavigation!=null,[ze.route.id,Le]);Br.filter(St=>St.key!==$).forEach(St=>{let Ai=St.key,Lu=I.fetchers.get(Ai),Pu=ic(void 0,Lu?Lu.data:void 0);I.fetchers.set(Ai,Pu),xr(Ai),St.controller&&j.set(Ai,St.controller)}),Ue({fetchers:new Map(I.fetchers)});let Hr=()=>Br.forEach(St=>xr(St.key));_e.signal.addEventListener("abort",Hr);let{loaderResults:Fr,fetcherResults:Pe}=await Du(Ri,Br,Er,fe);if(_e.signal.aborted)return;if(_e.signal.removeEventListener("abort",Hr),ae.delete($),j.delete($),Br.forEach(St=>j.delete(St.key)),I.fetchers.has($)){let St=es(Le.data);I.fetchers.set($,St)}let kt=Gd(Fr);if(kt)return Ur(Er,kt.result,!1,{preventScrollReset:ve});if(kt=Gd(Pe),kt)return M.add(kt.key),Ur(Er,kt.result,!1,{preventScrollReset:ve});let{loaderData:qr,errors:pn}=E1(I,ln,Fr,void 0,Br,Pe);Ds(jn),I.navigation.state==="loading"&&jn>ne?($e(P,"Expected pending action"),H&&H.abort(),_t(I.navigation.location,{matches:ln,loaderData:qr,errors:pn,fetchers:new Map(I.fetchers)})):(Ue({errors:pn,loaderData:T1(I.loaderData,qr,ln,pn),fetchers:new Map(I.fetchers)}),te=!1)}async function ko($,W,ee,ce,fe,ye,xe,ve,Ee){let Re=I.fetchers.get($);hn($,ic(Ee,Re?Re.data:void 0),{flushSync:xe});let _e=new AbortController,Se=ba(e.history,ee,_e.signal);if(ye){let st=await Ms(ce,new URL(Se.url).pathname,Se.signal,$);if(st.type==="aborted")return;if(st.type==="error"){bt($,W,st.error,{flushSync:xe});return}else if(st.matches)ce=st.matches;else{bt($,W,Qn(404,{pathname:ee}),{flushSync:xe});return}}let ze=mf(ce,ee);j.set($,_e);let Ze=K,yt=Ea(o,l,Se,ce,ze,i,fe),Le=(await Ci(Se,yt,fe,$))[ze.route.id];if(j.get($)===_e&&j.delete($),!Se.signal.aborted){if(ie.has($)){hn($,es(void 0));return}if(oo(Le))if(ne>Ze){hn($,es(void 0));return}else{M.add($),await Ur(Se,Le,!1,{preventScrollReset:ve});return}if(kn(Le)){bt($,W,Le.error);return}hn($,es(Le.data))}}async function Ur($,W,ee,{submission:ce,fetcherSubmission:fe,preventScrollReset:ye,replace:xe}={}){W.response.headers.has("X-Remix-Revalidate")&&(te=!0);let ve=W.response.headers.get("Location");$e(ve,"Expected a Location header on the redirect Response"),ve=x1(ve,new URL($.url),p);let Ee=Uc(I.location,ve,{_isRedirect:!0});if(n){let yt=!1;if(W.response.headers.has("X-Remix-Reload-Document"))yt=!0;else if(Iv(ve)){const Tt=lC(ve,!0);yt=Tt.origin!==t.location.origin||Jn(Tt.pathname,p)==null}if(yt){xe?t.location.replace(ve):t.location.assign(ve);return}}H=null;let Re=xe===!0||W.response.headers.has("X-Remix-Replace")?"REPLACE":"PUSH",{formMethod:_e,formAction:Se,formEncType:ze}=I.navigation;!ce&&!fe&&_e&&Se&&ze&&(ce=A1(I.navigation));let Ze=ce||fe;if(lM.has(W.response.status)&&Ze&&_n(Ze.formMethod))await Et(Re,Ee,{submission:{...Ze,formAction:ve},preventScrollReset:ye||F,enableViewTransition:ee?B:void 0});else{let yt=Rg(Ee,ce);await Et(Re,Ee,{overrideNavigation:yt,fetcherSubmission:fe,preventScrollReset:ye||F,enableViewTransition:ee?B:void 0})}}async function Ci($,W,ee,ce){let fe,ye={};try{fe=await _M(h,$,W,ce,ee,!1)}catch(xe){return W.filter(ve=>ve.shouldLoad).forEach(ve=>{ye[ve.route.id]={type:"error",error:xe}}),ye}if($.signal.aborted)return ye;for(let[xe,ve]of Object.entries(fe))if(AM(ve)){let Ee=ve.result;ye[xe]={type:"redirect",response:wM(Ee,$,xe,W,p)}}else ye[xe]=await xM(ve);return ye}async function Du($,W,ee,ce){let fe=Ci(ee,$,ce,null),ye=Promise.all(W.map(async Ee=>{if(Ee.matches&&Ee.match&&Ee.request&&Ee.controller){let _e=(await Ci(Ee.request,Ee.matches,ce,Ee.key))[Ee.match.route.id];return{[Ee.key]:_e}}else return Promise.resolve({[Ee.key]:{type:"error",error:Qn(404,{pathname:Ee.path})}})})),xe=await fe,ve=(await ye).reduce((Ee,Re)=>Object.assign(Ee,Re),{});return{loaderResults:xe,fetcherResults:ve}}function ol(){te=!0,X.forEach(($,W)=>{j.has(W)&&ue.add(W),xr(W)})}function hn($,W,ee={}){I.fetchers.set($,W),Ue({fetchers:new Map(I.fetchers)},{flushSync:(ee&&ee.flushSync)===!0})}function bt($,W,ee,ce={}){let fe=rs(I.matches,W);Qt($),Ue({errors:{[fe.route.id]:ee},fetchers:new Map(I.fetchers)},{flushSync:(ce&&ce.flushSync)===!0})}function sr($){return le.set($,(le.get($)||0)+1),ie.has($)&&ie.delete($),I.fetchers.get($)||cM}function Qt($){let W=I.fetchers.get($);j.has($)&&!(W&&W.state==="loading"&&ae.has($))&&xr($),X.delete($),ae.delete($),M.delete($),ie.delete($),ue.delete($),I.fetchers.delete($)}function fp($){let W=(le.get($)||0)-1;W<=0?(le.delete($),ie.add($)):le.set($,W),Ue({fetchers:new Map(I.fetchers)})}function xr($){let W=j.get($);W&&(W.abort(),j.delete($))}function Ou($){for(let W of $){let ee=sr(W),ce=es(ee.data);I.fetchers.set(W,ce)}}function Is(){let $=[],W=!1;for(let ee of M){let ce=I.fetchers.get(ee);$e(ce,`Expected fetcher: ${ee}`),ce.state==="loading"&&(M.delete(ee),$.push(ee),W=!0)}return Ou($),W}function Ds($){let W=[];for(let[ee,ce]of ae)if(ce<$){let fe=I.fetchers.get(ee);$e(fe,`Expected fetcher: ${ee}`),fe.state==="loading"&&(xr(ee),ae.delete(ee),W.push(ee))}return Ou(W),W.length>0}function zr($,W){let ee=I.blockers.get($)||rc;return de.get($)!==W&&de.set($,W),ee}function Os($){I.blockers.delete($),de.delete($)}function wr($,W){let ee=I.blockers.get($)||rc;$e(ee.state==="unblocked"&&W.state==="blocked"||ee.state==="blocked"&&W.state==="blocked"||ee.state==="blocked"&&W.state==="proceeding"||ee.state==="blocked"&&W.state==="unblocked"||ee.state==="proceeding"&&W.state==="unblocked",`Invalid blocker state transition: ${ee.state} -> ${W.state}`);let ce=new Map(I.blockers);ce.set($,W),Ue({blockers:ce})}function ku({currentLocation:$,nextLocation:W,historyAction:ee}){if(de.size===0)return;de.size>1&&wt(!1,"A router only supports one blocker at a time");let ce=Array.from(de.entries()),[fe,ye]=ce[ce.length-1],xe=I.blockers.get(fe);if(!(xe&&xe.state==="proceeding")&&ye({currentLocation:$,nextLocation:W,historyAction:ee}))return fe}function No($){let W=Qn(404,{pathname:$}),ee=f||u,{matches:ce,route:fe}=Vd(ee);return{notFoundMatches:ce,route:fe,error:W}}function Nu($,W,ee){if(b=$,O=W,x=ee||null,!R&&I.navigation===Cg){R=!0;let ce=Mu(I.location,I.matches);ce!=null&&Ue({restoreScrollPosition:ce})}return()=>{b=null,O=null,x=null}}function Mo($,W){return x&&x($,W.map(ce=>UN(ce,I.loaderData)))||$.key}function ks($,W){if(b&&O){let ee=Mo($,W);b[ee]=O()}}function Mu($,W){if(b){let ee=Mo($,W),ce=b[ee];if(typeof ce=="number")return ce}return null}function Ns($,W,ee){if(e.patchRoutesOnNavigation)if($){if(Object.keys($[0].params).length>0)return{active:!0,matches:pf(W,ee,p,!0)}}else return{active:!0,matches:pf(W,ee,p,!0)||[]};return{active:!1,matches:null}}async function Ms($,W,ee,ce){if(!e.patchRoutesOnNavigation)return{type:"success",matches:$};let fe=$;for(;;){let ye=f==null,xe=f||u,ve=l;try{await e.patchRoutesOnNavigation({signal:ee,path:W,matches:fe,fetcherKey:ce,patch:(_e,Se)=>{ee.aborted||v1(_e,Se,xe,ve,o,!1)}})}catch(_e){return{type:"error",error:_e,partialMatches:fe}}finally{ye&&!ee.aborted&&(u=[...u])}if(ee.aborted)return{type:"aborted"};let Ee=ns(xe,W,p);if(Ee)return{type:"success",matches:Ee};let Re=pf(xe,W,p,!0);if(!Re||fe.length===Re.length&&fe.every((_e,Se)=>_e.route.id===Re[Se].route.id))return{type:"success",matches:null};fe=Re}}function al($){l={},f=zc($,o,void 0,l)}function ll($,W,ee=!1){let ce=f==null;v1($,W,f||u,l,o,ee),ce&&(u=[...u],Ue({}))}return N={get basename(){return p},get future(){return y},get state(){return I},get routes(){return u},get window(){return t},initialize:Ie,subscribe:Oe,enableScrollRestoration:Nu,navigate:gt,fetch:As,revalidate:Ln,createHref:$=>e.history.createHref($),encodeLocation:$=>e.history.encodeLocation($),getFetcher:sr,deleteFetcher:fp,dispose:be,getBlocker:zr,deleteBlocker:Os,patchRoutes:ll,_internalFetchControllers:j,_internalSetRoutes:al,_internalSetStateDoNotUseOrYouWillBreakYourApp($){Ue($)}},N}function hM(e){return e!=null&&("formData"in e&&e.formData!=null||"body"in e&&e.body!==void 0)}function Ty(e,t,n,i,o,l){let u,f;if(o){u=[];for(let h of t)if(u.push(h),h.route.id===o){f=h;break}}else u=t,f=t[t.length-1];let p=Rh(i||".",Ch(u),Jn(e.pathname,n)||e.pathname,l==="path");if(i==null&&(p.search=e.search,p.hash=e.hash),(i==null||i===""||i===".")&&f){let h=Dv(p.search);if(f.route.index&&!h)p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index";else if(!f.route.index&&h){let y=new URLSearchParams(p.search),v=y.getAll("index");y.delete("index"),v.filter(b=>b).forEach(b=>y.append("index",b));let _=y.toString();p.search=_?`?${_}`:""}}return n!=="/"&&(p.pathname=ZN({basename:n,pathname:p.pathname})),ms(p)}function g1(e,t,n){if(!n||!hM(n))return{path:t};if(n.formMethod&&!IM(n.formMethod))return{path:t,error:Qn(405,{method:n.formMethod})};let i=()=>({path:t,error:Qn(400,{type:"invalid-body"})}),l=(n.formMethod||"get").toUpperCase(),u=bC(t);if(n.body!==void 0){if(n.formEncType==="text/plain"){if(!_n(l))return i();let v=typeof n.body=="string"?n.body:n.body instanceof FormData||n.body instanceof URLSearchParams?Array.from(n.body.entries()).reduce((_,[b,x])=>`${_}${b}=${x}
`,""):String(n.body);return{path:t,submission:{formMethod:l,formAction:u,formEncType:n.formEncType,formData:void 0,json:void 0,text:v}}}else if(n.formEncType==="application/json"){if(!_n(l))return i();try{let v=typeof n.body=="string"?JSON.parse(n.body):n.body;return{path:t,submission:{formMethod:l,formAction:u,formEncType:n.formEncType,formData:void 0,json:v,text:void 0}}}catch{return i()}}}$e(typeof FormData=="function","FormData is not available in this environment");let f,p;if(n.formData)f=Ay(n.formData),p=n.formData;else if(n.body instanceof FormData)f=Ay(n.body),p=n.body;else if(n.body instanceof URLSearchParams)f=n.body,p=w1(f);else if(n.body==null)f=new URLSearchParams,p=new FormData;else try{f=new URLSearchParams(n.body),p=w1(f)}catch{return i()}let h={formMethod:l,formAction:u,formEncType:n&&n.formEncType||"application/x-www-form-urlencoded",formData:p,json:void 0,text:void 0};if(_n(h.formMethod))return{path:t,submission:h};let y=Si(t);return e&&y.search&&Dv(y.search)&&f.append("index",""),y.search=`?${f}`,{path:ms(y),submission:h}}function y1(e,t,n,i,o,l,u,f,p,h,y,v,_,b,x,O,R,D,k,C){let A=C?kn(C[1])?C[1].error:C[1].data:void 0,N=o.createURL(l.location),I=o.createURL(p),P;if(y&&l.errors){let V=Object.keys(l.errors)[0];P=u.findIndex(te=>te.route.id===V)}else if(C&&kn(C[1])){let V=C[0];P=u.findIndex(te=>te.route.id===V)-1}let F=C?C[1].statusCode:void 0,H=F&&F>=400,B={currentUrl:N,currentParams:l.matches[0]?.params||{},nextUrl:I,nextParams:u[0].params,...f,actionResult:A,actionStatus:F},z=u.map((V,te)=>{let{route:ue}=V,j=null;if(P!=null&&te>P?j=!1:ue.lazy?j=!0:ue.loader==null?j=!1:y?j=Cy(ue,l.loaderData,l.errors):pM(l.loaderData,l.matches[te],V)&&(j=!0),j!==null)return Ry(n,i,e,V,h,t,j);let K=H?!1:v||N.pathname+N.search===I.pathname+I.search||N.search!==I.search||mM(l.matches[te],V),ne={...B,defaultShouldRevalidate:K},ae=Mf(V,ne);return Ry(n,i,e,V,h,t,ae,ne)}),G=[];return x.forEach((V,te)=>{if(y||!u.some(le=>le.route.id===V.routeId)||b.has(te))return;let ue=l.fetchers.get(te),j=ue&&ue.state!=="idle"&&ue.data===void 0,K=ns(R,V.path,D);if(!K){if(k&&j)return;G.push({key:te,routeId:V.routeId,path:V.path,matches:null,match:null,request:null,controller:null});return}if(O.has(te))return;let ne=mf(K,V.path),ae=new AbortController,M=ba(o,V.path,ae.signal),X=null;if(_.has(te))_.delete(te),X=Ea(n,i,M,K,ne,h,t);else if(j)v&&(X=Ea(n,i,M,K,ne,h,t));else{let le={...B,defaultShouldRevalidate:H?!1:v};Mf(ne,le)&&(X=Ea(n,i,M,K,ne,h,t,le))}X&&G.push({key:te,routeId:V.routeId,path:V.path,matches:X,match:ne,request:M,controller:ae})}),{dsMatches:z,revalidatingFetchers:G}}function Cy(e,t,n){if(e.lazy)return!0;if(!e.loader)return!1;let i=t!=null&&e.id in t,o=n!=null&&n[e.id]!==void 0;return!i&&o?!1:typeof e.loader=="function"&&e.loader.hydrate===!0?!0:!i&&!o}function pM(e,t,n){let i=!t||n.route.id!==t.route.id,o=!e.hasOwnProperty(n.route.id);return i||o}function mM(e,t){let n=e.route.path;return e.pathname!==t.pathname||n!=null&&n.endsWith("*")&&e.params["*"]!==t.params["*"]}function Mf(e,t){if(e.route.shouldRevalidate){let n=e.route.shouldRevalidate(t);if(typeof n=="boolean")return n}return t.defaultShouldRevalidate}function v1(e,t,n,i,o,l){let u;if(e){let h=i[e];$e(h,`No route found to patch children into: routeId = ${e}`),h.children||(h.children=[]),u=h.children}else u=n;let f=[],p=[];if(t.forEach(h=>{let y=u.find(v=>mC(h,v));y?p.push({existingRoute:y,newRoute:h}):f.push(h)}),f.length>0){let h=zc(f,o,[e||"_","patch",String(u?.length||"0")],i);u.push(...h)}if(l&&p.length>0)for(let h=0;h<p.length;h++){let{existingRoute:y,newRoute:v}=p[h],_=y,[b]=zc([v],o,[],{},!0);Object.assign(_,{element:b.element?b.element:_.element,errorElement:b.errorElement?b.errorElement:_.errorElement,hydrateFallbackElement:b.hydrateFallbackElement?b.hydrateFallbackElement:_.hydrateFallbackElement})}}function mC(e,t){return"id"in e&&"id"in t&&e.id===t.id?!0:e.index===t.index&&e.path===t.path&&e.caseSensitive===t.caseSensitive?(!e.children||e.children.length===0)&&(!t.children||t.children.length===0)?!0:e.children.every((n,i)=>t.children?.some(o=>mC(n,o))):!1}var _1=new WeakMap,gC=({key:e,route:t,manifest:n,mapRouteProperties:i})=>{let o=n[t.id];if($e(o,"No route found in manifest"),!o.lazy||typeof o.lazy!="object")return;let l=o.lazy[e];if(!l)return;let u=_1.get(o);u||(u={},_1.set(o,u));let f=u[e];if(f)return f;let p=(async()=>{let h=LN(e),v=o[e]!==void 0&&e!=="hasErrorBoundary";if(h)wt(!h,"Route property "+e+" is not a supported lazy route property. This property will be ignored."),u[e]=Promise.resolve();else if(v)wt(!1,`Route "${o.id}" has a static property "${e}" defined. The lazy property will be ignored.`);else{let _=await l();_!=null&&(Object.assign(o,{[e]:_}),Object.assign(o,i(o)))}typeof o.lazy=="object"&&(o.lazy[e]=void 0,Object.values(o.lazy).every(_=>_===void 0)&&(o.lazy=void 0))})();return u[e]=p,p},b1=new WeakMap;function gM(e,t,n,i,o){let l=n[e.id];if($e(l,"No route found in manifest"),!e.lazy)return{lazyRoutePromise:void 0,lazyHandlerPromise:void 0};if(typeof e.lazy=="function"){let y=b1.get(l);if(y)return{lazyRoutePromise:y,lazyHandlerPromise:y};let v=(async()=>{$e(typeof e.lazy=="function","No lazy route function found");let _=await e.lazy(),b={};for(let x in _){let O=_[x];if(O===void 0)continue;let R=jN(x),k=l[x]!==void 0&&x!=="hasErrorBoundary";R?wt(!R,"Route property "+x+" is not a supported property to be returned from a lazy route function. This property will be ignored."):k?wt(!k,`Route "${l.id}" has a static property "${x}" defined but its lazy function is also returning a value for this property. The lazy route property "${x}" will be ignored.`):b[x]=O}Object.assign(l,b),Object.assign(l,{...i(l),lazy:void 0})})();return b1.set(l,v),v.catch(()=>{}),{lazyRoutePromise:v,lazyHandlerPromise:v}}let u=Object.keys(e.lazy),f=[],p;for(let y of u){if(o&&o.includes(y))continue;let v=gC({key:y,route:e,manifest:n,mapRouteProperties:i});v&&(f.push(v),y===t&&(p=v))}let h=f.length>0?Promise.all(f).then(()=>{}):void 0;return h?.catch(()=>{}),p?.catch(()=>{}),{lazyRoutePromise:h,lazyHandlerPromise:p}}async function S1(e){let t=e.matches.filter(o=>o.shouldLoad),n={};return(await Promise.all(t.map(o=>o.resolve()))).forEach((o,l)=>{n[t[l].route.id]=o}),n}async function yM(e){return e.matches.some(t=>t.route.middleware)?yC(e,()=>S1(e)):S1(e)}function yC(e,t){return vM(e,t,i=>i,CM,n);function n(i,o,l){if(l)return Promise.resolve(Object.assign(l.value,{[o]:{type:"error",result:i}}));{let{matches:u}=e,f=Math.min(u.findIndex(h=>h.route.id===o)||0,u.findIndex(h=>h.unstable_shouldCallHandler())||0),p=rs(u,u[f].route.id).route.id;return Promise.resolve({[p]:{type:"error",result:i}})}}}async function vM(e,t,n,i,o){let{matches:l,request:u,params:f,context:p}=e,h=l.flatMap(v=>v.route.middleware?v.route.middleware.map(_=>[v.route.id,_]):[]);return await vC({request:u,params:f,context:p},h,t,n,i,o)}async function vC(e,t,n,i,o,l,u=0){let{request:f}=e;if(f.signal.aborted)throw f.signal.reason??new Error(`Request aborted: ${f.method} ${f.url}`);let p=t[u];if(!p)return await n();let[h,y]=p,v,_=async()=>{if(v)throw new Error("You may only call `next()` once per middleware");try{return v={value:await vC(e,t,n,i,o,l,u+1)},v.value}catch(b){return v={value:await l(b,h,v)},v.value}};try{let b=await y(e,_),x=b!=null?i(b):void 0;return o(x)?x:v?x??v.value:(v={value:await _()},v.value)}catch(b){return await l(b,h,v)}}function _C(e,t,n,i,o){let l=gC({key:"middleware",route:i.route,manifest:t,mapRouteProperties:e}),u=gM(i.route,_n(n.method)?"action":"loader",t,e,o);return{middleware:l,route:u.lazyRoutePromise,handler:u.lazyHandlerPromise}}function Ry(e,t,n,i,o,l,u,f=null){let p=!1,h=_C(e,t,n,i,o);return{...i,_lazyPromises:h,shouldLoad:u,unstable_shouldRevalidateArgs:f,unstable_shouldCallHandler(y){return p=!0,f?typeof y=="boolean"?Mf(i,{...f,defaultShouldRevalidate:y}):Mf(i,f):u},resolve(y){return p||u||y&&!_n(n.method)&&(i.route.lazy||i.route.loader)?bM({request:n,match:i,lazyHandlerPromise:h?.handler,lazyRoutePromise:h?.route,handlerOverride:y,scopedContext:l}):Promise.resolve({type:"data",result:void 0})}}}function Ea(e,t,n,i,o,l,u,f=null){return i.map(p=>p.route.id!==o.route.id?{...p,shouldLoad:!1,unstable_shouldRevalidateArgs:f,unstable_shouldCallHandler:()=>!1,_lazyPromises:_C(e,t,n,p,l),resolve:()=>Promise.resolve({type:"data",result:void 0})}:Ry(e,t,n,p,l,u,!0,f))}async function _M(e,t,n,i,o,l){n.some(h=>h._lazyPromises?.middleware)&&await Promise.all(n.map(h=>h._lazyPromises?.middleware));let u={request:t,params:n[0].params,context:o,matches:n},p=await e({...u,fetcherKey:i,runClientMiddleware:h=>{let y=u;return yC(y,()=>h({...y,fetcherKey:i,runClientMiddleware:()=>{throw new Error("Cannot call `runClientMiddleware()` from within an `runClientMiddleware` handler")}}))}});try{await Promise.all(n.flatMap(h=>[h._lazyPromises?.handler,h._lazyPromises?.route]))}catch{}return p}async function bM({request:e,match:t,lazyHandlerPromise:n,lazyRoutePromise:i,handlerOverride:o,scopedContext:l}){let u,f,p=_n(e.method),h=p?"action":"loader",y=v=>{let _,b=new Promise((R,D)=>_=D);f=()=>_(),e.signal.addEventListener("abort",f);let x=R=>typeof v!="function"?Promise.reject(new Error(`You cannot call the handler for a route which defines a boolean "${h}" [routeId: ${t.route.id}]`)):v({request:e,params:t.params,context:l},...R!==void 0?[R]:[]),O=(async()=>{try{return{type:"data",result:await(o?o(D=>x(D)):x())}}catch(R){return{type:"error",result:R}}})();return Promise.race([O,b])};try{let v=p?t.route.action:t.route.loader;if(n||i)if(v){let _,[b]=await Promise.all([y(v).catch(x=>{_=x}),n,i]);if(_!==void 0)throw _;u=b}else{await n;let _=p?t.route.action:t.route.loader;if(_)[u]=await Promise.all([y(_),i]);else if(h==="action"){let b=new URL(e.url),x=b.pathname+b.search;throw Qn(405,{method:e.method,pathname:x,routeId:t.route.id})}else return{type:"data",result:void 0}}else if(v)u=await y(v);else{let _=new URL(e.url),b=_.pathname+_.search;throw Qn(404,{pathname:b})}}catch(v){return{type:"error",result:v}}finally{f&&e.signal.removeEventListener("abort",f)}return u}async function SM(e){let t=e.headers.get("Content-Type");return t&&/\bapplication\/json\b/.test(t)?e.body==null?null:e.json():e.text()}async function xM(e){let{result:t,type:n}=e;if(SC(t)){let i;try{i=await SM(t)}catch(o){return{type:"error",error:o}}return n==="error"?{type:"error",error:new Nf(t.status,t.statusText,i),statusCode:t.status,headers:t.headers}:{type:"data",data:i,statusCode:t.status,headers:t.headers}}return n==="error"?R1(t)?t.data instanceof Error?{type:"error",error:t.data,statusCode:t.init?.status,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"error",error:new Nf(t.init?.status||500,void 0,t.data),statusCode:Bc(t)?t.status:void 0,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"error",error:t,statusCode:Bc(t)?t.status:void 0}:R1(t)?{type:"data",data:t.data,statusCode:t.init?.status,headers:t.init?.headers?new Headers(t.init.headers):void 0}:{type:"data",data:t}}function wM(e,t,n,i,o){let l=e.headers.get("Location");if($e(l,"Redirects returned/thrown from loaders/actions must have a Location header"),!Iv(l)){let u=i.slice(0,i.findIndex(f=>f.route.id===n)+1);l=Ty(new URL(t.url),u,o,l),e.headers.set("Location",l)}return e}function x1(e,t,n){if(Iv(e)){let i=e,o=i.startsWith("//")?new URL(t.protocol+i):new URL(i),l=Jn(o.pathname,n)!=null;if(o.origin===t.origin&&l)return o.pathname+o.search+o.hash}return e}function ba(e,t,n,i){let o=e.createURL(bC(t)).toString(),l={signal:n};if(i&&_n(i.formMethod)){let{formMethod:u,formEncType:f}=i;l.method=u.toUpperCase(),f==="application/json"?(l.headers=new Headers({"Content-Type":f}),l.body=JSON.stringify(i.json)):f==="text/plain"?l.body=i.text:f==="application/x-www-form-urlencoded"&&i.formData?l.body=Ay(i.formData):l.body=i.formData}return new Request(o,l)}function Ay(e){let t=new URLSearchParams;for(let[n,i]of e.entries())t.append(n,typeof i=="string"?i:i.name);return t}function w1(e){let t=new FormData;for(let[n,i]of e.entries())t.append(n,i);return t}function EM(e,t,n,i=!1,o=!1){let l={},u=null,f,p=!1,h={},y=n&&kn(n[1])?n[1].error:void 0;return e.forEach(v=>{if(!(v.route.id in t))return;let _=v.route.id,b=t[_];if($e(!oo(b),"Cannot handle redirect results in processLoaderData"),kn(b)){let x=b.error;if(y!==void 0&&(x=y,y=void 0),u=u||{},o)u[_]=x;else{let O=rs(e,_);u[O.route.id]==null&&(u[O.route.id]=x)}i||(l[_]=pC),p||(p=!0,f=Bc(b.error)?b.error.status:500),b.headers&&(h[_]=b.headers)}else l[_]=b.data,b.statusCode&&b.statusCode!==200&&!p&&(f=b.statusCode),b.headers&&(h[_]=b.headers)}),y!==void 0&&n&&(u={[n[0]]:y},n[2]&&(l[n[2]]=void 0)),{loaderData:l,errors:u,statusCode:f||200,loaderHeaders:h}}function E1(e,t,n,i,o,l){let{loaderData:u,errors:f}=EM(t,n,i);return o.filter(p=>!p.matches||p.matches.some(h=>h.shouldLoad)).forEach(p=>{let{key:h,match:y,controller:v}=p;if(v&&v.signal.aborted)return;let _=l[h];if($e(_,"Did not find corresponding fetcher result"),kn(_)){let b=rs(e.matches,y?.route.id);f&&f[b.route.id]||(f={...f,[b.route.id]:_.error}),e.fetchers.delete(h)}else if(oo(_))$e(!1,"Unhandled fetcher revalidation redirect");else{let b=es(_.data);e.fetchers.set(h,b)}}),{loaderData:u,errors:f}}function T1(e,t,n,i){let o=Object.entries(t).filter(([,l])=>l!==pC).reduce((l,[u,f])=>(l[u]=f,l),{});for(let l of n){let u=l.route.id;if(!t.hasOwnProperty(u)&&e.hasOwnProperty(u)&&l.route.loader&&(o[u]=e[u]),i&&i.hasOwnProperty(u))break}return o}function C1(e){return e?kn(e[1])?{actionData:{}}:{actionData:{[e[0]]:e[1].data}}:{}}function rs(e,t){return(t?e.slice(0,e.findIndex(i=>i.route.id===t)+1):[...e]).reverse().find(i=>i.route.hasErrorBoundary===!0)||e[0]}function Vd(e){let t=e.length===1?e[0]:e.find(n=>n.index||!n.path||n.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:t}],route:t}}function Qn(e,{pathname:t,routeId:n,method:i,type:o,message:l}={}){let u="Unknown Server Error",f="Unknown @remix-run/router error";return e===400?(u="Bad Request",i&&t&&n?f=`You made a ${i} request to "${t}" but did not provide a \`loader\` for route "${n}", so there is no way to handle the request.`:o==="invalid-body"&&(f="Unable to encode submission body")):e===403?(u="Forbidden",f=`Route "${n}" does not match URL "${t}"`):e===404?(u="Not Found",f=`No route matches URL "${t}"`):e===405&&(u="Method Not Allowed",i&&t&&n?f=`You made a ${i.toUpperCase()} request to "${t}" but did not provide an \`action\` for route "${n}", so there is no way to handle the request.`:i&&(f=`Invalid request method "${i.toUpperCase()}"`)),new Nf(e||500,u,new Error(f),!0)}function Gd(e){let t=Object.entries(e);for(let n=t.length-1;n>=0;n--){let[i,o]=t[n];if(oo(o))return{key:i,result:o}}}function bC(e){let t=typeof e=="string"?Si(e):e;return ms({...t,hash:""})}function TM(e,t){return e.pathname!==t.pathname||e.search!==t.search?!1:e.hash===""?t.hash!=="":e.hash===t.hash?!0:t.hash!==""}function CM(e){return e!=null&&typeof e=="object"&&Object.entries(e).every(([t,n])=>typeof t=="string"&&RM(n))}function RM(e){return e!=null&&typeof e=="object"&&"type"in e&&"result"in e&&(e.type==="data"||e.type==="error")}function AM(e){return SC(e.result)&&aM.has(e.result.status)}function kn(e){return e.type==="error"}function oo(e){return(e&&e.type)==="redirect"}function R1(e){return typeof e=="object"&&e!=null&&"type"in e&&"data"in e&&"init"in e&&e.type==="DataWithResponseInit"}function SC(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.headers=="object"&&typeof e.body<"u"}function IM(e){return oM.has(e.toUpperCase())}function _n(e){return iM.has(e.toUpperCase())}function Dv(e){return new URLSearchParams(e).getAll("index").some(t=>t==="")}function mf(e,t){let n=typeof t=="string"?Si(t).search:t.search;if(e[e.length-1].route.index&&Dv(n||""))return e[e.length-1];let i=dC(e);return i[i.length-1]}function A1(e){let{formMethod:t,formAction:n,formEncType:i,text:o,formData:l,json:u}=e;if(!(!t||!n||!i)){if(o!=null)return{formMethod:t,formAction:n,formEncType:i,formData:void 0,json:void 0,text:o};if(l!=null)return{formMethod:t,formAction:n,formEncType:i,formData:l,json:void 0,text:void 0};if(u!==void 0)return{formMethod:t,formAction:n,formEncType:i,formData:void 0,json:u,text:void 0}}}function Rg(e,t){return t?{state:"loading",location:e,formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text}:{state:"loading",location:e,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0}}function DM(e,t){return{state:"submitting",location:e,formMethod:t.formMethod,formAction:t.formAction,formEncType:t.formEncType,formData:t.formData,json:t.json,text:t.text}}function ic(e,t){return e?{state:"loading",formMethod:e.formMethod,formAction:e.formAction,formEncType:e.formEncType,formData:e.formData,json:e.json,text:e.text,data:t}:{state:"loading",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:t}}function OM(e,t){return{state:"submitting",formMethod:e.formMethod,formAction:e.formAction,formEncType:e.formEncType,formData:e.formData,json:e.json,text:e.text,data:t?t.data:void 0}}function es(e){return{state:"idle",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0,json:void 0,text:void 0,data:e}}function kM(e,t){try{let n=e.sessionStorage.getItem(hC);if(n){let i=JSON.parse(n);for(let[o,l]of Object.entries(i||{}))l&&Array.isArray(l)&&t.set(o,new Set(l||[]))}}catch{}}function NM(e,t){if(t.size>0){let n={};for(let[i,o]of t)n[i]=[...o];try{e.sessionStorage.setItem(hC,JSON.stringify(n))}catch(i){wt(!1,`Failed to save applied view transitions in sessionStorage (${i}).`)}}}function MM(){let e,t,n=new Promise((i,o)=>{e=async l=>{i(l);try{await n}catch{}},t=async l=>{o(l);try{await n}catch{}}});return{promise:n,resolve:e,reject:t}}var Co=E.createContext(null);Co.displayName="DataRouter";var fu=E.createContext(null);fu.displayName="DataRouterState";E.createContext(!1);var Ov=E.createContext({isTransitioning:!1});Ov.displayName="ViewTransition";var xC=E.createContext(new Map);xC.displayName="Fetchers";var LM=E.createContext(null);LM.displayName="Await";var Sr=E.createContext(null);Sr.displayName="Navigation";var Ah=E.createContext(null);Ah.displayName="Location";var rr=E.createContext({outlet:null,matches:[],isDataRoute:!1});rr.displayName="Route";var kv=E.createContext(null);kv.displayName="RouteError";function PM(e,{relative:t}={}){$e(Ga(),"useHref() may be used only in the context of a <Router> component.");let{basename:n,navigator:i}=E.useContext(Sr),{hash:o,pathname:l,search:u}=hu(e,{relative:t}),f=l;return n!=="/"&&(f=l==="/"?n:Or([n,l])),i.createHref({pathname:f,search:u,hash:o})}function Ga(){return E.useContext(Ah)!=null}function Pr(){return $e(Ga(),"useLocation() may be used only in the context of a <Router> component."),E.useContext(Ah).location}var wC="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function EC(e){E.useContext(Sr).static||E.useLayoutEffect(e)}function ws(){let{isDataRoute:e}=E.useContext(rr);return e?ZM():jM()}function jM(){$e(Ga(),"useNavigate() may be used only in the context of a <Router> component.");let e=E.useContext(Co),{basename:t,navigator:n}=E.useContext(Sr),{matches:i}=E.useContext(rr),{pathname:o}=Pr(),l=JSON.stringify(Ch(i)),u=E.useRef(!1);return EC(()=>{u.current=!0}),E.useCallback((p,h={})=>{if(wt(u.current,wC),!u.current)return;if(typeof p=="number"){n.go(p);return}let y=Rh(p,JSON.parse(l),o,h.relative==="path");e==null&&t!=="/"&&(y.pathname=y.pathname==="/"?t:Or([t,y.pathname])),(h.replace?n.replace:n.push)(y,h.state,h)},[t,n,l,o,e])}var $M=E.createContext(null);function UM(e){let t=E.useContext(rr).outlet;return t&&E.createElement($M.Provider,{value:e},t)}function zM(){let{matches:e}=E.useContext(rr),t=e[e.length-1];return t?t.params:{}}function hu(e,{relative:t}={}){let{matches:n}=E.useContext(rr),{pathname:i}=Pr(),o=JSON.stringify(Ch(n));return E.useMemo(()=>Rh(e,JSON.parse(o),i,t==="path"),[e,o,i,t])}function BM(e,t,n,i,o){$e(Ga(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:l}=E.useContext(Sr),{matches:u}=E.useContext(rr),f=u[u.length-1],p=f?f.params:{},h=f?f.pathname:"/",y=f?f.pathnameBase:"/",v=f&&f.route;{let k=v&&v.path||"";TC(h,!v||k.endsWith("*")||k.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${h}" (under <Route path="${k}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${k}"> to <Route path="${k==="/"?"*":`${k}/*`}">.`)}let _=Pr(),b;b=_;let x=b.pathname||"/",O=x;if(y!=="/"){let k=y.replace(/^\//,"").split("/");O="/"+x.replace(/^\//,"").split("/").slice(k.length).join("/")}let R=ns(e,{pathname:O});return wt(v||R!=null,`No routes matched location "${b.pathname}${b.search}${b.hash}" `),wt(R==null||R[R.length-1].route.element!==void 0||R[R.length-1].route.Component!==void 0||R[R.length-1].route.lazy!==void 0,`Matched leaf route at location "${b.pathname}${b.search}${b.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`),GM(R&&R.map(k=>Object.assign({},k,{params:Object.assign({},p,k.params),pathname:Or([y,l.encodeLocation?l.encodeLocation(k.pathname).pathname:k.pathname]),pathnameBase:k.pathnameBase==="/"?y:Or([y,l.encodeLocation?l.encodeLocation(k.pathnameBase).pathname:k.pathnameBase])})),u,n,i,o)}function HM(){let e=XM(),t=Bc(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,i="rgba(200,200,200, 0.5)",o={padding:"0.5rem",backgroundColor:i},l={padding:"2px 4px",backgroundColor:i},u=null;return console.error("Error handled by React Router default ErrorBoundary:",e),u=E.createElement(E.Fragment,null,E.createElement("p",null,"💿 Hey developer 👋"),E.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",E.createElement("code",{style:l},"ErrorBoundary")," or"," ",E.createElement("code",{style:l},"errorElement")," prop on your route.")),E.createElement(E.Fragment,null,E.createElement("h2",null,"Unexpected Application Error!"),E.createElement("h3",{style:{fontStyle:"italic"}},t),n?E.createElement("pre",{style:o},n):null,u)}var FM=E.createElement(HM,null),qM=class extends E.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:t.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.unstable_onError?this.props.unstable_onError(e,t):console.error("React Router caught the following error during render",e)}render(){return this.state.error!==void 0?E.createElement(rr.Provider,{value:this.props.routeContext},E.createElement(kv.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function VM({routeContext:e,match:t,children:n}){let i=E.useContext(Co);return i&&i.static&&i.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=t.route.id),E.createElement(rr.Provider,{value:e},n)}function GM(e,t=[],n=null,i=null,o=null){if(e==null){if(!n)return null;if(n.errors)e=n.matches;else if(t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let l=e,u=n?.errors;if(u!=null){let h=l.findIndex(y=>y.route.id&&u?.[y.route.id]!==void 0);$e(h>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(u).join(",")}`),l=l.slice(0,Math.min(l.length,h+1))}let f=!1,p=-1;if(n)for(let h=0;h<l.length;h++){let y=l[h];if((y.route.HydrateFallback||y.route.hydrateFallbackElement)&&(p=h),y.route.id){let{loaderData:v,errors:_}=n,b=y.route.loader&&!v.hasOwnProperty(y.route.id)&&(!_||_[y.route.id]===void 0);if(y.route.lazy||b){f=!0,p>=0?l=l.slice(0,p+1):l=[l[0]];break}}}return l.reduceRight((h,y,v)=>{let _,b=!1,x=null,O=null;n&&(_=u&&y.route.id?u[y.route.id]:void 0,x=y.route.errorElement||FM,f&&(p<0&&v===0?(TC("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),b=!0,O=null):p===v&&(b=!0,O=y.route.hydrateFallbackElement||null)));let R=t.concat(l.slice(0,v+1)),D=()=>{let k;return _?k=x:b?k=O:y.route.Component?k=E.createElement(y.route.Component,null):y.route.element?k=y.route.element:k=h,E.createElement(VM,{match:y,routeContext:{outlet:h,matches:R,isDataRoute:n!=null},children:k})};return n&&(y.route.ErrorBoundary||y.route.errorElement||v===0)?E.createElement(qM,{location:n.location,revalidation:n.revalidation,component:x,error:_,children:D(),routeContext:{outlet:null,matches:R,isDataRoute:!0},unstable_onError:i}):D()},null)}function Nv(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function WM(e){let t=E.useContext(Co);return $e(t,Nv(e)),t}function YM(e){let t=E.useContext(fu);return $e(t,Nv(e)),t}function QM(e){let t=E.useContext(rr);return $e(t,Nv(e)),t}function Mv(e){let t=QM(e),n=t.matches[t.matches.length-1];return $e(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function KM(){return Mv("useRouteId")}function XM(){let e=E.useContext(kv),t=YM("useRouteError"),n=Mv("useRouteError");return e!==void 0?e:t.errors?.[n]}function ZM(){let{router:e}=WM("useNavigate"),t=Mv("useNavigate"),n=E.useRef(!1);return EC(()=>{n.current=!0}),E.useCallback(async(o,l={})=>{wt(n.current,wC),n.current&&(typeof o=="number"?e.navigate(o):await e.navigate(o,{fromRouteId:t,...l}))},[e,t])}var I1={};function TC(e,t,n){!t&&!I1[e]&&(I1[e]=!0,wt(!1,n))}var D1={};function O1(e,t){!e&&!D1[t]&&(D1[t]=!0,console.warn(t))}function JM(e){let t={hasErrorBoundary:e.hasErrorBoundary||e.ErrorBoundary!=null||e.errorElement!=null};return e.Component&&(e.element&&wt(!1,"You should not include both `Component` and `element` on your route - `Component` will be used."),Object.assign(t,{element:E.createElement(e.Component),Component:void 0})),e.HydrateFallback&&(e.hydrateFallbackElement&&wt(!1,"You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used."),Object.assign(t,{hydrateFallbackElement:E.createElement(e.HydrateFallback),HydrateFallback:void 0})),e.ErrorBoundary&&(e.errorElement&&wt(!1,"You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used."),Object.assign(t,{errorElement:E.createElement(e.ErrorBoundary),ErrorBoundary:void 0})),t}var e2=["HydrateFallback","hydrateFallbackElement"],t2=class{constructor(){this.status="pending",this.promise=new Promise((t,n)=>{this.resolve=i=>{this.status==="pending"&&(this.status="resolved",t(i))},this.reject=i=>{this.status==="pending"&&(this.status="rejected",n(i))}})}};function n2({router:e,flushSync:t,unstable_onError:n}){let[i,o]=E.useState(e.state),[l,u]=E.useState(),[f,p]=E.useState({isTransitioning:!1}),[h,y]=E.useState(),[v,_]=E.useState(),[b,x]=E.useState(),O=E.useRef(new Map),R=E.useCallback(N=>{o(I=>(N.errors&&n&&Object.entries(N.errors).forEach(([P,F])=>{I.errors?.[P]!==F&&n(F)}),N))},[n]),D=E.useCallback((N,{deletedFetchers:I,flushSync:P,viewTransitionOpts:F})=>{N.fetchers.forEach((B,z)=>{B.data!==void 0&&O.current.set(z,B.data)}),I.forEach(B=>O.current.delete(B)),O1(P===!1||t!=null,'You provided the `flushSync` option to a router update, but you are not using the `<RouterProvider>` from `react-router/dom` so `ReactDOM.flushSync()` is unavailable.  Please update your app to `import { RouterProvider } from "react-router/dom"` and ensure you have `react-dom` installed as a dependency to use the `flushSync` option.');let H=e.window!=null&&e.window.document!=null&&typeof e.window.document.startViewTransition=="function";if(O1(F==null||H,"You provided the `viewTransition` option to a router update, but you do not appear to be running in a DOM environment as `window.startViewTransition` is not available."),!F||!H){t&&P?t(()=>R(N)):E.startTransition(()=>R(N));return}if(t&&P){t(()=>{v&&(h&&h.resolve(),v.skipTransition()),p({isTransitioning:!0,flushSync:!0,currentLocation:F.currentLocation,nextLocation:F.nextLocation})});let B=e.window.document.startViewTransition(()=>{t(()=>R(N))});B.finished.finally(()=>{t(()=>{y(void 0),_(void 0),u(void 0),p({isTransitioning:!1})})}),t(()=>_(B));return}v?(h&&h.resolve(),v.skipTransition(),x({state:N,currentLocation:F.currentLocation,nextLocation:F.nextLocation})):(u(N),p({isTransitioning:!0,flushSync:!1,currentLocation:F.currentLocation,nextLocation:F.nextLocation}))},[e.window,t,v,h,R]);E.useLayoutEffect(()=>e.subscribe(D),[e,D]),E.useEffect(()=>{f.isTransitioning&&!f.flushSync&&y(new t2)},[f]),E.useEffect(()=>{if(h&&l&&e.window){let N=l,I=h.promise,P=e.window.document.startViewTransition(async()=>{E.startTransition(()=>R(N)),await I});P.finished.finally(()=>{y(void 0),_(void 0),u(void 0),p({isTransitioning:!1})}),_(P)}},[l,h,e.window,R]),E.useEffect(()=>{h&&l&&i.location.key===l.location.key&&h.resolve()},[h,v,i.location,l]),E.useEffect(()=>{!f.isTransitioning&&b&&(u(b.state),p({isTransitioning:!0,flushSync:!1,currentLocation:b.currentLocation,nextLocation:b.nextLocation}),x(void 0))},[f.isTransitioning,b]);let k=E.useMemo(()=>({createHref:e.createHref,encodeLocation:e.encodeLocation,go:N=>e.navigate(N),push:(N,I,P)=>e.navigate(N,{state:I,preventScrollReset:P?.preventScrollReset}),replace:(N,I,P)=>e.navigate(N,{replace:!0,state:I,preventScrollReset:P?.preventScrollReset})}),[e]),C=e.basename||"/",A=E.useMemo(()=>({router:e,navigator:k,static:!1,basename:C,unstable_onError:n}),[e,k,C,n]);return E.createElement(E.Fragment,null,E.createElement(Co.Provider,{value:A},E.createElement(fu.Provider,{value:i},E.createElement(xC.Provider,{value:O.current},E.createElement(Ov.Provider,{value:f},E.createElement(o2,{basename:C,location:i.location,navigationType:i.historyAction,navigator:k},E.createElement(r2,{routes:e.routes,future:e.future,state:i,unstable_onError:n})))))),null)}var r2=E.memo(i2);function i2({routes:e,future:t,state:n,unstable_onError:i}){return BM(e,void 0,n,i,t)}function Lv({to:e,replace:t,state:n,relative:i}){$e(Ga(),"<Navigate> may be used only in the context of a <Router> component.");let{static:o}=E.useContext(Sr);wt(!o,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:l}=E.useContext(rr),{pathname:u}=Pr(),f=ws(),p=Rh(e,Ch(l),u,i==="path"),h=JSON.stringify(p);return E.useEffect(()=>{f(JSON.parse(h),{replace:t,state:n,relative:i})},[f,h,i,t,n]),null}function s2(e){return UM(e.context)}function Yn(e){$e(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function o2({basename:e="/",children:t=null,location:n,navigationType:i="POP",navigator:o,static:l=!1}){$e(!Ga(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let u=e.replace(/^\/*/,"/"),f=E.useMemo(()=>({basename:u,navigator:o,static:l,future:{}}),[u,o,l]);typeof n=="string"&&(n=Si(n));let{pathname:p="/",search:h="",hash:y="",state:v=null,key:_="default"}=n,b=E.useMemo(()=>{let x=Jn(p,u);return x==null?null:{location:{pathname:x,search:h,hash:y,state:v,key:_},navigationType:i}},[u,p,h,y,v,_,i]);return wt(b!=null,`<Router basename="${u}"> is not able to match the URL "${p}${h}${y}" because it does not start with the basename, so the <Router> won't render anything.`),b==null?null:E.createElement(Sr.Provider,{value:f},E.createElement(Ah.Provider,{children:t,value:b}))}function Iy(e,t=[]){let n=[];return E.Children.forEach(e,(i,o)=>{if(!E.isValidElement(i))return;let l=[...t,o];if(i.type===E.Fragment){n.push.apply(n,Iy(i.props.children,l));return}$e(i.type===Yn,`[${typeof i.type=="string"?i.type:i.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),$e(!i.props.index||!i.props.children,"An index route cannot have child routes.");let u={id:i.props.id||l.join("-"),caseSensitive:i.props.caseSensitive,element:i.props.element,Component:i.props.Component,index:i.props.index,path:i.props.path,loader:i.props.loader,action:i.props.action,hydrateFallbackElement:i.props.hydrateFallbackElement,HydrateFallback:i.props.HydrateFallback,errorElement:i.props.errorElement,ErrorBoundary:i.props.ErrorBoundary,hasErrorBoundary:i.props.hasErrorBoundary===!0||i.props.ErrorBoundary!=null||i.props.errorElement!=null,shouldRevalidate:i.props.shouldRevalidate,handle:i.props.handle,lazy:i.props.lazy};i.props.children&&(u.children=Iy(i.props.children,l)),n.push(u)}),n}var a2=Iy,gf="get",yf="application/x-www-form-urlencoded";function Ih(e){return e!=null&&typeof e.tagName=="string"}function l2(e){return Ih(e)&&e.tagName.toLowerCase()==="button"}function c2(e){return Ih(e)&&e.tagName.toLowerCase()==="form"}function u2(e){return Ih(e)&&e.tagName.toLowerCase()==="input"}function d2(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function f2(e,t){return e.button===0&&(!t||t==="_self")&&!d2(e)}function Dy(e=""){return new URLSearchParams(typeof e=="string"||Array.isArray(e)||e instanceof URLSearchParams?e:Object.keys(e).reduce((t,n)=>{let i=e[n];return t.concat(Array.isArray(i)?i.map(o=>[n,o]):[[n,i]])},[]))}function h2(e,t){let n=Dy(e);return t&&t.forEach((i,o)=>{n.has(o)||t.getAll(o).forEach(l=>{n.append(o,l)})}),n}var Wd=null;function p2(){if(Wd===null)try{new FormData(document.createElement("form"),0),Wd=!1}catch{Wd=!0}return Wd}var m2=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Ag(e){return e!=null&&!m2.has(e)?(wt(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${yf}"`),null):e}function g2(e,t){let n,i,o,l,u;if(c2(e)){let f=e.getAttribute("action");i=f?Jn(f,t):null,n=e.getAttribute("method")||gf,o=Ag(e.getAttribute("enctype"))||yf,l=new FormData(e)}else if(l2(e)||u2(e)&&(e.type==="submit"||e.type==="image")){let f=e.form;if(f==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=e.getAttribute("formaction")||f.getAttribute("action");if(i=p?Jn(p,t):null,n=e.getAttribute("formmethod")||f.getAttribute("method")||gf,o=Ag(e.getAttribute("formenctype"))||Ag(f.getAttribute("enctype"))||yf,l=new FormData(f,e),!p2()){let{name:h,type:y,value:v}=e;if(y==="image"){let _=h?`${h}.`:"";l.append(`${_}x`,"0"),l.append(`${_}y`,"0")}else h&&l.append(h,v)}}else{if(Ih(e))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');n=gf,i=null,o=yf,u=e}return l&&o==="text/plain"&&(u=l,l=void 0),{action:i,method:n.toLowerCase(),encType:o,formData:l,body:u}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Pv(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function y2(e,t,n){let i=typeof e=="string"?new URL(e,typeof window>"u"?"server://singlefetch/":window.location.origin):e;return i.pathname==="/"?i.pathname=`_root.${n}`:t&&Jn(i.pathname,t)==="/"?i.pathname=`${t.replace(/\/$/,"")}/_root.${n}`:i.pathname=`${i.pathname.replace(/\/$/,"")}.${n}`,i}async function v2(e,t){if(e.id in t)return t[e.id];try{let n=await import(e.module);return t[e.id]=n,n}catch(n){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(n),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function _2(e){return e==null?!1:e.href==null?e.rel==="preload"&&typeof e.imageSrcSet=="string"&&typeof e.imageSizes=="string":typeof e.rel=="string"&&typeof e.href=="string"}async function b2(e,t,n){let i=await Promise.all(e.map(async o=>{let l=t.routes[o.route.id];if(l){let u=await v2(l,n);return u.links?u.links():[]}return[]}));return E2(i.flat(1).filter(_2).filter(o=>o.rel==="stylesheet"||o.rel==="preload").map(o=>o.rel==="stylesheet"?{...o,rel:"prefetch",as:"style"}:{...o,rel:"prefetch"}))}function k1(e,t,n,i,o,l){let u=(p,h)=>n[h]?p.route.id!==n[h].route.id:!0,f=(p,h)=>n[h].pathname!==p.pathname||n[h].route.path?.endsWith("*")&&n[h].params["*"]!==p.params["*"];return l==="assets"?t.filter((p,h)=>u(p,h)||f(p,h)):l==="data"?t.filter((p,h)=>{let y=i.routes[p.route.id];if(!y||!y.hasLoader)return!1;if(u(p,h)||f(p,h))return!0;if(p.route.shouldRevalidate){let v=p.route.shouldRevalidate({currentUrl:new URL(o.pathname+o.search+o.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function S2(e,t,{includeHydrateFallback:n}={}){return x2(e.map(i=>{let o=t.routes[i.route.id];if(!o)return[];let l=[o.module];return o.clientActionModule&&(l=l.concat(o.clientActionModule)),o.clientLoaderModule&&(l=l.concat(o.clientLoaderModule)),n&&o.hydrateFallbackModule&&(l=l.concat(o.hydrateFallbackModule)),o.imports&&(l=l.concat(o.imports)),l}).flat(1))}function x2(e){return[...new Set(e)]}function w2(e){let t={},n=Object.keys(e).sort();for(let i of n)t[i]=e[i];return t}function E2(e,t){let n=new Set;return new Set(t),e.reduce((i,o)=>{let l=JSON.stringify(w2(o));return n.has(l)||(n.add(l),i.push({key:l,link:o})),i},[])}function CC(){let e=E.useContext(Co);return Pv(e,"You must render this element inside a <DataRouterContext.Provider> element"),e}function T2(){let e=E.useContext(fu);return Pv(e,"You must render this element inside a <DataRouterStateContext.Provider> element"),e}var jv=E.createContext(void 0);jv.displayName="FrameworkContext";function RC(){let e=E.useContext(jv);return Pv(e,"You must render this element inside a <HydratedRouter> element"),e}function C2(e,t){let n=E.useContext(jv),[i,o]=E.useState(!1),[l,u]=E.useState(!1),{onFocus:f,onBlur:p,onMouseEnter:h,onMouseLeave:y,onTouchStart:v}=t,_=E.useRef(null);E.useEffect(()=>{if(e==="render"&&u(!0),e==="viewport"){let O=D=>{D.forEach(k=>{u(k.isIntersecting)})},R=new IntersectionObserver(O,{threshold:.5});return _.current&&R.observe(_.current),()=>{R.disconnect()}}},[e]),E.useEffect(()=>{if(i){let O=setTimeout(()=>{u(!0)},100);return()=>{clearTimeout(O)}}},[i]);let b=()=>{o(!0)},x=()=>{o(!1),u(!1)};return n?e!=="intent"?[l,_,{}]:[l,_,{onFocus:sc(f,b),onBlur:sc(p,x),onMouseEnter:sc(h,b),onMouseLeave:sc(y,x),onTouchStart:sc(v,b)}]:[!1,_,{}]}function sc(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function R2({page:e,...t}){let{router:n}=CC(),i=E.useMemo(()=>ns(n.routes,e,n.basename),[n.routes,e,n.basename]);return i?E.createElement(I2,{page:e,matches:i,...t}):null}function A2(e){let{manifest:t,routeModules:n}=RC(),[i,o]=E.useState([]);return E.useEffect(()=>{let l=!1;return b2(e,t,n).then(u=>{l||o(u)}),()=>{l=!0}},[e,t,n]),i}function I2({page:e,matches:t,...n}){let i=Pr(),{manifest:o,routeModules:l}=RC(),{basename:u}=CC(),{loaderData:f,matches:p}=T2(),h=E.useMemo(()=>k1(e,t,p,o,i,"data"),[e,t,p,o,i]),y=E.useMemo(()=>k1(e,t,p,o,i,"assets"),[e,t,p,o,i]),v=E.useMemo(()=>{if(e===i.pathname+i.search+i.hash)return[];let x=new Set,O=!1;if(t.forEach(D=>{let k=o.routes[D.route.id];!k||!k.hasLoader||(!h.some(C=>C.route.id===D.route.id)&&D.route.id in f&&l[D.route.id]?.shouldRevalidate||k.hasClientLoader?O=!0:x.add(D.route.id))}),x.size===0)return[];let R=y2(e,u,"data");return O&&x.size>0&&R.searchParams.set("_routes",t.filter(D=>x.has(D.route.id)).map(D=>D.route.id).join(",")),[R.pathname+R.search]},[u,f,i,o,h,t,e,l]),_=E.useMemo(()=>S2(y,o),[y,o]),b=A2(y);return E.createElement(E.Fragment,null,v.map(x=>E.createElement("link",{key:x,rel:"prefetch",as:"fetch",href:x,...n})),_.map(x=>E.createElement("link",{key:x,rel:"modulepreload",href:x,...n})),b.map(({key:x,link:O})=>E.createElement("link",{key:x,nonce:n.nonce,...O})))}function D2(...e){return t=>{e.forEach(n=>{typeof n=="function"?n(t):n!=null&&(n.current=t)})}}var AC=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{AC&&(window.__reactRouterVersion="7.9.1")}catch{}function O2(e,t){return fM({basename:t?.basename,getContext:t?.getContext,future:t?.future,history:ON({window:t?.window}),hydrationData:k2(),routes:e,mapRouteProperties:JM,hydrationRouteProperties:e2,dataStrategy:t?.dataStrategy,patchRoutesOnNavigation:t?.patchRoutesOnNavigation,window:t?.window}).initialize()}function k2(){let e=window?.__staticRouterHydrationData;return e&&e.errors&&(e={...e,errors:N2(e.errors)}),e}function N2(e){if(!e)return null;let t=Object.entries(e),n={};for(let[i,o]of t)if(o&&o.__type==="RouteErrorResponse")n[i]=new Nf(o.status,o.statusText,o.data,o.internal===!0);else if(o&&o.__type==="Error"){if(o.__subType){let l=window[o.__subType];if(typeof l=="function")try{let u=new l(o.message);u.stack="",n[i]=u}catch{}}if(n[i]==null){let l=new Error(o.message);l.stack="",n[i]=l}}else n[i]=o;return n}var IC=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Es=E.forwardRef(function({onClick:t,discover:n="render",prefetch:i="none",relative:o,reloadDocument:l,replace:u,state:f,target:p,to:h,preventScrollReset:y,viewTransition:v,..._},b){let{basename:x}=E.useContext(Sr),O=typeof h=="string"&&IC.test(h),R,D=!1;if(typeof h=="string"&&O&&(R=h,AC))try{let H=new URL(window.location.href),B=h.startsWith("//")?new URL(H.protocol+h):new URL(h),z=Jn(B.pathname,x);B.origin===H.origin&&z!=null?h=z+B.search+B.hash:D=!0}catch{wt(!1,`<Link to="${h}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let k=PM(h,{relative:o}),[C,A,N]=C2(i,_),I=P2(h,{replace:u,state:f,target:p,preventScrollReset:y,relative:o,viewTransition:v});function P(H){t&&t(H),H.defaultPrevented||I(H)}let F=E.createElement("a",{..._,...N,href:R||k,onClick:D||l?t:P,ref:D2(b,A),target:p,"data-discover":!O&&n==="render"?"true":void 0});return C&&!O?E.createElement(E.Fragment,null,F,E.createElement(R2,{page:k})):F});Es.displayName="Link";var $v=E.forwardRef(function({"aria-current":t="page",caseSensitive:n=!1,className:i="",end:o=!1,style:l,to:u,viewTransition:f,children:p,...h},y){let v=hu(u,{relative:h.relative}),_=Pr(),b=E.useContext(fu),{navigator:x,basename:O}=E.useContext(Sr),R=b!=null&&H2(v)&&f===!0,D=x.encodeLocation?x.encodeLocation(v).pathname:v.pathname,k=_.pathname,C=b&&b.navigation&&b.navigation.location?b.navigation.location.pathname:null;n||(k=k.toLowerCase(),C=C?C.toLowerCase():null,D=D.toLowerCase()),C&&O&&(C=Jn(C,O)||C);const A=D!=="/"&&D.endsWith("/")?D.length-1:D.length;let N=k===D||!o&&k.startsWith(D)&&k.charAt(A)==="/",I=C!=null&&(C===D||!o&&C.startsWith(D)&&C.charAt(D.length)==="/"),P={isActive:N,isPending:I,isTransitioning:R},F=N?t:void 0,H;typeof i=="function"?H=i(P):H=[i,N?"active":null,I?"pending":null,R?"transitioning":null].filter(Boolean).join(" ");let B=typeof l=="function"?l(P):l;return E.createElement(Es,{...h,"aria-current":F,className:H,ref:y,style:B,to:u,viewTransition:f},typeof p=="function"?p(P):p)});$v.displayName="NavLink";var M2=E.forwardRef(({discover:e="render",fetcherKey:t,navigate:n,reloadDocument:i,replace:o,state:l,method:u=gf,action:f,onSubmit:p,relative:h,preventScrollReset:y,viewTransition:v,..._},b)=>{let x=z2(),O=B2(f,{relative:h}),R=u.toLowerCase()==="get"?"get":"post",D=typeof f=="string"&&IC.test(f),k=C=>{if(p&&p(C),C.defaultPrevented)return;C.preventDefault();let A=C.nativeEvent.submitter,N=A?.getAttribute("formmethod")||u;x(A||C.currentTarget,{fetcherKey:t,method:N,navigate:n,replace:o,state:l,relative:h,preventScrollReset:y,viewTransition:v})};return E.createElement("form",{ref:b,method:R,action:O,onSubmit:i?p:k,..._,"data-discover":!D&&e==="render"?"true":void 0})});M2.displayName="Form";function L2(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function DC(e){let t=E.useContext(Co);return $e(t,L2(e)),t}function P2(e,{target:t,replace:n,state:i,preventScrollReset:o,relative:l,viewTransition:u}={}){let f=ws(),p=Pr(),h=hu(e,{relative:l});return E.useCallback(y=>{if(f2(y,t)){y.preventDefault();let v=n!==void 0?n:ms(p)===ms(h);f(e,{replace:v,state:i,preventScrollReset:o,relative:l,viewTransition:u})}},[p,f,h,n,i,t,e,o,l,u])}function j2(e){wt(typeof URLSearchParams<"u","You cannot use the `useSearchParams` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.");let t=E.useRef(Dy(e)),n=E.useRef(!1),i=Pr(),o=E.useMemo(()=>h2(i.search,n.current?null:t.current),[i.search]),l=ws(),u=E.useCallback((f,p)=>{const h=Dy(typeof f=="function"?f(new URLSearchParams(o)):f);n.current=!0,l("?"+h,p)},[l,o]);return[o,u]}var $2=0,U2=()=>`__${String(++$2)}__`;function z2(){let{router:e}=DC("useSubmit"),{basename:t}=E.useContext(Sr),n=KM();return E.useCallback(async(i,o={})=>{let{action:l,method:u,encType:f,formData:p,body:h}=g2(i,t);if(o.navigate===!1){let y=o.fetcherKey||U2();await e.fetch(y,n,o.action||l,{preventScrollReset:o.preventScrollReset,formData:p,body:h,formMethod:o.method||u,formEncType:o.encType||f,flushSync:o.flushSync})}else await e.navigate(o.action||l,{preventScrollReset:o.preventScrollReset,formData:p,body:h,formMethod:o.method||u,formEncType:o.encType||f,replace:o.replace,state:o.state,fromRouteId:n,flushSync:o.flushSync,viewTransition:o.viewTransition})},[e,t,n])}function B2(e,{relative:t}={}){let{basename:n}=E.useContext(Sr),i=E.useContext(rr);$e(i,"useFormAction must be used inside a RouteContext");let[o]=i.matches.slice(-1),l={...hu(e||".",{relative:t})},u=Pr();if(e==null){l.search=u.search;let f=new URLSearchParams(l.search),p=f.getAll("index");if(p.some(y=>y==="")){f.delete("index"),p.filter(v=>v).forEach(v=>f.append("index",v));let y=f.toString();l.search=y?`?${y}`:""}}return(!e||e===".")&&o.route.index&&(l.search=l.search?l.search.replace(/^\?/,"?index&"):"?index"),n!=="/"&&(l.pathname=l.pathname==="/"?n:Or([n,l.pathname])),ms(l)}function H2(e,{relative:t}={}){let n=E.useContext(Ov);$e(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:i}=DC("useViewTransitionState"),o=hu(e,{relative:t});if(!n.isTransitioning)return!1;let l=Jn(n.currentLocation.pathname,i)||n.currentLocation.pathname,u=Jn(n.nextLocation.pathname,i)||n.nextLocation.pathname;return kf(o.pathname,u)!=null||kf(o.pathname,l)!=null}var F2=eC();function q2(e){return E.createElement(n2,{flushSync:F2.flushSync,...e})}var Gt=function(){return Gt=Object.assign||function(t){for(var n,i=1,o=arguments.length;i<o;i++){n=arguments[i];for(var l in n)Object.prototype.hasOwnProperty.call(n,l)&&(t[l]=n[l])}return t},Gt.apply(this,arguments)};function Hc(e,t,n){if(n||arguments.length===2)for(var i=0,o=t.length,l;i<o;i++)(l||!(i in t))&&(l||(l=Array.prototype.slice.call(t,0,i)),l[i]=t[i]);return e.concat(l||Array.prototype.slice.call(t))}var mt="-ms-",Cc="-moz-",tt="-webkit-",OC="comm",Dh="rule",Uv="decl",V2="@import",kC="@keyframes",G2="@layer",NC=Math.abs,zv=String.fromCharCode,Oy=Object.assign;function W2(e,t){return qt(e,0)^45?(((t<<2^qt(e,0))<<2^qt(e,1))<<2^qt(e,2))<<2^qt(e,3):0}function MC(e){return e.trim()}function ai(e,t){return(e=t.exec(e))?e[0]:e}function Be(e,t,n){return e.replace(t,n)}function vf(e,t,n){return e.indexOf(t,n)}function qt(e,t){return e.charCodeAt(t)|0}function Oa(e,t,n){return e.slice(t,n)}function Dr(e){return e.length}function LC(e){return e.length}function Sc(e,t){return t.push(e),e}function Y2(e,t){return e.map(t).join("")}function N1(e,t){return e.filter(function(n){return!ai(n,t)})}var Oh=1,ka=1,PC=0,er=0,Lt=0,Wa="";function kh(e,t,n,i,o,l,u,f){return{value:e,root:t,parent:n,type:i,props:o,children:l,line:Oh,column:ka,length:u,return:"",siblings:f}}function ts(e,t){return Oy(kh("",null,null,"",null,null,0,e.siblings),e,{length:-e.length},t)}function ma(e){for(;e.root;)e=ts(e.root,{children:[e]});Sc(e,e.siblings)}function Q2(){return Lt}function K2(){return Lt=er>0?qt(Wa,--er):0,ka--,Lt===10&&(ka=1,Oh--),Lt}function pr(){return Lt=er<PC?qt(Wa,er++):0,ka++,Lt===10&&(ka=1,Oh++),Lt}function fo(){return qt(Wa,er)}function _f(){return er}function Nh(e,t){return Oa(Wa,e,t)}function ky(e){switch(e){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function X2(e){return Oh=ka=1,PC=Dr(Wa=e),er=0,[]}function Z2(e){return Wa="",e}function Ig(e){return MC(Nh(er-1,Ny(e===91?e+2:e===40?e+1:e)))}function J2(e){for(;(Lt=fo())&&Lt<33;)pr();return ky(e)>2||ky(Lt)>3?"":" "}function eL(e,t){for(;--t&&pr()&&!(Lt<48||Lt>102||Lt>57&&Lt<65||Lt>70&&Lt<97););return Nh(e,_f()+(t<6&&fo()==32&&pr()==32))}function Ny(e){for(;pr();)switch(Lt){case e:return er;case 34:case 39:e!==34&&e!==39&&Ny(Lt);break;case 40:e===41&&Ny(e);break;case 92:pr();break}return er}function tL(e,t){for(;pr()&&e+Lt!==57;)if(e+Lt===84&&fo()===47)break;return"/*"+Nh(t,er-1)+"*"+zv(e===47?e:pr())}function nL(e){for(;!ky(fo());)pr();return Nh(e,er)}function rL(e){return Z2(bf("",null,null,null,[""],e=X2(e),0,[0],e))}function bf(e,t,n,i,o,l,u,f,p){for(var h=0,y=0,v=u,_=0,b=0,x=0,O=1,R=1,D=1,k=0,C="",A=o,N=l,I=i,P=C;R;)switch(x=k,k=pr()){case 40:if(x!=108&&qt(P,v-1)==58){vf(P+=Be(Ig(k),"&","&\f"),"&\f",NC(h?f[h-1]:0))!=-1&&(D=-1);break}case 34:case 39:case 91:P+=Ig(k);break;case 9:case 10:case 13:case 32:P+=J2(x);break;case 92:P+=eL(_f()-1,7);continue;case 47:switch(fo()){case 42:case 47:Sc(iL(tL(pr(),_f()),t,n,p),p);break;default:P+="/"}break;case 123*O:f[h++]=Dr(P)*D;case 125*O:case 59:case 0:switch(k){case 0:case 125:R=0;case 59+y:D==-1&&(P=Be(P,/\f/g,"")),b>0&&Dr(P)-v&&Sc(b>32?L1(P+";",i,n,v-1,p):L1(Be(P," ","")+";",i,n,v-2,p),p);break;case 59:P+=";";default:if(Sc(I=M1(P,t,n,h,y,o,f,C,A=[],N=[],v,l),l),k===123)if(y===0)bf(P,t,I,I,A,l,v,f,N);else switch(_===99&&qt(P,3)===110?100:_){case 100:case 108:case 109:case 115:bf(e,I,I,i&&Sc(M1(e,I,I,0,0,o,f,C,o,A=[],v,N),N),o,N,v,f,i?A:N);break;default:bf(P,I,I,I,[""],N,0,f,N)}}h=y=b=0,O=D=1,C=P="",v=u;break;case 58:v=1+Dr(P),b=x;default:if(O<1){if(k==123)--O;else if(k==125&&O++==0&&K2()==125)continue}switch(P+=zv(k),k*O){case 38:D=y>0?1:(P+="\f",-1);break;case 44:f[h++]=(Dr(P)-1)*D,D=1;break;case 64:fo()===45&&(P+=Ig(pr())),_=fo(),y=v=Dr(C=P+=nL(_f())),k++;break;case 45:x===45&&Dr(P)==2&&(O=0)}}return l}function M1(e,t,n,i,o,l,u,f,p,h,y,v){for(var _=o-1,b=o===0?l:[""],x=LC(b),O=0,R=0,D=0;O<i;++O)for(var k=0,C=Oa(e,_+1,_=NC(R=u[O])),A=e;k<x;++k)(A=MC(R>0?b[k]+" "+C:Be(C,/&\f/g,b[k])))&&(p[D++]=A);return kh(e,t,n,o===0?Dh:f,p,h,y,v)}function iL(e,t,n,i){return kh(e,t,n,OC,zv(Q2()),Oa(e,2,-2),0,i)}function L1(e,t,n,i,o){return kh(e,t,n,Uv,Oa(e,0,i),Oa(e,i+1,-1),i,o)}function jC(e,t,n){switch(W2(e,t)){case 5103:return tt+"print-"+e+e;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return tt+e+e;case 4789:return Cc+e+e;case 5349:case 4246:case 4810:case 6968:case 2756:return tt+e+Cc+e+mt+e+e;case 5936:switch(qt(e,t+11)){case 114:return tt+e+mt+Be(e,/[svh]\w+-[tblr]{2}/,"tb")+e;case 108:return tt+e+mt+Be(e,/[svh]\w+-[tblr]{2}/,"tb-rl")+e;case 45:return tt+e+mt+Be(e,/[svh]\w+-[tblr]{2}/,"lr")+e}case 6828:case 4268:case 2903:return tt+e+mt+e+e;case 6165:return tt+e+mt+"flex-"+e+e;case 5187:return tt+e+Be(e,/(\w+).+(:[^]+)/,tt+"box-$1$2"+mt+"flex-$1$2")+e;case 5443:return tt+e+mt+"flex-item-"+Be(e,/flex-|-self/g,"")+(ai(e,/flex-|baseline/)?"":mt+"grid-row-"+Be(e,/flex-|-self/g,""))+e;case 4675:return tt+e+mt+"flex-line-pack"+Be(e,/align-content|flex-|-self/g,"")+e;case 5548:return tt+e+mt+Be(e,"shrink","negative")+e;case 5292:return tt+e+mt+Be(e,"basis","preferred-size")+e;case 6060:return tt+"box-"+Be(e,"-grow","")+tt+e+mt+Be(e,"grow","positive")+e;case 4554:return tt+Be(e,/([^-])(transform)/g,"$1"+tt+"$2")+e;case 6187:return Be(Be(Be(e,/(zoom-|grab)/,tt+"$1"),/(image-set)/,tt+"$1"),e,"")+e;case 5495:case 3959:return Be(e,/(image-set\([^]*)/,tt+"$1$`$1");case 4968:return Be(Be(e,/(.+:)(flex-)?(.*)/,tt+"box-pack:$3"+mt+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+tt+e+e;case 4200:if(!ai(e,/flex-|baseline/))return mt+"grid-column-align"+Oa(e,t)+e;break;case 2592:case 3360:return mt+Be(e,"template-","")+e;case 4384:case 3616:return n&&n.some(function(i,o){return t=o,ai(i.props,/grid-\w+-end/)})?~vf(e+(n=n[t].value),"span",0)?e:mt+Be(e,"-start","")+e+mt+"grid-row-span:"+(~vf(n,"span",0)?ai(n,/\d+/):+ai(n,/\d+/)-+ai(e,/\d+/))+";":mt+Be(e,"-start","")+e;case 4896:case 4128:return n&&n.some(function(i){return ai(i.props,/grid-\w+-start/)})?e:mt+Be(Be(e,"-end","-span"),"span ","")+e;case 4095:case 3583:case 4068:case 2532:return Be(e,/(.+)-inline(.+)/,tt+"$1$2")+e;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Dr(e)-1-t>6)switch(qt(e,t+1)){case 109:if(qt(e,t+4)!==45)break;case 102:return Be(e,/(.+:)(.+)-([^]+)/,"$1"+tt+"$2-$3$1"+Cc+(qt(e,t+3)==108?"$3":"$2-$3"))+e;case 115:return~vf(e,"stretch",0)?jC(Be(e,"stretch","fill-available"),t,n)+e:e}break;case 5152:case 5920:return Be(e,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(i,o,l,u,f,p,h){return mt+o+":"+l+h+(u?mt+o+"-span:"+(f?p:+p-+l)+h:"")+e});case 4949:if(qt(e,t+6)===121)return Be(e,":",":"+tt)+e;break;case 6444:switch(qt(e,qt(e,14)===45?18:11)){case 120:return Be(e,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+tt+(qt(e,14)===45?"inline-":"")+"box$3$1"+tt+"$2$3$1"+mt+"$2box$3")+e;case 100:return Be(e,":",":"+mt)+e}break;case 5719:case 2647:case 2135:case 3927:case 2391:return Be(e,"scroll-","scroll-snap-")+e}return e}function Lf(e,t){for(var n="",i=0;i<e.length;i++)n+=t(e[i],i,e,t)||"";return n}function sL(e,t,n,i){switch(e.type){case G2:if(e.children.length)break;case V2:case Uv:return e.return=e.return||e.value;case OC:return"";case kC:return e.return=e.value+"{"+Lf(e.children,i)+"}";case Dh:if(!Dr(e.value=e.props.join(",")))return""}return Dr(n=Lf(e.children,i))?e.return=e.value+"{"+n+"}":""}function oL(e){var t=LC(e);return function(n,i,o,l){for(var u="",f=0;f<t;f++)u+=e[f](n,i,o,l)||"";return u}}function aL(e){return function(t){t.root||(t=t.return)&&e(t)}}function lL(e,t,n,i){if(e.length>-1&&!e.return)switch(e.type){case Uv:e.return=jC(e.value,e.length,n);return;case kC:return Lf([ts(e,{value:Be(e.value,"@","@"+tt)})],i);case Dh:if(e.length)return Y2(n=e.props,function(o){switch(ai(o,i=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":ma(ts(e,{props:[Be(o,/:(read-\w+)/,":"+Cc+"$1")]})),ma(ts(e,{props:[o]})),Oy(e,{props:N1(n,i)});break;case"::placeholder":ma(ts(e,{props:[Be(o,/:(plac\w+)/,":"+tt+"input-$1")]})),ma(ts(e,{props:[Be(o,/:(plac\w+)/,":"+Cc+"$1")]})),ma(ts(e,{props:[Be(o,/:(plac\w+)/,mt+"input-$1")]})),ma(ts(e,{props:[o]})),Oy(e,{props:N1(n,i)});break}return""})}}var cL={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},On={},Na=typeof process<"u"&&On!==void 0&&(On.REACT_APP_SC_ATTR||On.SC_ATTR)||"data-styled",$C="active",UC="data-styled-version",Mh="6.1.19",Bv=`/*!sc*/
`,Pf=typeof window<"u"&&typeof document<"u",uL=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&On!==void 0&&On.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&On.REACT_APP_SC_DISABLE_SPEEDY!==""?On.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&On.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&On!==void 0&&On.SC_DISABLE_SPEEDY!==void 0&&On.SC_DISABLE_SPEEDY!==""&&On.SC_DISABLE_SPEEDY!=="false"&&On.SC_DISABLE_SPEEDY),dL={},Lh=Object.freeze([]),Ma=Object.freeze({});function zC(e,t,n){return n===void 0&&(n=Ma),e.theme!==n.theme&&e.theme||t||n.theme}var BC=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),fL=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,hL=/(^-|-$)/g;function P1(e){return e.replace(fL,"-").replace(hL,"")}var pL=/(a)(d)/gi,Yd=52,j1=function(e){return String.fromCharCode(e+(e>25?39:97))};function My(e){var t,n="";for(t=Math.abs(e);t>Yd;t=t/Yd|0)n=j1(t%Yd)+n;return(j1(t%Yd)+n).replace(pL,"$1-$2")}var Dg,HC=5381,Sa=function(e,t){for(var n=t.length;n;)e=33*e^t.charCodeAt(--n);return e},FC=function(e){return Sa(HC,e)};function qC(e){return My(FC(e)>>>0)}function mL(e){return e.displayName||e.name||"Component"}function Og(e){return typeof e=="string"&&!0}var VC=typeof Symbol=="function"&&Symbol.for,GC=VC?Symbol.for("react.memo"):60115,gL=VC?Symbol.for("react.forward_ref"):60112,yL={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},vL={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},WC={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},_L=((Dg={})[gL]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},Dg[GC]=WC,Dg);function $1(e){return("type"in(t=e)&&t.type.$$typeof)===GC?WC:"$$typeof"in e?_L[e.$$typeof]:yL;var t}var bL=Object.defineProperty,SL=Object.getOwnPropertyNames,U1=Object.getOwnPropertySymbols,xL=Object.getOwnPropertyDescriptor,wL=Object.getPrototypeOf,z1=Object.prototype;function YC(e,t,n){if(typeof t!="string"){if(z1){var i=wL(t);i&&i!==z1&&YC(e,i,n)}var o=SL(t);U1&&(o=o.concat(U1(t)));for(var l=$1(e),u=$1(t),f=0;f<o.length;++f){var p=o[f];if(!(p in vL||n&&n[p]||u&&p in u||l&&p in l)){var h=xL(t,p);try{bL(e,p,h)}catch{}}}}return e}function ho(e){return typeof e=="function"}function Hv(e){return typeof e=="object"&&"styledComponentId"in e}function ao(e,t){return e&&t?"".concat(e," ").concat(t):e||t||""}function Ly(e,t){if(e.length===0)return"";for(var n=e[0],i=1;i<e.length;i++)n+=e[i];return n}function Fc(e){return e!==null&&typeof e=="object"&&e.constructor.name===Object.name&&!("props"in e&&e.$$typeof)}function Py(e,t,n){if(n===void 0&&(n=!1),!n&&!Fc(e)&&!Array.isArray(e))return t;if(Array.isArray(t))for(var i=0;i<t.length;i++)e[i]=Py(e[i],t[i]);else if(Fc(t))for(var i in t)e[i]=Py(e[i],t[i]);return e}function Fv(e,t){Object.defineProperty(e,"toString",{value:t})}function gs(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e," for more information.").concat(t.length>0?" Args: ".concat(t.join(", ")):""))}var EL=(function(){function e(t){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=t}return e.prototype.indexOfGroup=function(t){for(var n=0,i=0;i<t;i++)n+=this.groupSizes[i];return n},e.prototype.insertRules=function(t,n){if(t>=this.groupSizes.length){for(var i=this.groupSizes,o=i.length,l=o;t>=l;)if((l<<=1)<0)throw gs(16,"".concat(t));this.groupSizes=new Uint32Array(l),this.groupSizes.set(i),this.length=l;for(var u=o;u<l;u++)this.groupSizes[u]=0}for(var f=this.indexOfGroup(t+1),p=(u=0,n.length);u<p;u++)this.tag.insertRule(f,n[u])&&(this.groupSizes[t]++,f++)},e.prototype.clearGroup=function(t){if(t<this.length){var n=this.groupSizes[t],i=this.indexOfGroup(t),o=i+n;this.groupSizes[t]=0;for(var l=i;l<o;l++)this.tag.deleteRule(i)}},e.prototype.getGroup=function(t){var n="";if(t>=this.length||this.groupSizes[t]===0)return n;for(var i=this.groupSizes[t],o=this.indexOfGroup(t),l=o+i,u=o;u<l;u++)n+="".concat(this.tag.getRule(u)).concat(Bv);return n},e})(),Sf=new Map,jf=new Map,xf=1,Qd=function(e){if(Sf.has(e))return Sf.get(e);for(;jf.has(xf);)xf++;var t=xf++;return Sf.set(e,t),jf.set(t,e),t},TL=function(e,t){xf=t+1,Sf.set(e,t),jf.set(t,e)},CL="style[".concat(Na,"][").concat(UC,'="').concat(Mh,'"]'),RL=new RegExp("^".concat(Na,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),AL=function(e,t,n){for(var i,o=n.split(","),l=0,u=o.length;l<u;l++)(i=o[l])&&e.registerName(t,i)},IL=function(e,t){for(var n,i=((n=t.textContent)!==null&&n!==void 0?n:"").split(Bv),o=[],l=0,u=i.length;l<u;l++){var f=i[l].trim();if(f){var p=f.match(RL);if(p){var h=0|parseInt(p[1],10),y=p[2];h!==0&&(TL(y,h),AL(e,y,p[3]),e.getTag().insertRules(h,o)),o.length=0}else o.push(f)}}},B1=function(e){for(var t=document.querySelectorAll(CL),n=0,i=t.length;n<i;n++){var o=t[n];o&&o.getAttribute(Na)!==$C&&(IL(e,o),o.parentNode&&o.parentNode.removeChild(o))}};function DL(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var QC=function(e){var t=document.head,n=e||t,i=document.createElement("style"),o=(function(f){var p=Array.from(f.querySelectorAll("style[".concat(Na,"]")));return p[p.length-1]})(n),l=o!==void 0?o.nextSibling:null;i.setAttribute(Na,$C),i.setAttribute(UC,Mh);var u=DL();return u&&i.setAttribute("nonce",u),n.insertBefore(i,l),i},OL=(function(){function e(t){this.element=QC(t),this.element.appendChild(document.createTextNode("")),this.sheet=(function(n){if(n.sheet)return n.sheet;for(var i=document.styleSheets,o=0,l=i.length;o<l;o++){var u=i[o];if(u.ownerNode===n)return u}throw gs(17)})(this.element),this.length=0}return e.prototype.insertRule=function(t,n){try{return this.sheet.insertRule(n,t),this.length++,!0}catch{return!1}},e.prototype.deleteRule=function(t){this.sheet.deleteRule(t),this.length--},e.prototype.getRule=function(t){var n=this.sheet.cssRules[t];return n&&n.cssText?n.cssText:""},e})(),kL=(function(){function e(t){this.element=QC(t),this.nodes=this.element.childNodes,this.length=0}return e.prototype.insertRule=function(t,n){if(t<=this.length&&t>=0){var i=document.createTextNode(n);return this.element.insertBefore(i,this.nodes[t]||null),this.length++,!0}return!1},e.prototype.deleteRule=function(t){this.element.removeChild(this.nodes[t]),this.length--},e.prototype.getRule=function(t){return t<this.length?this.nodes[t].textContent:""},e})(),NL=(function(){function e(t){this.rules=[],this.length=0}return e.prototype.insertRule=function(t,n){return t<=this.length&&(this.rules.splice(t,0,n),this.length++,!0)},e.prototype.deleteRule=function(t){this.rules.splice(t,1),this.length--},e.prototype.getRule=function(t){return t<this.length?this.rules[t]:""},e})(),H1=Pf,ML={isServer:!Pf,useCSSOMInjection:!uL},$f=(function(){function e(t,n,i){t===void 0&&(t=Ma),n===void 0&&(n={});var o=this;this.options=Gt(Gt({},ML),t),this.gs=n,this.names=new Map(i),this.server=!!t.isServer,!this.server&&Pf&&H1&&(H1=!1,B1(this)),Fv(this,function(){return(function(l){for(var u=l.getTag(),f=u.length,p="",h=function(v){var _=(function(D){return jf.get(D)})(v);if(_===void 0)return"continue";var b=l.names.get(_),x=u.getGroup(v);if(b===void 0||!b.size||x.length===0)return"continue";var O="".concat(Na,".g").concat(v,'[id="').concat(_,'"]'),R="";b!==void 0&&b.forEach(function(D){D.length>0&&(R+="".concat(D,","))}),p+="".concat(x).concat(O,'{content:"').concat(R,'"}').concat(Bv)},y=0;y<f;y++)h(y);return p})(o)})}return e.registerId=function(t){return Qd(t)},e.prototype.rehydrate=function(){!this.server&&Pf&&B1(this)},e.prototype.reconstructWithOptions=function(t,n){return n===void 0&&(n=!0),new e(Gt(Gt({},this.options),t),this.gs,n&&this.names||void 0)},e.prototype.allocateGSInstance=function(t){return this.gs[t]=(this.gs[t]||0)+1},e.prototype.getTag=function(){return this.tag||(this.tag=(t=(function(n){var i=n.useCSSOMInjection,o=n.target;return n.isServer?new NL(o):i?new OL(o):new kL(o)})(this.options),new EL(t)));var t},e.prototype.hasNameForId=function(t,n){return this.names.has(t)&&this.names.get(t).has(n)},e.prototype.registerName=function(t,n){if(Qd(t),this.names.has(t))this.names.get(t).add(n);else{var i=new Set;i.add(n),this.names.set(t,i)}},e.prototype.insertRules=function(t,n,i){this.registerName(t,n),this.getTag().insertRules(Qd(t),i)},e.prototype.clearNames=function(t){this.names.has(t)&&this.names.get(t).clear()},e.prototype.clearRules=function(t){this.getTag().clearGroup(Qd(t)),this.clearNames(t)},e.prototype.clearTag=function(){this.tag=void 0},e})(),LL=/&/g,PL=/^\s*\/\/.*$/gm;function KC(e,t){return e.map(function(n){return n.type==="rule"&&(n.value="".concat(t," ").concat(n.value),n.value=n.value.replaceAll(",",",".concat(t," ")),n.props=n.props.map(function(i){return"".concat(t," ").concat(i)})),Array.isArray(n.children)&&n.type!=="@keyframes"&&(n.children=KC(n.children,t)),n})}function jL(e){var t,n,i,o=Ma,l=o.options,u=l===void 0?Ma:l,f=o.plugins,p=f===void 0?Lh:f,h=function(_,b,x){return x.startsWith(n)&&x.endsWith(n)&&x.replaceAll(n,"").length>0?".".concat(t):_},y=p.slice();y.push(function(_){_.type===Dh&&_.value.includes("&")&&(_.props[0]=_.props[0].replace(LL,n).replace(i,h))}),u.prefix&&y.push(lL),y.push(sL);var v=function(_,b,x,O){b===void 0&&(b=""),x===void 0&&(x=""),O===void 0&&(O="&"),t=O,n=b,i=new RegExp("\\".concat(n,"\\b"),"g");var R=_.replace(PL,""),D=rL(x||b?"".concat(x," ").concat(b," { ").concat(R," }"):R);u.namespace&&(D=KC(D,u.namespace));var k=[];return Lf(D,oL(y.concat(aL(function(C){return k.push(C)})))),k};return v.hash=p.length?p.reduce(function(_,b){return b.name||gs(15),Sa(_,b.name)},HC).toString():"",v}var $L=new $f,jy=jL(),XC=dr.createContext({shouldForwardProp:void 0,styleSheet:$L,stylis:jy});XC.Consumer;dr.createContext(void 0);function $y(){return E.useContext(XC)}var UL=(function(){function e(t,n){var i=this;this.inject=function(o,l){l===void 0&&(l=jy);var u=i.name+l.hash;o.hasNameForId(i.id,u)||o.insertRules(i.id,u,l(i.rules,u,"@keyframes"))},this.name=t,this.id="sc-keyframes-".concat(t),this.rules=n,Fv(this,function(){throw gs(12,String(i.name))})}return e.prototype.getName=function(t){return t===void 0&&(t=jy),this.name+t.hash},e})(),zL=function(e){return e>="A"&&e<="Z"};function F1(e){for(var t="",n=0;n<e.length;n++){var i=e[n];if(n===1&&i==="-"&&e[0]==="-")return e;zL(i)?t+="-"+i.toLowerCase():t+=i}return t.startsWith("ms-")?"-"+t:t}var ZC=function(e){return e==null||e===!1||e===""},JC=function(e){var t,n,i=[];for(var o in e){var l=e[o];e.hasOwnProperty(o)&&!ZC(l)&&(Array.isArray(l)&&l.isCss||ho(l)?i.push("".concat(F1(o),":"),l,";"):Fc(l)?i.push.apply(i,Hc(Hc(["".concat(o," {")],JC(l),!1),["}"],!1)):i.push("".concat(F1(o),": ").concat((t=o,(n=l)==null||typeof n=="boolean"||n===""?"":typeof n!="number"||n===0||t in cL||t.startsWith("--")?String(n).trim():"".concat(n,"px")),";")))}return i};function cs(e,t,n,i){if(ZC(e))return[];if(Hv(e))return[".".concat(e.styledComponentId)];if(ho(e)){if(!ho(l=e)||l.prototype&&l.prototype.isReactComponent||!t)return[e];var o=e(t);return cs(o,t,n,i)}var l;return e instanceof UL?n?(e.inject(n,i),[e.getName(i)]):[e]:Fc(e)?JC(e):Array.isArray(e)?Array.prototype.concat.apply(Lh,e.map(function(u){return cs(u,t,n,i)})):[e.toString()]}function eR(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(ho(n)&&!Hv(n))return!1}return!0}var BL=FC(Mh),HL=(function(){function e(t,n,i){this.rules=t,this.staticRulesId="",this.isStatic=(i===void 0||i.isStatic)&&eR(t),this.componentId=n,this.baseHash=Sa(BL,n),this.baseStyle=i,$f.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,i){var o=this.baseStyle?this.baseStyle.generateAndInjectStyles(t,n,i):"";if(this.isStatic&&!i.hash)if(this.staticRulesId&&n.hasNameForId(this.componentId,this.staticRulesId))o=ao(o,this.staticRulesId);else{var l=Ly(cs(this.rules,t,n,i)),u=My(Sa(this.baseHash,l)>>>0);if(!n.hasNameForId(this.componentId,u)){var f=i(l,".".concat(u),void 0,this.componentId);n.insertRules(this.componentId,u,f)}o=ao(o,u),this.staticRulesId=u}else{for(var p=Sa(this.baseHash,i.hash),h="",y=0;y<this.rules.length;y++){var v=this.rules[y];if(typeof v=="string")h+=v;else if(v){var _=Ly(cs(v,t,n,i));p=Sa(p,_+y),h+=_}}if(h){var b=My(p>>>0);n.hasNameForId(this.componentId,b)||n.insertRules(this.componentId,b,i(h,".".concat(b),void 0,this.componentId)),o=ao(o,b)}}return o},e})(),La=dr.createContext(void 0);La.Consumer;function qv(){var e=E.useContext(La);if(!e)throw gs(18);return e}function FL(e){var t=dr.useContext(La),n=E.useMemo(function(){return(function(i,o){if(!i)throw gs(14);if(ho(i)){var l=i(o);return l}if(Array.isArray(i)||typeof i!="object")throw gs(8);return o?Gt(Gt({},o),i):i})(e.theme,t)},[e.theme,t]);return e.children?dr.createElement(La.Provider,{value:n},e.children):null}var kg={};function qL(e,t,n){var i=Hv(e),o=e,l=!Og(e),u=t.attrs,f=u===void 0?Lh:u,p=t.componentId,h=p===void 0?(function(A,N){var I=typeof A!="string"?"sc":P1(A);kg[I]=(kg[I]||0)+1;var P="".concat(I,"-").concat(qC(Mh+I+kg[I]));return N?"".concat(N,"-").concat(P):P})(t.displayName,t.parentComponentId):p,y=t.displayName,v=y===void 0?(function(A){return Og(A)?"styled.".concat(A):"Styled(".concat(mL(A),")")})(e):y,_=t.displayName&&t.componentId?"".concat(P1(t.displayName),"-").concat(t.componentId):t.componentId||h,b=i&&o.attrs?o.attrs.concat(f).filter(Boolean):f,x=t.shouldForwardProp;if(i&&o.shouldForwardProp){var O=o.shouldForwardProp;if(t.shouldForwardProp){var R=t.shouldForwardProp;x=function(A,N){return O(A,N)&&R(A,N)}}else x=O}var D=new HL(n,_,i?o.componentStyle:void 0);function k(A,N){return(function(I,P,F){var H=I.attrs,B=I.componentStyle,z=I.defaultProps,G=I.foldedComponentIds,V=I.styledComponentId,te=I.target,ue=dr.useContext(La),j=$y(),K=I.shouldForwardProp||j.shouldForwardProp,ne=zC(P,ue,z)||Ma,ae=(function(me,pe,Ie){for(var be,Oe=Gt(Gt({},pe),{className:void 0,theme:Ie}),Ue=0;Ue<me.length;Ue+=1){var _t=ho(be=me[Ue])?be(Oe):be;for(var gt in _t)Oe[gt]=gt==="className"?ao(Oe[gt],_t[gt]):gt==="style"?Gt(Gt({},Oe[gt]),_t[gt]):_t[gt]}return pe.className&&(Oe.className=ao(Oe.className,pe.className)),Oe})(H,P,ne),M=ae.as||te,X={};for(var le in ae)ae[le]===void 0||le[0]==="$"||le==="as"||le==="theme"&&ae.theme===ne||(le==="forwardedAs"?X.as=ae.forwardedAs:K&&!K(le,M)||(X[le]=ae[le]));var ie=(function(me,pe){var Ie=$y(),be=me.generateAndInjectStyles(pe,Ie.styleSheet,Ie.stylis);return be})(B,ae),de=ao(G,V);return ie&&(de+=" "+ie),ae.className&&(de+=" "+ae.className),X[Og(M)&&!BC.has(M)?"class":"className"]=de,F&&(X.ref=F),E.createElement(M,X)})(C,A,N)}k.displayName=v;var C=dr.forwardRef(k);return C.attrs=b,C.componentStyle=D,C.displayName=v,C.shouldForwardProp=x,C.foldedComponentIds=i?ao(o.foldedComponentIds,o.styledComponentId):"",C.styledComponentId=_,C.target=i?o.target:e,Object.defineProperty(C,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(A){this._foldedDefaultProps=i?(function(N){for(var I=[],P=1;P<arguments.length;P++)I[P-1]=arguments[P];for(var F=0,H=I;F<H.length;F++)Py(N,H[F],!0);return N})({},o.defaultProps,A):A}}),Fv(C,function(){return".".concat(C.styledComponentId)}),l&&YC(C,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),C}function q1(e,t){for(var n=[e[0]],i=0,o=t.length;i<o;i+=1)n.push(t[i],e[i+1]);return n}var V1=function(e){return Object.assign(e,{isCss:!0})};function nn(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];if(ho(e)||Fc(e))return V1(cs(q1(Lh,Hc([e],t,!0))));var i=e;return t.length===0&&i.length===1&&typeof i[0]=="string"?cs(i):V1(cs(q1(i,t)))}function Uy(e,t,n){if(n===void 0&&(n=Ma),!t)throw gs(1,t);var i=function(o){for(var l=[],u=1;u<arguments.length;u++)l[u-1]=arguments[u];return e(t,n,nn.apply(void 0,Hc([o],l,!1)))};return i.attrs=function(o){return Uy(e,t,Gt(Gt({},n),{attrs:Array.prototype.concat(n.attrs,o).filter(Boolean)}))},i.withConfig=function(o){return Uy(e,t,Gt(Gt({},n),o))},i}var tR=function(e){return Uy(qL,e)},T=tR;BC.forEach(function(e){T[e]=tR(e)});var VL=(function(){function e(t,n){this.rules=t,this.componentId=n,this.isStatic=eR(t),$f.registerId(this.componentId+1)}return e.prototype.createStyles=function(t,n,i,o){var l=o(Ly(cs(this.rules,n,i,o)),""),u=this.componentId+t;i.insertRules(u,u,l)},e.prototype.removeStyles=function(t,n){n.clearRules(this.componentId+t)},e.prototype.renderStyles=function(t,n,i,o){t>2&&$f.registerId(this.componentId+t),this.removeStyles(t,i),this.createStyles(t,n,i,o)},e})();function GL(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];var i=nn.apply(void 0,Hc([e],t,!1)),o="sc-global-".concat(qC(JSON.stringify(i))),l=new VL(i,o),u=function(p){var h=$y(),y=dr.useContext(La),v=dr.useRef(h.styleSheet.allocateGSInstance(o)).current;return h.styleSheet.server&&f(v,p,h.styleSheet,y,h.stylis),dr.useLayoutEffect(function(){if(!h.styleSheet.server)return f(v,p,h.styleSheet,y,h.stylis),function(){return l.removeStyles(v,h.styleSheet)}},[v,p,h.styleSheet,y,h.stylis]),null};function f(p,h,y,v,_){if(l.isStatic)l.renderStyles(p,dL,y,_);else{var b=Gt(Gt({},h),{theme:zC(h,v,u.defaultProps)});l.renderStyles(p,b,y,_)}}return dr.memo(u)}const Ta=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,ys=globalThis,Rc="10.11.0";function nR(){return Vv(ys),ys}function Vv(e){const t=e.__SENTRY__=e.__SENTRY__||{};return t.version=t.version||Rc,t[Rc]=t[Rc]||{}}function Gv(e,t,n=ys){const i=n.__SENTRY__=n.__SENTRY__||{},o=i[Rc]=i[Rc]||{};return o[e]||(o[e]=t())}const WL="Sentry Logger ",G1={};function YL(e){if(!("console"in ys))return e();const t=ys.console,n={},i=Object.keys(G1);i.forEach(o=>{const l=G1[o];n[o]=t[o],t[o]=l});try{return e()}finally{i.forEach(o=>{t[o]=n[o]})}}function QL(){Yv().enabled=!0}function KL(){Yv().enabled=!1}function rR(){return Yv().enabled}function XL(...e){Wv("log",...e)}function ZL(...e){Wv("warn",...e)}function JL(...e){Wv("error",...e)}function Wv(e,...t){Ta&&rR()&&YL(()=>{ys.console[e](`${WL}[${e}]:`,...t)})}function Yv(){return Ta?Gv("loggerSettings",()=>({enabled:!1})):{enabled:!1}}const wf={enable:QL,disable:KL,isEnabled:rR,log:XL,warn:ZL,error:JL},eP=Object.prototype.toString;function tP(e,t){return eP.call(e)===`[object ${t}]`}function nP(e){return tP(e,"Object")}function rP(e){return!!(e?.then&&typeof e.then=="function")}function iP(e,t=0){return typeof e!="string"||t===0||e.length<=t?e:`${e.slice(0,t)}...`}function sP(e,t,n){try{Object.defineProperty(e,t,{value:n,writable:!0,configurable:!0})}catch{Ta&&wf.log(`Failed to add non-enumerable property "${t}" to object`,e)}}function oP(){const e=ys;return e.crypto||e.msCrypto}function Ac(e=oP()){let t=()=>Math.random()*16;try{if(e?.randomUUID)return e.randomUUID().replace(/-/g,"");e?.getRandomValues&&(t=()=>{const n=new Uint8Array(1);return e.getRandomValues(n),n[0]})}catch{}return("10000000100040008000"+1e11).replace(/[018]/g,n=>(n^(t()&15)>>n/4).toString(16))}const iR=1e3;function sR(){return Date.now()/iR}function aP(){const{performance:e}=ys;if(!e?.now||!e.timeOrigin)return sR;const t=e.timeOrigin;return()=>(t+e.now())/iR}let W1;function lP(){return(W1??(W1=aP()))()}function cP(e,t={}){if(t.user&&(!e.ipAddress&&t.user.ip_address&&(e.ipAddress=t.user.ip_address),!e.did&&!t.did&&(e.did=t.user.id||t.user.email||t.user.username)),e.timestamp=t.timestamp||lP(),t.abnormal_mechanism&&(e.abnormal_mechanism=t.abnormal_mechanism),t.ignoreDuration&&(e.ignoreDuration=t.ignoreDuration),t.sid&&(e.sid=t.sid.length===32?t.sid:Ac()),t.init!==void 0&&(e.init=t.init),!e.did&&t.did&&(e.did=`${t.did}`),typeof t.started=="number"&&(e.started=t.started),e.ignoreDuration)e.duration=void 0;else if(typeof t.duration=="number")e.duration=t.duration;else{const n=e.timestamp-e.started;e.duration=n>=0?n:0}t.release&&(e.release=t.release),t.environment&&(e.environment=t.environment),!e.ipAddress&&t.ipAddress&&(e.ipAddress=t.ipAddress),!e.userAgent&&t.userAgent&&(e.userAgent=t.userAgent),typeof t.errors=="number"&&(e.errors=t.errors),t.status&&(e.status=t.status)}function oR(e,t,n=2){if(!t||typeof t!="object"||n<=0)return t;if(e&&Object.keys(t).length===0)return e;const i={...e};for(const o in t)Object.prototype.hasOwnProperty.call(t,o)&&(i[o]=oR(i[o],t[o],n-1));return i}function Y1(){return Ac()}const zy="_sentrySpan";function Q1(e,t){t?sP(e,zy,t):delete e[zy]}function K1(e){return e[zy]}const uP=100;class po{constructor(){this._notifyingListeners=!1,this._scopeListeners=[],this._eventProcessors=[],this._breadcrumbs=[],this._attachments=[],this._user={},this._tags={},this._extra={},this._contexts={},this._sdkProcessingMetadata={},this._propagationContext={traceId:Y1(),sampleRand:Math.random()}}clone(){const t=new po;return t._breadcrumbs=[...this._breadcrumbs],t._tags={...this._tags},t._extra={...this._extra},t._contexts={...this._contexts},this._contexts.flags&&(t._contexts.flags={values:[...this._contexts.flags.values]}),t._user=this._user,t._level=this._level,t._session=this._session,t._transactionName=this._transactionName,t._fingerprint=this._fingerprint,t._eventProcessors=[...this._eventProcessors],t._attachments=[...this._attachments],t._sdkProcessingMetadata={...this._sdkProcessingMetadata},t._propagationContext={...this._propagationContext},t._client=this._client,t._lastEventId=this._lastEventId,Q1(t,K1(this)),t}setClient(t){this._client=t}setLastEventId(t){this._lastEventId=t}getClient(){return this._client}lastEventId(){return this._lastEventId}addScopeListener(t){this._scopeListeners.push(t)}addEventProcessor(t){return this._eventProcessors.push(t),this}setUser(t){return this._user=t||{email:void 0,id:void 0,ip_address:void 0,username:void 0},this._session&&cP(this._session,{user:t}),this._notifyScopeListeners(),this}getUser(){return this._user}setTags(t){return this._tags={...this._tags,...t},this._notifyScopeListeners(),this}setTag(t,n){return this._tags={...this._tags,[t]:n},this._notifyScopeListeners(),this}setExtras(t){return this._extra={...this._extra,...t},this._notifyScopeListeners(),this}setExtra(t,n){return this._extra={...this._extra,[t]:n},this._notifyScopeListeners(),this}setFingerprint(t){return this._fingerprint=t,this._notifyScopeListeners(),this}setLevel(t){return this._level=t,this._notifyScopeListeners(),this}setTransactionName(t){return this._transactionName=t,this._notifyScopeListeners(),this}setContext(t,n){return n===null?delete this._contexts[t]:this._contexts[t]=n,this._notifyScopeListeners(),this}setSession(t){return t?this._session=t:delete this._session,this._notifyScopeListeners(),this}getSession(){return this._session}update(t){if(!t)return this;const n=typeof t=="function"?t(this):t,i=n instanceof po?n.getScopeData():nP(n)?t:void 0,{tags:o,extra:l,user:u,contexts:f,level:p,fingerprint:h=[],propagationContext:y}=i||{};return this._tags={...this._tags,...o},this._extra={...this._extra,...l},this._contexts={...this._contexts,...f},u&&Object.keys(u).length&&(this._user=u),p&&(this._level=p),h.length&&(this._fingerprint=h),y&&(this._propagationContext=y),this}clear(){return this._breadcrumbs=[],this._tags={},this._extra={},this._user={},this._contexts={},this._level=void 0,this._transactionName=void 0,this._fingerprint=void 0,this._session=void 0,Q1(this,void 0),this._attachments=[],this.setPropagationContext({traceId:Y1(),sampleRand:Math.random()}),this._notifyScopeListeners(),this}addBreadcrumb(t,n){const i=typeof n=="number"?n:uP;if(i<=0)return this;const o={timestamp:sR(),...t,message:t.message?iP(t.message,2048):t.message};return this._breadcrumbs.push(o),this._breadcrumbs.length>i&&(this._breadcrumbs=this._breadcrumbs.slice(-i),this._client?.recordDroppedEvent("buffer_overflow","log_item")),this._notifyScopeListeners(),this}getLastBreadcrumb(){return this._breadcrumbs[this._breadcrumbs.length-1]}clearBreadcrumbs(){return this._breadcrumbs=[],this._notifyScopeListeners(),this}addAttachment(t){return this._attachments.push(t),this}clearAttachments(){return this._attachments=[],this}getScopeData(){return{breadcrumbs:this._breadcrumbs,attachments:this._attachments,contexts:this._contexts,tags:this._tags,extra:this._extra,user:this._user,level:this._level,fingerprint:this._fingerprint||[],eventProcessors:this._eventProcessors,propagationContext:this._propagationContext,sdkProcessingMetadata:this._sdkProcessingMetadata,transactionName:this._transactionName,span:K1(this)}}setSDKProcessingMetadata(t){return this._sdkProcessingMetadata=oR(this._sdkProcessingMetadata,t,2),this}setPropagationContext(t){return this._propagationContext=t,this}getPropagationContext(){return this._propagationContext}captureException(t,n){const i=n?.event_id||Ac();if(!this._client)return Ta&&wf.warn("No client configured on scope - will not capture exception!"),i;const o=new Error("Sentry syntheticException");return this._client.captureException(t,{originalException:t,syntheticException:o,...n,event_id:i},this),i}captureMessage(t,n,i){const o=i?.event_id||Ac();if(!this._client)return Ta&&wf.warn("No client configured on scope - will not capture message!"),o;const l=new Error(t);return this._client.captureMessage(t,n,{originalException:t,syntheticException:l,...i,event_id:o},this),o}captureEvent(t,n){const i=n?.event_id||Ac();return this._client?(this._client.captureEvent(t,{...n,event_id:i},this),i):(Ta&&wf.warn("No client configured on scope - will not capture event!"),i)}_notifyScopeListeners(){this._notifyingListeners||(this._notifyingListeners=!0,this._scopeListeners.forEach(t=>{t(this)}),this._notifyingListeners=!1)}}function dP(){return Gv("defaultCurrentScope",()=>new po)}function fP(){return Gv("defaultIsolationScope",()=>new po)}class hP{constructor(t,n){let i;t?i=t:i=new po;let o;n?o=n:o=new po,this._stack=[{scope:i}],this._isolationScope=o}withScope(t){const n=this._pushScope();let i;try{i=t(n)}catch(o){throw this._popScope(),o}return rP(i)?i.then(o=>(this._popScope(),o),o=>{throw this._popScope(),o}):(this._popScope(),i)}getClient(){return this.getStackTop().client}getScope(){return this.getStackTop().scope}getIsolationScope(){return this._isolationScope}getStackTop(){return this._stack[this._stack.length-1]}_pushScope(){const t=this.getScope().clone();return this._stack.push({client:this.getClient(),scope:t}),t}_popScope(){return this._stack.length<=1?!1:!!this._stack.pop()}}function Pa(){const e=nR(),t=Vv(e);return t.stack=t.stack||new hP(dP(),fP())}function pP(e){return Pa().withScope(e)}function mP(e,t){const n=Pa();return n.withScope(()=>(n.getStackTop().scope=e,t(e)))}function X1(e){return Pa().withScope(()=>e(Pa().getIsolationScope()))}function gP(){return{withIsolationScope:X1,withScope:pP,withSetScope:mP,withSetIsolationScope:(e,t)=>X1(t),getCurrentScope:()=>Pa().getScope(),getIsolationScope:()=>Pa().getIsolationScope()}}function yP(e){const t=Vv(e);return t.acs?t.acs:gP()}function aR(){const e=nR();return yP(e).getCurrentScope()}function Nr(e,t){return aR().captureException(e,void 0)}function Qv(e,t){const n=typeof t=="string"?t:void 0,i=typeof t!="string"?{captureContext:t}:void 0;return aR().captureMessage(e,n,i)}const vP=()=>{};var Z1={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he=function(e,t){if(!e)throw Ya(t)},Ya=function(e){return new Error("Firebase Database ("+lR.SDK_VERSION+") INTERNAL ASSERT FAILED: "+e)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SP(e){return dR(void 0,e)}function dR(e,t){if(!(t instanceof Object))return t;switch(t.constructor){case Date:const n=t;return new Date(n.getTime());case Object:e===void 0&&(e={});break;case Array:e=[];break;default:return t}for(const n in t)!t.hasOwnProperty(n)||!xP(n)||(e[n]=dR(e[n],t[n]));return e}function xP(e){return e!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qa(e){try{return(e.startsWith("http://")||e.startsWith("https://")?new URL(e).hostname:e).endsWith(".cloudworkstations.dev")}catch{return!1}}async function mR(e){return(await fetch(e,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Zv(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(fn())}function OP(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function kP(){const e=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof e=="object"&&e.id!==void 0}function yR(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function NP(){const e=fn();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function MP(){return lR.NODE_ADMIN===!0}function vR(){try{return typeof indexedDB=="object"}catch{return!1}}function _R(){return new Promise((e,t)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(i);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(i),e(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{t(o.error?.message||"")}}catch(n){t(n)}})}function LP(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bR=function(e){let t={},n={},i={},o="";try{const l=e.split(".");t=qc(zf(l[0])||""),n=qc(zf(l[1])||""),o=l[2],i=n.d||{},delete n.d}catch{}return{header:t,claims:n,data:i,signature:o}},UP=function(e){const t=bR(e),n=t.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},zP=function(e){const t=bR(e).claims;return typeof t=="object"&&t.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Za=$j;function wR(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const i={name:Vy,automaticDataCollectionEnabled:!0,...t},o=i.name;if(typeof o!="string"||!o)throw us.create("bad-app-name",{appName:String(o)});if(n||(n=hR()),!n)throw us.create("no-options");const l=Hf.get(o);if(l){if(mo(n,l.options)&&mo(i,l.config))return l;throw us.create("duplicate-app",{appName:o})}const u=new QP(o);for(const p of Gy.values())u.addComponent(p);const f=new Hj(n,i,u);return Hf.set(o,f),f}function t_(e=Vy){const t=Hf.get(e);if(!t&&e===Vy&&hR())return wR();if(!t)throw us.create("no-app",{appName:e});return t}function Zn(e,t,n){let i=Uj[e]??e;n&&(i+=`-${n}`);const o=i.match(/\s|\//),l=t.match(/\s|\//);if(o||l){const u=[`Unable to register library "${i}" with version "${t}":`];o&&u.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&l&&u.push("and"),l&&u.push(`version name "${t}" contains illegal characters (whitespace or "/")`),yi.warn(u.join(" "));return}Mr(new _r(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fj="firebase-heartbeat-database",qj=1,Vc="firebase-heartbeat-store";let $g=null;function ER(){return $g||($g=$h(Fj,qj,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(Vc)}catch(n){console.warn(n)}}}}).catch(e=>{throw us.create("idb-open",{originalErrorMessage:e.message})})),$g}async function Vj(e){try{const n=(await ER()).transaction(Vc),i=await n.objectStore(Vc).get(TR(e));return await n.done,i}catch(t){if(t instanceof xi)yi.warn(t.message);else{const n=us.create("idb-get",{originalErrorMessage:t?.message});yi.warn(n.message)}}}async function ow(e,t){try{const i=(await ER()).transaction(Vc,"readwrite");await i.objectStore(Vc).put(t,TR(e)),await i.done}catch(n){if(n instanceof xi)yi.warn(n.message);else{const i=us.create("idb-set",{originalErrorMessage:n?.message});yi.warn(i.message)}}}function TR(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zj(e){Mr(new _r("platform-logger",t=>new uj(t),"PRIVATE")),Mr(new _r("heartbeat",t=>new Yj(t),"PRIVATE")),Zn(qy,iw,e),Zn(qy,iw,"esm2020"),Zn("fire-js","")}Zj("");const CR="@firebase/installations",n_="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RR=1e4,AR=`w:${n_}`,IR="FIS_v2",Jj="https://firebaseinstallations.googleapis.com/v1",e4=3600*1e3,t4="installations",n4="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OR({projectId:e}){return`${Jj}/projects/${e}/installations`}function kR(e){return{token:e.token,requestStatus:2,expiresIn:s4(e.expiresIn),creationTime:Date.now()}}async function NR(e,t){const i=(await t.json()).error;return go.create("request-failed",{requestName:e,serverCode:i.code,serverMessage:i.message,serverStatus:i.status})}function MR({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function i4(e,{refreshToken:t}){const n=MR(e);return n.append("Authorization",o4(t)),n}async function LR(e){const t=await e();return t.status>=500&&t.status<600?e():t}function s4(e){return Number(e.replace("s","000"))}function o4(e){return`${IR} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function a4({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const i=OR(e),o=MR(e),l=t.getImmediate({optional:!0});if(l){const h=await l.getHeartbeatsHeader();h&&o.append("x-firebase-client",h)}const u={fid:n,authVersion:IR,appId:e.appId,sdkVersion:AR},f={method:"POST",headers:o,body:JSON.stringify(u)},p=await LR(()=>fetch(i,f));if(p.ok){const h=await p.json();return{fid:h.fid||n,registrationStatus:2,refreshToken:h.refreshToken,authToken:kR(h.authToken)}}else throw await NR("Create Installation",p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jR=new Map;function $R(e,t){const n=Uh(e);UR(n,t),f4(n,t)}function UR(e,t){const n=jR.get(e);if(n)for(const i of n)i(t)}function f4(e,t){const n=h4();n&&n.postMessage({key:e,fid:t}),p4()}let lo=null;function h4(){return!lo&&"BroadcastChannel"in self&&(lo=new BroadcastChannel("[Firebase] FID Change"),lo.onmessage=e=>{UR(e.data.key,e.data.fid)}),lo}function p4(){jR.size===0&&lo&&(lo.close(),lo=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m4="firebase-installations-database",g4=1,yo="firebase-installations-store";let Ug=null;function r_(){return Ug||(Ug=$h(m4,g4,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(yo)}}})),Ug}async function Ff(e,t){const n=Uh(e),o=(await r_()).transaction(yo,"readwrite"),l=o.objectStore(yo),u=await l.get(n);return await l.put(t,n),await o.done,(!u||u.fid!==t.fid)&&$R(e,t.fid),t}async function zR(e){const t=Uh(e),i=(await r_()).transaction(yo,"readwrite");await i.objectStore(yo).delete(t),await i.done}async function zh(e,t){const n=Uh(e),o=(await r_()).transaction(yo,"readwrite"),l=o.objectStore(yo),u=await l.get(n),f=t(u);return f===void 0?await l.delete(n):await l.put(f,n),await o.done,f&&(!u||u.fid!==f.fid)&&$R(e,f.fid),f}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function i_(e){let t;const n=await zh(e.appConfig,i=>{const o=y4(i),l=v4(e,o);return t=l.registrationPromise,l.installationEntry});return n.fid===Wy?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function y4(e){const t=e||{fid:u4(),registrationStatus:0};return BR(t)}function v4(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(go.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=_4(e,n);return{installationEntry:n,registrationPromise:i}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:b4(e)}:{installationEntry:t}}async function _4(e,t){try{const n=await a4(e,t);return Ff(e.appConfig,n)}catch(n){throw DR(n)&&n.customData.serverCode===409?await zR(e.appConfig):await Ff(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function b4(e){let t=await cw(e.appConfig);for(;t.registrationStatus===1;)await PR(100),t=await cw(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await i_(e);return i||n}return t}function cw(e){return zh(e,t=>{if(!t)throw go.create("installation-not-found");return BR(t)})}function BR(e){return S4(e)?{fid:e.fid,registrationStatus:0}:e}function S4(e){return e.registrationStatus===1&&e.registrationTime+RR<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function x4({appConfig:e,heartbeatServiceProvider:t},n){const i=w4(e,n),o=i4(e,n),l=t.getImmediate({optional:!0});if(l){const h=await l.getHeartbeatsHeader();h&&o.append("x-firebase-client",h)}const u={installation:{sdkVersion:AR,appId:e.appId}},f={method:"POST",headers:o,body:JSON.stringify(u)},p=await LR(()=>fetch(i,f));if(p.ok){const h=await p.json();return kR(h)}else throw await NR("Generate Auth Token",p)}function w4(e,{fid:t}){return`${OR(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function s_(e,t=!1){let n;const i=await zh(e.appConfig,l=>{if(!HR(l))throw go.create("not-registered");const u=l.authToken;if(!t&&C4(u))return l;if(u.requestStatus===1)return n=E4(e,t),l;{if(!navigator.onLine)throw go.create("app-offline");const f=A4(l);return n=T4(e,f),f}});return n?await n:i.authToken}async function E4(e,t){let n=await uw(e.appConfig);for(;n.authToken.requestStatus===1;)await PR(100),n=await uw(e.appConfig);const i=n.authToken;return i.requestStatus===0?s_(e,t):i}function uw(e){return zh(e,t=>{if(!HR(t))throw go.create("not-registered");const n=t.authToken;return I4(n)?{...t,authToken:{requestStatus:0}}:t})}async function T4(e,t){try{const n=await x4(e,t),i={...t,authToken:n};return await Ff(e.appConfig,i),n}catch(n){if(DR(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await zR(e.appConfig);else{const i={...t,authToken:{requestStatus:0}};await Ff(e.appConfig,i)}throw n}}function HR(e){return e!==void 0&&e.registrationStatus===2}function C4(e){return e.requestStatus===2&&!R4(e)}function R4(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+e4}function A4(e){const t={requestStatus:1,requestTime:Date.now()};return{...e,authToken:t}}function I4(e){return e.requestStatus===1&&e.requestTime+RR<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FR="installations",M4="installations-internal",L4=e=>{const t=e.getProvider("app").getImmediate(),n=N4(t),i=Xa(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},P4=e=>{const t=e.getProvider("app").getImmediate(),n=Xa(t,FR).getImmediate();return{getId:()=>D4(n),getToken:o=>O4(n,o)}};function j4(){Mr(new _r(FR,L4,"PUBLIC")),Mr(new _r(M4,P4,"PRIVATE"))}j4();Zn(CR,n_);Zn(CR,n_,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $4="/firebase-messaging-sw.js",U4="/firebase-cloud-messaging-push-scope",qR="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",z4="https://fcmregistrations.googleapis.com/v1",VR="google.c.a.c_id",B4="google.c.a.c_l",H4="google.c.a.ts",F4="google.c.a.e",dw=1e4;var fw;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(fw||(fw={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y4="firebase-messaging-database",Q4=1,Wc="firebase-messaging-store";let Hg=null;function GR(){return Hg||(Hg=$h(Y4,Q4,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Wc)}}})),Hg}async function K4(e){const t=WR(e),i=await(await GR()).transaction(Wc).objectStore(Wc).get(t);if(i)return i;{const o=await G4(e.appConfig.senderId);if(o)return await o_(e,o),o}}async function o_(e,t){const n=WR(e),o=(await GR()).transaction(Wc,"readwrite");return await o.objectStore(Wc).put(t,n),await o.done,t}function WR({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function c6(e){return typeof e=="object"&&!!e&&VR in e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function m6(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=qR)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QR(e,t){if(!navigator)throw an.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw an.create("permission-blocked");return await m6(e,t?.vapidKey),await p6(e,t?.serviceWorkerRegistration),n6(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function g6(e,t,n){const i=y6(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[VR],message_name:n[B4],message_time:n[H4],message_device_time:Math.floor(Date.now()/1e3)})}function y6(e){switch(e){case Gc.NOTIFICATION_CLICKED:return"notification_open";case Gc.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function x6(){try{await _R()}catch{return!1}return typeof window<"u"&&vR()&&LP()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function E6(e=t_()){return x6().then(t=>{if(!t)throw an.create("unsupported-browser")},t=>{throw an.create("indexed-db-unsupported")}),Xa(Wt(e),"messaging").getImmediate()}async function T6(e,t){return e=Wt(e),QR(e,t)}function C6(e,t){return e=Wt(e),w6(e,t)}S6();const Bh=e=>{try{return e()}catch(t){throw t}};var R6="firebase",A6="12.2.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Zn(R6,A6,"app");const I6={apiKey:"AIzaSyAMtG6b23AqO2WbJ2ad8SKMXD1X4tfALtc",authDomain:"peloton-alerts.firebaseapp.com",projectId:"peloton-alerts",storageBucket:"peloton-alerts.appspot.com",messagingSenderId:"331185140393",appId:"1:331185140393:web:5f49c5c60b8b162914efb8",measurementId:"G-R2QRE36WEQ",databaseURL:"https://peloton-alerts-default-rtdb.firebaseio.com/"},Dc=Bh(()=>wR(I6)),xa=Bh(()=>E6(Dc)),D6="serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window,KR=async()=>{if(!("serviceWorker"in navigator))throw new Error("Service workers are not supported");return navigator.serviceWorker.register("/peloton-reservations/pr-preview/pr-56/messaging-sw.js",{type:"classic"})};let qg=KR();const vw=async()=>{if(!xa)throw new Error("Messaging is not set up");if(!D6)throw new Error("Browser environment does not allow messaging");let e;try{e=await qg,console.log("Registered service worker successfully")}catch(t){console.error("Failed to register service worker. Trying again...",t),qg=KR(),e=await qg}return T6(xa,{vapidKey:"BO9hF0_u2BKehXtAWTxtm7RtvIUGIEA5GT_jGycvCfUEW0yZZkLvtRB1Y8R_5KKBEODsLufyDkcBXn9rx5dHY5g",serviceWorkerRegistration:e})};function Jt(e){return`Minified Redux error #${e}; visit https://redux.js.org/Errors?code=${e} for the full message or use the non-minified dev environment for full errors. `}var O6=typeof Symbol=="function"&&Symbol.observable||"@@observable",_w=O6,Vg=()=>Math.random().toString(36).substring(7).split("").join("."),k6={INIT:`@@redux/INIT${Vg()}`,REPLACE:`@@redux/REPLACE${Vg()}`,PROBE_UNKNOWN_ACTION:()=>`@@redux/PROBE_UNKNOWN_ACTION${Vg()}`},qf=k6;function vs(e){if(typeof e!="object"||e===null)return!1;let t=e;for(;Object.getPrototypeOf(t)!==null;)t=Object.getPrototypeOf(t);return Object.getPrototypeOf(e)===t||Object.getPrototypeOf(e)===null}function XR(e,t,n){if(typeof e!="function")throw new Error(Jt(2));if(typeof t=="function"&&typeof n=="function"||typeof n=="function"&&typeof arguments[3]=="function")throw new Error(Jt(0));if(typeof t=="function"&&typeof n>"u"&&(n=t,t=void 0),typeof n<"u"){if(typeof n!="function")throw new Error(Jt(1));return n(XR)(e,t)}let i=e,o=t,l=new Map,u=l,f=0,p=!1;function h(){u===l&&(u=new Map,l.forEach((R,D)=>{u.set(D,R)}))}function y(){if(p)throw new Error(Jt(3));return o}function v(R){if(typeof R!="function")throw new Error(Jt(4));if(p)throw new Error(Jt(5));let D=!0;h();const k=f++;return u.set(k,R),function(){if(D){if(p)throw new Error(Jt(6));D=!1,h(),u.delete(k),l=null}}}function _(R){if(!vs(R))throw new Error(Jt(7));if(typeof R.type>"u")throw new Error(Jt(8));if(typeof R.type!="string")throw new Error(Jt(17));if(p)throw new Error(Jt(9));try{p=!0,o=i(o,R)}finally{p=!1}return(l=u).forEach(k=>{k()}),R}function b(R){if(typeof R!="function")throw new Error(Jt(10));i=R,_({type:qf.REPLACE})}function x(){const R=v;return{subscribe(D){if(typeof D!="object"||D===null)throw new Error(Jt(11));function k(){const A=D;A.next&&A.next(y())}return k(),{unsubscribe:R(k)}},[_w](){return this}}}return _({type:qf.INIT}),{dispatch:_,subscribe:v,getState:y,replaceReducer:b,[_w]:x}}function N6(e){Object.keys(e).forEach(t=>{const n=e[t];if(typeof n(void 0,{type:qf.INIT})>"u")throw new Error(Jt(12));if(typeof n(void 0,{type:qf.PROBE_UNKNOWN_ACTION()})>"u")throw new Error(Jt(13))})}function ZR(e){const t=Object.keys(e),n={};for(let l=0;l<t.length;l++){const u=t[l];typeof e[u]=="function"&&(n[u]=e[u])}const i=Object.keys(n);let o;try{N6(n)}catch(l){o=l}return function(u={},f){if(o)throw o;let p=!1;const h={};for(let y=0;y<i.length;y++){const v=i[y],_=n[v],b=u[v],x=_(b,f);if(typeof x>"u")throw f&&f.type,new Error(Jt(14));h[v]=x,p=p||x!==b}return p=p||i.length!==Object.keys(u).length,p?h:u}}function Vf(...e){return e.length===0?t=>t:e.length===1?e[0]:e.reduce((t,n)=>(...i)=>t(n(...i)))}function M6(...e){return t=>(n,i)=>{const o=t(n,i);let l=()=>{throw new Error(Jt(15))};const u={getState:o.getState,dispatch:(p,...h)=>l(p,...h)},f=e.map(p=>p(u));return l=Vf(...f)(o.dispatch),{...o,dispatch:l}}}function JR(e){return vs(e)&&"type"in e&&typeof e.type=="string"}var c_=Symbol.for("immer-nothing"),Oc=Symbol.for("immer-draftable"),Sn=Symbol.for("immer-state");function tn(e,...t){throw new Error(`[Immer] minified error nr: ${e}. Full error at: https://bit.ly/3cXEKWf`)}var $a=Object.getPrototypeOf;function Lr(e){return!!e&&!!e[Sn]}function br(e){return e?eA(e)||Array.isArray(e)||!!e[Oc]||!!e.constructor?.[Oc]||Ja(e)||mu(e):!1}var L6=Object.prototype.constructor.toString(),bw=new WeakMap;function eA(e){if(!e||typeof e!="object")return!1;const t=Object.getPrototypeOf(e);if(t===null||t===Object.prototype)return!0;const n=Object.hasOwnProperty.call(t,"constructor")&&t.constructor;if(n===Object)return!0;if(typeof n!="function")return!1;let i=bw.get(n);return i===void 0&&(i=Function.toString.call(n),bw.set(n,i)),i===L6}function P6(e){return Lr(e)||tn(15,e),e[Sn].base_}function Yc(e,t,n=!0){vo(e)===0?(n?Reflect.ownKeys(e):Object.keys(e)).forEach(o=>{t(o,e[o],e)}):e.forEach((i,o)=>t(o,i,e))}function vo(e){const t=e[Sn];return t?t.type_:Array.isArray(e)?1:Ja(e)?2:mu(e)?3:0}function Qc(e,t){return vo(e)===2?e.has(t):Object.prototype.hasOwnProperty.call(e,t)}function Gg(e,t){return vo(e)===2?e.get(t):e[t]}function tA(e,t,n){const i=vo(e);i===2?e.set(t,n):i===3?e.add(n):e[t]=n}function j6(e,t){return e===t?e!==0||1/e===1/t:e!==e&&t!==t}function Ja(e){return e instanceof Map}function mu(e){return e instanceof Set}function io(e){return e.copy_||e.base_}function Yy(e,t){if(Ja(e))return new Map(e);if(mu(e))return new Set(e);if(Array.isArray(e))return Array.prototype.slice.call(e);const n=eA(e);if(t===!0||t==="class_only"&&!n){const i=Object.getOwnPropertyDescriptors(e);delete i[Sn];let o=Reflect.ownKeys(i);for(let l=0;l<o.length;l++){const u=o[l],f=i[u];f.writable===!1&&(f.writable=!0,f.configurable=!0),(f.get||f.set)&&(i[u]={configurable:!0,writable:!0,enumerable:f.enumerable,value:e[u]})}return Object.create($a(e),i)}else{const i=$a(e);if(i!==null&&n)return{...e};const o=Object.create(i);return Object.assign(o,e)}}function u_(e,t=!1){return Hh(e)||Lr(e)||!br(e)||(vo(e)>1&&Object.defineProperties(e,{set:Kd,add:Kd,clear:Kd,delete:Kd}),Object.freeze(e),t&&Object.values(e).forEach(n=>u_(n,!0))),e}function $6(){tn(2)}var Kd={value:$6};function Hh(e){return e===null||typeof e!="object"?!0:Object.isFrozen(e)}var Qy={};function _o(e){const t=Qy[e];return t||tn(0,e),t}function U6(e,t){Qy[e]||(Qy[e]=t)}var Kc;function nA(){return Kc}function z6(e,t){return{drafts_:[],parent_:e,immer_:t,canAutoFreeze_:!0,unfinalizedDrafts_:0}}function Sw(e,t){t&&(_o("Patches"),e.patches_=[],e.inversePatches_=[],e.patchListener_=t)}function Ky(e){Xy(e),e.drafts_.forEach(B6),e.drafts_=null}function Xy(e){e===Kc&&(Kc=e.parent_)}function xw(e){return Kc=z6(Kc,e)}function B6(e){const t=e[Sn];t.type_===0||t.type_===1?t.revoke_():t.revoked_=!0}function ww(e,t){t.unfinalizedDrafts_=t.drafts_.length;const n=t.drafts_[0];return e!==void 0&&e!==n?(n[Sn].modified_&&(Ky(t),tn(4)),br(e)&&(e=Gf(t,e),t.parent_||Wf(t,e)),t.patches_&&_o("Patches").generateReplacementPatches_(n[Sn].base_,e,t.patches_,t.inversePatches_)):e=Gf(t,n,[]),Ky(t),t.patches_&&t.patchListener_(t.patches_,t.inversePatches_),e!==c_?e:void 0}function Gf(e,t,n){if(Hh(t))return t;const i=e.immer_.shouldUseStrictIteration(),o=t[Sn];if(!o)return Yc(t,(l,u)=>Ew(e,o,t,l,u,n),i),t;if(o.scope_!==e)return t;if(!o.modified_)return Wf(e,o.base_,!0),o.base_;if(!o.finalized_){o.finalized_=!0,o.scope_.unfinalizedDrafts_--;const l=o.copy_;let u=l,f=!1;o.type_===3&&(u=new Set(l),l.clear(),f=!0),Yc(u,(p,h)=>Ew(e,o,l,p,h,n,f),i),Wf(e,l,!1),n&&e.patches_&&_o("Patches").generatePatches_(o,n,e.patches_,e.inversePatches_)}return o.copy_}function Ew(e,t,n,i,o,l,u){if(o==null||typeof o!="object"&&!u)return;const f=Hh(o);if(!(f&&!u)){if(Lr(o)){const p=l&&t&&t.type_!==3&&!Qc(t.assigned_,i)?l.concat(i):void 0,h=Gf(e,o,p);if(tA(n,i,h),Lr(h))e.canAutoFreeze_=!1;else return}else u&&n.add(o);if(br(o)&&!f){if(!e.immer_.autoFreeze_&&e.unfinalizedDrafts_<1||t&&t.base_&&t.base_[i]===o&&f)return;Gf(e,o),(!t||!t.scope_.parent_)&&typeof i!="symbol"&&(Ja(n)?n.has(i):Object.prototype.propertyIsEnumerable.call(n,i))&&Wf(e,o)}}}function Wf(e,t,n=!1){!e.parent_&&e.immer_.autoFreeze_&&e.canAutoFreeze_&&u_(t,n)}function H6(e,t){const n=Array.isArray(e),i={type_:n?1:0,scope_:t?t.scope_:nA(),modified_:!1,finalized_:!1,assigned_:{},parent_:t,base_:e,draft_:null,copy_:null,revoke_:null,isManual_:!1};let o=i,l=d_;n&&(o=[i],l=Xc);const{revoke:u,proxy:f}=Proxy.revocable(o,l);return i.draft_=f,i.revoke_=u,f}var d_={get(e,t){if(t===Sn)return e;const n=io(e);if(!Qc(n,t))return F6(e,n,t);const i=n[t];return e.finalized_||!br(i)?i:i===Wg(e.base_,t)?(Yg(e),e.copy_[t]=Jy(i,e)):i},has(e,t){return t in io(e)},ownKeys(e){return Reflect.ownKeys(io(e))},set(e,t,n){const i=rA(io(e),t);if(i?.set)return i.set.call(e.draft_,n),!0;if(!e.modified_){const o=Wg(io(e),t),l=o?.[Sn];if(l&&l.base_===n)return e.copy_[t]=n,e.assigned_[t]=!1,!0;if(j6(n,o)&&(n!==void 0||Qc(e.base_,t)))return!0;Yg(e),Zy(e)}return e.copy_[t]===n&&(n!==void 0||t in e.copy_)||Number.isNaN(n)&&Number.isNaN(e.copy_[t])||(e.copy_[t]=n,e.assigned_[t]=!0),!0},deleteProperty(e,t){return Wg(e.base_,t)!==void 0||t in e.base_?(e.assigned_[t]=!1,Yg(e),Zy(e)):delete e.assigned_[t],e.copy_&&delete e.copy_[t],!0},getOwnPropertyDescriptor(e,t){const n=io(e),i=Reflect.getOwnPropertyDescriptor(n,t);return i&&{writable:!0,configurable:e.type_!==1||t!=="length",enumerable:i.enumerable,value:n[t]}},defineProperty(){tn(11)},getPrototypeOf(e){return $a(e.base_)},setPrototypeOf(){tn(12)}},Xc={};Yc(d_,(e,t)=>{Xc[e]=function(){return arguments[0]=arguments[0][0],t.apply(this,arguments)}});Xc.deleteProperty=function(e,t){return Xc.set.call(this,e,t,void 0)};Xc.set=function(e,t,n){return d_.set.call(this,e[0],t,n,e[0])};function Wg(e,t){const n=e[Sn];return(n?io(n):e)[t]}function F6(e,t,n){const i=rA(t,n);return i?"value"in i?i.value:i.get?.call(e.draft_):void 0}function rA(e,t){if(!(t in e))return;let n=$a(e);for(;n;){const i=Object.getOwnPropertyDescriptor(n,t);if(i)return i;n=$a(n)}}function Zy(e){e.modified_||(e.modified_=!0,e.parent_&&Zy(e.parent_))}function Yg(e){e.copy_||(e.copy_=Yy(e.base_,e.scope_.immer_.useStrictShallowCopy_))}var q6=class{constructor(e){this.autoFreeze_=!0,this.useStrictShallowCopy_=!1,this.useStrictIteration_=!0,this.produce=(t,n,i)=>{if(typeof t=="function"&&typeof n!="function"){const l=n;n=t;const u=this;return function(p=l,...h){return u.produce(p,y=>n.call(this,y,...h))}}typeof n!="function"&&tn(6),i!==void 0&&typeof i!="function"&&tn(7);let o;if(br(t)){const l=xw(this),u=Jy(t,void 0);let f=!0;try{o=n(u),f=!1}finally{f?Ky(l):Xy(l)}return Sw(l,i),ww(o,l)}else if(!t||typeof t!="object"){if(o=n(t),o===void 0&&(o=t),o===c_&&(o=void 0),this.autoFreeze_&&u_(o,!0),i){const l=[],u=[];_o("Patches").generateReplacementPatches_(t,o,l,u),i(l,u)}return o}else tn(1,t)},this.produceWithPatches=(t,n)=>{if(typeof t=="function")return(u,...f)=>this.produceWithPatches(u,p=>t(p,...f));let i,o;return[this.produce(t,n,(u,f)=>{i=u,o=f}),i,o]},typeof e?.autoFreeze=="boolean"&&this.setAutoFreeze(e.autoFreeze),typeof e?.useStrictShallowCopy=="boolean"&&this.setUseStrictShallowCopy(e.useStrictShallowCopy),typeof e?.useStrictIteration=="boolean"&&this.setUseStrictIteration(e.useStrictIteration)}createDraft(e){br(e)||tn(8),Lr(e)&&(e=V6(e));const t=xw(this),n=Jy(e,void 0);return n[Sn].isManual_=!0,Xy(t),n}finishDraft(e,t){const n=e&&e[Sn];(!n||!n.isManual_)&&tn(9);const{scope_:i}=n;return Sw(i,t),ww(void 0,i)}setAutoFreeze(e){this.autoFreeze_=e}setUseStrictShallowCopy(e){this.useStrictShallowCopy_=e}setUseStrictIteration(e){this.useStrictIteration_=e}shouldUseStrictIteration(){return this.useStrictIteration_}applyPatches(e,t){let n;for(n=t.length-1;n>=0;n--){const o=t[n];if(o.path.length===0&&o.op==="replace"){e=o.value;break}}n>-1&&(t=t.slice(n+1));const i=_o("Patches").applyPatches_;return Lr(e)?i(e,t):this.produce(e,o=>i(o,t))}};function Jy(e,t){const n=Ja(e)?_o("MapSet").proxyMap_(e,t):mu(e)?_o("MapSet").proxySet_(e,t):H6(e,t);return(t?t.scope_:nA()).drafts_.push(n),n}function V6(e){return Lr(e)||tn(10,e),iA(e)}function iA(e){if(!br(e)||Hh(e))return e;const t=e[Sn];let n,i=!0;if(t){if(!t.modified_)return t.base_;t.finalized_=!0,n=Yy(e,t.scope_.immer_.useStrictShallowCopy_),i=t.scope_.immer_.shouldUseStrictIteration()}else n=Yy(e,!0);return Yc(n,(o,l)=>{tA(n,o,iA(l))},i),t&&(t.finalized_=!1),n}function G6(){const t="replace",i="remove";function o(_,b,x,O){switch(_.type_){case 0:case 2:return u(_,b,x,O);case 1:return l(_,b,x,O);case 3:return f(_,b,x,O)}}function l(_,b,x,O){let{base_:R,assigned_:D}=_,k=_.copy_;k.length<R.length&&([R,k]=[k,R],[x,O]=[O,x]);for(let C=0;C<R.length;C++)if(D[C]&&k[C]!==R[C]){const A=b.concat([C]);x.push({op:t,path:A,value:v(k[C])}),O.push({op:t,path:A,value:v(R[C])})}for(let C=R.length;C<k.length;C++){const A=b.concat([C]);x.push({op:"add",path:A,value:v(k[C])})}for(let C=k.length-1;R.length<=C;--C){const A=b.concat([C]);O.push({op:i,path:A})}}function u(_,b,x,O){const{base_:R,copy_:D}=_;Yc(_.assigned_,(k,C)=>{const A=Gg(R,k),N=Gg(D,k),I=C?Qc(R,k)?t:"add":i;if(A===N&&I===t)return;const P=b.concat(k);x.push(I===i?{op:I,path:P}:{op:I,path:P,value:N}),O.push(I==="add"?{op:i,path:P}:I===i?{op:"add",path:P,value:v(A)}:{op:t,path:P,value:v(A)})})}function f(_,b,x,O){let{base_:R,copy_:D}=_,k=0;R.forEach(C=>{if(!D.has(C)){const A=b.concat([k]);x.push({op:i,path:A,value:C}),O.unshift({op:"add",path:A,value:C})}k++}),k=0,D.forEach(C=>{if(!R.has(C)){const A=b.concat([k]);x.push({op:"add",path:A,value:C}),O.unshift({op:i,path:A,value:C})}k++})}function p(_,b,x,O){x.push({op:t,path:[],value:b===c_?void 0:b}),O.push({op:t,path:[],value:_})}function h(_,b){return b.forEach(x=>{const{path:O,op:R}=x;let D=_;for(let N=0;N<O.length-1;N++){const I=vo(D);let P=O[N];typeof P!="string"&&typeof P!="number"&&(P=""+P),(I===0||I===1)&&(P==="__proto__"||P==="constructor")&&tn(19),typeof D=="function"&&P==="prototype"&&tn(19),D=Gg(D,P),typeof D!="object"&&tn(18,O.join("/"))}const k=vo(D),C=y(x.value),A=O[O.length-1];switch(R){case t:switch(k){case 2:return D.set(A,C);case 3:tn(16);default:return D[A]=C}case"add":switch(k){case 1:return A==="-"?D.push(C):D.splice(A,0,C);case 2:return D.set(A,C);case 3:return D.add(C);default:return D[A]=C}case i:switch(k){case 1:return D.splice(A,1);case 2:return D.delete(A);case 3:return D.delete(x.value);default:return delete D[A]}default:tn(17,R)}}),_}function y(_){if(!br(_))return _;if(Array.isArray(_))return _.map(y);if(Ja(_))return new Map(Array.from(_.entries()).map(([x,O])=>[x,y(O)]));if(mu(_))return new Set(Array.from(_).map(y));const b=Object.create($a(_));for(const x in _)b[x]=y(_[x]);return Qc(_,Oc)&&(b[Oc]=_[Oc]),b}function v(_){return Lr(_)?y(_):_}U6("Patches",{applyPatches_:h,generatePatches_:o,generateReplacementPatches_:p})}var Zc=new q6,gu=Zc.produce,sA=Zc.produceWithPatches.bind(Zc),Tw=Zc.applyPatches.bind(Zc);function W6(e,t=`expected a function, instead received ${typeof e}`){if(typeof e!="function")throw new TypeError(t)}function Y6(e,t=`expected an object, instead received ${typeof e}`){if(typeof e!="object")throw new TypeError(t)}function Q6(e,t="expected all items to be functions, instead received the following types: "){if(!e.every(n=>typeof n=="function")){const n=e.map(i=>typeof i=="function"?`function ${i.name||"unnamed"}()`:typeof i).join(", ");throw new TypeError(`${t}[${n}]`)}}var Cw=e=>Array.isArray(e)?e:[e];function K6(e){const t=Array.isArray(e[0])?e[0]:e;return Q6(t,"createSelector expects all input-selectors to be functions, but received the following types: "),t}function X6(e,t){const n=[],{length:i}=e;for(let o=0;o<i;o++)n.push(e[o].apply(null,t));return n}var Z6=class{constructor(e){this.value=e}deref(){return this.value}},J6=typeof WeakRef<"u"?WeakRef:Z6,e3=0,Rw=1;function Xd(){return{s:e3,v:void 0,o:null,p:null}}function Yf(e,t={}){let n=Xd();const{resultEqualityCheck:i}=t;let o,l=0;function u(){let f=n;const{length:p}=arguments;for(let v=0,_=p;v<_;v++){const b=arguments[v];if(typeof b=="function"||typeof b=="object"&&b!==null){let x=f.o;x===null&&(f.o=x=new WeakMap);const O=x.get(b);O===void 0?(f=Xd(),x.set(b,f)):f=O}else{let x=f.p;x===null&&(f.p=x=new Map);const O=x.get(b);O===void 0?(f=Xd(),x.set(b,f)):f=O}}const h=f;let y;if(f.s===Rw)y=f.v;else if(y=e.apply(null,arguments),l++,i){const v=o?.deref?.()??o;v!=null&&i(v,y)&&(y=v,l!==0&&l--),o=typeof y=="object"&&y!==null||typeof y=="function"?new J6(y):y}return h.s=Rw,h.v=y,y}return u.clearCache=()=>{n=Xd(),u.resetResultsCount()},u.resultsCount=()=>l,u.resetResultsCount=()=>{l=0},u}function t3(e,...t){const n=typeof e=="function"?{memoize:e,memoizeOptions:t}:e,i=(...o)=>{let l=0,u=0,f,p={},h=o.pop();typeof h=="object"&&(p=h,h=o.pop()),W6(h,`createSelector expects an output function after the inputs, but received: [${typeof h}]`);const y={...n,...p},{memoize:v,memoizeOptions:_=[],argsMemoize:b=Yf,argsMemoizeOptions:x=[]}=y,O=Cw(_),R=Cw(x),D=K6(o),k=v(function(){return l++,h.apply(null,arguments)},...O),C=b(function(){u++;const N=X6(D,arguments);return f=k.apply(null,N),f},...R);return Object.assign(C,{resultFunc:h,memoizedResultFunc:k,dependencies:D,dependencyRecomputations:()=>u,resetDependencyRecomputations:()=>{u=0},lastResult:()=>f,recomputations:()=>l,resetRecomputations:()=>{l=0},memoize:v,argsMemoize:b})};return Object.assign(i,{withTypes:()=>i}),i}var wi=t3(Yf),n3=Object.assign((e,t=wi)=>{Y6(e,`createStructuredSelector expects first argument to be an object where each property is a selector, instead received a ${typeof e}`);const n=Object.keys(e),i=n.map(l=>e[l]);return t(i,(...l)=>l.reduce((u,f,p)=>(u[n[p]]=f,u),{}))},{withTypes:()=>n3});function oA(e){return({dispatch:n,getState:i})=>o=>l=>typeof l=="function"?l(n,i,e):o(l)}var r3=oA(),i3=oA,s3=typeof window<"u"&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__:function(){if(arguments.length!==0)return typeof arguments[0]=="object"?Vf:Vf.apply(null,arguments)},o3=e=>e&&typeof e.match=="function";function mr(e,t){function n(...i){if(t){let o=t(...i);if(!o)throw new Error(gr(0));return{type:e,payload:o.payload,..."meta"in o&&{meta:o.meta},..."error"in o&&{error:o.error}}}return{type:e,payload:i[0]}}return n.toString=()=>`${e}`,n.type=e,n.match=i=>JR(i)&&i.type===e,n}var aA=class Ec extends Array{constructor(...t){super(...t),Object.setPrototypeOf(this,Ec.prototype)}static get[Symbol.species](){return Ec}concat(...t){return super.concat.apply(this,t)}prepend(...t){return t.length===1&&Array.isArray(t[0])?new Ec(...t[0].concat(this)):new Ec(...t.concat(this))}};function Aw(e){return br(e)?gu(e,()=>{}):e}function Zd(e,t,n){return e.has(t)?e.get(t):e.set(t,n(t)).get(t)}function a3(e){return typeof e=="boolean"}var l3=()=>function(t){const{thunk:n=!0,immutableCheck:i=!0,serializableCheck:o=!0,actionCreatorCheck:l=!0}=t??{};let u=new aA;return n&&(a3(n)?u.push(r3):u.push(i3(n.extraArgument))),u},Fh="RTK_autoBatch",oc=()=>e=>({payload:e,meta:{[Fh]:!0}}),Iw=e=>t=>{setTimeout(t,e)},c3=(e={type:"raf"})=>t=>(...n)=>{const i=t(...n);let o=!0,l=!1,u=!1;const f=new Set,p=e.type==="tick"?queueMicrotask:e.type==="raf"?typeof window<"u"&&window.requestAnimationFrame?window.requestAnimationFrame:Iw(10):e.type==="callback"?e.queueNotification:Iw(e.timeout),h=()=>{u=!1,l&&(l=!1,f.forEach(y=>y()))};return Object.assign({},i,{subscribe(y){const v=()=>o&&y(),_=i.subscribe(v);return f.add(y),()=>{_(),f.delete(y)}},dispatch(y){try{return o=!y?.meta?.[Fh],l=!o,l&&(u||(u=!0,p(h))),i.dispatch(y)}finally{o=!0}}})},u3=e=>function(n){const{autoBatch:i=!0}=n??{};let o=new aA(e);return i&&o.push(c3(typeof i=="object"?i:void 0)),o};function d3(e){const t=l3(),{reducer:n=void 0,middleware:i,devTools:o=!0,preloadedState:l=void 0,enhancers:u=void 0}=e||{};let f;if(typeof n=="function")f=n;else if(vs(n))f=ZR(n);else throw new Error(gr(1));let p;typeof i=="function"?p=i(t):p=t();let h=Vf;o&&(h=s3({trace:!1,...typeof o=="object"&&o}));const y=M6(...p),v=u3(y);let _=typeof u=="function"?u(v):v();const b=h(..._);return XR(f,l,b)}function lA(e){const t={},n=[];let i;const o={addCase(l,u){const f=typeof l=="string"?l:l.type;if(!f)throw new Error(gr(28));if(f in t)throw new Error(gr(29));return t[f]=u,o},addAsyncThunk(l,u){return u.pending&&(t[l.pending.type]=u.pending),u.rejected&&(t[l.rejected.type]=u.rejected),u.fulfilled&&(t[l.fulfilled.type]=u.fulfilled),u.settled&&n.push({matcher:l.settled,reducer:u.settled}),o},addMatcher(l,u){return n.push({matcher:l,reducer:u}),o},addDefaultCase(l){return i=l,o}};return e(o),[t,n,i]}function f3(e){return typeof e=="function"}function h3(e,t){let[n,i,o]=lA(t),l;if(f3(e))l=()=>Aw(e());else{const f=Aw(e);l=()=>f}function u(f=l(),p){let h=[n[p.type],...i.filter(({matcher:y})=>y(p)).map(({reducer:y})=>y)];return h.filter(y=>!!y).length===0&&(h=[o]),h.reduce((y,v)=>{if(v)if(Lr(y)){const b=v(y,p);return b===void 0?y:b}else{if(br(y))return gu(y,_=>v(_,p));{const _=v(y,p);if(_===void 0){if(y===null)return y;throw Error("A case reducer on a non-draftable value must not return undefined")}return _}}return y},f)}return u.getInitialState=l,u}var cA=(e,t)=>o3(e)?e.match(t):e(t);function vi(...e){return t=>e.some(n=>cA(n,t))}function kc(...e){return t=>e.every(n=>cA(n,t))}function qh(e,t){if(!e||!e.meta)return!1;const n=typeof e.meta.requestId=="string",i=t.indexOf(e.meta.requestStatus)>-1;return n&&i}function yu(e){return typeof e[0]=="function"&&"pending"in e[0]&&"fulfilled"in e[0]&&"rejected"in e[0]}function f_(...e){return e.length===0?t=>qh(t,["pending"]):yu(e)?vi(...e.map(t=>t.pending)):f_()(e[0])}function Ua(...e){return e.length===0?t=>qh(t,["rejected"]):yu(e)?vi(...e.map(t=>t.rejected)):Ua()(e[0])}function Vh(...e){const t=n=>n&&n.meta&&n.meta.rejectedWithValue;return e.length===0?kc(Ua(...e),t):yu(e)?kc(Ua(...e),t):Vh()(e[0])}function _s(...e){return e.length===0?t=>qh(t,["fulfilled"]):yu(e)?vi(...e.map(t=>t.fulfilled)):_s()(e[0])}function ev(...e){return e.length===0?t=>qh(t,["pending","fulfilled","rejected"]):yu(e)?vi(...e.flatMap(t=>[t.pending,t.rejected,t.fulfilled])):ev()(e[0])}var p3="ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW",h_=(e=21)=>{let t="",n=e;for(;n--;)t+=p3[Math.random()*64|0];return t},m3=["name","message","stack","code"],Qg=class{constructor(e,t){this.payload=e,this.meta=t}_type},Dw=class{constructor(e,t){this.payload=e,this.meta=t}_type},g3=e=>{if(typeof e=="object"&&e!==null){const t={};for(const n of m3)typeof e[n]=="string"&&(t[n]=e[n]);return t}return{message:String(e)}},Ow="External signal was aborted",kw=(()=>{function e(t,n,i){const o=mr(t+"/fulfilled",(p,h,y,v)=>({payload:p,meta:{...v||{},arg:y,requestId:h,requestStatus:"fulfilled"}})),l=mr(t+"/pending",(p,h,y)=>({payload:void 0,meta:{...y||{},arg:h,requestId:p,requestStatus:"pending"}})),u=mr(t+"/rejected",(p,h,y,v,_)=>({payload:v,error:(i&&i.serializeError||g3)(p||"Rejected"),meta:{..._||{},arg:y,requestId:h,rejectedWithValue:!!v,requestStatus:"rejected",aborted:p?.name==="AbortError",condition:p?.name==="ConditionError"}}));function f(p,{signal:h}={}){return(y,v,_)=>{const b=i?.idGenerator?i.idGenerator(p):h_(),x=new AbortController;let O,R;function D(C){R=C,x.abort()}h&&(h.aborted?D(Ow):h.addEventListener("abort",()=>D(Ow),{once:!0}));const k=(async function(){let C;try{let N=i?.condition?.(p,{getState:v,extra:_});if(v3(N)&&(N=await N),N===!1||x.signal.aborted)throw{name:"ConditionError",message:"Aborted due to condition callback returning false."};const I=new Promise((P,F)=>{O=()=>{F({name:"AbortError",message:R||"Aborted"})},x.signal.addEventListener("abort",O)});y(l(b,p,i?.getPendingMeta?.({requestId:b,arg:p},{getState:v,extra:_}))),C=await Promise.race([I,Promise.resolve(n(p,{dispatch:y,getState:v,extra:_,requestId:b,signal:x.signal,abort:D,rejectWithValue:(P,F)=>new Qg(P,F),fulfillWithValue:(P,F)=>new Dw(P,F)})).then(P=>{if(P instanceof Qg)throw P;return P instanceof Dw?o(P.payload,b,p,P.meta):o(P,b,p)})])}catch(N){C=N instanceof Qg?u(null,b,p,N.payload,N.meta):u(N,b,p)}finally{O&&x.signal.removeEventListener("abort",O)}return i&&!i.dispatchConditionRejection&&u.match(C)&&C.meta.condition||y(C),C})();return Object.assign(k,{abort:D,requestId:b,arg:p,unwrap(){return k.then(y3)}})}}return Object.assign(f,{pending:l,rejected:u,fulfilled:o,settled:vi(u,o),typePrefix:t})}return e.withTypes=()=>e,e})();function y3(e){if(e.meta&&e.meta.rejectedWithValue)throw e.payload;if(e.error)throw e.error;return e.payload}function v3(e){return e!==null&&typeof e=="object"&&typeof e.then=="function"}var _3=Symbol.for("rtk-slice-createasyncthunk");function b3(e,t){return`${e}/${t}`}function S3({creators:e}={}){const t=e?.asyncThunk?.[_3];return function(i){const{name:o,reducerPath:l=o}=i;if(!o)throw new Error(gr(11));const u=(typeof i.reducers=="function"?i.reducers(w3()):i.reducers)||{},f=Object.keys(u),p={sliceCaseReducersByName:{},sliceCaseReducersByType:{},actionCreators:{},sliceMatchers:[]},h={addCase(C,A){const N=typeof C=="string"?C:C.type;if(!N)throw new Error(gr(12));if(N in p.sliceCaseReducersByType)throw new Error(gr(13));return p.sliceCaseReducersByType[N]=A,h},addMatcher(C,A){return p.sliceMatchers.push({matcher:C,reducer:A}),h},exposeAction(C,A){return p.actionCreators[C]=A,h},exposeCaseReducer(C,A){return p.sliceCaseReducersByName[C]=A,h}};f.forEach(C=>{const A=u[C],N={reducerName:C,type:b3(o,C),createNotation:typeof i.reducers=="function"};T3(A)?R3(N,A,h,t):E3(N,A,h)});function y(){const[C={},A=[],N=void 0]=typeof i.extraReducers=="function"?lA(i.extraReducers):[i.extraReducers],I={...C,...p.sliceCaseReducersByType};return h3(i.initialState,P=>{for(let F in I)P.addCase(F,I[F]);for(let F of p.sliceMatchers)P.addMatcher(F.matcher,F.reducer);for(let F of A)P.addMatcher(F.matcher,F.reducer);N&&P.addDefaultCase(N)})}const v=C=>C,_=new Map,b=new WeakMap;let x;function O(C,A){return x||(x=y()),x(C,A)}function R(){return x||(x=y()),x.getInitialState()}function D(C,A=!1){function N(P){let F=P[C];return typeof F>"u"&&A&&(F=Zd(b,N,R)),F}function I(P=v){const F=Zd(_,A,()=>new WeakMap);return Zd(F,P,()=>{const H={};for(const[B,z]of Object.entries(i.selectors??{}))H[B]=x3(z,P,()=>Zd(b,P,R),A);return H})}return{reducerPath:C,getSelectors:I,get selectors(){return I(N)},selectSlice:N}}const k={name:o,reducer:O,actions:p.actionCreators,caseReducers:p.sliceCaseReducersByName,getInitialState:R,...D(l),injectInto(C,{reducerPath:A,...N}={}){const I=A??l;return C.inject({reducerPath:I,reducer:O},N),{...k,...D(I,!0)}}};return k}}function x3(e,t,n,i){function o(l,...u){let f=t(l);return typeof f>"u"&&i&&(f=n()),e(f,...u)}return o.unwrapped=e,o}var Kn=S3();function w3(){function e(t,n){return{_reducerDefinitionType:"asyncThunk",payloadCreator:t,...n}}return e.withTypes=()=>e,{reducer(t){return Object.assign({[t.name](...n){return t(...n)}}[t.name],{_reducerDefinitionType:"reducer"})},preparedReducer(t,n){return{_reducerDefinitionType:"reducerWithPrepare",prepare:t,reducer:n}},asyncThunk:e}}function E3({type:e,reducerName:t,createNotation:n},i,o){let l,u;if("reducer"in i){if(n&&!C3(i))throw new Error(gr(17));l=i.reducer,u=i.prepare}else l=i;o.addCase(e,l).exposeCaseReducer(t,l).exposeAction(t,u?mr(e,u):mr(e))}function T3(e){return e._reducerDefinitionType==="asyncThunk"}function C3(e){return e._reducerDefinitionType==="reducerWithPrepare"}function R3({type:e,reducerName:t},n,i,o){if(!o)throw new Error(gr(18));const{payloadCreator:l,fulfilled:u,pending:f,rejected:p,settled:h,options:y}=n,v=o(e,l,y);i.exposeAction(t,v),u&&i.addCase(v.fulfilled,u),f&&i.addCase(v.pending,f),p&&i.addCase(v.rejected,p),h&&i.addMatcher(v.settled,h),i.exposeCaseReducer(t,{fulfilled:u||Jd,pending:f||Jd,rejected:p||Jd,settled:h||Jd})}function Jd(){}function gr(e){return`Minified Redux Toolkit error #${e}; visit https://redux-toolkit.js.org/Errors?code=${e} for the full message or use the non-minified dev environment for full errors. `}const el=e=>e.session,vu=wi([el],e=>{if(e.state==="fulfilled")return e.data?.id}),Mn=sC,et=oC,_u=E.createContext({refreshToken:()=>{},deleteToken:()=>Promise.reject("Not implemented")});var Nw={};const Mw="@firebase/database",Lw="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dA=function(e){try{if(typeof window<"u"&&typeof window[e]<"u"){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new I3(t)}}catch{}return new D3},co=dA("localStorage"),O3=dA("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g_="5",mA="v",gA="s",yA="r",vA="f",_A=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,bA="ls",SA="p",nv="ac",xA="websocket",wA="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $w="start",K3="close",X3="pLPCommand",Z3="pRTLPCB",CA="id",RA="pw",AA="ser",J3="cb",e$="seg",t$="ts",n$="d",r$="dframe",IA=1870,DA=30,i$=IA-DA,s$=25e3,o$=3e4;class wa{constructor(t,n,i,o,l,u,f){this.connId=t,this.repoInfo=n,this.applicationId=i,this.appCheckToken=o,this.authToken=l,this.transportSessionId=u,this.lastSessionId=f,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Su(t),this.stats_=y_(n),this.urlFn=p=>(this.appCheckToken&&(p[nv]=this.appCheckToken),TA(n,wA,p))}open(t,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new Q3(t),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(o$)),L3(()=>{if(this.isClosed_)return;this.scriptTagHolder=new v_((...l)=>{const[u,f,p,h,y]=l;if(this.incrementIncomingBytes_(l),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,u===$w)this.id=f,this.password=p;else if(u===K3)f?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(f,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+u)},(...l)=>{const[u,f]=l;this.incrementIncomingBytes_(l),this.myPacketOrderer.handleResponse(u,f)},()=>{this.onClosed_()},this.urlFn);const i={};i[$w]="t",i[AA]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[J3]=this.scriptTagHolder.uniqueCallbackIdentifier),i[mA]=g_,this.transportSessionId&&(i[gA]=this.transportSessionId),this.lastSessionId&&(i[bA]=this.lastSessionId),this.applicationId&&(i[SA]=this.applicationId),this.appCheckToken&&(i[nv]=this.appCheckToken),typeof location<"u"&&location.hostname&&_A.test(location.hostname)&&(i[yA]=vA);const o=this.urlFn(i);this.log_("Connecting via long-poll to "+o),this.scriptTagHolder.addTag(o,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){wa.forceAllow_=!0}static forceDisallow(){wa.forceDisallow_=!0}static isAvailable(){return wa.forceAllow_?!0:!wa.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!j3()&&!$3()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(t){const n=Ut(t);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const i=uR(n),o=hA(i,i$);for(let l=0;l<o.length;l++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,o.length,o[l]),this.curSegmentNum++}addDisconnectPingFrame(t,n){this.myDisconnFrame=document.createElement("iframe");const i={};i[r$]="t",i[CA]=t,i[RA]=n,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(t){const n=Ut(t).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class v_{constructor(t,n,i,o){this.onDisconnect=i,this.urlFn=o,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=k3(),window[X3+this.uniqueCallbackIdentifier]=t,window[Z3+this.uniqueCallbackIdentifier]=n,this.myIFrame=v_.createIFrame_();let l="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(l='<script>document.domain="'+document.domain+'";<\/script>');const u="<html><body>"+l+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(u),this.myIFrame.doc.close()}catch(f){en("frame writing exception"),f.stack&&en(f.stack),en(f)}}}static createIFrame_(){const t=document.createElement("iframe");if(t.style.display="none",document.body){document.body.appendChild(t);try{t.contentWindow.document||en("No IE domain setting required")}catch{const i=document.domain;t.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return t.contentDocument?t.doc=t.contentDocument:t.contentWindow?t.doc=t.contentWindow.document:t.document&&(t.doc=t.document),t}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const t=this.onDisconnect;t&&(this.onDisconnect=null,t())}startLongPoll(t,n){for(this.myID=t,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const t={};t[CA]=this.myID,t[RA]=this.myPW,t[AA]=this.currentSerial;let n=this.urlFn(t),i="",o=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+DA+i.length<=IA;){const u=this.pendingSegs.shift();i=i+"&"+e$+o+"="+u.seg+"&"+t$+o+"="+u.ts+"&"+n$+o+"="+u.d,o++}return n=n+i,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(t,n,i){this.pendingSegs.push({seg:t,ts:n,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(t,n){this.outstandingRequests.add(n);const i=()=>{this.outstandingRequests.delete(n),this.newRequest_()},o=setTimeout(i,Math.floor(s$)),l=()=>{clearTimeout(o),i()};this.addTag(t,l)}addTag(t,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=t,i.onload=i.onreadystatechange=function(){const o=i.readyState;(!o||o==="loaded"||o==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),n())},i.onerror=()=>{en("Long-poll script failed to load: "+t),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OA{put(t,n,i,o){}merge(t,n,i,o){}refreshAuthToken(t){}refreshAppCheckToken(t){}onDisconnectPut(t,n,i){}onDisconnectMerge(t,n,i){}onDisconnectCancel(t,n){}reportStats(t){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kf extends kA{static getInstance(){return new Kf}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Zv()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(t){return he(t==="online","Unknown event type: "+t),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S_ extends kA{static getInstance(){return new S_}constructor(){super(["visible"]);let t,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",t="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",t="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",t="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",t="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const i=!document[t];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}getInitialEvent(t){return he(t==="visible","Unknown event type: "+t),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const t of this.listens.values())for(const n of t.values())this.sendListen_(n);for(let t=0;t<this.outstandingPuts_.length;t++)this.outstandingPuts_[t]&&this.sendPut_(t);for(;this.onDisconnectRequestQueue_.length;){const t=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(t.action,t.pathString,t.data,t.onComplete)}for(let t=0;t<this.outstandingGets_.length;t++)this.outstandingGets_[t]&&this.sendGet_(t)}sendConnectStats_(){const t={};let n="js";t["sdk."+n+"."+uA.replace(/\./g,"-")]=1,Zv()?t["framework.cordova"]=1:yR()&&(t["framework.reactnative"]=1),this.reportStats(t)}shouldReconnect_(){const t=Kf.getInstance().currentlyOnline();return By(this.interruptReasons_)&&t}}mi.nextPersistentConnectionId_=0;mi.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rv;function A$(e){rv=e}const PA=function(e){return typeof e=="number"?"number:"+pA(e):"string:"+e},jA=function(e){if(e.isLeafNode()){const t=e.val();he(typeof t=="string"||typeof t=="number"||typeof t=="object"&&jr(t,".sv"),"Priority must be a string or number.")}else he(e===rv||e.isEmpty(),"priority of unexpected type.");he(e===rv||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qw;class Ft{static set __childrenNodeConstructor(t){Qw=t}static get __childrenNodeConstructor(){return Qw}constructor(t,n=Ft.__childrenNodeConstructor.EMPTY_NODE){this.value_=t,this.priorityNode_=n,this.lazyHash_=null,he(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),jA(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(t){return new Ft(this.value_,t)}getImmediateChild(t){return t===".priority"?this.priorityNode_:Ft.__childrenNodeConstructor.EMPTY_NODE}getChild(t){return Ye(t)?this:qe(t)===".priority"?this.priorityNode_:Ft.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(t,n){return null}updateImmediateChild(t,n){return t===".priority"?this.updatePriority(n):n.isEmpty()&&t!==".priority"?this:Ft.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(t,n).updatePriority(this.priorityNode_)}updateChild(t,n){const i=qe(t);return i===null?n:n.isEmpty()&&i!==".priority"?this:(he(i!==".priority"||bs(t)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,Ft.__childrenNodeConstructor.EMPTY_NODE.updateChild(pt(t),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(t,n){return!1}val(t){return t&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let t="";this.priorityNode_.isEmpty()||(t+="priority:"+PA(this.priorityNode_.val())+":");const n=typeof this.value_;t+=n+":",n==="number"?t+=pA(this.value_):t+=this.value_,this.lazyHash_=fA(t)}return this.lazyHash_}getValue(){return this.value_}compareTo(t){return t===Ft.__childrenNodeConstructor.EMPTY_NODE?1:t instanceof Ft.__childrenNodeConstructor?-1:(he(t.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(t))}compareToLeafNode_(t){const n=typeof t.value_,i=typeof this.value_,o=Ft.VALUE_TYPE_ORDER.indexOf(n),l=Ft.VALUE_TYPE_ORDER.indexOf(i);return he(o>=0,"Unknown leaf type: "+n),he(l>=0,"Unknown leaf type: "+i),o===l?i==="object"?0:this.value_<t.value_?-1:this.value_===t.value_?0:1:l-o}withIndex(){return this}isIndexed(){return!0}equals(t){if(t===this)return!0;if(t.isLeafNode()){const n=t;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}Ft.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $A,UA;function I$(e){$A=e}function D$(e){UA=e}class O$ extends Gh{compare(t,n){const i=t.node.getPriority(),o=n.node.getPriority(),l=i.compareTo(o);return l===0?Ao(t.name,n.name):l}isDefinedOn(t){return!t.getPriority().isEmpty()}indexedValueChanged(t,n){return!t.getPriority().equals(n.getPriority())}minPost(){return Ve.MIN}maxPost(){return new Ve(bo,new Ft("[PRIORITY-POST]",UA))}makePost(t,n){const i=$A(t);return new Ve(n,new Ft("[PRIORITY-POST]",i))}toString(){return".priority"}}const It=new O$;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k$=Math.log(2);class N${constructor(t){const n=l=>parseInt(Math.log(l)/k$,10),i=l=>parseInt(Array(l+1).join("1"),2);this.count=n(t+1),this.current_=this.count-1;const o=i(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const Xf=function(e,t,n,i){e.sort(t);const o=function(p,h){const y=h-p;let v,_;if(y===0)return null;if(y===1)return v=e[p],_=n?n(v):v,new Vt(_,v.node,Vt.BLACK,null,null);{const b=parseInt(y/2,10)+p,x=o(p,b),O=o(b+1,h);return v=e[b],_=n?n(v):v,new Vt(_,v.node,Vt.BLACK,x,O)}},l=function(p){let h=null,y=null,v=e.length;const _=function(x,O){const R=v-x,D=v;v-=x;const k=o(R+1,D),C=e[R],A=n?n(C):C;b(new Vt(A,C.node,O,null,k))},b=function(x){h?(h.left=x,h=x):(y=x,h=x)};for(let x=0;x<p.count;++x){const O=p.nextBitIsOne(),R=Math.pow(2,p.count-(x+1));O?_(R,Vt.BLACK):(_(R,Vt.BLACK),_(R,Vt.RED))}return y},u=new N$(e.length),f=l(u);return new bn(i||t,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wh(e,t){return{eventCache:e,serverCache:t}}function Lc(e,t,n,i){return Wh(new Ss(t,n,i),e.serverCache)}function HA(e,t,n,i){return Wh(e.eventCache,new Ss(t,n,i))}function th(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function xo(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let sh;class XA{constructor(){this.views=new Map}}function I5(e){he(!sh,"__referenceConstructor has already been defined"),sh=e}function D5(){return he(sh,"Reference.ts has not been loaded"),sh}function O5(e){return e.views.size===0}function O_(e,t,n,i){const o=t.source.queryId;if(o!==null){const l=e.views.get(o);return he(l!=null,"SyncTree gave us an op for an invalid query."),oE(l,t,n,i)}else{let l=[];for(const u of e.views.values())l=l.concat(oE(u,t,n,i));return l}}function ZA(e,t,n,i,o){const l=t._queryIdentifier,u=e.views.get(l);if(!u){let f=nh(n,o?i:null),p=!1;f?p=!0:i instanceof Ne?(f=A_(n,i),p=!1):(f=Ne.EMPTY_NODE,p=!1);const h=Wh(new Ss(f,p,!1),new Ss(i,o,!1));return new w5(t,h)}return u}function k5(e,t,n,i,o,l){const u=ZA(e,t,i,o,l);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,u),R5(u,n),A5(u,n)}function N5(e,t,n,i){const o=t._queryIdentifier,l=[];let u=[];const f=xs(e);if(o==="default")for(const[p,h]of e.views.entries())u=u.concat(sE(h,n,i)),iE(h)&&(e.views.delete(p),h.query._queryParams.loadsAllData()||l.push(h.query));else{const p=e.views.get(o);p&&(u=u.concat(sE(p,n,i)),iE(p)&&(e.views.delete(o),p.query._queryParams.loadsAllData()||l.push(p.query)))}return f&&!xs(e)&&l.push(new(D5())(t._repo,t._path)),{removed:l,events:u}}function JA(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function fs(e,t){let n=null;for(const i of e.views.values())n=n||C5(i,t);return n}function eI(e,t){if(t._queryParams.loadsAllData())return Qh(e);{const i=t._queryIdentifier;return e.views.get(i)}}function tI(e,t){return eI(e,t)!=null}function xs(e){return Qh(e)!=null}function Qh(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oh;function M5(e){he(!oh,"__referenceConstructor has already been defined"),oh=e}function L5(){return he(oh,"Reference.ts has not been loaded"),oh}let P5=1;class aE{constructor(t){this.listenProvider_=t,this.syncPointTree_=new ht(null),this.pendingWriteTree_=d5(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function nI(e,t,n,i,o){return J$(e.pendingWriteTree_,t,n,i,o),o?nl(e,new So(T_(),t,n)):[]}function j5(e,t,n,i){e5(e.pendingWriteTree_,t,n,i);const o=ht.fromObject(n);return nl(e,new Ha(T_(),t,o))}function as(e,t,n=!1){const i=t5(e.pendingWriteTree_,t);if(n5(e.pendingWriteTree_,t)){let l=new ht(null);return i.snap!=null?l=l.set(Xe(),!0):rn(i.children,u=>{l=l.set(new ut(u),!0)}),nl(e,new eh(i.path,l,n))}else return[]}function wu(e,t,n){return nl(e,new So(C_(),t,n))}function $5(e,t,n){const i=ht.fromObject(n);return nl(e,new Ha(C_(),t,i))}function U5(e,t){return nl(e,new iu(C_(),t))}function z5(e,t,n){const i=N_(e,n);if(i){const o=M_(i),l=o.path,u=o.queryId,f=un(l,t),p=new iu(R_(u),f);return L_(e,l,p)}else return[]}function ah(e,t,n,i,o=!1){const l=t._path,u=e.syncPointTree_.get(l);let f=[];if(u&&(t._queryIdentifier==="default"||tI(u,t))){const p=N5(u,t,n,i);O5(u)&&(e.syncPointTree_=e.syncPointTree_.remove(l));const h=p.removed;if(f=p.events,!o){const y=h.findIndex(_=>_._queryParams.loadsAllData())!==-1,v=e.syncPointTree_.findOnPath(l,(_,b)=>xs(b));if(y&&!v){const _=e.syncPointTree_.subtree(l);if(!_.isEmpty()){const b=F5(_);for(let x=0;x<b.length;++x){const O=b[x],R=O.query,D=oI(e,O);e.listenProvider_.startListening(jc(R),su(e,R),D.hashFn,D.onComplete)}}}!v&&h.length>0&&!i&&(y?e.listenProvider_.stopListening(jc(t),null):h.forEach(_=>{const b=e.queryToTagMap.get(Kh(_));e.listenProvider_.stopListening(jc(_),b)}))}q5(e,h)}return f}function rI(e,t,n,i){const o=N_(e,i);if(o!=null){const l=M_(o),u=l.path,f=l.queryId,p=un(u,t),h=new So(R_(f),p,n);return L_(e,u,h)}else return[]}function B5(e,t,n,i){const o=N_(e,i);if(o){const l=M_(o),u=l.path,f=l.queryId,p=un(u,t),h=ht.fromObject(n),y=new Ha(R_(f),p,h);return L_(e,u,y)}else return[]}function uv(e,t,n,i=!1){const o=t._path;let l=null,u=!1;e.syncPointTree_.foreachOnPath(o,(_,b)=>{const x=un(_,o);l=l||fs(b,x),u=u||xs(b)});let f=e.syncPointTree_.get(o);f?(u=u||xs(f),l=l||fs(f,Xe())):(f=new XA,e.syncPointTree_=e.syncPointTree_.set(o,f));let p;l!=null?p=!0:(p=!1,l=Ne.EMPTY_NODE,e.syncPointTree_.subtree(o).foreachChild((b,x)=>{const O=fs(x,Xe());O&&(l=l.updateImmediateChild(b,O))}));const h=tI(f,t);if(!h&&!t._queryParams.loadsAllData()){const _=Kh(t);he(!e.queryToTagMap.has(_),"View does not exist, but we have a tag");const b=V5();e.queryToTagMap.set(_,b),e.tagToQueryMap.set(b,_)}const y=Yh(e.pendingWriteTree_,o);let v=k5(f,t,n,y,l,p);if(!h&&!u&&!i){const _=eI(f,t);v=v.concat(G5(e,t,_))}return v}function k_(e,t,n){const o=e.pendingWriteTree_,l=e.syncPointTree_.findOnPath(t,(u,f)=>{const p=un(u,t),h=fs(f,p);if(h)return h});return VA(o,t,l,n,!0)}function H5(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,(h,y)=>{const v=un(h,n);i=i||fs(y,v)});let o=e.syncPointTree_.get(n);o?i=i||fs(o,Xe()):(o=new XA,e.syncPointTree_=e.syncPointTree_.set(n,o));const l=i!=null,u=l?new Ss(i,!0,!1):null,f=Yh(e.pendingWriteTree_,t._path),p=ZA(o,t,f,l?u.getNode():Ne.EMPTY_NODE,l);return T5(p)}function nl(e,t){return iI(t,e.syncPointTree_,null,Yh(e.pendingWriteTree_,Xe()))}function iI(e,t,n,i){if(Ye(e.path))return sI(e,t,n,i);{const o=t.get(Xe());n==null&&o!=null&&(n=fs(o,Xe()));let l=[];const u=qe(e.path),f=e.operationForChild(u),p=t.children.get(u);if(p&&f){const h=n?n.getImmediateChild(u):null,y=GA(i,u);l=l.concat(iI(f,p,h,y))}return o&&(l=l.concat(O_(o,e,i,n))),l}}function sI(e,t,n,i){const o=t.get(Xe());n==null&&o!=null&&(n=fs(o,Xe()));let l=[];return t.children.inorderTraversal((u,f)=>{const p=n?n.getImmediateChild(u):null,h=GA(i,u),y=e.operationForChild(u);y&&(l=l.concat(sI(y,f,p,h)))}),o&&(l=l.concat(O_(o,e,i,n))),l}function oI(e,t){const n=t.query,i=su(e,n);return{hashFn:()=>(E5(t)||Ne.EMPTY_NODE).hash(),onComplete:o=>{if(o==="ok")return i?z5(e,n._path,i):U5(e,n._path);{const l=U3(o,n);return ah(e,n,null,l)}}}}function su(e,t){const n=Kh(t);return e.queryToTagMap.get(n)}function Kh(e){return e._path.toString()+"$"+e._queryIdentifier}function N_(e,t){return e.tagToQueryMap.get(t)}function M_(e){const t=e.indexOf("$");return he(t!==-1&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new ut(e.substr(0,t))}}function L_(e,t,n){const i=e.syncPointTree_.get(t);he(i,"Missing sync point for query tag that we're tracking");const o=Yh(e.pendingWriteTree_,t);return O_(i,n,o,null)}function F5(e){return e.fold((t,n,i)=>{if(n&&xs(n))return[Qh(n)];{let o=[];return n&&(o=JA(n)),rn(i,(l,u)=>{o=o.concat(u)}),o}})}function jc(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(L5())(e._repo,e._path):e}function q5(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const o=Kh(i),l=e.queryToTagMap.get(o);e.queryToTagMap.delete(o),e.tagToQueryMap.delete(l)}}}function V5(){return P5++}function G5(e,t,n){const i=t._path,o=su(e,t),l=oI(e,n),u=e.listenProvider_.startListening(jc(t),o,l.hashFn,l.onComplete),f=e.syncPointTree_.subtree(i);if(o)he(!xs(f.value),"If we're adding a query, it shouldn't be shadowed");else{const p=f.fold((h,y,v)=>{if(!Ye(h)&&y&&xs(y))return[Qh(y).query];{let _=[];return y&&(_=_.concat(JA(y).map(b=>b.query))),rn(v,(b,x)=>{_=_.concat(x)}),_}});for(let h=0;h<p.length;++h){const y=p[h];e.listenProvider_.stopListening(jc(y),su(e,y))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aU{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Jh(e,t){let n=null;for(let i=0;i<t.length;i++){const o=t[i],l=o.getPath();n!==null&&!b_(l,n.path)&&(e.eventLists_.push(n),n=null),n===null&&(n={events:[],path:l}),n.events.push(o)}n&&e.eventLists_.push(n)}function mI(e,t,n){Jh(e,n),gI(e,i=>b_(i,t))}function tr(e,t,n){Jh(e,n),gI(e,i=>Xn(i,t)||Xn(t,i))}function gI(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const o=e.eventLists_[i];if(o){const l=o.path;t(l)?(lU(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function lU(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(n!==null){e.events[t]=null;const i=n.getEventRunner();Nc&&en("event: "+n.toString()),tl(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W_{constructor(t,n,i,o){this._repo=t,this._path=n,this._queryParams=i,this._orderByCalled=o}get key(){return Ye(this._path)?null:__(this._path)}get ref(){return new Ei(this._repo,this._path)}get _queryIdentifier(){const t=Xw(this._queryParams),n=m_(t);return n==="{}"?"default":n}get _queryObject(){return Xw(this._queryParams)}isEqual(t){if(t=Wt(t),!(t instanceof W_))return!1;const n=this._repo===t._repo,i=b_(this._path,t._path),o=this._queryIdentifier===t._queryIdentifier;return n&&i&&o}toJSON(){return this.toString()}toString(){return this._repo.toString()+y$(this._path)}}class Ei extends W_{constructor(t,n){super(t,n,new E_,!1)}get parent(){const t=NA(this._path);return t===null?null:new Ei(this._repo,t)}get root(){let t=this;for(;t.parent!==null;)t=t.parent;return t}}class ou{constructor(t,n,i){this._node=t,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(t){const n=new ut(t),i=au(this.ref,t);return new ou(this._node.getChild(n),i,It)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(t){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,o)=>t(new ou(o,au(this.ref,i),It)))}hasChild(t){const n=new ut(t);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ir(e,t){return e=Wt(e),e._checkNotDeleted("ref"),t!==void 0?au(e._root,t):e._root}function au(e,t){return e=Wt(e),qe(e._path)===null?sU("child","path",t):pI("child","path",t),new Ei(e._repo,At(e._path,t))}function AU(e,t){e=Wt(e),H_("push",e._path),hI("push",t,e._path,!0);const n=yI(e._repo),i=TU(n),o=au(e,i),l=au(e,i);let u;return t!=null?u=Y_(l,t).then(()=>l):u=Promise.resolve(l),o.then=u.then.bind(u),o.catch=u.then.bind(u,void 0),o}function wI(e){return H_("remove",e._path),Y_(e,null)}function Y_(e,t){e=Wt(e),H_("set",e._path),hI("set",t,e._path,!1);const n=new pu;return mU(e._repo,e._path,t,null,n.wrapCallback(()=>{})),n.promise}function EI(e,t){iU("update",t,e._path);const n=new pu;return gU(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise}function TI(e){e=Wt(e);const t=new xI(()=>{}),n=new np(t);return pU(e._repo,e,n).then(i=>new ou(i,new Ei(e._repo,e._path),e._queryParams.getIndex()))}class np{constructor(t){this.callbackContext=t}respondsTo(t){return t==="value"}createEvent(t,n){const i=n._queryParams.getIndex();return new CU("value",this,new ou(t.snapshotNode,new Ei(n._repo,n._path),i))}getEventRunner(t){return t.getEventType()==="cancel"?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,null)}createCancelEvent(t,n){return this.callbackContext.hasCancelCallback?new RU(this,t,n):null}matches(t){return t instanceof np?!t.callbackContext||!this.callbackContext?!0:t.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function IU(e,t,n,i,o){let l;if(typeof i=="object"&&(l=void 0,o=i),typeof i=="function"&&(l=i),o&&o.onlyOnce){const p=n,h=(y,v)=>{dE(e._repo,e,f),p(y,v)};h.userCallback=n.userCallback,h.context=n.context,n=h}const u=new xI(n,l||void 0),f=new np(u);return vU(e._repo,e,f),()=>dE(e._repo,e,f)}function rp(e,t,n,i){return IU(e,"value",t,n,i)}I5(Ei);M5(Ei);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cu{constructor(t,n){this.shortDelay=t,this.longDelay=n,bi(n>t,"Short delay should be less than long delay!"),this.isMobile=Zv()||yR()}get(){return ez()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OI{static initialize(t,n,i){this.fetchImpl=t,n&&(this.headersImpl=n),i&&(this.responseImpl=i)}static fetch(){if(this.fetchImpl)return this.fetchImpl;if(typeof self<"u"&&"fetch"in self)return self.fetch;if(typeof globalThis<"u"&&globalThis.fetch)return globalThis.fetch;if(typeof fetch<"u")return fetch;fi("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static headers(){if(this.headersImpl)return this.headersImpl;if(typeof self<"u"&&"Headers"in self)return self.Headers;if(typeof globalThis<"u"&&globalThis.Headers)return globalThis.Headers;if(typeof Headers<"u")return Headers;fi("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static response(){if(this.responseImpl)return this.responseImpl;if(typeof self<"u"&&"Response"in self)return self.Response;if(typeof globalThis<"u"&&globalThis.Response)return globalThis.Response;if(typeof Response<"u")return Response;fi("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uh(e){const t=e.auth,n=await e.getIdToken(),i=await lu(e,ch(t,{idToken:n}));ke(i?.users.length,t,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const l=o.providerUserInfo?.length?MI(o.providerUserInfo):[],u=pz(e.providerData,l),f=e.isAnonymous,p=!(e.email&&o.passwordHash)&&!u?.length,h=f?p:!1,y={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:u,metadata:new mv(o.createdAt,o.lastLoginAt),isAnonymous:h};Object.assign(e,y)}async function hz(e){const t=Wt(e);await uh(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function pz(e,t){return[...e.filter(i=>!t.some(o=>o.providerId===i.providerId)),...t]}function MI(e){return e.map(({providerId:t,...n})=>({providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mz(e,t){const n=await kI(e,{},async()=>{const i=Ka({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:o,apiKey:l}=e.config,u=await NI(e,o,"/v1/token",`key=${l}`),f=await e._getAdditionalHeaders();f["Content-Type"]="application/x-www-form-urlencoded";const p={method:"POST",headers:f,body:i};return e.emulatorConfig&&Qa(e.emulatorConfig.host)&&(p.credentials="include"),OI.fetch()(u,p)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function gz(e,t){return Cs(e,"POST","/v2/accounts:revokeToken",Ts(e,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LI{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(t,n){this.storage[t]=n}async _get(t){const n=this.storage[t];return n===void 0?null:n}async _remove(t){delete this.storage[t]}_addListener(t,n){}_removeListener(t,n){}}LI.type="NONE";const DE=LI;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OE(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(UI(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(PI(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(BI(t))return"Blackberry";if(HI(t))return"Webos";if(jI(t))return"Safari";if((t.includes("chrome/")||$I(t))&&!t.includes("edge/"))return"Chrome";if(zI(t))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=e.match(n);if(i?.length===2)return i[1]}return"Other"}function PI(e=fn()){return/firefox\//i.test(e)}function jI(e=fn()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function $I(e=fn()){return/crios\//i.test(e)}function UI(e=fn()){return/iemobile/i.test(e)}function zI(e=fn()){return/android/i.test(e)}function BI(e=fn()){return/blackberry/i.test(e)}function HI(e=fn()){return/webos/i.test(e)}function rb(e=fn()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function yz(e=fn()){return rb(e)&&!!window.navigator?.standalone}function vz(){return NP()&&document.documentMode===10}function FI(e=fn()){return rb(e)||zI(e)||HI(e)||BI(e)||/windows phone/i.test(e)||UI(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qI(e,t=[]){let n;switch(e){case"Browser":n=OE(fn());break;case"Worker":n=`${OE(fn())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Za}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dh extends xi{constructor(t,n,i,o){super(n.code,n.message),this.operationType=i,this.user=o,Object.setPrototypeOf(this,dh.prototype),this.customData={appName:t.name,tenantId:t.tenantId??void 0,_serverResponse:n.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(t,n,i,o){return new dh(t,n,i,o)}}function QI(e,t,n,i){return(t==="reauthenticate"?n._getReauthenticationResolver(e):n._getIdTokenResponse(e)).catch(l=>{throw l.code==="auth/multi-factor-auth-required"?dh._fromErrorAndOperation(e,l,t,i):l})}async function qz(e,t,n=!1){const i=await lu(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Eo._forOperation(e,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KI(e,t,n=!1){if(Nn(e.app))return Promise.reject(gi(e));const i="signIn",o=await QI(e,i,t),l=await Eo._fromIdTokenResponse(e,i,o);return n||await e._updateCurrentUser(l.user),l}async function Gz(e,t){return KI(Rs(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function XI(e){const t=Rs(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function Wz(e,t,n){if(Nn(e.app))return Promise.reject(gi(e));const i=Rs(e),u=await gv(i,{returnSecureToken:!0,email:t,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Fz).catch(p=>{throw p.code==="auth/password-does-not-meet-requirements"&&XI(e),p}),f=await Eo._fromIdTokenResponse(i,"signIn",u);return await i._updateCurrentUser(f.user),f}function Yz(e,t,n){return Nn(e.app)?Promise.reject(gi(e)):Gz(Wt(e),il.credential(t,n)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&XI(e),i})}function Qz(e,t,n,i){return Wt(e).onIdTokenChanged(t,n,i)}function Kz(e,t,n){return Wt(e).beforeAuthStateChanged(t,n)}function Xz(e,t,n,i){return Wt(e).onAuthStateChanged(t,n,i)}const fh="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZI{constructor(t,n){this.storageRetriever=t,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(fh,"1"),this.storage.removeItem(fh),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(t,n){return this.storage.setItem(t,JSON.stringify(n)),Promise.resolve()}_get(t){const n=this.storage.getItem(t);return Promise.resolve(n?JSON.parse(n):null)}_remove(t){return this.storage.removeItem(t),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eD extends ZI{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(t,n){}_removeListener(t,n){}}eD.type="SESSION";const tD=eD;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nD(){return typeof kr().WorkerGlobalScope<"u"&&typeof kr().importScripts=="function"}async function i8(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function s8(){return navigator?.serviceWorker?.controller||null}function o8(){return nD()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oD(e,t){return t?hi(t):(ke(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aD{constructor(t,n,i,o,l=!1){this.auth=t,this.resolver=i,this.user=o,this.bypassAuthState=l,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(t,n)=>{this.pendingPromise={resolve:t,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(t){const{urlResponse:n,sessionId:i,postBody:o,tenantId:l,error:u,type:f}=t;if(u){this.reject(u);return}const p={auth:this.auth,requestUri:n,sessionId:i,tenantId:l||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(f)(p))}catch(h){this.reject(h)}}onError(t){this.reject(t)}getIdpTask(t){switch(t){case"signInViaPopup":case"signInViaRedirect":return h8;case"linkViaPopup":case"linkViaRedirect":return m8;case"reauthViaPopup":case"reauthViaRedirect":return p8;default:nr(this.auth,"internal-error")}}resolve(t){bi(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(t),this.unregisterAndCleanUp()}reject(t){bi(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(t),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v8="pendingRedirect",Rf=new Map;class _8 extends aD{constructor(t,n,i=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let t=Rf.get(this.auth._key());if(!t){try{const i=await b8(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(i)}catch(n){t=()=>Promise.reject(n)}Rf.set(this.auth._key(),t)}return this.bypassAuthState||Rf.set(this.auth._key(),()=>Promise.resolve(null)),t()}async onAuthEvent(t){if(t.type==="signInViaRedirect")return super.onAuthEvent(t);if(t.type==="unknown"){this.resolve(null);return}if(t.eventId){const n=await this.auth._redirectUserForId(t.eventId);if(n)return this.user=n,super.onAuthEvent(t);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function b8(e,t){const n=w8(t),i=x8(e);if(!await i._isAvailable())return!1;const o=await i._get(n)==="true";return await i._remove(n),o}function S8(e,t){Rf.set(e._key(),t)}function x8(e){return hi(e._redirectPersistence)}function w8(e){return Cf(v8,e.config.apiKey,e.name)}async function E8(e,t,n=!1){if(Nn(e.app))return Promise.reject(gi(e));const i=Rs(e),o=oD(i,t),u=await new _8(i,o,n).execute();return u&&!n&&(delete u.user._redirectEventId,await i._persistUserIfCurrent(u.user),await i._setRedirectUser(null,t)),u}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T8=600*1e3;class C8{constructor(t){this.auth=t,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(t){this.consumers.add(t),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,t)&&(this.sendToConsumer(this.queuedRedirectEvent,t),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(t){this.consumers.delete(t)}onEvent(t){if(this.hasEventBeenHandled(t))return!1;let n=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(t,i)&&(n=!0,this.sendToConsumer(t,i),this.saveEventToCache(t))}),this.hasHandledPotentialRedirect||!R8(t)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=t,n=!0)),n}sendToConsumer(t,n){if(t.error&&!lD(t)){const i=t.error.code?.split("auth/")[1]||"internal-error";n.onError(vr(this.auth,i))}else n.onAuthEvent(t)}isEventForConsumer(t,n){const i=n.eventId===null||!!t.eventId&&t.eventId===n.eventId;return n.filter.includes(t.type)&&i}hasEventBeenHandled(t){return Date.now()-this.lastProcessedEventTime>=T8&&this.cachedEventUids.clear(),this.cachedEventUids.has($E(t))}saveEventToCache(t){this.cachedEventUids.add($E(t)),this.lastProcessedEventTime=Date.now()}}function $E(e){return[e.type,e.eventId,e.sessionId,e.tenantId].filter(t=>t).join("-")}function lD({type:e,error:t}){return e==="unknown"&&t?.code==="auth/no-auth-event"}function R8(e){switch(e.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return lD(e);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rB(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function iB(e){Mr(new _r("auth",(t,{options:n})=>{const i=t.getProvider("app").getImmediate(),o=t.getProvider("heartbeat"),l=t.getProvider("app-check-internal"),{apiKey:u,authDomain:f}=i.options;ke(u&&!u.includes(":"),"invalid-api-key",{appName:i.name});const p={apiKey:u,authDomain:f,clientPlatform:e,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:qI(e)},h=new wz(i,o,l,p);return kz(h,n),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,n,i)=>{t.getProvider("auth-internal").initialize()})),Mr(new _r("auth-internal",t=>{const n=Rs(t.getProvider("auth").getImmediate());return(i=>new nB(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Zn(HE,FE,rB(e)),Zn(HE,FE,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sB=300,oB=pR("authIdTokenMaxAge")||sB;let qE=null;const aB=e=>async t=>{const n=t&&await t.getIdTokenResult(),i=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(i&&i>oB)return;const o=n?.token;qE!==o&&(qE=o,await fetch(e,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function lB(e=t_()){const t=Xa(e,"auth");if(t.isInitialized())return t.getImmediate();const n=WI(e,{popupRedirectResolver:tB,persistence:[f8,e8,tD]}),i=pR("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(i,location.origin);if(location.origin===l.origin){const u=aB(l.toString());Kz(n,u,()=>u(n.currentUser)),Qz(n,f=>u(f))}}const o=fR("auth");return o&&Nz(n,`http://${o}`),n}function cB(){return document.getElementsByTagName("head")?.[0]??document}Ez({loadJS(e){return new Promise((t,n)=>{const i=document.createElement("script");i.setAttribute("src",e),i.onload=t,i.onerror=o=>{const l=vr("internal-error");l.customData=o,n(l)},i.type="text/javascript",i.charset="UTF-8",cB().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});iB("Browser");const uB=II,ui=Bh(()=>{if(!Dc)throw new Error("Firebase app not initialized");try{return lB(Dc)}catch{return WI(Dc,{errorMap:uB})}}),cD=E.createContext({isDark:!1,toggle:()=>{}}),dB=T.button`
  display: flex;
  align-items: center;
...
`,uD=()=>{const{isDark:e,toggle:t}=E.useContext(cD);return g.jsxs(dB,{type:"button",role:"switch","aria-checked":e,onClick:t,children:["Dark mode",g.jsx(fB,{$on:e,"aria-hidden":"true"})]})},hB=T(Es)`
  display: block;
  width: 100%;
  padding: 10px 0;
  font-size: 14px;
...
`,PB=()=>{const e=et(el),[t,n]=E.useState(!1),{deleteToken:i}=E.useContext(_u),o=E.useCallback(async()=>{await i(),await ui?.signOut()},[i]);if(e.state!=="fulfilled"||!e.data){const l=e.state==="loading";return g.jsx(OB,{to:nt.SIGN_IN,$disabled:l,"aria-disabled":l,tabIndex:l?-1:void 0,children:"Sign in"})}return g.jsxs(NB,{children:[g.jsx(kB,{type:"button",onClick:()=>n(!0),"aria-expanded":t,"aria-haspopup":"dialog",children:e.data.displayName}),g.jsxs(DB,{open:t,onClose:()=>n(!1),children:[g.jsx(uD,{}),g.jsx(MB,{}),g.jsx(LB,{type:"button",onClick:o,children:"Sign out"})]})]})},jB="#181a2f",ap=680,$B=T.nav`
  height: inherit;
  background-color: ${jB};
  color: #fff;
  display: flex;
...
`,qB=()=>g.jsx("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none","aria-hidden":"true",children:g.jsx("path",{d:"M3 5h14M3 10h14M3 15h14",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})}),VB=()=>{const[e,t]=E.useState(!1),n=et(Z_);return g.jsxs(g.Fragment,{children:[g.jsxs($B,{children:[g.jsxs(UB,{to:nt.CLASS_LIST,children:[g.jsx(RI,{}),g.jsx(zB,{children:"Peloton Alerts"})]}),g.jsxs(BB,{children:[g.jsx(sf,{to:nt.CLASS_LIST,end:!0,children:"Classes"}),g.jsx(sf,{to:nt.ALERTS,children:"Alerts"}),g.jsx(sf,{to:nt.ABOUT,end:!0,children:"FAQ"}),n&&g.jsx(sf,{to:nt.STATS,children:"Stats"})]}),g.jsx(HB,{children:g.jsx(PB,{})}),g.jsx(FB,{type:"button","aria-label":"Open menu",onClick:()=>t(!0),children:g.jsx(qB,{})})]}),g.jsx(AB,{open:e,onClose:()=>t(!1)})]})},GB=T.div`
  min-height: 100%;
  display: flex;
  flex-direction: column;
`,WB=T.div`
...
`,of=T.p`
  ...
  text-align: center;
  padding: 32px 0;
`,MH=()=>{const{alertId:e}=zM(),t=ws(),n=E.useContext(ub),[i,o]=E.useState("idle"),l=E.useMemo(()=>n.state!=="fulfilled"?null:n.data.find(R=>R.id===e)??null,[n,e]),u=eH(l?.studioId??null),f=l?Ce.STUDIOS[l.studioId]?.timezone??"UTC":"UTC",p=E.useMemo(()=>!l||u.state!=="fulfilled"?[]:nH(u.data,f),[l,u,f]),{matchCount:h,nearMissCount:y}=E.useMemo(()=>{if(!l||u.state!=="fulfilled")return{matchCount:0,nearMissCount:0};let R=0,D=0;for(const k of u.data){const C=Ce.classifySnapshotMatch(k,l);C.type==="match"?R++:C.type==="near-miss"&&D++}return{matchCount:R,nearMissCount:D}},[l,u]),v=n.state==="loading"||n.state==="idle"||u.state==="loading",_="Notification"in window&&"serviceWorker"in navigator,b=E.useCallback(async()=>{if(_){o("sending");try{if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){o("idle");return}const R=await navigator.serviceWorker.ready,D=l?Ce.STUDIOS[l.studioId]:null,k="Spot opened up!",C=`${l?.name??"Test alert"} — ${D?.location??"Studio"} · test notification`;await R.showNotification(k,{body:C,icon:"/icons/icon-192x192.png",badge:"/icons/icon-96x96.png",data:{classUrl:"/p/7248695-peloton-studios-new-york/e/99586855-30-min-intervals-ride/"}}),o("sent"),setTimeout(()=>o("idle"),3e3)}catch{o("error"),setTimeout(()=>o("idle"),3e3)}}},[l,_]),x=l?.name??"Alert",O=i==="sending"?"Sending…":i==="sent"?"Sent!":i==="error"?"Error":"Send test notification";return g.jsxs(CH,{children:[g.jsxs(RH,{children:[g.jsx(DH,{type:"button",onClick:()=>t(-1),children:"← Alerts"}),g.jsxs(AH,{children:[g.jsx("div",{children:g.jsxs(OH,{children:[x," — Past 7 Days"]})}),_&&g.jsx(IH,{type:"button",$sent:i==="sent",disabled:i==="sending",onClick:b,title:"Fire a test push notification to verify delivery and the notification URL",children:O})]}),g.jsx(kH,{children:l?`${Ce.STUDIOS[l.studioId]?.location??l.studioId}`:""})]}),g.jsxs(NH,{children:[v&&g.jsx(of,{children:"Loading…"}),!v&&!l&&g.jsx(of,{children:"Alert not found."}),!v&&l&&u.state==="fulfilled"&&g.jsxs(g.Fragment,{children:[g.jsx(TH,{matchCount:h,nearMissCount:y}),p.length===0&&g.jsx(of,{children:"No class history yet. History builds up as the backend detects class changes."}),p.map(({label:R,dayIndex:D,snapshots:k})=>g.jsx(wH,{label:R,dayIndex:D,snapshots:k,alert:l,timezone:f},R))]}),!v&&u.state==="failed"&&g.jsx(of,{children:"Failed to load class history."})]})]})},LH=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},PH="STUDIO_ID",fD=e=>{const t=LH(PH);return t===null?e:Object.keys(Ce.STUDIOS).includes(t)?t:e},jH={studioId:fD(Ce.DEFAULT_STUDIO_ID)},vv=Kn({name:"studioSelector",initialState:jH,reducers:{setStudioId(e,t){e.studioId=t.payload}}}),{setStudioId:ph}=vv.actions,$H=async(e,t)=>{const n=xn;if(!n)throw new Error("No Firebase database connection to use");const i=(await AU(ir(n,Ce.PATHS.alerts(e)),t)).key;if(!i)throw new Error("Missing ID from insertion operation");return{...t,id:i}},hD=async(e,t)=>{const n=xn;if(!n)throw new Error("No Firebase database connection to use");const i={...t,name:t.name??null,watchedClassIds:t.watchedClassIds??null,disabled:t.disabled??null};await EI(ir(n,Ce.PATHS.alert(e,t.id)),i)},UH=T.div`
  display: flex;
  flex-direction: column;
`,zH=T.label`
  color: ${e=>e.theme.colors.main};
...
`,yh=({discipline:e,size:t=32})=>{const n=qv(),i=E.useMemo(()=>{const o=Object.keys(ZE),l=e.name.toLowerCase(),u=o.find(f=>f.toLowerCase()===l)??o.find(f=>{const p=f.toLowerCase();return p.includes(l)||l.includes(p)});if(u)return ZE[u];{const f=`Received unsupported discipline ${e.name}`;return console.log(f),Qv(f),n.colors.secondarySurface}},[e.name,n.colors.secondarySurface]);return g.jsx(JH,{color:i,size:t,children:g.jsx(e9,{alt:e.name,src:e.iconUrl,size:t,color:i})})},t9=T.img`
  ...
  border-radius: 50%;
  color: ${e=>e.theme.colors.secondary};
`,db=({instructor:e,size:t=32})=>g.jsx(t9,{src:e.imageUrl,alt:`Profile of ${e.name}`,size:t});var n9=class extends Error{issues;constructor(e){super(e[0].message),this.name="SchemaError",this.issues=e}},mD=(e=>(e.uninitialized="uninitialized",e.pending="pending",e.fulfilled="fulfilled",e.rejected="rejected",e))(mD||{});function JE(e){return{status:e,isUninitialized:e==="uninitialized",isLoading:e==="pending",isSuccess:e==="fulfilled",isError:e==="rejected"}}var eT=vs;function fb(e,t){if(e===t||!(eT(e)&&eT(t)||Array.isArray(e)&&Array.isArray(t)))return t;const n=Object.keys(t),i=Object.keys(e);let o=n.length===i.length;const l=Array.isArray(t)?[]:{};for(const u of n)l[u]=fb(e[u],t[u]),o&&(o=e[u]===l[u]);return o?e:l}function dy(e){let t=0;for(const n in e)t++;return t}var tT=e=>[].concat(...e);function r9(e){return new RegExp("(^|:)//").test(e)}function i9(){return typeof document>"u"?!0:document.visibilityState!=="hidden"}function vh(e){return e!=null}function s9(){return typeof navigator>"u"||navigator.onLine===void 0?!0:navigator.onLine}var o9=e=>e.replace(/\/$/,""),a9=e=>e.replace(/^\//,"");function l9(e,t){if(!e)return t;if(!t)return e;if(r9(t))return t;const n=e.endsWith("/")||!t.startsWith("?")?"/":"";return e=o9(e),t=a9(t),`${e}${n}${t}`}function c9(e,t,n){return e.has(t)?e.get(t):e.set(t,n).get(t)}function _v(e,t,n){return e.has(t)?e.get(t):e.set(t,n(t)).get(t)}var bv=()=>new Map,nT=(...e)=>fetch(...e),u9=e=>e.status>=200&&e.status<=299,d9=e=>/ion\/(vnd\.api\+)?json/.test(e.get("content-type")||"");function rT(e){if(!vs(e))return e;const t={...e};for(const[n,i]of Object.entries(t))i===void 0&&delete t[n];return t}function f9({baseUrl:e,prepareHeaders:t=v=>v,fetchFn:n=nT,paramsSerializer:i,isJsonContentType:o=d9,jsonContentType:l="application/json",jsonReplacer:u,timeout:f,responseHandler:p,validateStatus:h,...y}={}){return typeof fetch>"u"&&n===nT&&console.warn("Warning: `fetch` is not available. Please supply a custom `fetchFn` property to use `fetchBaseQuery` on SSR environments."),async(_,b,x)=>{const{getState:O,extra:R,endpoint:D,forced:k,type:C}=b;let A,{url:N,headers:I=new Headers(y.headers),params:P=void 0,responseHandler:F=p??"json",validateStatus:H=h??u9,timeout:B=f,...z}=typeof _=="string"?{url:_}:_,G,V=b.signal;B&&(G=new AbortController,b.signal.addEventListener("abort",G.abort),V=G.signal);let te={...y,signal:V,...z};I=new Headers(rT(I)),te.headers=await t(I,{getState:O,arg:_,extra:R,endpoint:D,forced:k,type:C,extraOptions:x})||I;const ue=de=>typeof de=="object"&&(vs(de)||Array.isArray(de)||typeof de.toJSON=="function");if(!te.headers.has("content-type")&&ue(te.body)&&te.headers.set("content-type",l),ue(te.body)&&o(te.headers)&&(te.body=JSON.stringify(te.body,u)),P){const de=~N.indexOf("?")?"&":"?",me=i?i(P):new URLSearchParams(rT(P));N+=de+me}N=l9(e,N);const j=new Request(N,te);A={request:new Request(N,te)};let ne,ae=!1,M=G&&setTimeout(()=>{ae=!0,G.abort()},B);try{ne=await n(j)}catch(de){return{error:{status:ae?"TIMEOUT_ERROR":"FETCH_ERROR",error:String(de)},meta:A}}finally{M&&clearTimeout(M),G?.signal.removeEventListener("abort",G.abort)}const X=ne.clone();A.response=X;let le,ie="";try{let de;if(await Promise.all([v(ne,F).then(me=>le=me,me=>de=me),X.text().then(me=>ie=me,()=>{})]),de)throw de}catch(de){return{error:{status:"PARSING_ERROR",originalStatus:ne.status,data:ie,error:String(de)},meta:A}}return H(ne,le)?{data:le,meta:A}:{error:{status:ne.status,data:le},meta:A}};async function v(_,b){if(typeof b=="function")return b(_);if(b==="content-type"&&(b=o(_.headers)?"json":"text"),b==="json"){const x=await _.text();return x.length?JSON.parse(x):null}return _.text()}}var iT=class{constructor(e,t=void 0){this.value=e,this.meta=t}},hb=mr("__rtkq/focused"),gD=mr("__rtkq/unfocused"),pb=mr("__rtkq/online"),yD=mr("__rtkq/offline");function lp(e){return e.type==="query"}function h9(e){return e.type==="mutation"}function cp(e){return e.type==="infinitequery"}function _h(e){return lp(e)||cp(e)}function mb(e,t,n,i,o,l){return p9(e)?e(t,n,i,o).filter(vh).map(Sv).map(l):Array.isArray(e)?e.map(Sv).map(l):[]}function p9(e){return typeof e=="function"}function Sv(e){return typeof e=="string"?{type:e}:e}function m9(e,t){return e.catch(t)}var uu=Symbol("forceQueryFn"),xv=e=>typeof e[uu]=="function";function g9({serializeQueryArgs:e,queryThunk:t,infiniteQueryThunk:n,mutationThunk:i,api:o,context:l,internalState:u}){const{runningQueries:f,runningMutations:p}=u,{unsubscribeQueryResult:h,removeMutationResult:y,updateSubscriptionOptions:v}=o.internalActions;return{buildInitiateQuery:D,buildInitiateInfiniteQuery:k,buildInitiateMutation:C,getRunningQueryThunk:_,getRunningMutationThunk:b,getRunningQueriesThunk:x,getRunningMutationsThunk:O};function _(A,N){return I=>{const P=l.endpointDefinitions[A],F=e({queryArgs:N,endpointDefinition:P,endpointName:A});return f.get(I)?.[F]}}function b(A,N){return I=>p.get(I)?.[N]}function x(){return A=>Object.values(f.get(A)||{}).filter(vh)}function O(){return A=>Object.values(p.get(A)||{}).filter(vh)}function R(A,N){const I=(P,{subscribe:F=!0,forceRefetch:H,subscriptionOptions:B,[uu]:z,...G}={})=>(V,te)=>{const ue=e({queryArgs:P,endpointDefinition:N,endpointName:A});let j;const K={...G,type:"query",subscribe:F,forceRefetch:H,subscriptionOptions:B,endpointName:A,originalArgs:P,queryCacheKey:ue,[uu]:z};if(lp(N))j=t(K);else{const{direction:Ie,initialPageParam:be}=G;j=n({...K,direction:Ie,initialPageParam:be})}const ne=o.endpoints[A].select(P),ae=V(j),M=ne(te()),{requestId:X,abort:le}=ae,ie=M.requestId!==X,de=f.get(V)?.[ue],me=()=>ne(te()),pe=Object.assign(z?ae.then(me):ie&&!de?Promise.resolve(M):Promise.all([de,ae]).then(me),{arg:P,requestId:X,subscriptionOptions:B,queryCacheKey:ue,abort:le,async unwrap(){const Ie=await pe;if(Ie.isError)throw Ie.error;return Ie.data},refetch:()=>V(I(P,{subscribe:!1,forceRefetch:!0})),unsubscribe(){F&&V(h({queryCacheKey:ue,requestId:X}))},updateSubscriptionOptions(Ie){pe.subscriptionOptions=Ie,V(v({endpointName:A,requestId:X,queryCacheKey:ue,options:Ie}))}});if(!de&&!ie&&!z){const Ie=c9(f,V,{});Ie[ue]=pe,pe.then(()=>{delete Ie[ue],dy(Ie)||f.delete(V)})}return pe};return I}function D(A,N){return R(A,N)}function k(A,N){return R(A,N)}function C(A){return(N,{track:I=!0,fixedCacheKey:P}={})=>(F,H)=>{const B=i({type:"mutation",endpointName:A,originalArgs:N,track:I,fixedCacheKey:P}),z=F(B),{requestId:G,abort:V,unwrap:te}=z,ue=m9(z.unwrap().then(ae=>({data:ae})),ae=>({error:ae})),j=()=>{F(y({requestId:G,fixedCacheKey:P}))},K=Object.assign(ue,{arg:z.arg,requestId:G,abort:V,unwrap:te,reset:j}),ne=p.get(F)||{};return p.set(F,ne),ne[G]=K,K.then(()=>{delete ne[G],dy(ne)||p.delete(F)}),P&&(ne[P]=K,K.then(()=>{ne[P]===K&&(delete ne[P],dy(ne)||p.delete(F))})),K}}}var vD=class extends n9{constructor(e,t,n,i){super(e),this.value=t,this.schemaName=n,this._bqMeta=i}},to=(e,t)=>Array.isArray(e)?e.includes(t):!!e;async function no(e,t,n,i){const o=await e["~standard"].validate(t);if(o.issues)throw new vD(o.issues,t,n,i);return o.value}function sT(e){return e}var gc=(e={})=>({...e,[Fh]:!0});function y9({reducerPath:e,baseQuery:t,context:{endpointDefinitions:n},serializeQueryArgs:i,api:o,assertTagType:l,selectors:u,onSchemaFailure:f,catchSchemaFailure:p,skipSchemaValidation:h}){const y=(z,G,V,te)=>(ue,j)=>{const K=n[z],ne=i({queryArgs:G,endpointDefinition:K,endpointName:z});if(ue(o.internalActions.queryResultPatched({queryCacheKey:ne,patches:V})),!te)return;const ae=o.endpoints[z].select(G)(j()),M=mb(K.providesTags,ae.data,void 0,G,{},l);ue(o.internalActions.updateProvidedBy([{queryCacheKey:ne,providedTags:M}]))};function v(z,G,V=0){const te=[G,...z];return V&&te.length>V?te.slice(0,-1):te}function _(z,G,V=0){const te=[...z,G];return V&&te.length>V?te.slice(1):te}const b=(z,G,V,te=!0)=>(ue,j)=>{const ne=o.endpoints[z].select(G)(j()),ae={patches:[],inversePatches:[],undo:()=>ue(o.util.patchQueryData(z,G,ae.inversePatches,te))};if(ne.status==="uninitialized")return ae;let M;if("data"in ne)if(br(ne.data)){const[X,le,ie]=sA(ne.data,V);ae.patches.push(...le),ae.inversePatches.push(...ie),M=X}else M=V(ne.data),ae.patches.push({op:"replace",path:[],value:M}),ae.inversePatches.push({op:"replace",path:[],value:ne.data});return ae.patches.length===0||ue(o.util.patchQueryData(z,G,ae.patches,te)),ae},x=(z,G,V)=>te=>te(o.endpoints[z].initiate(G,{subscribe:!1,forceRefetch:!0,[uu]:()=>({data:V})})),O=(z,G)=>z.query&&z[G]?z[G]:sT,R=async(z,{signal:G,abort:V,rejectWithValue:te,fulfillWithValue:ue,dispatch:j,getState:K,extra:ne})=>{const ae=n[z.endpointName],{metaSchema:M,skipSchemaValidation:X=h}=ae;try{let le=sT;const ie={signal:G,abort:V,dispatch:j,getState:K,extra:ne,endpoint:z.endpointName,type:z.type,forced:z.type==="query"?D(z,K()):void 0,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0},de=z.type==="query"?z[uu]:void 0;let me;const pe=async(be,Oe,Ue,_t)=>{if(Oe==null&&be.pages.length)return Promise.resolve({data:be});const gt={queryArg:z.originalArgs,pageParam:Oe},Ln=await Ie(gt),Et=_t?v:_;return{data:{pages:Et(be.pages,Ln.data,Ue),pageParams:Et(be.pageParams,Oe,Ue)},meta:Ln.meta}};async function Ie(be){let Oe;const{extraOptions:Ue,argSchema:_t,rawResponseSchema:gt,responseSchema:Ln}=ae;if(_t&&!to(X,"arg")&&(be=await no(_t,be,"argSchema",{})),de?Oe=de():ae.query?(le=O(ae,"transformResponse"),Oe=await t(ae.query(be),ie,Ue)):Oe=await ae.queryFn(be,ie,Ue,$r=>t($r,ie,Ue)),typeof process<"u",Oe.error)throw new iT(Oe.error,Oe.meta);let{data:Et}=Oe;gt&&!to(X,"rawResponse")&&(Et=await no(gt,Oe.data,"rawResponseSchema",Oe.meta));let Pn=await le(Et,Oe.meta,be);return Ln&&!to(X,"response")&&(Pn=await no(Ln,Pn,"responseSchema",Oe.meta)),{...Oe,data:Pn}}if(z.type==="query"&&"infiniteQueryOptions"in ae){const{infiniteQueryOptions:be}=ae,{maxPages:Oe=1/0}=be;let Ue;const _t={pages:[],pageParams:[]},gt=u.selectQueryEntry(K(),z.queryCacheKey)?.data,Et=D(z,K())&&!z.direction||!gt?_t:gt;if("direction"in z&&z.direction&&Et.pages.length){const Pn=z.direction==="backward",Yt=(Pn?_D:wv)(be,Et,z.originalArgs);Ue=await pe(Et,Yt,Oe,Pn)}else{const{initialPageParam:Pn=be.initialPageParam}=z,$r=gt?.pageParams??[],Yt=$r[0]??Pn,sl=$r.length;Ue=await pe(Et,Yt,Oe),de&&(Ue={data:Ue.data.pages[0]});for(let As=1;As<sl;As++){const Oo=wv(be,Ue.data,z.originalArgs);Ue=await pe(Ue.data,Oo,Oe)}}me=Ue}else me=await Ie(z.originalArgs);return M&&!to(X,"meta")&&me.meta&&(me.meta=await no(M,me.meta,"metaSchema",me.meta)),ue(me.data,gc({fulfilledTimeStamp:Date.now(),baseQueryMeta:me.meta}))}catch(le){let ie=le;if(ie instanceof iT){let de=O(ae,"transformErrorResponse");const{rawErrorResponseSchema:me,errorResponseSchema:pe}=ae;let{value:Ie,meta:be}=ie;try{me&&!to(X,"rawErrorResponse")&&(Ie=await no(me,Ie,"rawErrorResponseSchema",be)),M&&!to(X,"meta")&&(be=await no(M,be,"metaSchema",be));let Oe=await de(Ie,be,z.originalArgs);return pe&&!to(X,"errorResponse")&&(Oe=await no(pe,Oe,"errorResponseSchema",be)),te(Oe,gc({baseQueryMeta:be}))}catch(Oe){ie=Oe}}try{if(ie instanceof vD){const de={endpoint:z.endpointName,arg:z.originalArgs,type:z.type,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0};ae.onSchemaFailure?.(ie,de),f?.(ie,de);const{catchSchemaFailure:me=p}=ae;if(me)return te(me(ie,de),gc({baseQueryMeta:ie._bqMeta}))}}catch(de){ie=de}throw console.error(ie),ie}};function D(z,G){const V=u.selectQueryEntry(G,z.queryCacheKey),te=u.selectConfig(G).refetchOnMountOrArgChange,ue=V?.fulfilledTimeStamp,j=z.forceRefetch??(z.subscribe&&te);return j?j===!0||(Number(new Date)-Number(ue))/1e3>=j:!1}const k=()=>kw(`${e}/executeQuery`,R,{getPendingMeta({arg:G}){const V=n[G.endpointName];return gc({startedTimeStamp:Date.now(),...cp(V)?{direction:G.direction}:{}})},condition(G,{getState:V}){const te=V(),ue=u.selectQueryEntry(te,G.queryCacheKey),j=ue?.fulfilledTimeStamp,K=G.originalArgs,ne=ue?.originalArgs,ae=n[G.endpointName],M=G.direction;return xv(G)?!0:ue?.status==="pending"?!1:D(G,te)||lp(ae)&&ae?.forceRefetch?.({currentArg:K,previousArg:ne,endpointState:ue,state:te})?!0:!(j&&!M)},dispatchConditionRejection:!0}),C=k(),A=k(),N=kw(`${e}/executeMutation`,R,{getPendingMeta(){return gc({startedTimeStamp:Date.now()})}}),I=z=>"force"in z,P=z=>"ifOlderThan"in z,F=(z,G,V)=>(te,ue)=>{const j=I(V)&&V.force,K=P(V)&&V.ifOlderThan,ne=(M=!0)=>{const X={forceRefetch:M,isPrefetch:!0};return o.endpoints[z].initiate(G,X)},ae=o.endpoints[z].select(G)(ue());if(j)te(ne());else if(K){const M=ae?.fulfilledTimeStamp;if(!M){te(ne());return}(Number(new Date)-Number(new Date(M)))/1e3>=K&&te(ne())}else te(ne(!1))};function H(z){return G=>G?.meta?.arg?.endpointName===z}function B(z,G){return{matchPending:kc(f_(z),H(G)),matchFulfilled:kc(_s(z),H(G)),matchRejected:kc(Ua(z),H(G))}}return{queryThunk:C,mutationThunk:N,infiniteQueryThunk:A,prefetch:F,updateQueryData:b,upsertQueryData:x,patchQueryData:y,buildMatchThunkActions:B}}function wv(e,{pages:t,pageParams:n},i){const o=t.length-1;return e.getNextPageParam(t[o],t,n[o],n,i)}function _D(e,{pages:t,pageParams:n},i){return e.getPreviousPageParam?.(t[0],t,n[0],n,i)}function bD(e,t,n,i){return mb(n[e.meta.arg.endpointName][t],_s(e)?e.payload:void 0,Vh(e)?e.payload:void 0,e.meta.arg.originalArgs,"baseQueryMeta"in e.meta?e.meta.baseQueryMeta:void 0,i)}function af(e,t,n){const i=e[t];i&&n(i)}function du(e){return("arg"in e?e.arg.fixedCacheKey:e.fixedCacheKey)??e.requestId}function oT(e,t,n){const i=e[du(t)];i&&n(i)}var lf={};function v9({reducerPath:e,queryThunk:t,mutationThunk:n,serializeQueryArgs:i,context:{endpointDefinitions:o,apiUid:l,extractRehydrationInfo:u,hasRehydrationInfo:f},assertTagType:p,config:h}){const y=mr(`${e}/resetApiState`);function v(H,B,z,G){H[B.queryCacheKey]??={status:"uninitialized",endpointName:B.endpointName},af(H,B.queryCacheKey,V=>{V.status="pending",V.requestId=z&&V.requestId?V.requestId:G.requestId,B.originalArgs!==void 0&&(V.originalArgs=B.originalArgs),V.startedTimeStamp=G.startedTimeStamp;const te=o[G.arg.endpointName];cp(te)&&"direction"in B&&(V.direction=B.direction)})}function _(H,B,z,G){af(H,B.arg.queryCacheKey,V=>{if(V.requestId!==B.requestId&&!G)return;const{merge:te}=o[B.arg.endpointName];if(V.status="fulfilled",te)if(V.data!==void 0){const{fulfilledTimeStamp:ue,arg:j,baseQueryMeta:K,requestId:ne}=B;let ae=gu(V.data,M=>te(M,z,{arg:j.originalArgs,baseQueryMeta:K,fulfilledTimeStamp:ue,requestId:ne}));V.data=ae}else V.data=z;else V.data=o[B.arg.endpointName].structuralSharing??!0?fb(Lr(V.data)?P6(V.data):V.data,z):z;delete V.error,V.fulfilledTimeStamp=B.fulfilledTimeStamp})}const b=Kn({name:`${e}/queries`,initialState:lf,reducers:{removeQueryResult:{reducer(H,{payload:{queryCacheKey:B}}){delete H[B]},prepare:oc()},cacheEntriesUpserted:{reducer(H,B){for(const z of B.payload){const{queryDescription:G,value:V}=z;v(H,G,!0,{arg:G,requestId:B.meta.requestId,startedTimeStamp:B.meta.timestamp}),_(H,{arg:G,requestId:B.meta.requestId,fulfilledTimeStamp:B.meta.timestamp,baseQueryMeta:{}},V,!0)}},prepare:H=>({payload:H.map(G=>{const{endpointName:V,arg:te,value:ue}=G,j=o[V];return{queryDescription:{type:"query",endpointName:V,originalArgs:G.arg,queryCacheKey:i({queryArgs:te,endpointDefinition:j,endpointName:V})},value:ue}}),meta:{[Fh]:!0,requestId:h_(),timestamp:Date.now()}})},queryResultPatched:{reducer(H,{payload:{queryCacheKey:B,patches:z}}){af(H,B,G=>{G.data=Tw(G.data,z.concat())})},prepare:oc()}},extraReducers(H){H.addCase(t.pending,(B,{meta:z,meta:{arg:G}})=>{const V=xv(G);v(B,G,V,z)}).addCase(t.fulfilled,(B,{meta:z,payload:G})=>{const V=xv(z.arg);_(B,z,G,V)}).addCase(t.rejected,(B,{meta:{condition:z,arg:G,requestId:V},error:te,payload:ue})=>{af(B,G.queryCacheKey,j=>{if(!z){if(j.requestId!==V)return;j.status="rejected",j.error=ue??te}})}).addMatcher(f,(B,z)=>{const{queries:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&(B[V]=te)})}}),x=Kn({name:`${e}/mutations`,initialState:lf,reducers:{removeMutationResult:{reducer(H,{payload:B}){const z=du(B);z in H&&delete H[z]},prepare:oc()}},extraReducers(H){H.addCase(n.pending,(B,{meta:z,meta:{requestId:G,arg:V,startedTimeStamp:te}})=>{V.track&&(B[du(z)]={requestId:G,status:"pending",endpointName:V.endpointName,startedTimeStamp:te})}).addCase(n.fulfilled,(B,{payload:z,meta:G})=>{G.arg.track&&oT(B,G,V=>{V.requestId===G.requestId&&(V.status="fulfilled",V.data=z,V.fulfilledTimeStamp=G.fulfilledTimeStamp)})}).addCase(n.rejected,(B,{payload:z,error:G,meta:V})=>{V.arg.track&&oT(B,V,te=>{te.requestId===V.requestId&&(te.status="rejected",te.error=z??G)})}).addMatcher(f,(B,z)=>{const{mutations:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&V!==te?.requestId&&(B[V]=te)})}}),O={tags:{},keys:{}},R=Kn({name:`${e}/invalidation`,initialState:O,reducers:{updateProvidedBy:{reducer(H,B){for(const{queryCacheKey:z,providedTags:G}of B.payload){D(H,z);for(const{type:V,id:te}of G){const ue=(H.tags[V]??={})[te||"__internal_without_id"]??=[];ue.includes(z)||ue.push(z)}H.keys[z]=G}},prepare:oc()}},extraReducers(H){H.addCase(b.actions.removeQueryResult,(B,{payload:{queryCacheKey:z}})=>{D(B,z)}).addMatcher(f,(B,z)=>{const{provided:G}=u(z);for(const[V,te]of Object.entries(G.tags??{}))for(const[ue,j]of Object.entries(te)){const K=(B.tags[V]??={})[ue||"__internal_without_id"]??=[];for(const ne of j)K.includes(ne)||K.push(ne),B.keys[ne]=G.keys[ne]}}).addMatcher(vi(_s(t),Vh(t)),(B,z)=>{k(B,[z])}).addMatcher(b.actions.cacheEntriesUpserted.match,(B,z)=>{const G=z.payload.map(({queryDescription:V,value:te})=>({type:"UNKNOWN",payload:te,meta:{requestStatus:"fulfilled",requestId:"UNKNOWN",arg:V}}));k(B,G)})}});function D(H,B){const z=H.keys[B]??[];for(const G of z){const V=G.type,te=G.id??"__internal_without_id",ue=H.tags[V]?.[te];ue&&(H.tags[V][te]=ue.filter(j=>j!==B))}delete H.keys[B]}function k(H,B){const z=B.map(G=>{const V=bD(G,"providesTags",o,p),{queryCacheKey:te}=G.meta.arg;return{queryCacheKey:te,providedTags:V}});R.caseReducers.updateProvidedBy(H,R.actions.updateProvidedBy(z))}const C=Kn({name:`${e}/subscriptions`,initialState:lf,reducers:{updateSubscriptionOptions(H,B){},unsubscribeQueryResult(H,B){},internal_getRTKQSubscriptions(){}}}),A=Kn({name:`${e}/internalSubscriptions`,initialState:lf,reducers:{subscriptionsUpdated:{reducer(H,B){return Tw(H,B.payload)},prepare:oc()}}}),N=Kn({name:`${e}/config`,initialState:{online:s9(),focused:i9(),middlewareRegistered:!1,...h},reducers:{middlewareRegistered(H,{payload:B}){H.middlewareRegistered=H.middlewareRegistered==="conflict"||l!==B?"conflict":!0}},extraReducers:H=>{H.addCase(pb,B=>{B.online=!0}).addCase(yD,B=>{B.online=!1}).addCase(hb,B=>{B.focused=!0}).addCase(gD,B=>{B.focused=!1}).addMatcher(f,B=>({...B}))}}),I=ZR({queries:b.reducer,mutations:x.reducer,provided:R.reducer,subscriptions:A.reducer,config:N.reducer}),P=(H,B)=>I(y.match(B)?void 0:H,B),F={...N.actions,...b.actions,...C.actions,...A.actions,...x.actions,...R.actions,resetApiState:y};return{reducer:P,actions:F}}var cr=Symbol.for("RTKQ/skipToken"),SD={status:"uninitialized"},aT=gu(SD,()=>{}),lT=gu(SD,()=>{});function _9({serializeQueryArgs:e,reducerPath:t,createSelector:n}){const i=C=>aT,o=C=>lT;return{buildQuerySelector:_,buildInfiniteQuerySelector:b,buildMutationSelector:x,selectInvalidatedBy:O,selectCachedArgsForQuery:R,selectApiState:u,selectQueries:f,selectMutations:h,selectQueryEntry:p,selectConfig:y};function l(C){return{...C,...JE(C.status)}}function u(C){return C[t]}function f(C){return u(C)?.queries}function p(C,A){return f(C)?.[A]}function h(C){return u(C)?.mutations}function y(C){return u(C)?.config}function v(C,A,N){return I=>{if(I===cr)return n(i,N);const P=e({queryArgs:I,endpointDefinition:A,endpointName:C});return n(H=>p(H,P)??aT,N)}}function _(C,A){return v(C,A,l)}function b(C,A){const{infiniteQueryOptions:N}=A;function I(P){const F={...P,...JE(P.status)},{isLoading:H,isError:B,direction:z}=F,G=z==="forward",V=z==="backward";return{...F,hasNextPage:D(N,F.data,F.originalArgs),hasPreviousPage:k(N,F.data,F.originalArgs),isFetchingNextPage:H&&G,isFetchingPreviousPage:H&&V,isFetchNextPageError:B&&G,isFetchPreviousPageError:B&&V}}return v(C,A,I)}function x(){return C=>{let A;return typeof C=="object"?A=du(C)??cr:A=C,n(A===cr?o:P=>u(P)?.mutations?.[A]??lT,l)}}function O(C,A){const N=C[t],I=new Set;for(const P of A.filter(vh).map(Sv)){const F=N.provided.tags[P.type];if(!F)continue;let H=(P.id!==void 0?F[P.id]:tT(Object.values(F)))??[];for(const B of H)I.add(B)}return tT(Array.from(I.values()).map(P=>{const F=N.queries[P];return F?[{queryCacheKey:P,endpointName:F.endpointName,originalArgs:F.originalArgs}]:[]}))}function R(C,A){return Object.values(f(C)).filter(N=>N?.endpointName===A&&N.status!=="uninitialized").map(N=>N.originalArgs)}function D(C,A,N){return A?wv(C,A,N)!=null:!1}function k(C,A,N){return!A||!C.getPreviousPageParam?!1:_D(C,A,N)!=null}}var cT=WeakMap?new WeakMap:void 0,uT=({endpointName:e,queryArgs:t})=>{let n="";const i=cT?.get(t);if(typeof i=="string")n=i;else{const o=JSON.stringify(t,(l,u)=>(u=typeof u=="bigint"?{$bigint:u.toString()}:u,u=vs(u)?Object.keys(u).sort().reduce((f,p)=>(f[p]=u[p],f),{}):u,u));vs(t)&&cT?.set(t,o),n=o}return`${e}(${n})`};function xD(...e){return function(n){const i=Yf(h=>n.extractRehydrationInfo?.(h,{reducerPath:n.reducerPath??"api"})),o={reducerPath:"api",keepUnusedDataFor:60,refetchOnMountOrArgChange:!1,refetchOnFocus:!1,refetchOnReconnect:!1,invalidationBehavior:"delayed",...n,extractRehydrationInfo:i,serializeQueryArgs(h){let y=uT;if("serializeQueryArgs"in h.endpointDefinition){const v=h.endpointDefinition.serializeQueryArgs;y=_=>{const b=v(_);return typeof b=="string"?b:uT({..._,queryArgs:b})}}else n.serializeQueryArgs&&(y=n.serializeQueryArgs);return y(h)},tagTypes:[...n.tagTypes||[]]},l={endpointDefinitions:{},batch(h){h()},apiUid:h_(),extractRehydrationInfo:i,hasRehydrationInfo:Yf(h=>i(h)!=null)},u={injectEndpoints:p,enhanceEndpoints({addTagTypes:h,endpoints:y}){if(h)for(const v of h)o.tagTypes.includes(v)||o.tagTypes.push(v);if(y)for(const[v,_]of Object.entries(y))typeof _=="function"?_(l.endpointDefinitions[v]):Object.assign(l.endpointDefinitions[v]||{},_);return u}},f=e.map(h=>h.init(u,o,l));function p(h){const y=h.endpoints({query:v=>({...v,type:"query"}),mutation:v=>({...v,type:"mutation"}),infiniteQuery:v=>({...v,type:"infinitequery"})});for(const[v,_]of Object.entries(y)){if(h.overrideExisting!==!0&&v in l.endpointDefinitions){if(h.overrideExisting==="throw")throw new Error(gr(39));continue}l.endpointDefinitions[v]=_;for(const b of f)b.injectEndpoint(v,_)}return u}return u.injectEndpoints({endpoints:n.endpoints})}}function si(e,...t){return Object.assign(e,...t)}var b9=({api:e,queryThunk:t,internalState:n,mwApi:i})=>{const o=`${e.reducerPath}/subscriptions`;let l=null,u=null;const{updateSubscriptionOptions:f,unsubscribeQueryResult:p}=e.internalActions,h=(O,R)=>{if(f.match(R)){const{queryCacheKey:k,requestId:C,options:A}=R.payload,N=O.get(k);return N?.has(C)&&N.set(C,A),!0}if(p.match(R)){const{queryCacheKey:k,requestId:C}=R.payload,A=O.get(k);return A&&A.delete(C),!0}if(e.internalActions.removeQueryResult.match(R))return O.delete(R.payload.queryCacheKey),!0;if(t.pending.match(R)){const{meta:{arg:k,requestId:C}}=R,A=_v(O,k.queryCacheKey,bv);return k.subscribe&&A.set(C,k.subscriptionOptions??A.get(C)??{}),!0}let D=!1;if(t.rejected.match(R)){const{meta:{condition:k,arg:C,requestId:A}}=R;if(k&&C.subscribe){const N=_v(O,C.queryCacheKey,bv);N.set(A,C.subscriptionOptions??N.get(A)??{}),D=!0}}return D},y=()=>n.currentSubscriptions,b={getSubscriptions:y,getSubscriptionCount:O=>y().get(O)?.size??0,isRequestSubscribed:(O,R)=>!!y()?.get(O)?.get(R)};function x(O){return JSON.parse(JSON.stringify(Object.fromEntries([...O].map(([R,D])=>[R,Object.fromEntries(D)]))))}return(O,R)=>{if(l||(l=x(n.currentSubscriptions)),e.util.resetApiState.match(O))return l={},n.currentSubscriptions.clear(),u=null,[!0,!1];if(e.internalActions.internal_getRTKQSubscriptions.match(O))return[!1,b];const D=h(n.currentSubscriptions,O);let k=!0;if(D){u||(u=setTimeout(()=>{const N=x(n.currentSubscriptions),[,I]=sA(l,()=>N);R.next(e.internalActions.subscriptionsUpdated(I)),l=N,u=null},500));const C=typeof O.type=="string"&&!!O.type.startsWith(o),A=t.rejected.match(O)&&O.meta.condition&&!!O.meta.arg.subscribe;k=!C&&!A}return[k,!1]}},S9=2147483647/1e3-1,x9=({reducerPath:e,api:t,queryThunk:n,context:i,internalState:o,selectors:{selectQueryEntry:l,selectConfig:u},getRunningQueryThunk:f,mwApi:p})=>{const{removeQueryResult:h,unsubscribeQueryResult:y,cacheEntriesUpserted:v}=t.internalActions,_=o.runningQueries.get(p.dispatch),b=vi(y.match,n.fulfilled,n.rejected,v.match);function x(C){const A=o.currentSubscriptions.get(C);if(!A)return!1;const N=A.size>0,I=_?.[C]!==void 0;return N||I}const O={},R=(C,A,N)=>{const I=A.getState(),P=u(I);if(b(C)){let F;if(v.match(C))F=C.payload.map(H=>H.queryDescription.queryCacheKey);else{const{queryCacheKey:H}=y.match(C)?C.payload:C.meta.arg;F=[H]}D(F,A,P)}if(t.util.resetApiState.match(C))for(const[F,H]of Object.entries(O))H&&clearTimeout(H),delete O[F];if(i.hasRehydrationInfo(C)){const{queries:F}=i.extractRehydrationInfo(C);D(Object.keys(F),A,P)}};function D(C,A,N){const I=A.getState();for(const P of C){const F=l(I,P);F?.endpointName&&k(P,F.endpointName,A,N)}}function k(C,A,N,I){const F=i.endpointDefinitions[A]?.keepUnusedDataFor??I.keepUnusedDataFor;if(F===1/0)return;const H=Math.max(0,Math.min(F,S9));if(!x(C)){const B=O[C];B&&clearTimeout(B),O[C]=setTimeout(()=>{if(!x(C)){const z=l(N.getState(),C);z?.endpointName&&N.dispatch(f(z.endpointName,z.originalArgs))?.abort(),N.dispatch(h({queryCacheKey:C}))}delete O[C]},H*1e3)}}return R},dT=new Error("Promise never resolved before cacheEntryRemoved."),w9=({api:e,reducerPath:t,context:n,queryThunk:i,mutationThunk:o,internalState:l,selectors:{selectQueryEntry:u,selectApiState:f}})=>{const p=ev(i),h=ev(o),y=_s(i,o),v={};function _(D,k,C){const A=v[D];A?.valueResolved&&(A.valueResolved({data:k,meta:C}),delete A.valueResolved)}function b(D){const k=v[D];k&&(delete v[D],k.cacheEntryRemoved())}const x=(D,k,C)=>{const A=O(D);function N(I,P,F,H){const B=u(C,P),z=u(k.getState(),P);!B&&z&&R(I,H,P,k,F)}if(i.pending.match(D))N(D.meta.arg.endpointName,A,D.meta.requestId,D.meta.arg.originalArgs);else if(e.internalActions.cacheEntriesUpserted.match(D))for(const{queryDescription:I,value:P}of D.payload){const{endpointName:F,originalArgs:H,queryCacheKey:B}=I;N(F,B,D.meta.requestId,H),_(B,P,{})}else if(o.pending.match(D))k.getState()[t].mutations[A]&&R(D.meta.arg.endpointName,D.meta.arg.originalArgs,A,k,D.meta.requestId);else if(y(D))_(A,D.payload,D.meta.baseQueryMeta);else if(e.internalActions.removeQueryResult.match(D)||e.internalActions.removeMutationResult.match(D))b(A);else if(e.util.resetApiState.match(D))for(const I of Object.keys(v))b(I)};function O(D){return p(D)?D.meta.arg.queryCacheKey:h(D)?D.meta.arg.fixedCacheKey??D.meta.requestId:e.internalActions.removeQueryResult.match(D)?D.payload.queryCacheKey:e.internalActions.removeMutationResult.match(D)?du(D.payload):""}function R(D,k,C,A,N){const I=n.endpointDefinitions[D],P=I?.onCacheEntryAdded;if(!P)return;const F={},H=new Promise(ue=>{F.cacheEntryRemoved=ue}),B=Promise.race([new Promise(ue=>{F.valueResolved=ue}),H.then(()=>{throw dT})]);B.catch(()=>{}),v[C]=F;const z=e.endpoints[D].select(_h(I)?k:C),G=A.dispatch((ue,j,K)=>K),V={...A,getCacheEntry:()=>z(A.getState()),requestId:N,extra:G,updateCachedData:_h(I)?ue=>A.dispatch(e.util.updateQueryData(D,k,ue)):void 0,cacheDataLoaded:B,cacheEntryRemoved:H},te=P(k,V);Promise.resolve(te).catch(ue=>{if(ue!==dT)throw ue})}return x},E9=({api:e,context:{apiUid:t},reducerPath:n})=>(i,o)=>{e.util.resetApiState.match(i)&&o.dispatch(e.internalActions.middlewareRegistered(t))},T9=({reducerPath:e,context:t,context:{endpointDefinitions:n},mutationThunk:i,queryThunk:o,api:l,assertTagType:u,refetchQuery:f,internalState:p})=>{const{removeQueryResult:h}=l.internalActions,y=vi(_s(i),Vh(i)),v=vi(_s(i,o),Ua(i,o));let _=[];const b=(R,D)=>{y(R)?O(bD(R,"invalidatesTags",n,u),D):v(R)?O([],D):l.util.invalidateTags.match(R)&&O(mb(R.payload,void 0,void 0,void 0,void 0,u),D)};function x(R){const{queries:D,mutations:k}=R;for(const C of[D,k])for(const A in C)if(C[A]?.status==="pending")return!0;return!1}function O(R,D){const k=D.getState(),C=k[e];if(_.push(...R),C.config.invalidationBehavior==="delayed"&&x(C))return;const A=_;if(_=[],A.length===0)return;const N=l.util.selectInvalidatedBy(k,A);t.batch(()=>{const I=Array.from(N.values());for(const{queryCacheKey:P}of I){const F=C.queries[P],H=_v(p.currentSubscriptions,P,bv);F&&(H.size===0?D.dispatch(h({queryCacheKey:P})):F.status!=="uninitialized"&&D.dispatch(f(F)))}})}return b},C9=({reducerPath:e,queryThunk:t,api:n,refetchQuery:i,internalState:o})=>{const{currentPolls:l,currentSubscriptions:u}=o,f=new Set;let p=null;const h=(R,D)=>{(n.internalActions.updateSubscriptionOptions.match(R)||n.internalActions.unsubscribeQueryResult.match(R))&&y(R.payload.queryCacheKey,D),(t.pending.match(R)||t.rejected.match(R)&&R.meta.condition)&&y(R.meta.arg.queryCacheKey,D),(t.fulfilled.match(R)||t.rejected.match(R)&&!R.meta.condition)&&v(R.meta.arg,D),n.util.resetApiState.match(R)&&(x(),p&&(clearTimeout(p),p=null),f.clear())};function y(R,D){f.add(R),p||(p=setTimeout(()=>{for(const k of f)_({queryCacheKey:k},D);f.clear(),p=null},0))}function v({queryCacheKey:R},D){const k=D.getState()[e],C=k.queries[R],A=u.get(R);if(!C||C.status==="uninitialized")return;const{lowestPollingInterval:N,skipPollingIfUnfocused:I}=O(A);if(!Number.isFinite(N))return;const P=l.get(R);P?.timeout&&(clearTimeout(P.timeout),P.timeout=void 0);const F=Date.now()+N;l.set(R,{nextPollTimestamp:F,pollingInterval:N,timeout:setTimeout(()=>{(k.config.focused||!I)&&D.dispatch(i(C)),v({queryCacheKey:R},D)},N)})}function _({queryCacheKey:R},D){const C=D.getState()[e].queries[R],A=u.get(R);if(!C||C.status==="uninitialized")return;const{lowestPollingInterval:N}=O(A);if(!Number.isFinite(N)){b(R);return}const I=l.get(R),P=Date.now()+N;(!I||P<I.nextPollTimestamp)&&v({queryCacheKey:R},D)}function b(R){const D=l.get(R);D?.timeout&&clearTimeout(D.timeout),l.delete(R)}function x(){for(const R of l.keys())b(R)}function O(R=new Map){let D=!1,k=Number.POSITIVE_INFINITY;for(const C of R.values())C.pollingInterval&&(k=Math.min(C.pollingInterval,k),D=C.skipPollingIfUnfocused||D);return{lowestPollingInterval:k,skipPollingIfUnfocused:D}}return h},R9=({api:e,context:t,queryThunk:n,mutationThunk:i})=>{const o=f_(n,i),l=Ua(n,i),u=_s(n,i),f={};return(h,y)=>{if(o(h)){const{requestId:v,arg:{endpointName:_,originalArgs:b}}=h.meta,x=t.endpointDefinitions[_],O=x?.onQueryStarted;if(O){const R={},D=new Promise((N,I)=>{R.resolve=N,R.reject=I});D.catch(()=>{}),f[v]=R;const k=e.endpoints[_].select(_h(x)?b:v),C=y.dispatch((N,I,P)=>P),A={...y,getCacheEntry:()=>k(y.getState()),requestId:v,extra:C,updateCachedData:_h(x)?N=>y.dispatch(e.util.updateQueryData(_,b,N)):void 0,queryFulfilled:D};O(b,A)}}else if(u(h)){const{requestId:v,baseQueryMeta:_}=h.meta;f[v]?.resolve({data:h.payload,meta:_}),delete f[v]}else if(l(h)){const{requestId:v,rejectedWithValue:_,baseQueryMeta:b}=h.meta;f[v]?.reject({error:h.payload??h.error,isUnhandledError:!_,meta:b}),delete f[v]}}},A9=({reducerPath:e,context:t,api:n,refetchQuery:i,internalState:o})=>{const{removeQueryResult:l}=n.internalActions,u=(p,h)=>{hb.match(p)&&f(h,"refetchOnFocus"),pb.match(p)&&f(h,"refetchOnReconnect")};function f(p,h){const y=p.getState()[e],v=y.queries,_=o.currentSubscriptions;t.batch(()=>{for(const b of _.keys()){const x=v[b],O=_.get(b);if(!O||!x)continue;const R=[...O.values()];(R.some(k=>k[h]===!0)||R.every(k=>k[h]===void 0)&&y.config[h])&&(O.size===0?p.dispatch(l({queryCacheKey:b})):x.status!=="uninitialized"&&p.dispatch(i(x)))}})}return u};function I9(e){const{reducerPath:t,queryThunk:n,api:i,context:o,internalState:l}=e,{apiUid:u}=o,f={invalidateTags:mr(`${t}/invalidateTags`)},p=_=>_.type.startsWith(`${t}/`),h=[E9,x9,T9,C9,w9,R9];return{middleware:_=>{let b=!1;const x={...e,internalState:l,refetchQuery:v,isThisApiSliceAction:p,mwApi:_},O=h.map(k=>k(x)),R=b9(x),D=A9(x);return k=>C=>{if(!JR(C))return k(C);b||(b=!0,_.dispatch(i.internalActions.middlewareRegistered(u)));const A={..._,next:k},N=_.getState(),[I,P]=R(C,A,N);let F;if(I?F=k(C):F=P,_.getState()[t]&&(D(C,A,N),p(C)||o.hasRehydrationInfo(C)))for(const H of O)H(C,A,N);return F}},actions:f};function v(_){return e.api.endpoints[_.endpointName].initiate(_.originalArgs,{subscribe:!1,forceRefetch:!0})}}var fT=Symbol(),wD=({createSelector:e=wi}={})=>({name:fT,init(t,{baseQuery:n,tagTypes:i,reducerPath:o,serializeQueryArgs:l,keepUnusedDataFor:u,refetchOnMountOrArgChange:f,refetchOnFocus:p,refetchOnReconnect:h,invalidationBehavior:y,onSchemaFailure:v,catchSchemaFailure:_,skipSchemaValidation:b},x){G6();const O=pe=>pe;Object.assign(t,{reducerPath:o,endpoints:{},internalActions:{onOnline:pb,onOffline:yD,onFocus:hb,onFocusLost:gD},util:{}});const R=_9({serializeQueryArgs:l,reducerPath:o,createSelector:e}),{selectInvalidatedBy:D,selectCachedArgsForQuery:k,buildQuerySelector:C,buildInfiniteQuerySelector:A,buildMutationSelector:N}=R;si(t.util,{selectInvalidatedBy:D,selectCachedArgsForQuery:k});const{queryThunk:I,infiniteQueryThunk:P,mutationThunk:F,patchQueryData:H,updateQueryData:B,upsertQueryData:z,prefetch:G,buildMatchThunkActions:V}=y9({baseQuery:n,reducerPath:o,context:x,api:t,serializeQueryArgs:l,assertTagType:O,selectors:R,onSchemaFailure:v,catchSchemaFailure:_,skipSchemaValidation:b}),{reducer:te,actions:ue}=v9({context:x,queryThunk:I,mutationThunk:F,serializeQueryArgs:l,reducerPath:o,assertTagType:O,config:{refetchOnFocus:p,refetchOnReconnect:h,refetchOnMountOrArgChange:f,keepUnusedDataFor:u,reducerPath:o,invalidationBehavior:y}});si(t.util,{patchQueryData:H,updateQueryData:B,upsertQueryData:z,prefetch:G,resetApiState:ue.resetApiState,upsertQueryEntries:ue.cacheEntriesUpserted}),si(t.internalActions,ue);const j={currentSubscriptions:new Map,currentPolls:new Map,runningQueries:new Map,runningMutations:new Map},{buildInitiateQuery:K,buildInitiateInfiniteQuery:ne,buildInitiateMutation:ae,getRunningMutationThunk:M,getRunningMutationsThunk:X,getRunningQueriesThunk:le,getRunningQueryThunk:ie}=g9({queryThunk:I,mutationThunk:F,infiniteQueryThunk:P,api:t,serializeQueryArgs:l,context:x,internalState:j});si(t.util,{getRunningMutationThunk:M,getRunningMutationsThunk:X,getRunningQueryThunk:ie,getRunningQueriesThunk:le});const{middleware:de,actions:me}=I9({reducerPath:o,context:x,queryThunk:I,mutationThunk:F,infiniteQueryThunk:P,api:t,assertTagType:O,selectors:R,getRunningQueryThunk:ie,internalState:j});return si(t.util,me),si(t,{reducer:te,middleware:de}),{name:fT,injectEndpoint(pe,Ie){const be=t,Oe=be.endpoints[pe]??={};lp(Ie)&&si(Oe,{name:pe,select:C(pe,Ie),initiate:K(pe,Ie)},V(I,pe)),h9(Ie)&&si(Oe,{name:pe,select:N(),initiate:ae(pe)},V(F,pe)),cp(Ie)&&si(Oe,{name:pe,select:A(pe,Ie),initiate:ne(pe,Ie)},V(I,pe))}}}});wD();function cf(e){return e.replace(e[0],e[0].toUpperCase())}function D9(e){return e.type==="query"}function O9(e){return e.type==="mutation"}function ED(e){return e.type==="infinitequery"}function yc(e,...t){return Object.assign(e,...t)}var fy=Symbol();function hy(e){const t=E.useRef(e),n=E.useMemo(()=>fb(t.current,e),[e]);return E.useEffect(()=>{t.current!==n&&(t.current=n)},[n]),n}function uf(e){const t=E.useRef(e);return E.useEffect(()=>{Tc(t.current,e)||(t.current=e)},[e]),Tc(t.current,e)?t.current:e}var k9=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",N9=k9(),M9=()=>typeof navigator<"u"&&navigator.product==="ReactNative",L9=M9(),P9=()=>N9||L9?E.useLayoutEffect:E.useEffect,j9=P9(),hT=e=>e.isUninitialized?{...e,isUninitialized:!1,isFetching:!0,isLoading:e.data===void 0,status:mD.pending}:e;function py(e,...t){const n={};return t.forEach(i=>{n[i]=e[i]}),n}var my=["data","status","isLoading","isSuccess","isError","error"];function $9({api:e,moduleOptions:{batch:t,hooks:{useDispatch:n,useSelector:i,useStore:o},unstable__sideEffectsInRender:l,createSelector:u},serializeQueryArgs:f,context:p}){const h=l?A=>A():E.useEffect;return{buildQueryHooks:D,buildInfiniteQueryHooks:k,buildMutationHook:C,usePrefetch:_};function y(A,N,I){if(N?.endpointName&&A.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];I!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:I,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=A.isSuccess?A.data:N?.data;P===void 0&&(P=A.data);const F=P!==void 0,H=A.isLoading,B=(!N||N.isLoading||N.isUninitialized)&&!F&&H,z=A.isSuccess||F&&(H&&!N?.isError||A.isUninitialized);return{...A,data:P,currentData:A.data,isFetching:H,isLoading:B,isSuccess:z}}function v(A,N,I){if(N?.endpointName&&A.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];I!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:I,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=A.isSuccess?A.data:N?.data;P===void 0&&(P=A.data);const F=P!==void 0,H=A.isLoading,B=(!N||N.isLoading||N.isUninitialized)&&!F&&H,z=A.isSuccess||H&&F;return{...A,data:P,currentData:A.data,isFetching:H,isLoading:B,isSuccess:z}}function _(A,N){const I=n(),P=uf(N);return E.useCallback((F,H)=>I(e.util.prefetch(A,F,{...P,...H})),[A,I,P])}function b(A,N,{refetchOnReconnect:I,refetchOnFocus:P,refetchOnMountOrArgChange:F,skip:H=!1,pollingInterval:B=0,skipPollingIfUnfocused:z=!1,...G}={}){const{initiate:V}=e.endpoints[A],te=n(),ue=E.useRef(void 0);if(!ue.current){const me=te(e.internalActions.internal_getRTKQSubscriptions());ue.current=me}const j=hy(H?cr:N),K=uf({refetchOnReconnect:I,refetchOnFocus:P,pollingInterval:B,skipPollingIfUnfocused:z}),ne=G.initialPageParam,ae=uf(ne),M=E.useRef(void 0);let{queryCacheKey:X,requestId:le}=M.current||{},ie=!1;X&&le&&(ie=ue.current.isRequestSubscribed(X,le));const de=!ie&&M.current!==void 0;return h(()=>{de&&(M.current=void 0)},[de]),h(()=>{const me=M.current;if(j===cr){me?.unsubscribe(),M.current=void 0;return}const pe=M.current?.subscriptionOptions;if(!me||me.arg!==j){me?.unsubscribe();const Ie=te(V(j,{subscriptionOptions:K,forceRefetch:F,...ED(p.endpointDefinitions[A])?{initialPageParam:ae}:{}}));M.current=Ie}else K!==pe&&me.updateSubscriptionOptions(K)},[te,V,F,j,K,de,ae,A]),[M,te,V,K]}function x(A,N){return(P,{skip:F=!1,selectFromResult:H}={})=>{const{select:B}=e.endpoints[A],z=hy(F?cr:P),G=E.useRef(void 0),V=E.useMemo(()=>u([B(z),(ne,ae)=>ae,ne=>z],N,{memoizeOptions:{resultEqualityCheck:Tc}}),[B,z]),te=E.useMemo(()=>H?u([V],H,{devModeChecks:{identityFunctionCheck:"never"}}):V,[V,H]),ue=i(ne=>te(ne,G.current),Tc),j=o(),K=V(j.getState(),G.current);return j9(()=>{G.current=K},[K]),ue}}function O(A){E.useEffect(()=>()=>{A.current?.unsubscribe?.(),A.current=void 0},[A])}function R(A){if(!A.current)throw new Error(gr(38));return A.current.refetch()}function D(A){const N=(F,H={})=>{const[B]=b(A,F,H);return O(B),E.useMemo(()=>({refetch:()=>R(B)}),[B])},I=({refetchOnReconnect:F,refetchOnFocus:H,pollingInterval:B=0,skipPollingIfUnfocused:z=!1}={})=>{const{initiate:G}=e.endpoints[A],V=n(),[te,ue]=E.useState(fy),j=E.useRef(void 0),K=uf({refetchOnReconnect:F,refetchOnFocus:H,pollingInterval:B,skipPollingIfUnfocused:z});h(()=>{const X=j.current?.subscriptionOptions;K!==X&&j.current?.updateSubscriptionOptions(K)},[K]);const ne=E.useRef(K);h(()=>{ne.current=K},[K]);const ae=E.useCallback(function(X,le=!1){let ie;return t(()=>{j.current?.unsubscribe(),j.current=ie=V(G(X,{subscriptionOptions:ne.current,forceRefetch:!le})),ue(X)}),ie},[V,G]),M=E.useCallback(()=>{j.current?.queryCacheKey&&V(e.internalActions.removeQueryResult({queryCacheKey:j.current?.queryCacheKey}))},[V]);return E.useEffect(()=>()=>{j?.current?.unsubscribe()},[]),E.useEffect(()=>{te!==fy&&!j.current&&ae(te,!0)},[te,ae]),E.useMemo(()=>[ae,te,{reset:M}],[ae,te,M])},P=x(A,y);return{useQueryState:P,useQuerySubscription:N,useLazyQuerySubscription:I,useLazyQuery(F){const[H,B,{reset:z}]=I(F),G=P(B,{...F,skip:B===fy}),V=E.useMemo(()=>({lastArg:B}),[B]);return E.useMemo(()=>[H,{...G,reset:z},V],[H,G,z,V])},useQuery(F,H){const B=N(F,H),z=P(F,{selectFromResult:F===cr||H?.skip?void 0:hT,...H}),G=py(z,...my);return E.useDebugValue(G),E.useMemo(()=>({...z,...B}),[z,B])}}}function k(A){const N=(P,F={})=>{const[H,B,z,G]=b(A,P,F),V=E.useRef(G);h(()=>{V.current=G},[G]);const te=E.useCallback(function(K,ne){let ae;return t(()=>{H.current?.unsubscribe(),H.current=ae=B(z(K,{subscriptionOptions:V.current,direction:ne}))}),ae},[H,B,z]);O(H);const ue=hy(F.skip?cr:P),j=E.useCallback(()=>R(H),[H]);return E.useMemo(()=>({trigger:te,refetch:j,fetchNextPage:()=>te(ue,"forward"),fetchPreviousPage:()=>te(ue,"backward")}),[j,te,ue])},I=x(A,v);return{useInfiniteQueryState:I,useInfiniteQuerySubscription:N,useInfiniteQuery(P,F){const{refetch:H,fetchNextPage:B,fetchPreviousPage:z}=N(P,F),G=I(P,{selectFromResult:P===cr||F?.skip?void 0:hT,...F}),V=py(G,...my,"hasNextPage","hasPreviousPage");return E.useDebugValue(V),E.useMemo(()=>({...G,fetchNextPage:B,fetchPreviousPage:z,refetch:H}),[G,B,z,H])}}}function C(A){return({selectFromResult:N,fixedCacheKey:I}={})=>{const{select:P,initiate:F}=e.endpoints[A],H=n(),[B,z]=E.useState();E.useEffect(()=>()=>{B?.arg.fixedCacheKey||B?.reset()},[B]);const G=E.useCallback(function(X){const le=H(F(X,{fixedCacheKey:I}));return z(le),le},[H,F,I]),{requestId:V}=B||{},te=E.useMemo(()=>P({fixedCacheKey:I,requestId:B?.requestId}),[I,B,P]),ue=E.useMemo(()=>N?u([te],N):te,[N,te]),j=i(ue,Tc),K=I==null?B?.arg.originalArgs:void 0,ne=E.useCallback(()=>{t(()=>{B&&z(void 0),I&&H(e.internalActions.removeMutationResult({requestId:V,fixedCacheKey:I}))})},[H,I,B,V]),ae=py(j,...my,"endpointName");E.useDebugValue(ae);const M=E.useMemo(()=>({...j,originalArgs:K,reset:ne}),[j,K,ne]);return E.useMemo(()=>[G,M],[G,M])}}}var U9=Symbol(),z9=({batch:e=AN,hooks:t={useDispatch:sC,useSelector:oC,useStore:iC},createSelector:n=wi,unstable__sideEffectsInRender:i=!1,...o}={})=>({name:U9,init(l,{serializeQueryArgs:u},f){const p=l,{buildQueryHooks:h,buildInfiniteQueryHooks:y,buildMutationHook:v,usePrefetch:_}=$9({api:l,moduleOptions:{batch:e,hooks:t,unstable__sideEffectsInRender:i,createSelector:n},serializeQueryArgs:u,context:f});return yc(p,{usePrefetch:_}),yc(f,{batch:e}),{injectEndpoint(b,x){if(D9(x)){const{useQuery:O,useLazyQuery:R,useLazyQuerySubscription:D,useQueryState:k,useQuerySubscription:C}=h(b);yc(p.endpoints[b],{useQuery:O,useLazyQuery:R,useLazyQuerySubscription:D,useQueryState:k,useQuerySubscription:C}),l[`use${cf(b)}Query`]=O,l[`useLazy${cf(b)}Query`]=R}if(O9(x)){const O=v(b);yc(p.endpoints[b],{useMutation:O}),l[`use${cf(b)}Mutation`]=O}else if(ED(x)){const{useInfiniteQuery:O,useInfiniteQuerySubscription:R,useInfiniteQueryState:D}=y(b);yc(p.endpoints[b],{useInfiniteQuery:O,useInfiniteQuerySubscription:R,useInfiniteQueryState:D}),l[`use${cf(b)}InfiniteQuery`]=O}}}}}),B9=xD(wD(),z9());const TD=e=>({id:String(e.id),name:e.name,imageUrl:e.picture_url,display:!0}),H9=e=>e.results.map(TD).sort((n,i)=>n.name.localeCompare(i.name)),CD=e=>{const t=e.image.original_height||48,n=e.image.original_width||48;return{id:String(e.id),name:e.name,iconUrl:e.image.url.replace("{height}",t).replace("{width}",n)}},F9=e=>e.results.map(CD).sort((n,i)=>n.name.localeCompare(i.name)),q9=e=>{const t=e.instructors[0],n=t?TD(t):{id:"0",name:"Unknown Instructor",imageUrl:"",display:!1},i=Ce.getBookableStatus(e),o=new Date(e.starts_at),u=(new Date(e.ends_at).getTime()-o.getTime())/1e3;return Number.isNaN(u)&&Qv("Computed invalid duration",{extra:{rawClass:e}}),{...e,id:String(e.id),name:e.name,start:e.starts_at,end:e.ends_at,customerUrl:e.customer_url,duration:u,discipline:CD(e.offering_type.category),instructor:n,status:i}},V9=e=>e.results.map(q9),G9=["id","name","max_occupancy","occupancy","attending_count","starts_at","ends_at","waiting_count","active_registration_status","category.name","venue","customer_url","description"],W9=["instructors","active_registration_status","category","offering_type","offering_type.category","venue","suggested_booking_action"],If=B9({reducerPath:"pelotonApi",baseQuery:f9({baseUrl:`${Ce.PELOTON_CORS_PROXY}/${Ce.PELOTON_API_BASE}/`}),endpoints:e=>({getClasses:e.query({queryFn:async t=>{try{const n=Ce.getPelotonHeaders(t),i=Ce.buildEventsUrl({fields:G9,expand:W9,corsProxy:!0}),o=await Ce.fetchAllPelotonPages(i,async l=>{const u=await fetch(l,{headers:n});if(!u.ok)throw new Error(`${u.status}: ${await u.text()}`);return u.json()},!0);return{data:V9({results:o})}}catch(n){return{error:{status:"FETCH_ERROR",error:String(n)}}}}}),getDisciplines:e.query({query:t=>({url:`offering_type_categories?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>F9(t)}),getInstructors:e.query({query:t=>({url:`instructors?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>H9(t)})})}),{useGetClassesQuery:gb,useGetDisciplinesQuery:yb,useGetInstructorsQuery:vb}=If,Y9=e=>{if("error"in e&&typeof e.error=="string")return e.error;if("message"in e&&typeof e.message=="string")return e.message},Q9=T.label`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
...
`,X9=T.input`
  accent-color: ${e=>e.theme.colors.accent};
`,RD=({value:e,checked:t,onChange:n,label:i,icon:o})=>{const l=E.useId();return g.jsxs(Q9,{$checked:t,htmlFor:l,children:[g.jsx(X9,{type:"checkbox",id:l,value:e,checked:t,onChange:n}),o,g.jsx(K9,{children:i})]})},pT=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,mT=T.legend`
...
`,Z9=T.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,J9=({studioId:e,selectedInstructors:t,setSelectedInstructors:n,selectedDisciplines:i,setSelectedDisciplines:o})=>{const l=vb(e),u=yb(e),f=E.useRef(t),p=E.useRef(i);E.useEffect(()=>{const b=f.current;if(!l.currentData||!Ce.isNotEmpty(b))return;const x=new Set(l.currentData.map(R=>R.id)),O=b.filter(R=>x.has(R));O.length<b.length&&(n(O),f.current=O)},[l.currentData,n]),E.useEffect(()=>{const b=p.current;if(!u.currentData||!Ce.isNotEmpty(b))return;const x=new Set(u.currentData.map(R=>String(R.id))),O=b.filter(R=>x.has(String(R))).map(String);O.length<b.length&&(o(O),p.current=O)},[u.currentData,o]);const h=E.useCallback(b=>{if(!Ce.isNotEmpty(t))return;const x=t.includes(b);n(x?t.filter(O=>O!==b):[...t,b])},[t,n]),y=E.useCallback(b=>{if(!Ce.isNotEmpty(i))return;const x=i.includes(b);o(x?i.filter(O=>O!==b):[...i,b])},[i,o]),v=Ce.isNotEmpty(t),_=Ce.isNotEmpty(i);return g.jsxs("div",{children:[g.jsxs(pT,{children:[g.jsx(mT,{children:"Instructors"}),g.jsx(gT,{children:"Filter by specific instructors or get alerts for all of them."}),g.jsxs(yT,{children:[g.jsx(df,{type:"button",$active:!v,onClick:()=>n(null),children:"Any instructor"}),g.jsx(df,{type:"button",$active:v,onClick:()=>{v||n([])},children:"Specific instructors"}),v&&t.length>0&&g.jsxs(vT,{children:[t.length," selected"]})]}),v&&g.jsx(eF,{query:l,selectedIds:t,onToggle:h})]}),g.jsx(Z9,{}),g.jsxs(pT,{children:[g.jsx(mT,{children:"Disciplines"}),g.jsx(gT,{children:"Filter by class type or get alerts for everything."}),g.jsxs(yT,{children:[g.jsx(df,{type:"button",$active:!_,onClick:()=>o(null),children:"Any discipline"}),g.jsx(df,{type:"button",$active:_,onClick:()=>{_||o([])},children:"Specific disciplines"}),_&&i.length>0&&g.jsxs(vT,{children:[i.length," selected"]})]}),_&&g.jsx(tF,{query:u,selectedIds:i,onToggle:y})]})]})},eF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(bh,{children:"Loading instructors…"}):e.error?g.jsxs(ID,{children:["Couldn't load instructors."," ",g.jsx(DD,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(bh,{children:"No instructors found for this studio."}):g.jsx(AD,{role:"group","aria-label":"Instructors",children:e.currentData.map(i=>g.jsx(RD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(db,{instructor:i,size:28})},i.id))})),tF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(bh,{children:"Loading disciplines…"}):e.error?g.jsxs(ID,{children:["Couldn't load disciplines."," ",g.jsx(DD,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(bh,{children:"No disciplines found for this studio."}):g.jsx(AD,{role:"group","aria-label":"Disciplines",children:e.currentData.map(i=>g.jsx(RD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(yh,{discipline:i,size:24})},i.id))})),nF=T.div`
  display: flex;
  align-items: center;
  gap: 4px;
  padding: 0 16px;
...
`,t7=T.span`
  ...
  ${Te`
    font-size: 12px;
  `}
`,n7=({alertToEdit:e,onSave:t,onCancel:n})=>{const i=Mn(),o=et(vu),[l,u]=E.useState(0),[f,p]=E.useState(!1),[h,y]=E.useState(),{selectedStudioId:v,name:_,setName:b,selectedInstructors:x,setSelectedInstructors:O,selectedDisciplines:R,setSelectedDisciplines:D,timeRanges:k,setTimeRanges:C,maxStatus:A,setMaxStatus:N,waitlistAlerts:I,setWaitlistAlerts:P,watchedClassIds:F,setWatchedClassIds:H}=WF(e),B=l<vy.length-1,z=l>0,G=l===vy.length-1,V=E.useCallback(()=>{B&&u(K=>K+1)},[B]),te=E.useCallback(()=>{z&&u(K=>K-1)},[z]),ue=E.useCallback(async()=>{if(!v||!o)return;p(!0),y(void 0);const K={id:e.id||null,created:e.created||new Date().getTime(),..._.trim()?{name:_.trim()}:{},studioId:v,instructors:x,disciplines:R,timeRanges:k,maxStatus:A,waitlistAlerts:I,...I&&F!==null?{watchedClassIds:F}:{}};try{K.id?await hD(o,K):await $H(o,K),t()}catch(ne){Nr(ne),y("Something went wrong. Please try again."),p(!1)}},[e.id,e.created,_,v,o,x,R,k,A,I,F,t]),j=!!e.id;return g.jsxs(YF,{children:[g.jsxs(QF,{children:[g.jsx(KF,{children:j?"Edit alert":"New alert"}),g.jsx(XF,{children:j?"Update your alert settings below.":"Set up a new alert in a few quick steps."}),g.jsx(aF,{steps:vy,currentStep:l,onStepClick:u})]}),g.jsxs(ZF,{children:[l===0&&g.jsx(XH,{name:_,onNameChange:b,studioId:v,onStudioChange:K=>i(ph(K)),maxStatus:A,onStatusChange:N}),l===1&&g.jsx(J9,{studioId:v,selectedInstructors:x,setSelectedInstructors:O,selectedDisciplines:R,setSelectedDisciplines:D}),l===2&&g.jsx(IF,{timeRanges:k,setTimeRanges:C}),l===3&&g.jsx(GF,{studioId:v,waitlistAlerts:I,onWaitlistAlertsChange:P,watchedClassIds:F,onWatchedClassIdsChange:H,selectedInstructors:x,selectedDisciplines:R,timeRanges:k}),l===4&&g.jsx(gF,{name:_,studioId:v,maxStatus:A,selectedInstructors:x,selectedDisciplines:R,timeRanges:k,waitlistAlerts:I,watchedClassIds:F})]}),g.jsxs(JF,{children:[g.jsx("div",{children:z?g.jsx(vc,{type:"button",onClick:te,children:"Back"}):g.jsx(vc,{type:"button",onClick:n,children:"Cancel"})}),g.jsxs(e7,{children:[h&&g.jsx(t7,{$error:!0,children:h}),G?g.jsx(vc,{type:"button",$primary:!0,onClick:ue,disabled:f,children:f?"Saving…":"Save alert"}):g.jsxs(g.Fragment,{children:[j&&g.jsx(vc,{type:"button",onClick:ue,disabled:f,children:f?"Saving…":"Save"}),g.jsx(vc,{type:"button",$primary:!0,onClick:V,children:"Continue"})]})]})]})]})},r7=()=>{const e=Pr(),t=ws(),n=e.state||{};return g.jsx(n7,{alertToEdit:n,onSave:()=>{t(nt.ALERTS)},onCancel:()=>{t(nt.ALERTS)}})},i7={userId:null,data:{state:"idle"}},OD=Kn({name:"alerts",initialState:i7,reducers:{setAlertsLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertsData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertsFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertsLoading:s7,setAlertsData:ET,setAlertsFailed:TT}=OD.actions,o7=OD.reducer,a7={userId:null,data:{state:"idle"}},kD=Kn({name:"alertPreferences",initialState:a7,reducers:{setAlertPreferencesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertPreferencesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertPreferencesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertPreferencesLoading:l7,setAlertPreferencesData:c7,setAlertPreferencesFailed:CT}=kD.actions,u7=kD.reducer,_b=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},bb=(e,t)=>{try{window.localStorage.setItem(e,t)}catch(n){Nr(n)}},ND=e=>{try{window.localStorage.removeItem(e)}catch(t){Nr(t)}},MD="BOOKABLE_STATUS_FILTERS",Ev="DISCIPLINE_FILTERS",Tv="INSTRUCTOR_FILTERS",d7=e=>{const t=_b(MD);return t===null?e:t.split(";").filter(Ce.isBookableStatus)},f7=e=>{bb(MD,e.join(";"))},h7=e=>{const t=_b(Ev);return t===null?e:t.split(";").filter(Boolean)},_y=e=>{e.length===0?ND(Ev):bb(Ev,e.join(";"))},p7=e=>{const t=_b(Tv);return t===null?e:t.split(";").filter(Boolean)},RT=e=>{e.length===0?ND(Tv):bb(Tv,e.join(";"))},m7={selectedBookableStatuses:d7(["free","waitlist"]),selectedInstructors:p7([]),selectedDisciplines:h7([])},LD=Kn({name:"filters",initialState:m7,reducers:{toggleBookableStatus(e,t){e.selectedBookableStatuses.includes(t.payload)?e.selectedBookableStatuses=e.selectedBookableStatuses.filter(n=>n!==t.payload):e.selectedBookableStatuses=[...e.selectedBookableStatuses,t.payload],f7(e.selectedBookableStatuses)},toggleInstructor(e,t){e.selectedInstructors.includes(t.payload)?e.selectedInstructors=e.selectedInstructors.filter(n=>n!==t.payload):e.selectedInstructors=[...e.selectedInstructors,t.payload],RT(e.selectedInstructors)},resetInstructors(e){e.selectedInstructors=[],RT(e.selectedInstructors)},toggleDiscipline(e,t){e.selectedDisciplines.includes(t.payload)?e.selectedDisciplines=e.selectedDisciplines.filter(n=>n!==t.payload):e.selectedDisciplines=[...e.selectedDisciplines,t.payload],_y(e.selectedDisciplines)},setDisciplines(e,t){e.selectedDisciplines=t.payload,_y(e.selectedDisciplines)},resetDisciplines(e){e.selectedDisciplines=[],_y(e.selectedDisciplines)}}}),{toggleBookableStatus:g7,toggleInstructor:y7,resetInstructors:v7,toggleDiscipline:_7,setDisciplines:b7,resetDisciplines:S7}=LD.actions,x7=LD.reducer,w7={userId:null,data:{state:"idle"}},PD=Kn({name:"registeredDevices",initialState:w7,reducers:{setRegisteredDevicesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setRegisteredDevicesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setRegisteredDevicesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setRegisteredDevicesLoading:E7,setRegisteredDevicesData:T7,setRegisteredDevicesFailed:AT}=PD.actions,C7=PD.reducer,R7={state:"idle"},jD=Kn({name:"session",initialState:R7,reducers:{setLoading(e){return{state:"loading"}},setSession(e,t){return{state:"fulfilled",data:t.payload}},removeSession(e){return{state:"fulfilled",data:null}}}}),{setLoading:IT,setSession:A7,removeSession:DT}=jD.actions,I7=jD.reducer,up=d3({reducer:{alerts:o7,alertPreferences:u7,filters:x7,registeredDevices:C7,session:I7,[If.reducerPath]:If.reducer,[vv.name]:vv.reducer},middleware:e=>e().concat(If.middleware)}),$D=E.createContext({state:"idle"}),D7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.registeredDevices);E.useEffect(()=>{const l=xn;if(!l)return n(AT({userId:t,error:{message:"No database set up"}})),()=>{};const u=up.getState().registeredDevices;(u.userId!==t||u.data.state!=="fulfilled")&&n(E7(t));const f=ir(l,`messagingTokens/${t}`),p=rp(f,h=>{const y=h.val();n(T7({userId:t,data:y||{}}))},h=>{n(AT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx($D.Provider,{value:o,children:e})},UD=E.createContext({state:"idle"}),O7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.alertPreferences);E.useEffect(()=>{const l=xn;if(!l)return n(CT({userId:t,error:{message:"No database set up"}})),()=>{};const u=up.getState().alertPreferences;(u.userId!==t||u.data.state!=="fulfilled")&&n(l7(t));const f=ir(l,Ce.PATHS.alertPreferences(t)),p=rp(f,h=>{const y=h.val();n(c7({userId:t,data:y||{}}))},h=>{n(CT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(UD.Provider,{value:o,children:e})},k7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.alerts);E.useEffect(()=>{const l=xn;if(!l)return n(TT({userId:t,error:{message:"No database set up"}})),()=>{};const u=up.getState().alerts;(u.userId!==t||u.data.state!=="fulfilled")&&n(s7(t));const f=ir(l,Ce.PATHS.alerts(t)),p=rp(f,h=>{const y=h.val();if(!y){n(ET({userId:t,data:[]}));return}const v=Object.entries(y).map(([_,b])=>({...b,timeRanges:new Array(ls.length).fill(null).map((x,O)=>b.timeRanges[O]||null),id:_}));n(ET({userId:t,data:v}))},h=>{n(TT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(ub.Provider,{value:o,children:e})},N7=T.div`
  margin: 0 auto;
  max-width: 960px;
  padding: 16px;
...
`,z7=T.p`
  ...
  padding: 32px 0;
  margin: 0;
`,B7=({children:e})=>{const t=et(el);return t.state==="loading"?g.jsx(z7,{children:"Loading…"}):t.state!=="fulfilled"||!t.data?g.jsxs(L7,{children:[g.jsx(P7,{children:"🔔"}),g.jsx(j7,{children:"Sign in to use Alerts"}),g.jsx($7,{children:"Track class availability and get push notifications when a spot opens up for the classes you care about."}),g.jsx(U7,{to:nt.SIGN_IN,children:"Sign in"})]}):e(t.data.id)},H7=e=>g.jsx(hs,{children:g.jsx(M7,{children:g.jsx(N7,{children:g.jsx(B7,{...e})})})}),F7=({userId:e})=>g.jsx(k7,{userId:e,children:g.jsx(O7,{userId:e,children:g.jsx(D7,{userId:e,children:g.jsx(s2,{})})})}),q7=()=>g.jsx(H7,{children:e=>g.jsx(F7,{userId:e})}),OT=async(e,t)=>{const n=xn;if(!n)throw new Error("No Firebase database connection to use");await EI(ir(n,Ce.PATHS.alertPreferences(e)),t)},V7=T.input`
  position: absolute;
  opacity: 0;
  width: 0;
  height: 0;
...
`,Y7=T.label`
  ...
  cursor: pointer;
  position: relative;
`,zD=({id:e,checked:t,onChange:n,label:i,"aria-label":o})=>g.jsxs(Y7,{htmlFor:e,children:[g.jsx(V7,{id:e,type:"checkbox",checked:t,"aria-label":o??i,onChange:l=>n(l.target.checked)}),g.jsx(G7,{$checked:t,children:g.jsx(W7,{$checked:t})}),i&&g.jsx("span",{children:i})]}),Q7=T.form`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,K7=T.div`
...
`,Vq=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-top: 4px;
`,Gq={free:{label:"Open spots",title:"Only alerts when a class has open spots available to book"},waitlist:{label:"Waitlist",title:"Alerts when a class has open spots or waitlist availability"},full:{label:"Any",title:"Alerts regardless of availability status"}},Wq=e=>Gq[e]||{label:e,title:""},Yq=E.memo(({alert:e,onDuplicate:t,onEdit:n})=>{const i=ws(),o=et(vu),l=!!e.disabled,[u,f]=E.useState(!1),p=E.useRef(null),h=E.useCallback(()=>{o&&hD(o,{...e,disabled:!l})},[o,e,l]);E.useEffect(()=>{if(!u)return;const k=N=>{N.key==="Escape"&&f(!1)},C=N=>{if(!(N.target instanceof Node))return f(!1);p.current?.contains(N.target)||f(!1)},A=setTimeout(()=>{document.addEventListener("keydown",k),document.addEventListener("click",C,!0)},0);return()=>{clearTimeout(A),document.removeEventListener("keydown",k),document.removeEventListener("click",C,!0)}},[u]);const{data:y}=vb(e.studioId),{data:v}=yb(e.studioId),_=E.useMemo(()=>{const C=new Date(e.created).getFullYear()===new Date().getFullYear();return new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",...C?{}:{year:"numeric"}}).format(e.created)},[e.created]),b=E.useMemo(()=>new Map(y?.map(k=>[k.id,k.name])),[y]),x=E.useMemo(()=>new Map(v?.map(k=>[k.id,k.name])),[v]),O=E.useMemo(()=>{if(e.name)return e.name;const k=Ce.isNotEmpty(e.instructors)&&y?e.instructors.map(A=>b.get(A)).filter(A=>!!A):null,C=Ce.isNotEmpty(e.disciplines)&&v?e.disciplines.map(A=>x.get(A)).filter(A=>!!A):null;return Iq(C,k)},[e.name,e.instructors,e.disciplines,y,v,b,x]),R=Ce.STUDIOS[e.studioId]?.location||e.studioId||"No studio",D=Wq(e.maxStatus);return g.jsx(Dq,{$disabled:l,children:g.jsxs(Oq,{children:[g.jsxs(kq,{children:[g.jsxs(Nq,{children:[g.jsx(Mq,{children:O}),g.jsx(Lq,{$status:e.maxStatus,title:D.title,children:D.label})]}),g.jsx(Pq,{children:R}),g.jsx(jq,{children:ls.map((k,C)=>g.jsx($q,{$active:!!e.timeRanges[C],title:e.timeRanges[C]?`${k}: monitoring enabled`:`${k}: not monitored`,children:k.charAt(0)},k))}),g.jsxs(Vq,{children:["Created ",_]})]}),g.jsxs(Uq,{children:[g.jsx(zD,{id:`toggle-${e.id}`,checked:!l,onChange:h,"aria-label":l?"Enable alert":"Disable alert"}),g.jsxs(zq,{ref:p,children:[g.jsx(Bq,{type:"button","aria-label":"More options","aria-expanded":u,"aria-haspopup":"menu",onClick:()=>f(k=>!k),children:g.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[g.jsx("circle",{cx:"8",cy:"3",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"13",r:"1.5"})]})}),u&&g.jsxs(Hq,{role:"menu",children:[g.jsx("li",{children:g.jsx(Df,{type:"button",role:"menuitem",onClick:()=>{f(!1),i(KU(e.id))},children:"Test"})}),g.jsx("li",{children:g.jsx(Df,{type:"button",role:"menuitem",onClick:()=>{f(!1),n(e)},children:"Edit"})}),g.jsx("li",{children:g.jsx(Df,{type:"button",role:"menuitem",onClick:()=>{f(!1),t(e)},children:"Duplicate"})}),g.jsx(qq,{}),g.jsx("li",{children:g.jsx(Fq,{type:"button",role:"menuitem",onClick:()=>{f(!1),o&&Aq(o,e.id)},children:"Delete"})})]})]})]})]})})}),Qq=T.ul`
  list-style: none;
  padding: 0;
  margin: 0;
  display: flex;
  flex-direction: column;
  gap: 8px;
`,Kq=({alerts:e,onDuplicate:t,onEdit:n})=>g.jsx(Qq,{children:e.map(i=>g.jsx(Yq,{alert:i,onDuplicate:t,onEdit:n},i.id))}),Xq=T.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 20px 24px 0;
...
`,cV=({onAdd:e})=>g.jsxs(oV,{children:[g.jsx(aV,{children:"Create your first alert to get notified when classes become available."}),g.jsx(lV,{type:"button",onClick:e,children:"Create an alert"})]}),uV=T.button`
  padding: 1.5em;
  max-width: 300px;
  width: 100%;
  line-height: 0;
...
`,jT=T.div`
  ...
  ${Te`
    padding: 12px 16px 16px;
  `}
`,gV=()=>{const e=ws();return g.jsxs(mV,{children:[g.jsx(Sy,{children:g.jsx(sV,{onAdd:()=>{e(nt.ALERTS_EDITOR,{state:{}})},onEdit:t=>{e(nt.ALERTS_EDITOR,{state:t})},onDuplicate:t=>{e(nt.ALERTS_EDITOR,{state:{...t,id:void 0,created:void 0}})}})}),g.jsxs(Sy,{children:[g.jsxs(MT,{children:[g.jsx(LT,{children:"Preferences"}),g.jsx(PT,{children:"Control how often you receive alert notifications."})]}),g.jsx(jT,{children:g.jsx(cq,{})})]}),g.jsxs(Sy,{children:[g.jsxs(MT,{children:[g.jsx(LT,{children:"Devices"}),g.jsx(PT,{children:"Devices registered to receive push notifications. Removed devices will re-register on their next visit."})]}),g.jsxs(jT,{children:[g.jsx(pV,{}),g.jsx(Rq,{})]})]})]})},yV=T.button.attrs({"aria-label":"Close",type:"button"})`
  position: relative;
  width: 50px;
  height: 50px;
  font-size: 0;
...
`,vV=()=>{const e=et(i=>i.filters.selectedBookableStatuses),t=Mn(),n=E.useCallback(i=>{t(g7(i))},[t]);return{bookableStatuses:e,toggleBookableStatus:n}},_V=T.button`
  cursor: pointer;
  color: ${e=>e.theme.colors.accent};
  font-size: 12px;
  background: none;
...
`,SV=T.h3`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin: 0;
`,dp=({label:e,onReset:t,children:n})=>g.jsxs(bV,{children:[g.jsx(SV,{children:e}),t&&g.jsx(_V,{type:"button",onClick:t,children:"Reset"}),n]}),xV=T.div`
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  padding: 0 16px 16px;
`,wV=T.button`
  ...
  ${e=>e.$active?nn`
        ...
        `}
`,EV=()=>{const{bookableStatuses:e,toggleBookableStatus:t}=vV(),n=qv(),i=[{label:"Free",status:"free",color:n.colors.status.free.text},{label:"Waitlist",status:"waitlist",color:n.colors.status.waitlist.text},{label:"Full",status:"full",color:n.colors.status.full.text}];return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(dp,{label:"Status"})}),g.jsx(xV,{children:i.map(o=>{const l=e.includes(o.status);return g.jsx(wV,{type:"button",$active:l,$color:o.color,onClick:()=>t(o.status),"aria-pressed":l,children:o.label},o.status)})})]})},TV=()=>{const e=et(i=>i.filters.selectedDisciplines),t=Mn(),n=E.useCallback(i=>{t(_7(i))},[t]);return{selectedDisciplines:e,toggleDiscipline:n}},BD=T.ul`
  list-style: none;
  margin: 0;
  padding: 0 0 8px;
`,HD=T.li`
...
`,xh=T.p`
  ...
  padding: 8px 16px 16px;
  margin: 0;
`,CV=({discipline:e,checked:t,onClick:n})=>g.jsxs(HD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(FD,{$checked:t}),g.jsx(yh,{discipline:e,size:24}),g.jsx(qD,{children:e.name})]}),RV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=yb(e),{selectedDisciplines:o,toggleDiscipline:l}=TV(),u=Mn(),f=E.useRef(o);return E.useEffect(()=>{const p=f.current;if(!t||p.length===0)return;const h=new Set(t.map(v=>v.id)),y=p.filter(v=>h.has(v));y.length<p.length&&u(b7(y))},[t,u]),i&&!n?g.jsx(xh,{children:"Failed to load disciplines"}):!t||n?g.jsx(xh,{children:"Loading…"}):g.jsx(BD,{children:t.map((p,h)=>g.jsx(CV,{discipline:p,checked:o.includes(p.id),onClick:()=>l(p.id)},h))})},AV=()=>{const e=et(n=>n.filters.selectedDisciplines.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(dp,{label:"Disciplines",onReset:e?()=>t(S7()):void 0}),g.jsx(RV,{})]})},IV=()=>{const e=et(i=>i.filters.selectedInstructors),t=Mn(),n=E.useCallback(i=>{t(y7(i))},[t]);return{selectedInstructors:e,toggleInstructor:n}},DV=({instructor:e,checked:t,onClick:n})=>g.jsxs(HD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(FD,{$checked:t}),g.jsx(db,{instructor:e,size:28}),g.jsx(qD,{children:e.name})]}),OV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=vb(e),{selectedInstructors:o,toggleInstructor:l}=IV();return i&&!n?g.jsx(xh,{children:"Failed to load instructors"}):!t||n?g.jsx(xh,{children:"Loading…"}):g.jsx(BD,{children:t.map((u,f)=>g.jsx(DV,{instructor:u,checked:o.includes(u.id),onClick:()=>l(u.id)},f))})},kV=()=>{const e=et(n=>n.filters.selectedInstructors.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(dp,{label:"Instructors",onReset:e?()=>t(v7()):void 0}),g.jsx(OV,{})]})},NV=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),MV=T.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
  padding: 0 16px 16px;
...
`,$V=T.span`
  font-size: 15px;
  color: ${e=>e.theme.colors.main};
`,UV=()=>{const e=Mn(),t=et(Do);return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(dp,{label:"Studio"})}),g.jsx(MV,{children:NV.map(n=>{const i=t===n.id;return g.jsxs(LV,{$selected:i,htmlFor:`studio-${n.id}`,children:[g.jsx(PV,{type:"radio",id:`studio-${n.id}`,name:"studio-selected",value:n.id,checked:i,onChange:()=>{i||e(ph(n.id))}}),g.jsx(jV,{$selected:i}),g.jsx($V,{children:n.label})]},n.id)})})]})},zV=T.div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,BV=T.div`
...
`,VV=({onClose:e})=>g.jsxs(zV,{children:[g.jsxs(BV,{children:[g.jsx(HV,{children:"Filters"}),g.jsx(FV,{onClick:()=>e()})]}),g.jsxs(qV,{children:[g.jsx(ff,{children:g.jsx(UV,{})}),g.jsx(ff,{children:g.jsx(EV,{})}),g.jsx(ff,{children:g.jsx(AV,{})}),g.jsx(ff,{children:g.jsx(kV,{})})]})]}),GV=()=>{const e=et(Do),{refetch:t}=gb(e);return{refresh:E.useCallback(async()=>{await t()},[t])}},$T=150,UT=60,WV=()=>document.documentElement.scrollTop||document.body.scrollTop,YV=({refresh:e})=>{const t=E.useRef(null),n=E.useRef(null),i=E.useRef(e);E.useLayoutEffect(()=>{i.current=e});const o=E.useMemo(()=>!!navigator.standalone||window.matchMedia("(display-mode: standalone)").matches||!1,[]);return E.useEffect(()=>{if(!o)return;let l=0,u=!1,f=!1,p=!1;const h=x=>{const O=n.current;O&&(O.style.transition=x?"transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease":"none",O.style.transform="",O.style.opacity="0")},y=x=>{l=x.touches[0].clientY,u=!1,f=!1},v=x=>{if(p||WV()>0)return;const O=x.touches[0].clientY-l;if(O<=0){u&&(u=!1,f=!1,h(!1));return}u=!0,f=O>=$T;const R=Math.min(O/$T,1),D=UT*(1-Math.pow(1-R,2)),k=Math.pow(R,.5),C=Math.floor(R*270),A=n.current;A&&(A.style.transition="none",A.style.transform=`translateY(${D}px) rotate(${C}deg)`,A.style.opacity=String(Math.min(k,1)))},_=()=>{if(u)if(u=!1,f&&!p){f=!1,p=!0;const x=n.current;x&&(x.classList.add("animate"),x.style.transition="none",x.style.transform=`translateY(${UT}px)`,x.style.opacity="1");let O=!1;const R=()=>{if(O)return;O=!0,p=!1;const k=n.current;k&&(k.classList.remove("animate"),h(!0))},D=setTimeout(R,1e4);i.current().finally(()=>{clearTimeout(D),R()})}else f=!1,h(!0)},b=()=>{u=!1,f=!1,h(!1)};return document.addEventListener("touchstart",y,{passive:!0}),document.addEventListener("touchmove",v,{passive:!0}),document.addEventListener("touchend",_,{passive:!0}),document.addEventListener("touchcancel",b,{passive:!0}),()=>{document.removeEventListener("touchstart",y),document.removeEventListener("touchmove",v),document.removeEventListener("touchend",_),document.removeEventListener("touchcancel",b)}},[o]),{swipeRef:t,spinnerRef:n}},QV=e=>e.filters.selectedDisciplines.length>0||e.filters.selectedInstructors.length>0,KV=e=>e.filters.selectedBookableStatuses,XV=e=>e.filters.selectedDisciplines,ZV=e=>e.filters.selectedInstructors,JV=(e,t)=>t,eG=wi([KV,XV,ZV,JV],(e,t,n,i)=>i.filter(o=>e.includes(o.status)).filter(o=>n.length>0?n.some(l=>l===o.instructor.id):!0).filter(o=>t.length>0?t.includes(o.discipline.id):!0)),VD=wi([Do],e=>{if(e)return Ce.STUDIOS[e]}),tG=wi([eG,VD],(e,t)=>{if(e.length===0)return[];const n=t?.timezone||"",i=[];let o=1,l=Va(e[0].start,n,!0),u=[e[0]];for(;o<e.length;){const f=e[o],p=Va(f.start,n,!0);p===l?u.push(f):(i.push({formattedDate:l,classes:u}),l=p,u=[f]),o++}return u.length>0&&i.push({formattedDate:l,classes:u}),i}),zT={free:{label:"Book"},waitlist:{label:"Waitlist"},full:{label:"Full"}},nG=T.a`
  display: flex;
  align-items: center;
  gap: 14px;
  text-decoration: none;
...
`,fG=T.button`
  ...
  ${Te`
    ...
    padding: 5px 10px;
  `}
`,hG=E.memo(({clazz:e})=>{const t=et(VD),n=e.status,i=n==="free"||n==="waitlist",o=E.useMemo(()=>e.customerUrl?new URL(e.customerUrl,"https://schedule.studio.onepeloton.com").href:(Qv("Missing customer URL",{extra:{clazz:e}}),""),[e]),l=E.useMemo(()=>To(e.start,t?.timezone),[e.start,t?.timezone]),u=zT[n]??zT.full;return g.jsxs(nG,{$status:n,$interactive:i,href:o,target:"_blank","aria-label":`${u.label} ${e.name} at ${l}`,children:[g.jsxs(rG,{children:[g.jsx(iG,{children:l}),g.jsxs(sG,{children:[e.duration/60," min"]})]}),g.jsxs(oG,{children:[g.jsx(db,{instructor:e.instructor,size:44}),g.jsx(yh,{discipline:e.discipline,size:36})]}),g.jsxs(aG,{children:[g.jsx(lG,{children:e.name}),g.jsxs(cG,{children:[e.instructor.name,g.jsx(uG,{children:"·"}),e.discipline.name,g.jsx(dG,{children:g.jsx(yh,{discipline:e.discipline,size:20})})]})]}),g.jsx(fG,{$status:n,disabled:!i,tabIndex:-1,children:u.label})]})}),pG=T.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
`,mG=T.div`
...
`,HT=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`,bG=({classes:e,fulfilledTimeStamp:t})=>{const n=et(u=>tG(u,e)),i=et(QV),o=et(u=>u.filters.selectedBookableStatuses.includes("free")),l=E.useMemo(()=>t?new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"}).format(t):void 0,[t]);return n.length===0?g.jsxs(vG,{children:[g.jsx(_G,{children:"No classes found"}),i&&g.jsx(HT,{children:"Try resetting your filters or selecting more options in the sidebar."}),o&&!i&&g.jsx(HT,{children:"New classes usually open at 12:00 pm on Mondays and Thursdays in your studio's timezone."})]}):g.jsx(pG,{children:n.map((u,f)=>g.jsxs(mG,{children:[g.jsxs(gG,{children:[g.jsx(yG,{children:u.formattedDate}),f===0&&l&&g.jsxs(BT,{children:["Times in studio timezone · loaded ",l]}),f===0&&!l&&g.jsx(BT,{children:"All times in studio timezone"})]}),u.classes.map((p,h)=>g.jsx(hG,{clazz:p},h))]},f))})},FT=T.div`
  background-color: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 32px 24px;
...
`,wG=T.code`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,EG=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i,fulfilledTimeStamp:o}=gb(e,{refetchOnMountOrArgChange:!0});return i&&!n?g.jsxs(FT,{children:[g.jsx(xG,{children:"Failed to load classes"}),g.jsx(wG,{children:Y9(i)})]}):!t||n?g.jsx(FT,{children:g.jsx(SG,{children:"Loading classes…"})}):g.jsx(bG,{classes:t,fulfilledTimeStamp:o})},TG=T.div``,Cv=300,CG=T.aside`
  max-width: 100%;
  width: ${Cv}px;
  top: calc(${X_}px + env(safe-area-inset-top, 0px));
  bottom: 0;
...
`,KT=T.p`
  color: ${e=>e.theme.colors.secondary};
  font-size: 14px;
`,wh=1e3,Of=140,Eh=12,GD=4,WD=Of-Eh-GD;function _c(e,t){return t<=1?wh/2:e/(t-1)*wh}function Ey(e,t){return Eh+WD*(1-e/t)}const ZG=[.25,.5,.75],JG=T.div`
  background: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 16px 16px 12px;
...
`,sW=T.div`
  ...
  background-color: ${e=>e.$color};
  flex-shrink: 0;
`;function oW(e){const[,t,n]=e.split("-");return`${parseInt(t)}/${parseInt(n)}`}function aW({days:e,legend:t}){return g.jsxs(g.Fragment,{children:[g.jsx(tW,{children:e.map(n=>g.jsx(nW,{children:oW(n.date)},n.date))}),g.jsx(rW,{children:t.map(n=>g.jsxs(iW,{children:[g.jsx(sW,{$color:n.color}),n.label]},n.label))})]})}const lW=T.div`
  position: relative;
`,cW=T.div`
  position: absolute;
  top: 6px;
...
`,pW=T.div`
  ...
  pointer-events: none;
`;function XT({days:e,seriesForDay:t,legend:n}){const i=e.length,[o,l]=E.useState(null),u=e.map(t),f=Math.max(...u.flatMap(_=>_.map(b=>b.value)),1),p=u[0].length,h=Ey(0,f).toFixed(1);function y(_,b){const{left:x,width:O}=b.getBoundingClientRect(),R=(_-x)/O;return Math.max(0,Math.min(i-1,Math.round(R*(i-1))))}const v=o!==null?o/(i-1)*100:null;return g.jsxs(JG,{children:[g.jsxs(lW,{children:[o!==null&&v!==null&&g.jsxs(g.Fragment,{children:[g.jsxs(cW,{$pct:v,children:[g.jsx(uW,{children:e[o].date}),u[o].map(_=>g.jsxs(dW,{children:[g.jsx(fW,{$color:_.color}),_.label,g.jsx(hW,{children:_.value})]},_.label))]}),u[o].map((_,b)=>g.jsx(pW,{$color:_.color,style:{left:`${v}%`,top:`${Ey(_.value,f)/Of*100}%`}},b))]}),g.jsxs(eW,{viewBox:`0 0 ${wh} ${Of}`,preserveAspectRatio:"none","aria-hidden":"true",style:{cursor:"crosshair",display:"block"},onMouseMove:_=>l(y(_.clientX,_.currentTarget)),onMouseLeave:()=>l(null),onTouchStart:_=>l(y(_.touches[0].clientX,_.currentTarget)),onTouchMove:_=>l(y(_.touches[0].clientX,_.currentTarget)),onTouchEnd:()=>l(null),children:[ZG.map(_=>{const b=(Eh+WD*(1-_)).toFixed(1);return g.jsx("line",{x1:0,y1:b,x2:wh,y2:b,stroke:"currentColor",strokeOpacity:.1,strokeWidth:1,vectorEffect:"non-scaling-stroke"},_)}),o!==null&&g.jsx("line",{x1:_c(o,i).toFixed(1),y1:Eh,x2:_c(o,i).toFixed(1),y2:Of-GD,stroke:"currentColor",strokeOpacity:.2,strokeWidth:1,vectorEffect:"non-scaling-stroke"}),Array.from({length:p},(_,b)=>{const x=u[0][b].color,R=u.map((k,C)=>({x:_c(C,i),y:Ey(k[b].value,f)})).map(({x:k,y:C},A)=>`${A===0?"M":"L"}${k.toFixed(1)},${C.toFixed(1)}`).join(" "),D=[R,`L${_c(i-1,i).toFixed(1)},${h}`,`L${_c(0,i).toFixed(1)},${h}`,"Z"].join(" ");return g.jsxs("g",{children:[g.jsx("path",{d:D,fill:x,fillOpacity:.12}),g.jsx("path",{d:R,fill:"none",stroke:x,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",vectorEffect:"non-scaling-stroke"})]},b)})]})]}),g.jsx(aW,{days:e,legend:n})]})}const Wn={added:"#4ade80",changed:"#facc15",removed:"#f87171",sent:"#60a5fa",failed:"#f87171",usersReached:"#a78bfa"},mW=()=>{const e=KG(14);if(e.state==="idle"||e.state==="loading")return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsx(KT,{children:"Loading…"})]})});if(e.state==="failed")return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsxs(KT,{children:["Failed to load metrics: ",e.error.message??"unknown error"]})]})});const t=e.data,n=t.reduce((o,l)=>{o.sent+=l.notifications.sent,o.failed+=l.notifications.failed,o.usersReached+=l.notifications.usersReached;for(const u of Object.values(l.diffs))o.added+=u.added,o.changed+=u.changed,o.removed+=u.removed;return o},{sent:0,failed:0,usersReached:0,added:0,changed:0,removed:0}),i=[...new Set(t.flatMap(o=>Object.keys(o.diffs)))];return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsxs(XG,{children:[g.jsxs(ya,{children:[g.jsx(va,{children:"Notifications sent (14d)"}),g.jsx(_a,{children:n.sent.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Users reached (14d)"}),g.jsx(_a,{children:n.usersReached.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Delivery failures (14d)"}),g.jsx(_a,{children:n.failed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes added (14d)"}),g.jsx(_a,{children:n.added.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes changed (14d)"}),g.jsx(_a,{children:n.changed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes removed (14d)"}),g.jsx(_a,{children:n.removed.toLocaleString()})]})]}),g.jsxs(YT,{children:[g.jsx(QT,{children:"Push notifications (14 days)"}),g.jsx(XT,{days:t,seriesForDay:o=>[{value:o.notifications.sent,color:Wn.sent,label:"Sent"},{value:o.notifications.failed,color:Wn.failed,label:"Failed"},{value:o.notifications.usersReached,color:Wn.usersReached,label:"Users reached"}],legend:[{color:Wn.sent,label:"Sent"},{color:Wn.failed,label:"Failed"},{color:Wn.usersReached,label:"Users reached"}]})]}),i.map(o=>g.jsxs(YT,{children:[g.jsxs(QT,{children:["Schedule changes — ",Ce.STUDIOS[o]?.location??o," (14 days)"]}),g.jsx(XT,{days:t,seriesForDay:l=>{const u=l.diffs[o]??{added:0,changed:0,removed:0};return[{value:u.added,color:Wn.added,label:"Added"},{value:u.changed,color:Wn.changed,label:"Changed"},{value:u.removed,color:Wn.removed,label:"Removed"}]},legend:[{color:Wn.added,label:"Added"},{color:Wn.changed,label:"Changed"},{color:Wn.removed,label:"Removed"}]})]},o))]})})},gW=T.div`
  max-width: 480px;
  margin: 0 auto;
  padding: 40px 20px;
  display: flex;
...
`,xW=T.p`
  ...
  font-size: 13px;
  color: ${e=>e.theme.colors.secondary};
`;function wW(e,t){if(!e)return null;try{const n=Ce.STUDIOS[t]?.timezone;return new Date(e).toLocaleString("en-US",{timeZone:n??"UTC",weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",timeZoneName:"short"})}catch{return null}}const EW=()=>{const[e]=j2(),t=e.get("studioId")??"",n=e.get("startsAt")??"",i=e.get("waitingCount"),o=Ce.STUDIOS[t],l=wW(n,t),u=i!==null?parseInt(i,10):null;return g.jsx(hs,{children:g.jsxs(gW,{children:[g.jsx(yW,{children:"📬"}),g.jsx(vW,{children:"Waitlist count changed"}),g.jsxs(_W,{children:["The number of people on the waitlist just changed",u!==null?` — there ${u===1?"is now 1 person":`are now ${u} people`} ahead`:"",". If you joined this waitlist, check your email — Peloton sends a message when it's your turn, and you'll have a 2-hour window to accept."]}),(l||o)&&g.jsxs(bW,{children:[o&&g.jsxs(g.Fragment,{children:[g.jsx(ZT,{children:"Studio"}),g.jsx(JT,{children:o.location})]}),l&&g.jsxs(g.Fragment,{children:[g.jsx(ZT,{style:{marginTop:o?8:0},children:"Class time"}),g.jsx(JT,{children:l})]})]}),g.jsx(SW,{href:"mailto:",children:"Open Mail App"}),g.jsx(xW,{children:"Opens your device's default mail app."})]})})},TW=O2(a2(g.jsxs(Yn,{children:[g.jsx(Yn,{path:nt.CLASS_LIST,element:g.jsx(NG,{})}),g.jsxs(Yn,{path:nt.ALERTS,element:g.jsx(q7,{}),children:[g.jsx(Yn,{index:!0,element:g.jsx(gV,{})}),g.jsx(Yn,{path:"edit",element:g.jsx(r7,{})}),g.jsx(Yn,{path:":alertId/test",element:g.jsx(MH,{})})]}),g.jsx(Yn,{path:nt.WAITLIST_ALERT,element:g.jsx(EW,{})}),g.jsx(Yn,{path:nt.SIGN_IN,element:g.jsx(YG,{})}),g.jsx(Yn,{path:nt.ABOUT,element:g.jsx(ZB,{})}),g.jsx(Yn,{path:nt.STATS,element:g.jsx(MG,{children:g.jsx(mW,{})})}),g.jsx(Yn,{path:"*",element:g.jsx(Lv,{to:nt.CLASS_LIST,replace:!0})})]}))),CW=(e,t)=>({id:e.uid,displayName:e.displayName||e.email||"",isAdmin:t}),RW=({children:e})=>{const t=Mn();return E.useEffect(()=>{if(t(IT()),!ui)return t(DT()),()=>{};const n=Xz(ui,async i=>{if(t(IT()),i){let o=!1;try{o=(xn?await TI(ir(xn,`admins/${i.uid}`)):null)?.val()===!0}catch{}t(A7(CW(i,o)))}else t(DT())});return()=>n()},[t]),g.jsx(g.Fragment,{children:e})},AW={mode:"light",borderRadius:"8px",borderColor:"#d1d1d1",colors:{main:"#494f59",secondary:"#514e60",mainSurface:"#fff",secondarySurface:"#ededed",accent:"#cb3449",error:"#d93025",hoverSurface:"rgba(0, 0, 0, 0.05)",status:{free:{bg:"#e8f5e9",text:"#2e7d32"},waitlist:{bg:"#fff3e0",text:"#e65100"},full:{text:"#9e9e9e"}}},widths:{tablet:1024,mobile:560}},IW={mode:"dark",borderRadius:"8px",borderColor:"#2e2f45",colors:{main:"#e2e4eb",secondary:"#9b98b0",mainSurface:"#1c1d2e",secondarySurface:"#13141f",accent:"#cb3449",error:"#ef5350",hoverSurface:"rgba(255, 255, 255, 0.08)",status:{free:{bg:"rgba(46, 125, 50, 0.15)",text:"#81c784"},waitlist:{bg:"rgba(230, 81, 0, 0.15)",text:"#ffb74d"},full:{text:"#757575"}}},widths:{tablet:1024,mobile:560}},DW=GL`
  html {
...
`,Rv="theme-mode";function OW(){const e=localStorage.getItem(Rv);return e!==null?e==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches}function kW(){const[e,t]=E.useState(OW),n=E.useCallback(()=>{t(i=>{const o=!i;return localStorage.setItem(Rv,o?"dark":"light"),o})},[]);return E.useEffect(()=>{const i=window.matchMedia("(prefers-color-scheme: dark)"),o=l=>{localStorage.getItem(Rv)===null&&t(l.matches)};return i.addEventListener("change",o),()=>i.removeEventListener("change",o)},[]),{isDark:e,toggle:n}}function NW(){const{isDark:e,toggle:t}=kW();return E.useEffect(()=>{const i=new URLSearchParams(window.location.search).get("classUrl");i&&(window.history.replaceState(null,"",window.location.pathname+window.location.hash),window.location.assign(new URL(i,"https://schedule.studio.onepeloton.com").href))},[]),g.jsx(cD.Provider,{value:{isDark:e,toggle:t},children:g.jsxs(FL,{theme:e?IW:AW,children:[g.jsx(DW,{}),g.jsx(EN,{store:up,children:g.jsx(RW,{children:g.jsx(QU,{children:g.jsx(q2,{router:TW})})})})]})})}lN.createRoot(document.getElementById("root")).render(g.jsx(E.StrictMode,{children:g.jsx(NW,{})}));
//# sourceMappingURL=index-CSXxcuGG.js.map
