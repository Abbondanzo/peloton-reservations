...
`,PB=I.span`
  font-size: 11px;
  opacity: 0.6;
`,jB=({snapshots:e,timezone:t})=>{const[n,i]=C.useState(!1),o=e.length;return v.jsxs("div",{children:[v.jsxs(MB,{type:"button",onClick:()=>i(l=>!l),children:[v.jsx("span",{children:n?"▾":"▸"}),o," class",o===1?"":"es"," skipped"]}),n&&v.jsx(kB,{children:e.map((l,u)=>{const f=t?Va(l.starts_at,t,!1):"",h=xo(l.starts_at,t),p=xo(new Date(l.snapshotAt).toISOString(),t);return v.jsxs(LB,{children:[v.jsxs("span",{children:[f," ",h,l.name?` · ${l.name}`:"",l.instructors[0]?` · ${l.instructors[0].name}`:""]}),v.jsxs(PB,{children:["detected at ",p]})]},u)})})]})},UB=I.section`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,$B=I.h3`
