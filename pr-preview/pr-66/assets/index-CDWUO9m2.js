 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var s1;function dN(){if(s1)return je;s1=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),u=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),_=Symbol.iterator;function v(O){return O===null||typeof O!="object"?null:(O=_&&O[_]||O["@@iterator"],typeof O=="function"?O:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},x=Object.assign,D={};function C(O,K,le){this.props=O,this.context=K,this.refs=D,this.updater=le||b}C.prototype.isReactComponent={},C.prototype.setState=function(O,K){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,K,"setState")},C.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function k(){}k.prototype=C.prototype;function M(O,K,le){this.props=O,this.context=K,this.refs=D,this.updater=le||b}var R=M.prototype=new k;R.constructor=M,x(R,C.prototype),R.isPureReactComponent=!0;var I=Array.isArray,N={H:null,A:null,T:null,S:null,V:null},A=Object.prototype.hasOwnProperty;function P(O,K,le,ie,de,me){return le=me.ref,{$$typeof:e,type:O,key:K,ref:le!==void 0?le:null,props:me}}function U(O,K){return P(O.type,K,void 0,void 0,void 0,O.props)}function F(O){return typeof O=="object"&&O!==null&&O.$$typeof===e}function H(O){var K={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(le){return K[le]})}var z=/\/+/g;function G(O,K){return typeof O=="object"&&O!==null&&O.key!=null?H(""+O.key):K.toString(36)}function V(){}function te(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(V,V):(O.status="pending",O.then(function(K){O.status==="pending"&&(O.status="fulfilled",O.value=K)},function(K){O.status==="pending"&&(O.status="rejected",O.reason=K)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function ue(O,K,le,ie,de){var me=typeof O;(me==="undefined"||me==="boolean")&&(O=null);var pe=!1;if(O===null)pe=!0;else switch(me){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(O.$$typeof){case e:case t:pe=!0;break;case y:return pe=O._init,ue(pe(O._payload),K,le,ie,de)}}if(pe)return de=de(O),pe=ie===""?"."+G(O,0):ie,I(de)?(le="",pe!=null&&(le=pe.replace(z,"$&/")+"/"),ue(de,K,le,"",function(ke){return ke})):de!=null&&(F(de)&&(de=U(de,le+(de.key==null||O&&O.key===de.key?"":(""+de.key).replace(z,"$&/")+"/")+pe)),K.push(de)),1;pe=0;var Ie=ie===""?".":ie+":";if(I(O))for(var be=0;be<O.length;be++)ie=O[be],me=Ie+G(ie,be),pe+=ue(ie,K,le,me,de);else if(be=v(O),typeof be=="function")for(O=be.call(O),be=0;!(ie=O.next()).done;)ie=ie.value,me=Ie+G(ie,be++),pe+=ue(ie,K,le,me,de);else if(me==="object"){if(typeof O.then=="function")return ue(te(O),K,le,ie,de);throw K=String(O),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return pe}function j(O,K,le){if(O==null)return O;var ie=[],de=0;return ue(O,ie,"","",function(me){return K.call(le,me,de++)}),ie}function X(O){if(O._status===-1){var K=O._result;K=K(),K.then(function(le){(O._status===0||O._status===-1)&&(O._status=1,O._result=le)},function(le){(O._status===0||O._status===-1)&&(O._status=2,O._result=le)}),O._status===-1&&(O._status=0,O._result=K)}if(O._status===1)return O._result.default;throw O._result}var ne=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)};function ae(){}return je.Children={map:j,forEach:function(O,K,le){j(O,function(){K.apply(this,arguments)},le)},count:function(O){var K=0;return j(O,function(){K++}),K},toArray:function(O){return j(O,function(K){return K})||[]},only:function(O){if(!F(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},je.Component=C,je.Fragment=n,je.Profiler=o,je.PureComponent=M,je.StrictMode=i,je.Suspense=p,je.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=N,je.__COMPILER_RUNTIME={__proto__:null,c:function(O){return N.H.useMemoCache(O)}},je.cache=function(O){return function(){return O.apply(null,arguments)}},je.cloneElement=function(O,K,le){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var ie=x({},O.props),de=O.key,me=void 0;if(K!=null)for(pe in K.ref!==void 0&&(me=void 0),K.key!==void 0&&(de=""+K.key),K)!A.call(K,pe)||pe==="key"||pe==="__self"||pe==="__source"||pe==="ref"&&K.ref===void 0||(ie[pe]=K[pe]);var pe=arguments.length-2;if(pe===1)ie.children=le;else if(1<pe){for(var Ie=Array(pe),be=0;be<pe;be++)Ie[be]=arguments[be+2];ie.children=Ie}return P(O.type,de,void 0,void 0,me,ie)},je.createContext=function(O){return O={$$typeof:u,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:l,_context:O},O},je.createElement=function(O,K,le){var ie,de={},me=null;if(K!=null)for(ie in K.key!==void 0&&(me=""+K.key),K)A.call(K,ie)&&ie!=="key"&&ie!=="__self"&&ie!=="__source"&&(de[ie]=K[ie]);var pe=arguments.length-2;if(pe===1)de.children=le;else if(1<pe){for(var Ie=Array(pe),be=0;be<pe;be++)Ie[be]=arguments[be+2];de.children=Ie}if(O&&O.defaultProps)for(ie in pe=O.defaultProps,pe)de[ie]===void 0&&(de[ie]=pe[ie]);return P(O,me,void 0,void 0,null,de)},je.createRef=function(){return{current:null}},je.forwardRef=function(O){return{$$typeof:f,render:O}},je.isValidElement=F,je.lazy=function(O){return{$$typeof:y,_payload:{_status:-1,_result:O},_init:X}},je.memo=function(O,K){return{$$typeof:h,type:O,compare:K===void 0?null:K}},je.startTransition=function(O){var K=N.T,le={};N.T=le;try{var ie=O(),de=N.S;de!==null&&de(le,ie),typeof ie=="object"&&ie!==null&&typeof ie.then=="function"&&ie.then(ae,ne)}catch(me){ne(me)}finally{N.T=K}},je.unstable_useCacheRefresh=function(){return N.H.useCacheRefresh()},je.use=function(O){return N.H.use(O)},je.useActionState=function(O,K,le){return N.H.useActionState(O,K,le)},je.useCallback=function(O,K){return N.H.useCallback(O,K)},je.useContext=function(O){return N.H.useContext(O)},je.useDebugValue=function(){},je.useDeferredValue=function(O,K){return N.H.useDeferredValue(O,K)},je.useEffect=function(O,K,le){var ie=N.H;if(typeof le=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return ie.useEffect(O,K)},je.useId=function(){return N.H.useId()},je.useImperativeHandle=function(O,K,le){return N.H.useImperativeHandle(O,K,le)},je.useInsertionEffect=function(O,K){return N.H.useInsertionEffect(O,K)},je.useLayoutEffect=function(O,K){return N.H.useLayoutEffect(O,K)},je.useMemo=function(O,K){return N.H.useMemo(O,K)},je.useOptimistic=function(O,K){return N.H.useOptimistic(O,K)},je.useReducer=function(O,K,le){return N.H.useReducer(O,K,le)},je.useRef=function(O){return N.H.useRef(O)},je.useState=function(O){return N.H.useState(O)},je.useSyncExternalStore=function(O,K,le){return N.H.useSyncExternalStore(O,K,le)},je.useTransition=function(){return N.H.useTransition()},je.version="19.1.1",je}var o1;function Ah(){return o1||(o1=1,bg.exports=dN()),bg.exports}var E=Ah();const dr=lN(E);var Sg={exports:{}},nc={},xg={exports:{}},wg={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var a1;function fN(){return a1||(a1=1,(function(e){function t(j,X){var ne=j.length;j.push(X);e:for(;0<ne;){var ae=ne-1>>>1,O=j[ae];if(0<o(O,X))j[ae]=X,j[ne]=O,ne=ae;else break e}}function n(j){return j.length===0?null:j[0]}function i(j){if(j.length===0)return null;var X=j[0],ne=j.pop();if(ne!==X){j[0]=ne;e:for(var ae=0,O=j.length,K=O>>>1;ae<K;){var le=2*(ae+1)-1,ie=j[le],de=le+1,me=j[de];if(0>o(ie,ne))de<O&&0>o(me,ie)?(j[ae]=me,j[de]=ne,ae=de):(j[ae]=ie,j[le]=ne,ae=le);else if(de<O&&0>o(me,ne))j[ae]=me,j[de]=ne,ae=de;else break e}}return X}function o(j,X){var ne=j.sortIndex-X.sortIndex;return ne!==0?ne:j.id-X.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var u=Date,f=u.now();e.unstable_now=function(){return u.now()-f}}var p=[],h=[],y=1,_=null,v=3,b=!1,x=!1,D=!1,C=!1,k=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;function I(j){for(var X=n(h);X!==null;){if(X.callback===null)i(h);else if(X.startTime<=j)i(h),X.sortIndex=X.expirationTime,t(p,X);else break;X=n(h)}}function N(j){if(D=!1,I(j),!x)if(n(p)!==null)x=!0,A||(A=!0,G());else{var X=n(h);X!==null&&ue(N,X.startTime-j)}}var A=!1,P=-1,U=5,F=-1;function H(){return C?!0:!(e.unstable_now()-F<U)}function z(){if(C=!1,A){var j=e.unstable_now();F=j;var X=!0;try{e:{x=!1,D&&(D=!1,M(P),P=-1),b=!0;var ne=v;try{t:{for(I(j),_=n(p);_!==null&&!(_.expirationTime>j&&H());){var ae=_.callback;if(typeof ae=="function"){_.callback=null,v=_.priorityLevel;var O=ae(_.expirationTime<=j);if(j=e.unstable_now(),typeof O=="function"){_.callback=O,I(j),X=!0;break t}_===n(p)&&i(p),I(j)}else i(p);_=n(p)}if(_!==null)X=!0;else{var K=n(h);K!==null&&ue(N,K.startTime-j),X=!1}}break e}finally{_=null,v=ne,b=!1}X=void 0}}finally{X?G():A=!1}}}var G;if(typeof R=="function")G=function(){R(z)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,te=V.port2;V.port1.onmessage=z,G=function(){te.postMessage(null)}}else G=function(){k(z,0)};function ue(j,X){P=k(function(){j(e.unstable_now())},X)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_next=function(j){switch(v){case 1:case 2:case 3:var X=3;break;default:X=v}var ne=v;v=X;try{return j()}finally{v=ne}},e.unstable_requestPaint=function(){C=!0},e.unstable_runWithPriority=function(j,X){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var ne=v;v=j;try{return X()}finally{v=ne}},e.unstable_scheduleCallback=function(j,X,ne){var ae=e.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?ae+ne:ae):ne=ae,j){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=ne+O,j={id:y++,callback:X,priorityLevel:j,startTime:ne,expirationTime:O,sortIndex:-1},ne>ae?(j.sortIndex=ne,t(h,j),n(p)===null&&j===n(h)&&(D?(M(P),P=-1):D=!0,ue(N,ne-ae))):(j.sortIndex=O,t(p,j),x||b||(x=!0,A||(A=!0,G()))),j},e.unstable_shouldYield=H,e.unstable_wrapCallback=function(j){var X=v;return function(){var ne=v;v=X;try{return j.apply(this,arguments)}finally{v=ne}}}})(wg)),wg}var l1;function hN(){return l1||(l1=1,xg.exports=fN()),xg.exports}var Eg={exports:{}},on={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var h1;function vN(){if(h1)return Cg;h1=1;var e=Ah();function t(p,h){return p===h&&(p!==0||1/p===1/h)||p!==p&&h!==h}var n=typeof Object.is=="function"?Object.is:t,i=e.useSyncExternalStore,o=e.useRef,l=e.useEffect,u=e.useMemo,f=e.useDebugValue;return Cg.useSyncExternalStoreWithSelector=function(p,h,y,_,v){var b=o(null);if(b.current===null){var x={hasValue:!1,value:null};b.current=x}else x=b.current;b=u(function(){function C(N){if(!k){if(k=!0,M=N,N=_(N),v!==void 0&&x.hasValue){var A=x.value;if(v(A,N))return R=A}return R=N}if(A=R,n(M,N))return A;var P=_(N);return v!==void 0&&v(A,P)?(M=N,A):(M=N,R=P)}var k=!1,M,R,I=y===void 0?null:y;return[function(){return C(h())},I===null?void 0:function(){return C(I())}]},[h,y,_,v]);var D=i(p,b[0],b[1]);return l(function(){x.hasValue=!0,x.value=D},[D]),f(D),D},Cg}var p1;function _N(){return p1||(p1=1,Tg.exports=vN()),Tg.exports}var bN=_N();function cC(e){e()}function SN(){let e=null,t=null;return{clear(){e=null,t=null},notify(){cC(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let i=e;for(;i;)n.push(i),i=i.next;return n},subscribe(n){let i=!0;const o=t={callback:n,next:null,prev:t};return o.prev?o.prev.next=o:e=o,function(){!i||e===null||(i=!1,o.next?o.next.prev=o.prev:t=o.prev,o.prev?o.prev.next=o.next:e=o.next)}}}}var m1={notify(){},get:()=>[]};function xN(e,t){let n,i=m1,o=0,l=!1;function u(D){y();const C=i.subscribe(D);let k=!1;return()=>{k||(k=!0,C(),_())}}function f(){i.notify()}function p(){x.onStateChange&&x.onStateChange()}function h(){return l}function y(){o++,n||(n=e.subscribe(p),i=SN())}function _(){o--,n&&o===0&&(n(),n=void 0,i.clear(),i=m1)}function v(){l||(l=!0,y())}function b(){l&&(l=!1,_())}const x={addNestedSub:u,notifyNestedSubs:f,handleChangeWrapper:p,isSubscribed:h,trySubscribe:v,tryUnsubscribe:b,getListeners:()=>i};return x}var wN=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",EN=wN(),TN=()=>typeof navigator<"u"&&navigator.product==="ReactNative",CN=TN(),RN=()=>EN||CN?E.useLayoutEffect:E.useEffect,AN=RN();function g1(e,t){return e===t?e!==0||t!==0||1/e===1/t:e!==e&&t!==t}function Cc(e,t){if(g1(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;const n=Object.keys(e),i=Object.keys(t);if(n.length!==i.length)return!1;for(let o=0;o<n.length;o++)if(!Object.prototype.hasOwnProperty.call(t,n[o])||!g1(e[n[o]],t[n[o]]))return!1;return!0}var IN=Symbol.for("react-redux-context"),DN=typeof globalThis<"u"?globalThis:{};function kN(){if(!E.createContext)return{};const e=DN[IN]??=new Map;let t=e.get(E.createContext);return t||(t=E.createContext(null),e.set(E.createContext,t)),t}var ps=kN();function ON(e){const{children:t,context:n,serverState:i,store:o}=e,l=E.useMemo(()=>{const p=xN(o);return{store:o,subscription:p,getServerState:i?()=>i:void 0}},[o,i]),u=E.useMemo(()=>o.getState(),[o]);AN(()=>{const{subscription:p}=l;return p.onStateChange=p.notifyNestedSubs,p.trySubscribe(),u!==o.getState()&&p.notifyNestedSubs(),()=>{p.tryUnsubscribe(),p.onStateChange=void 0}},[l,u]);const f=n||ps;return E.createElement(f.Provider,{value:l},t)}var NN=ON;function Mv(e=ps){return function(){return E.useContext(e)}}var uC=Mv();function dC(e=ps){const t=e===ps?uC:Mv(e),n=()=>{const{store:i}=t();return i};return Object.assign(n,{withTypes:()=>n}),n}var fC=dC();function MN(e=ps){const t=e===ps?fC:dC(e),n=()=>t().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var hC=MN(),LN=(e,t)=>e===t;function PN(e=ps){const t=e===ps?uC:Mv(e),n=(i,o={})=>{const{equalityFn:l=LN}=typeof o=="function"?{equalityFn:o}:o,u=t(),{store:f,subscription:p,getServerState:h}=u;E.useRef(!0);const y=E.useCallback({[i.name](v){return i(v)}}[i.name],[i]),_=bN.useSyncExternalStoreWithSelector(p.addNestedSub,f.getState,h||f.getState,y,l);return E.useDebugValue(_),_};return Object.assign(n,{withTypes:()=>n}),n}var pC=PN(),jN=cC;/**
 * react-router v7.9.1
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vi=new s_("@firebase/app"),bj="@firebase/app-compat",Sj="@firebase/analytics-compat",xj="@firebase/analytics",wj="@firebase/app-check-compat",Ej="@firebase/app-check",Tj="@firebase/auth",Cj="@firebase/auth-compat",Rj="@firebase/database",Aj="@firebase/data-connect",Ij="@firebase/database-compat",Dj="@firebase/functions",kj="@firebase/functions-compat",Oj="@firebase/installations",Nj="@firebase/installations-compat",Mj="@firebase/messaging",Lj="@firebase/messaging-compat",Pj="@firebase/performance",jj="@firebase/performance-compat",$j="@firebase/remote-config",Uj="@firebase/remote-config-compat",zj="@firebase/storage",Bj="@firebase/storage-compat",Hj="@firebase/firestore",Fj="@firebase/ai",qj="@firebase/firestore-compat",Vj="firebase",Gj="12.2.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function o4(e){Mr(new _r("platform-logger",t=>new vj(t),"PRIVATE")),Mr(new _r("heartbeat",t=>new n4(t),"PRIVATE")),Zn(Ky,cw,e),Zn(Ky,cw,"esm2020"),Zn("fire-js","")}o4("");const LR="@firebase/installations",l_="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function D4({appConfig:e,heartbeatServiceProvider:t},n){const i=k4(e,n),o=f4(e,n),l=t.getImmediate({optional:!0});if(l){const h=await l.getHeartbeatsHeader();h&&o.append("x-firebase-client",h)}const u={installation:{sdkVersion:jR,appId:e.appId}},f={method:"POST",headers:o,body:JSON.stringify(u)},p=await qR(()=>fetch(i,f));if(p.ok){const h=await p.json();return BR(h)}else throw await HR("Generate Auth Token",p)}function k4(e,{fid:t}){return`${zR(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZR="installations",H4="installations-internal",F4=e=>{const t=e.getProvider("app").getImmediate(),n=B4(t),i=Xa(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},q4=e=>{const t=e.getProvider("app").getImmediate(),n=Xa(t,ZR).getImmediate();return{getId:()=>$4(n),getToken:o=>U4(n,o)}};function V4(){Mr(new _r(ZR,F4,"PUBLIC")),Mr(new _r(H4,q4,"PRIVATE"))}V4();Zn(LR,l_);Zn(LR,l_,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O6(e=a_()){return D6().then(t=>{if(!t)throw an.create("unsupported-browser")},t=>{throw an.create("indexed-db-unsupported")}),Xa(Wt(e),"messaging").getImmediate()}async function N6(e,t){return e=Wt(e),iA(e,t)}function M6(e,t){return e=Wt(e),k6(e,t)}I6();const qh=e=>{try{return e()}catch(t){throw t}};var L6="firebase",P6="12.2.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x_="5",EA="v",TA="s",CA="r",RA="f",AA=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,IA="ls",DA="p",lv="ac",kA="websocket",OA="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z3=Math.log(2);class B3{constructor(t){const n=l=>parseInt(Math.log(l)/z3,10),i=l=>parseInt(Array(l+1).join("1"),2);this.count=n(t+1),this.current_=this.count-1;const o=i(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const th=function(e,t,n,i){e.sort(t);const o=function(p,h){const y=h-p;let _,v;if(y===0)return null;if(y===1)return _=e[p],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,null,null);{const b=parseInt(y/2,10)+p,x=o(p,b),D=o(b+1,h);return _=e[b],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,x,D)}},l=function(p){let h=null,y=null,_=e.length;const v=function(x,D){const C=_-x,k=_;_-=x;const M=o(C+1,k),R=e[C],I=n?n(R):R;b(new Vt(I,R.node,D,null,M))},b=function(x){h?(h.left=x,h=x):(y=x,h=x)};for(let x=0;x<p.count;++x){const D=p.nextBitIsOne(),C=Math.pow(2,p.count-(x+1));D?v(C,Vt.BLACK):(v(C,Vt.BLACK),v(C,Vt.RED))}return y},u=new B3(e.length),f=l(u);return new Sn(i||t,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var fr;(function(e){e[e.OVERWRITE=0]="OVERWRITE",e[e.MERGE=1]="MERGE",e[e.ACK_USER_WRITE=2]="ACK_USER_WRITE",e[e.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(fr||(fr={}));function k_(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function O_(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function N_(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ih{constructor(t,n,i){this.path=t,this.affectedTree=n,this.revert=i,this.type=fr.ACK_USER_WRITE,this.source=k_()}operationForChild(t){if(Ye(this.path)){if(this.affectedTree.value!=null)return he(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ut(t));return new ih(Xe(),n,this.revert)}}else return he(qe(this.path)===t,"operationForChild called for unrelated child."),new ih(pt(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kh(e,t){return{eventCache:e,serverCache:t}}function Pc(e,t,n,i){return Kh(new Ss(t,n,i),e.serverCache)}function XA(e,t,n,i){return Kh(e.eventCache,new Ss(t,n,i))}function sh(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function xo(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mU{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function np(e,t){let n=null;for(let i=0;i<t.length;i++){const o=t[i],l=o.getPath();n!==null&&!C_(l,n.path)&&(e.eventLists_.push(n),n=null),n===null&&(n={events:[],path:l}),n.events.push(o)}n&&e.eventLists_.push(n)}function EI(e,t,n){np(e,n),TI(e,i=>C_(i,t))}function tr(e,t,n){np(e,n),TI(e,i=>Xn(i,t)||Xn(t,i))}function TI(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const o=e.eventLists_[i];if(o){const l=o.path;t(l)?(gU(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function gU(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(n!==null){e.events[t]=null;const i=n.getEventRunner();Mc&&en("event: "+n.toString()),tl(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DU(e){let t="";const n=e.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let o=n[i];try{o=decodeURIComponent(o.replace(/\+/g," "))}catch{}t+="/"+o}return t}function kU(e){const t={};e.charAt(0)==="?"&&(e=e.substring(1));for(const n of e.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?t[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):fn(`Invalid query segment '${n}' in query '${e}'`)}return t}const yE=function(e,t){const n=OU(e),i=n.namespace;n.domain==="firebase.com"&&bi(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&bi("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||H$();const o=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new NA(n.host,n.secure,i,o,t,"",i!==n.subdomain),path:new ut(n.pathString)}},OU=function(e){let t="",n="",i="",o="",l="",u=!0,f="https",p=443;if(typeof e=="string"){let h=e.indexOf("//");h>=0&&(f=e.substring(0,h-1),e=e.substring(h+2));let y=e.indexOf("/");y===-1&&(y=e.length);let _=e.indexOf("?");_===-1&&(_=e.length),t=e.substring(0,Math.min(y,_)),y<_&&(o=DU(e.substring(y,_)));const v=kU(e.substring(Math.min(e.length,_)));h=t.indexOf(":"),h>=0?(u=f==="https"||f==="wss",p=parseInt(t.substring(h+1),10)):h=t.length;const b=t.slice(0,h);if(b.toLowerCase()==="localhost")n="localhost";else if(b.split(".").length<=2)n=b;else{const x=t.indexOf(".");i=t.substring(0,x).toLowerCase(),n=t.substring(x+1),l=i}"ns"in v&&(l=v.ns)}return{host:t,port:p,domain:n,subdomain:i,secure:u,scheme:f,pathString:o,namespace:l}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fh=new s_("@firebase/auth");function oz(e,...t){fh.logLevel<=ct.WARN&&fh.warn(`Auth (${Za}): ${e}`,...t)}function Af(e,...t){fh.logLevel<=ct.ERROR&&fh.error(`Auth (${Za}): ${e}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nr(e,...t){throw ob(e,...t)}function vr(e,...t){return ob(e,...t)}function sb(e,t,n){const i={...$I(),[t]:n};return new Ro("auth","Firebase",i).create(t,{appName:e.name})}function yi(e){return sb(e,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function az(e,t,n){const i=n;if(!(t instanceof i))throw i.name!==t.constructor.name&&nr(e,"argument-error"),sb(e,"argument-error",`Type of ${t.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function ob(e,...t){if(typeof e!="string"){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return UI.create(e,...t)}function Oe(e,t,...n){if(!e)throw ob(t,...n)}function hi(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Af(t),new Error(t)}function Si(e,t){e||hi(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bv(){return typeof self<"u"&&self.location?.href||""}function lz(){return OE()==="http:"||OE()==="https:"}function OE(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function _z(e,t=!1){const n=Wt(e),i=await n.getIdToken(t),o=lb(i);Oe(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const l=typeof o.firebase=="object"?o.firebase:void 0,u=l?.sign_in_provider;return{claims:o,token:i,authTime:Uc(hy(o.auth_time)),issuedAtTime:Uc(hy(o.iat)),expirationTime:Uc(hy(o.exp)),signInProvider:u||null,signInSecondFactor:l?.sign_in_second_factor||null}}function hy(e){return Number(e)*1e3}function lb(e){const[t,n,i]=e.split(".");if(t===void 0||n===void 0||i===void 0)return Af("JWT malformed, contained fewer than 3 sections"),null;try{const o=qf(n);return o?JSON.parse(o):(Af("Failed to decode base64 JWT payload"),null)}catch(o){return Af("Caught error parsing JWT payload as JSON",o?.toString()),null}}function ME(e){const t=lb(e);return Oe(t,"internal-error"),Oe(typeof t.exp<"u","internal-error"),Oe(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ph(e){const t=e.auth,n=await e.getIdToken(),i=await cu(e,hh(t,{idToken:n}));Oe(i?.users.length,t,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const l=o.providerUserInfo?.length?FI(o.providerUserInfo):[],u=wz(e.providerData,l),f=e.isAnonymous,p=!(e.email&&o.passwordHash)&&!u?.length,h=f?p:!1,y={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:u,metadata:new Sv(o.createdAt,o.lastLoginAt),isAnonymous:h};Object.assign(e,y)}async function xz(e){const t=Wt(e);await ph(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function wz(e,t){return[...e.filter(i=>!t.some(o=>o.providerId===i.providerId)),...t]}function FI(e){return e.map(({providerId:t,...n})=>({providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aa{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){Oe(t.idToken,"internal-error"),Oe(typeof t.idToken<"u","internal-error"),Oe(typeof t.refreshToken<"u","internal-error");const n="expiresIn"in t&&typeof t.expiresIn<"u"?Number(t.expiresIn):ME(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,n)}updateFromIdToken(t){Oe(t.length!==0,"internal-error");const n=ME(t);this.updateTokensAndExpiration(t,null,n)}async getToken(t,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(Oe(this.refreshToken,t,"user-token-expired"),this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(t,n){const{accessToken:i,refreshToken:o,expiresIn:l}=await Ez(t,n);this.updateTokensAndExpiration(i,o,Number(l))}updateTokensAndExpiration(t,n,i){this.refreshToken=n||null,this.accessToken=t||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(t,n){const{refreshToken:i,accessToken:o,expirationTime:l}=n,u=new Aa;return i&&(Oe(typeof i=="string","internal-error",{appName:t}),u.refreshToken=i),o&&(Oe(typeof o=="string","internal-error",{appName:t}),u.accessToken=o),l&&(Oe(typeof l=="number","internal-error",{appName:t}),u.expirationTime=l),u}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Aa,this.toJSON())}_performRefresh(){return hi("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,n=!1){const{auth:i}=e;if(Nn(i.app))return Promise.reject(yi(i));const o="reauthenticate";try{const l=await cu(e,iD(i,o,t,e),n);Oe(l.idToken,i,"internal-error");const u=lb(l.idToken);Oe(u,i,"internal-error");const{sub:f}=u;return Oe(e.uid===f,i,"user-mismatch"),Eo._forOperation(e,o,l)}catch(l){throw l?.code==="auth/user-not-found"&&nr(i,"user-mismatch"),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Or(){return window}function f8(e){Or().location.href=e}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dD(){return typeof Or().WorkerGlobalScope<"u"&&typeof Or().importScripts=="function"}async function h8(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function p8(){return navigator?.serviceWorker?.controller||null}function m8(){return dD()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mD(e,t){return t?pi(t):(Oe(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gD{constructor(t,n,i,o,l=!1){this.auth=t,this.resolver=i,this.user=o,this.bypassAuthState=l,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(t,n)=>{this.pendingPromise={resolve:t,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(t){const{urlResponse:n,sessionId:i,postBody:o,tenantId:l,error:u,type:f}=t;if(u){this.reject(u);return}const p={auth:this.auth,requestUri:n,sessionId:i,tenantId:l||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(f)(p))}catch(h){this.reject(h)}}onError(t){this.reject(t)}getIdpTask(t){switch(t){case"signInViaPopup":case"signInViaRedirect":return x8;case"linkViaPopup":case"linkViaRedirect":return E8;case"reauthViaPopup":case"reauthViaRedirect":return w8;default:nr(this.auth,"internal-error")}}resolve(t){Si(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(t),this.unregisterAndCleanUp()}reject(t){Si(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(t),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H8=new Au(3e4,6e4);function VE(){const e=Or().___jsl;if(e?.H){for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}}function F8(e){return new Promise((t,n)=>{function i(){VE(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{VE(),n(vr(e,"network-request-failed"))},timeout:H8.get()})}if(Or().gapi?.iframes?.Iframe)t(gapi.iframes.getContext());else if(Or().gapi?.load)i();else{const o=Pz("iframefcb");return Or()[o]=()=>{gapi.load?i():n(vr(e,"network-request-failed"))},eD(`${Lz()}?onload=${o}`).catch(l=>n(l))}}).catch(t=>{throw kf=null,t})}let kf=null;function q8(e){return kf=kf||F8(e),kf}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V8=new Au(5e3,15e3),G8="__/auth/iframe",W8="emulator/auth/iframe",Y8={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Q8=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function K8(e){const t=e.config;Oe(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?ab(t,W8):`https://${e.config.authDomain}/${G8}`,i={apiKey:t.apiKey,appName:e.name,v:Za},o=Q8.get(e.config.apiHost);o&&(i.eid=o);const l=e._getFrameworks();return l.length&&(i.fw=l.join(",")),`${n}?${Ka(i).slice(1)}`}async function X8(e){const t=await q8(e),n=Or().gapi;return Oe(n,e,"internal-error"),t.open({where:document.body,url:K8(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Y8,dontclear:!0},i=>new Promise(async(o,l)=>{await i.restyle({setHideOnLeave:!1});const u=vr(e,"network-request-failed"),f=Or().setTimeout(()=>{l(u)},V8.get());function p(){Or().clearTimeout(f),o(i)}i.ping(p).then(p,()=>{l(u)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fB(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function hB(e){Mr(new _r("auth",(t,{options:n})=>{const i=t.getProvider("app").getImmediate(),o=t.getProvider("heartbeat"),l=t.getProvider("app-check-internal"),{apiKey:u,authDomain:f}=i.options;Oe(u&&!u.includes(":"),"invalid-api-key",{appName:i.name});const p={apiKey:u,authDomain:f,clientPlatform:e,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:JI(e)},h=new Oz(i,o,l,p);return Bz(h,n),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,n,i)=>{t.getProvider("auth-internal").initialize()})),Mr(new _r("auth-internal",t=>{const n=Rs(t.getProvider("auth").getImmediate());return(i=>new dB(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Zn(YE,QE,fB(e)),Zn(YE,QE,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,LB=T.div`
  ...
  flex-shrink: 0;
`,PB=()=>g.jsx("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none","aria-hidden":"true",children:g.jsx("path",{d:"M4 4l10 10M14 4L4 14",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})}),jB=({open:e,onClose:t})=>{const n=et(ib);return g.jsxs(g.Fragment,{children:[g.jsx(AB,{$open:e,onClick:t}),g.jsxs(IB,{$open:e,onClick:i=>i.stopPropagation(),role:"dialog","aria-modal":"true","aria-label":"Navigation menu",children:[g.jsxs(DB,{children:[g.jsxs(kB,{to:nt.CLASS_LIST,onClick:t,children:[g.jsx(PI,{size:20}),g.jsx(OB,{children:"Peloton Alerts"})]}),g.jsx(NB,{onClick:t,"aria-label":"Close menu",children:g.jsx(PB,{})})]}),g.jsxs(MB,{onClick:t,children:[g.jsx(of,{to:nt.CLASS_LIST,end:!0,children:"Classes"}),g.jsx(of,{to:nt.ALERTS,children:"Alerts"}),g.jsx(of,{to:nt.ABOUT,end:!0,children:"FAQ"}),n&&g.jsx(of,{to:nt.STATS,children:"Stats"})]}),g.jsx(LB,{children:g.jsx(TB,{})})]})]})},$B=T.div`
  position: absolute;
...
`,OH=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  opacity: 0.6;
`,NH=({label:e,dayIndex:t,snapshots:n,alert:i,timezone:o})=>{const l=!!i.timeRanges[t],u=[],f=[],p=[];for(const h of n){const y=Ce.classifySnapshotMatch(h,i);y.type==="match"?u.push(h):y.type==="near-miss"?f.push({snapshot:h,reason:y.reason}):p.push(h)}return g.jsxs(DH,{children:[g.jsxs(kH,{children:[e,!l&&g.jsx(OH,{children:"not monitored"})]}),u.map((h,y)=>g.jsx(vH,{snapshot:h,timezone:o},y)),f.map(({snapshot:h,reason:y},_)=>g.jsx(EH,{snapshot:h,reason:y,timezone:o},_)),p.length>0&&g.jsx(IH,{snapshots:p,timezone:o})]})},MH=T.div`
  display: flex;
  gap: 16px;
  padding: 12px 0;
  border-bottom: 1px solid ${e=>e.theme.borderColor};
...
`,lf=T.p`
  ...
  text-align: center;
  padding: 32px 0;
`,qH=()=>{const{alertId:e}=QM(),t=ws(),n=E.useContext(mb),[i,o]=E.useState("idle"),l=E.useMemo(()=>n.state!=="fulfilled"?null:n.data.find(C=>C.id===e)??null,[n,e]),u=uH(l?.studioId??null),f=l?Ce.STUDIOS[l.studioId]?.timezone??"UTC":"UTC",p=E.useMemo(()=>!l||u.state!=="fulfilled"?[]:fH(u.data,f),[l,u,f]),{matchCount:h,nearMissCount:y}=E.useMemo(()=>{if(!l||u.state!=="fulfilled")return{matchCount:0,nearMissCount:0};let C=0,k=0;for(const M of u.data){const R=Ce.classifySnapshotMatch(M,l);R.type==="match"?C++:R.type==="near-miss"&&k++}return{matchCount:C,nearMissCount:k}},[l,u]),_=n.state==="loading"||n.state==="idle"||u.state==="loading",v="Notification"in window&&"serviceWorker"in navigator,b=E.useCallback(async()=>{if(v){o("sending");try{if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){o("idle");return}const C=await navigator.serviceWorker.ready,k=l?Ce.STUDIOS[l.studioId]:null,M="Spot opened up!",R=`${l?.name??"Test alert"} — ${k?.location??"Studio"} · test notification`;await C.showNotification(M,{body:R,icon:"/icons/icon-192x192.png",badge:"/icons/icon-96x96.png",data:{classUrl:"/p/7248695-peloton-studios-new-york/e/99586855-30-min-intervals-ride/"}}),o("sent"),setTimeout(()=>o("idle"),3e3)}catch{o("error"),setTimeout(()=>o("idle"),3e3)}}},[l,v]),x=l?.name??"Alert",D=i==="sending"?"Sending…":i==="sent"?"Sent!":i==="error"?"Error":"Send test notification";return g.jsxs(PH,{children:[g.jsxs(jH,{children:[g.jsx(zH,{type:"button",onClick:()=>t(-1),children:"← Alerts"}),g.jsxs($H,{children:[g.jsx("div",{children:g.jsxs(BH,{children:[x," — Past 7 Days"]})}),v&&g.jsx(UH,{type:"button",$sent:i==="sent",disabled:i==="sending",onClick:b,title:"Fire a test push notification to verify delivery and the notification URL",children:D})]}),g.jsx(HH,{children:l?`${Ce.STUDIOS[l.studioId]?.location??l.studioId}`:""})]}),g.jsxs(FH,{children:[_&&g.jsx(lf,{children:"Loading…"}),!_&&!l&&g.jsx(lf,{children:"Alert not found."}),!_&&l&&u.state==="fulfilled"&&g.jsxs(g.Fragment,{children:[g.jsx(LH,{matchCount:h,nearMissCount:y}),p.length===0&&g.jsx(lf,{children:"No class history yet. History builds up as the backend detects class changes."}),p.map(({label:C,dayIndex:k,snapshots:M})=>g.jsx(NH,{label:C,dayIndex:k,snapshots:M,alert:l,timezone:f},C))]}),!_&&u.state==="failed"&&g.jsx(lf,{children:"Failed to load class history."})]})]})},VH=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");const i=(await PU(Mn(n,Ce.PATHS.alerts(e)),t)).key;if(!i)throw new Error("Missing ID from insertion operation");return{...t,id:i}},SD=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");const i={...t,name:t.name??null,watchedClassIds:t.watchedClassIds??null,disabled:t.disabled??null};await NI(Mn(n,Ce.PATHS.alert(e,t.id)),i)},GH=T.div`
  display: flex;
  flex-direction: column;
`,WH=T.label`
  color: ${e=>e.theme.colors.main};
...
`,QH=T.span`
  ...
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,KH=({label:e,hint:t,placeholder:n,value:i,onChange:o})=>{const l=E.useId();return g.jsxs(GH,{children:[g.jsx(WH,{htmlFor:l,children:e}),g.jsx(YH,{id:l,placeholder:n,value:i,"aria-describedby":t?`${l}-hint`:void 0,onChange:({target:u})=>o(u.value)}),t&&g.jsx(QH,{id:`${l}-hint`,children:t})]})},XH=T.label`
  ${$r}
  ${up}
  display: flex;
  align-items: center;
...
`,vh=({name:e,value:t,checked:n,onChange:i,label:o,hint:l,icon:u})=>{const f=E.useId();return g.jsxs(XH,{htmlFor:f,children:[g.jsx(t9,{type:"radio",id:f,name:e,value:t,checked:n,onChange:i}),u,g.jsxs(ZH,{children:[g.jsx(JH,{children:o}),l&&g.jsx(e9,{children:l})]})]})},JE=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,eT=T.legend`
...
`,rT=T.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,n9=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),r9=[{status:"free",label:"Open spots only",hint:"Alert me when a class has available spots"},{status:"waitlist",label:"Open spots or waitlist",hint:"Alert me even if I'd join the waitlist"}],i9=({name:e,onNameChange:t,studioId:n,onStudioChange:i,maxStatus:o,onStatusChange:l})=>g.jsxs("div",{children:[g.jsx(KH,{label:"Alert name (optional)",hint:"Leave blank to auto-generate a name from your filters",placeholder:"e.g. Morning Cycling with Cody",value:e,onChange:t}),g.jsx(rT,{}),g.jsxs(JE,{children:[g.jsx(eT,{children:"Which studio?"}),g.jsx(tT,{children:"Pick the Peloton studio you want to monitor."}),g.jsx(nT,{children:n9.map(u=>g.jsx(vh,{name:"studio",value:u.id,checked:n===u.id,onChange:()=>i(u.id),label:u.label},u.id))})]}),g.jsx(rT,{}),g.jsxs(JE,{children:[g.jsx(eT,{children:"When should we alert you?"}),g.jsx(tT,{children:"Choose whether to include waitlisted classes."}),g.jsx(nT,{children:r9.map(u=>g.jsx(vh,{name:"status",value:u.status,checked:o===u.status,onChange:()=>l(u.status),label:u.label,hint:u.hint},u.status))})]})]}),iT={Cardio:"#d8ec43",Cycling:"#bbd4f4",Meditation:"#e6d4ff",Rowing:"#cbf293","Outdoor Run":"#a8e6cf","Outdoor Run/Walk":"#94f3d0",Running:"#fde987",Strength:"#ffc0d5",Tread:"#fdbe9f",Walking:"#ffa8a9",Yoga:"#ceffdc"},xD=.2,_h=e=>Math.round(e*(1-xD*2)),s9=e=>Math.round(e*xD),o9=T.div`
  width: ${e=>_h(e.size)}px;
  height: ${e=>_h(e.size)}px;
  border-radius: ${e=>e.size}px;
  background-color: ${e=>e.color};
  padding: ${e=>s9(e.size)}px;
  flex-shrink: 0;
`,a9=T.img`
  width: ${e=>_h(e.size)}px;
  height: ${e=>_h(e.size)}px;
  display: block;
`,bh=({discipline:e,size:t=32})=>{const n=Kv(),i=E.useMemo(()=>{const o=Object.keys(iT),l=e.name.toLowerCase(),u=o.find(f=>f.toLowerCase()===l)??o.find(f=>{const p=f.toLowerCase();return p.includes(l)||l.includes(p)});if(u)return iT[u];{const f=`Received unsupported discipline ${e.name}`;return console.log(f),t_(f),n.colors.secondarySurface}},[e.name,n.colors.secondarySurface]);return g.jsx(o9,{color:i,size:t,children:g.jsx(a9,{alt:e.name,src:e.iconUrl,size:t,color:i})})},l9=T.img`
  width: ${e=>e.size}px;
  ...
  border-radius: 50%;
  color: ${e=>e.theme.colors.secondary};
`,gb=({instructor:e,size:t=32})=>g.jsx(l9,{src:e.imageUrl,alt:`Profile of ${e.name}`,size:t});var c9=class extends Error{issues;constructor(e){super(e[0].message),this.name="SchemaError",this.issues=e}},wD=(e=>(e.uninitialized="uninitialized",e.pending="pending",e.fulfilled="fulfilled",e.rejected="rejected",e))(wD||{});function sT(e){return{status:e,isUninitialized:e==="uninitialized",isLoading:e==="pending",isSuccess:e==="fulfilled",isError:e==="rejected"}}var oT=vs;function yb(e,t){if(e===t||!(oT(e)&&oT(t)||Array.isArray(e)&&Array.isArray(t)))return t;const n=Object.keys(t),i=Object.keys(e);let o=n.length===i.length;const l=Array.isArray(t)?[]:{};for(const u of n)l[u]=yb(e[u],t[u]),o&&(o=e[u]===l[u]);return o?e:l}function my(e){let t=0;for(const n in e)t++;return t}var aT=e=>[].concat(...e);function u9(e){return new RegExp("(^|:)//").test(e)}function d9(){return typeof document>"u"?!0:document.visibilityState!=="hidden"}function Sh(e){return e!=null}function f9(){return typeof navigator>"u"||navigator.onLine===void 0?!0:navigator.onLine}var h9=e=>e.replace(/\/$/,""),p9=e=>e.replace(/^\//,"");function m9(e,t){if(!e)return t;if(!t)return e;if(u9(t))return t;const n=e.endsWith("/")||!t.startsWith("?")?"/":"";return e=h9(e),t=p9(t),`${e}${n}${t}`}function g9(e,t,n){return e.has(t)?e.get(t):e.set(t,n).get(t)}function Ev(e,t,n){return e.has(t)?e.get(t):e.set(t,n(t)).get(t)}var Tv=()=>new Map,lT=(...e)=>fetch(...e),y9=e=>e.status>=200&&e.status<=299,v9=e=>/ion\/(vnd\.api\+)?json/.test(e.get("content-type")||"");function cT(e){if(!vs(e))return e;const t={...e};for(const[n,i]of Object.entries(t))i===void 0&&delete t[n];return t}function _9({baseUrl:e,prepareHeaders:t=_=>_,fetchFn:n=lT,paramsSerializer:i,isJsonContentType:o=v9,jsonContentType:l="application/json",jsonReplacer:u,timeout:f,responseHandler:p,validateStatus:h,...y}={}){return typeof fetch>"u"&&n===lT&&console.warn("Warning: `fetch` is not available. Please supply a custom `fetchFn` property to use `fetchBaseQuery` on SSR environments."),async(v,b,x)=>{const{getState:D,extra:C,endpoint:k,forced:M,type:R}=b;let I,{url:N,headers:A=new Headers(y.headers),params:P=void 0,responseHandler:U=p??"json",validateStatus:F=h??y9,timeout:H=f,...z}=typeof v=="string"?{url:v}:v,G,V=b.signal;H&&(G=new AbortController,b.signal.addEventListener("abort",G.abort),V=G.signal);let te={...y,signal:V,...z};A=new Headers(cT(A)),te.headers=await t(A,{getState:D,arg:v,extra:C,endpoint:k,forced:M,type:R,extraOptions:x})||A;const ue=de=>typeof de=="object"&&(vs(de)||Array.isArray(de)||typeof de.toJSON=="function");if(!te.headers.has("content-type")&&ue(te.body)&&te.headers.set("content-type",l),ue(te.body)&&o(te.headers)&&(te.body=JSON.stringify(te.body,u)),P){const de=~N.indexOf("?")?"&":"?",me=i?i(P):new URLSearchParams(cT(P));N+=de+me}N=m9(e,N);const j=new Request(N,te);I={request:new Request(N,te)};let ne,ae=!1,O=G&&setTimeout(()=>{ae=!0,G.abort()},H);try{ne=await n(j)}catch(de){return{error:{status:ae?"TIMEOUT_ERROR":"FETCH_ERROR",error:String(de)},meta:I}}finally{O&&clearTimeout(O),G?.signal.removeEventListener("abort",G.abort)}const K=ne.clone();I.response=K;let le,ie="";try{let de;if(await Promise.all([_(ne,U).then(me=>le=me,me=>de=me),K.text().then(me=>ie=me,()=>{})]),de)throw de}catch(de){return{error:{status:"PARSING_ERROR",originalStatus:ne.status,data:ie,error:String(de)},meta:I}}return F(ne,le)?{data:le,meta:I}:{error:{status:ne.status,data:le},meta:I}};async function _(v,b){if(typeof b=="function")return b(v);if(b==="content-type"&&(b=o(v.headers)?"json":"text"),b==="json"){const x=await v.text();return x.length?JSON.parse(x):null}return v.text()}}var uT=class{constructor(e,t=void 0){this.value=e,this.meta=t}},vb=mr("__rtkq/focused"),ED=mr("__rtkq/unfocused"),_b=mr("__rtkq/online"),TD=mr("__rtkq/offline");function dp(e){return e.type==="query"}function b9(e){return e.type==="mutation"}function fp(e){return e.type==="infinitequery"}function xh(e){return dp(e)||fp(e)}function bb(e,t,n,i,o,l){return S9(e)?e(t,n,i,o).filter(Sh).map(Cv).map(l):Array.isArray(e)?e.map(Cv).map(l):[]}function S9(e){return typeof e=="function"}function Cv(e){return typeof e=="string"?{type:e}:e}function x9(e,t){return e.catch(t)}var du=Symbol("forceQueryFn"),Rv=e=>typeof e[du]=="function";function w9({serializeQueryArgs:e,queryThunk:t,infiniteQueryThunk:n,mutationThunk:i,api:o,context:l,internalState:u}){const{runningQueries:f,runningMutations:p}=u,{unsubscribeQueryResult:h,removeMutationResult:y,updateSubscriptionOptions:_}=o.internalActions;return{buildInitiateQuery:k,buildInitiateInfiniteQuery:M,buildInitiateMutation:R,getRunningQueryThunk:v,getRunningMutationThunk:b,getRunningQueriesThunk:x,getRunningMutationsThunk:D};function v(I,N){return A=>{const P=l.endpointDefinitions[I],U=e({queryArgs:N,endpointDefinition:P,endpointName:I});return f.get(A)?.[U]}}function b(I,N){return A=>p.get(A)?.[N]}function x(){return I=>Object.values(f.get(I)||{}).filter(Sh)}function D(){return I=>Object.values(p.get(I)||{}).filter(Sh)}function C(I,N){const A=(P,{subscribe:U=!0,forceRefetch:F,subscriptionOptions:H,[du]:z,...G}={})=>(V,te)=>{const ue=e({queryArgs:P,endpointDefinition:N,endpointName:I});let j;const X={...G,type:"query",subscribe:U,forceRefetch:F,subscriptionOptions:H,endpointName:I,originalArgs:P,queryCacheKey:ue,[du]:z};if(dp(N))j=t(X);else{const{direction:Ie,initialPageParam:be}=G;j=n({...X,direction:Ie,initialPageParam:be})}const ne=o.endpoints[I].select(P),ae=V(j),O=ne(te()),{requestId:K,abort:le}=ae,ie=O.requestId!==K,de=f.get(V)?.[ue],me=()=>ne(te()),pe=Object.assign(z?ae.then(me):ie&&!de?Promise.resolve(O):Promise.all([de,ae]).then(me),{arg:P,requestId:K,subscriptionOptions:H,queryCacheKey:ue,abort:le,async unwrap(){const Ie=await pe;if(Ie.isError)throw Ie.error;return Ie.data},refetch:()=>V(A(P,{subscribe:!1,forceRefetch:!0})),unsubscribe(){U&&V(h({queryCacheKey:ue,requestId:K}))},updateSubscriptionOptions(Ie){pe.subscriptionOptions=Ie,V(_({endpointName:I,requestId:K,queryCacheKey:ue,options:Ie}))}});if(!de&&!ie&&!z){const Ie=g9(f,V,{});Ie[ue]=pe,pe.then(()=>{delete Ie[ue],my(Ie)||f.delete(V)})}return pe};return A}function k(I,N){return C(I,N)}function M(I,N){return C(I,N)}function R(I){return(N,{track:A=!0,fixedCacheKey:P}={})=>(U,F)=>{const H=i({type:"mutation",endpointName:I,originalArgs:N,track:A,fixedCacheKey:P}),z=U(H),{requestId:G,abort:V,unwrap:te}=z,ue=x9(z.unwrap().then(ae=>({data:ae})),ae=>({error:ae})),j=()=>{U(y({requestId:G,fixedCacheKey:P}))},X=Object.assign(ue,{arg:z.arg,requestId:G,abort:V,unwrap:te,reset:j}),ne=p.get(U)||{};return p.set(U,ne),ne[G]=X,X.then(()=>{delete ne[G],my(ne)||p.delete(U)}),P&&(ne[P]=X,X.then(()=>{ne[P]===X&&(delete ne[P],my(ne)||p.delete(U))})),X}}}var CD=class extends c9{constructor(e,t,n,i){super(e),this.value=t,this.schemaName=n,this._bqMeta=i}},to=(e,t)=>Array.isArray(e)?e.includes(t):!!e;async function no(e,t,n,i){const o=await e["~standard"].validate(t);if(o.issues)throw new CD(o.issues,t,n,i);return o.value}function dT(e){return e}var gc=(e={})=>({...e,[Gh]:!0});function E9({reducerPath:e,baseQuery:t,context:{endpointDefinitions:n},serializeQueryArgs:i,api:o,assertTagType:l,selectors:u,onSchemaFailure:f,catchSchemaFailure:p,skipSchemaValidation:h}){const y=(z,G,V,te)=>(ue,j)=>{const X=n[z],ne=i({queryArgs:G,endpointDefinition:X,endpointName:z});if(ue(o.internalActions.queryResultPatched({queryCacheKey:ne,patches:V})),!te)return;const ae=o.endpoints[z].select(G)(j()),O=bb(X.providesTags,ae.data,void 0,G,{},l);ue(o.internalActions.updateProvidedBy([{queryCacheKey:ne,providedTags:O}]))};function _(z,G,V=0){const te=[G,...z];return V&&te.length>V?te.slice(0,-1):te}function v(z,G,V=0){const te=[...z,G];return V&&te.length>V?te.slice(1):te}const b=(z,G,V,te=!0)=>(ue,j)=>{const ne=o.endpoints[z].select(G)(j()),ae={patches:[],inversePatches:[],undo:()=>ue(o.util.patchQueryData(z,G,ae.inversePatches,te))};if(ne.status==="uninitialized")return ae;let O;if("data"in ne)if(br(ne.data)){const[K,le,ie]=pA(ne.data,V);ae.patches.push(...le),ae.inversePatches.push(...ie),O=K}else O=V(ne.data),ae.patches.push({op:"replace",path:[],value:O}),ae.inversePatches.push({op:"replace",path:[],value:ne.data});return ae.patches.length===0||ue(o.util.patchQueryData(z,G,ae.patches,te)),ae},x=(z,G,V)=>te=>te(o.endpoints[z].initiate(G,{subscribe:!1,forceRefetch:!0,[du]:()=>({data:V})})),D=(z,G)=>z.query&&z[G]?z[G]:dT,C=async(z,{signal:G,abort:V,rejectWithValue:te,fulfillWithValue:ue,dispatch:j,getState:X,extra:ne})=>{const ae=n[z.endpointName],{metaSchema:O,skipSchemaValidation:K=h}=ae;try{let le=dT;const ie={signal:G,abort:V,dispatch:j,getState:X,extra:ne,endpoint:z.endpointName,type:z.type,forced:z.type==="query"?k(z,X()):void 0,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0},de=z.type==="query"?z[du]:void 0;let me;const pe=async(be,ke,Ue,_t)=>{if(ke==null&&be.pages.length)return Promise.resolve({data:be});const gt={queryArg:z.originalArgs,pageParam:ke},Ln=await Ie(gt),Et=_t?_:v;return{data:{pages:Et(be.pages,Ln.data,Ue),pageParams:Et(be.pageParams,ke,Ue)},meta:Ln.meta}};async function Ie(be){let ke;const{extraOptions:Ue,argSchema:_t,rawResponseSchema:gt,responseSchema:Ln}=ae;if(_t&&!to(K,"arg")&&(be=await no(_t,be,"argSchema",{})),de?ke=de():ae.query?(le=D(ae,"transformResponse"),ke=await t(ae.query(be),ie,Ue)):ke=await ae.queryFn(be,ie,Ue,Ur=>t(Ur,ie,Ue)),typeof process<"u",ke.error)throw new uT(ke.error,ke.meta);let{data:Et}=ke;gt&&!to(K,"rawResponse")&&(Et=await no(gt,ke.data,"rawResponseSchema",ke.meta));let Pn=await le(Et,ke.meta,be);return Ln&&!to(K,"response")&&(Pn=await no(Ln,Pn,"responseSchema",ke.meta)),{...ke,data:Pn}}if(z.type==="query"&&"infiniteQueryOptions"in ae){const{infiniteQueryOptions:be}=ae,{maxPages:ke=1/0}=be;let Ue;const _t={pages:[],pageParams:[]},gt=u.selectQueryEntry(X(),z.queryCacheKey)?.data,Et=k(z,X())&&!z.direction||!gt?_t:gt;if("direction"in z&&z.direction&&Et.pages.length){const Pn=z.direction==="backward",Yt=(Pn?RD:Av)(be,Et,z.originalArgs);Ue=await pe(Et,Yt,ke,Pn)}else{const{initialPageParam:Pn=be.initialPageParam}=z,Ur=gt?.pageParams??[],Yt=Ur[0]??Pn,sl=Ur.length;Ue=await pe(Et,Yt,ke),de&&(Ue={data:Ue.data.pages[0]});for(let As=1;As<sl;As++){const ko=Av(be,Ue.data,z.originalArgs);Ue=await pe(Ue.data,ko,ke)}}me=Ue}else me=await Ie(z.originalArgs);return O&&!to(K,"meta")&&me.meta&&(me.meta=await no(O,me.meta,"metaSchema",me.meta)),ue(me.data,gc({fulfilledTimeStamp:Date.now(),baseQueryMeta:me.meta}))}catch(le){let ie=le;if(ie instanceof uT){let de=D(ae,"transformErrorResponse");const{rawErrorResponseSchema:me,errorResponseSchema:pe}=ae;let{value:Ie,meta:be}=ie;try{me&&!to(K,"rawErrorResponse")&&(Ie=await no(me,Ie,"rawErrorResponseSchema",be)),O&&!to(K,"meta")&&(be=await no(O,be,"metaSchema",be));let ke=await de(Ie,be,z.originalArgs);return pe&&!to(K,"errorResponse")&&(ke=await no(pe,ke,"errorResponseSchema",be)),te(ke,gc({baseQueryMeta:be}))}catch(ke){ie=ke}}try{if(ie instanceof CD){const de={endpoint:z.endpointName,arg:z.originalArgs,type:z.type,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0};ae.onSchemaFailure?.(ie,de),f?.(ie,de);const{catchSchemaFailure:me=p}=ae;if(me)return te(me(ie,de),gc({baseQueryMeta:ie._bqMeta}))}}catch(de){ie=de}throw console.error(ie),ie}};function k(z,G){const V=u.selectQueryEntry(G,z.queryCacheKey),te=u.selectConfig(G).refetchOnMountOrArgChange,ue=V?.fulfilledTimeStamp,j=z.forceRefetch??(z.subscribe&&te);return j?j===!0||(Number(new Date)-Number(ue))/1e3>=j:!1}const M=()=>jw(`${e}/executeQuery`,C,{getPendingMeta({arg:G}){const V=n[G.endpointName];return gc({startedTimeStamp:Date.now(),...fp(V)?{direction:G.direction}:{}})},condition(G,{getState:V}){const te=V(),ue=u.selectQueryEntry(te,G.queryCacheKey),j=ue?.fulfilledTimeStamp,X=G.originalArgs,ne=ue?.originalArgs,ae=n[G.endpointName],O=G.direction;return Rv(G)?!0:ue?.status==="pending"?!1:k(G,te)||dp(ae)&&ae?.forceRefetch?.({currentArg:X,previousArg:ne,endpointState:ue,state:te})?!0:!(j&&!O)},dispatchConditionRejection:!0}),R=M(),I=M(),N=jw(`${e}/executeMutation`,C,{getPendingMeta(){return gc({startedTimeStamp:Date.now()})}}),A=z=>"force"in z,P=z=>"ifOlderThan"in z,U=(z,G,V)=>(te,ue)=>{const j=A(V)&&V.force,X=P(V)&&V.ifOlderThan,ne=(O=!0)=>{const K={forceRefetch:O,isPrefetch:!0};return o.endpoints[z].initiate(G,K)},ae=o.endpoints[z].select(G)(ue());if(j)te(ne());else if(X){const O=ae?.fulfilledTimeStamp;if(!O){te(ne());return}(Number(new Date)-Number(new Date(O)))/1e3>=X&&te(ne())}else te(ne(!1))};function F(z){return G=>G?.meta?.arg?.endpointName===z}function H(z,G){return{matchPending:Nc(v_(z),F(G)),matchFulfilled:Nc(_s(z),F(G)),matchRejected:Nc(Ua(z),F(G))}}return{queryThunk:R,mutationThunk:N,infiniteQueryThunk:I,prefetch:U,updateQueryData:b,upsertQueryData:x,patchQueryData:y,buildMatchThunkActions:H}}function Av(e,{pages:t,pageParams:n},i){const o=t.length-1;return e.getNextPageParam(t[o],t,n[o],n,i)}function RD(e,{pages:t,pageParams:n},i){return e.getPreviousPageParam?.(t[0],t,n[0],n,i)}function AD(e,t,n,i){return bb(n[e.meta.arg.endpointName][t],_s(e)?e.payload:void 0,Yh(e)?e.payload:void 0,e.meta.arg.originalArgs,"baseQueryMeta"in e.meta?e.meta.baseQueryMeta:void 0,i)}function cf(e,t,n){const i=e[t];i&&n(i)}function fu(e){return("arg"in e?e.arg.fixedCacheKey:e.fixedCacheKey)??e.requestId}function fT(e,t,n){const i=e[fu(t)];i&&n(i)}var uf={};function T9({reducerPath:e,queryThunk:t,mutationThunk:n,serializeQueryArgs:i,context:{endpointDefinitions:o,apiUid:l,extractRehydrationInfo:u,hasRehydrationInfo:f},assertTagType:p,config:h}){const y=mr(`${e}/resetApiState`);function _(F,H,z,G){F[H.queryCacheKey]??={status:"uninitialized",endpointName:H.endpointName},cf(F,H.queryCacheKey,V=>{V.status="pending",V.requestId=z&&V.requestId?V.requestId:G.requestId,H.originalArgs!==void 0&&(V.originalArgs=H.originalArgs),V.startedTimeStamp=G.startedTimeStamp;const te=o[G.arg.endpointName];fp(te)&&"direction"in H&&(V.direction=H.direction)})}function v(F,H,z,G){cf(F,H.arg.queryCacheKey,V=>{if(V.requestId!==H.requestId&&!G)return;const{merge:te}=o[H.arg.endpointName];if(V.status="fulfilled",te)if(V.data!==void 0){const{fulfilledTimeStamp:ue,arg:j,baseQueryMeta:X,requestId:ne}=H;let ae=yu(V.data,O=>te(O,z,{arg:j.originalArgs,baseQueryMeta:X,fulfilledTimeStamp:ue,requestId:ne}));V.data=ae}else V.data=z;else V.data=o[H.arg.endpointName].structuralSharing??!0?yb(Lr(V.data)?q6(V.data):V.data,z):z;delete V.error,V.fulfilledTimeStamp=H.fulfilledTimeStamp})}const b=Kn({name:`${e}/queries`,initialState:uf,reducers:{removeQueryResult:{reducer(F,{payload:{queryCacheKey:H}}){delete F[H]},prepare:oc()},cacheEntriesUpserted:{reducer(F,H){for(const z of H.payload){const{queryDescription:G,value:V}=z;_(F,G,!0,{arg:G,requestId:H.meta.requestId,startedTimeStamp:H.meta.timestamp}),v(F,{arg:G,requestId:H.meta.requestId,fulfilledTimeStamp:H.meta.timestamp,baseQueryMeta:{}},V,!0)}},prepare:F=>({payload:F.map(G=>{const{endpointName:V,arg:te,value:ue}=G,j=o[V];return{queryDescription:{type:"query",endpointName:V,originalArgs:G.arg,queryCacheKey:i({queryArgs:te,endpointDefinition:j,endpointName:V})},value:ue}}),meta:{[Gh]:!0,requestId:__(),timestamp:Date.now()}})},queryResultPatched:{reducer(F,{payload:{queryCacheKey:H,patches:z}}){cf(F,H,G=>{G.data=Dw(G.data,z.concat())})},prepare:oc()}},extraReducers(F){F.addCase(t.pending,(H,{meta:z,meta:{arg:G}})=>{const V=Rv(G);_(H,G,V,z)}).addCase(t.fulfilled,(H,{meta:z,payload:G})=>{const V=Rv(z.arg);v(H,z,G,V)}).addCase(t.rejected,(H,{meta:{condition:z,arg:G,requestId:V},error:te,payload:ue})=>{cf(H,G.queryCacheKey,j=>{if(!z){if(j.requestId!==V)return;j.status="rejected",j.error=ue??te}})}).addMatcher(f,(H,z)=>{const{queries:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&(H[V]=te)})}}),x=Kn({name:`${e}/mutations`,initialState:uf,reducers:{removeMutationResult:{reducer(F,{payload:H}){const z=fu(H);z in F&&delete F[z]},prepare:oc()}},extraReducers(F){F.addCase(n.pending,(H,{meta:z,meta:{requestId:G,arg:V,startedTimeStamp:te}})=>{V.track&&(H[fu(z)]={requestId:G,status:"pending",endpointName:V.endpointName,startedTimeStamp:te})}).addCase(n.fulfilled,(H,{payload:z,meta:G})=>{G.arg.track&&fT(H,G,V=>{V.requestId===G.requestId&&(V.status="fulfilled",V.data=z,V.fulfilledTimeStamp=G.fulfilledTimeStamp)})}).addCase(n.rejected,(H,{payload:z,error:G,meta:V})=>{V.arg.track&&fT(H,V,te=>{te.requestId===V.requestId&&(te.status="rejected",te.error=z??G)})}).addMatcher(f,(H,z)=>{const{mutations:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&V!==te?.requestId&&(H[V]=te)})}}),D={tags:{},keys:{}},C=Kn({name:`${e}/invalidation`,initialState:D,reducers:{updateProvidedBy:{reducer(F,H){for(const{queryCacheKey:z,providedTags:G}of H.payload){k(F,z);for(const{type:V,id:te}of G){const ue=(F.tags[V]??={})[te||"__internal_without_id"]??=[];ue.includes(z)||ue.push(z)}F.keys[z]=G}},prepare:oc()}},extraReducers(F){F.addCase(b.actions.removeQueryResult,(H,{payload:{queryCacheKey:z}})=>{k(H,z)}).addMatcher(f,(H,z)=>{const{provided:G}=u(z);for(const[V,te]of Object.entries(G.tags??{}))for(const[ue,j]of Object.entries(te)){const X=(H.tags[V]??={})[ue||"__internal_without_id"]??=[];for(const ne of j)X.includes(ne)||X.push(ne),H.keys[ne]=G.keys[ne]}}).addMatcher(_i(_s(t),Yh(t)),(H,z)=>{M(H,[z])}).addMatcher(b.actions.cacheEntriesUpserted.match,(H,z)=>{const G=z.payload.map(({queryDescription:V,value:te})=>({type:"UNKNOWN",payload:te,meta:{requestStatus:"fulfilled",requestId:"UNKNOWN",arg:V}}));M(H,G)})}});function k(F,H){const z=F.keys[H]??[];for(const G of z){const V=G.type,te=G.id??"__internal_without_id",ue=F.tags[V]?.[te];ue&&(F.tags[V][te]=ue.filter(j=>j!==H))}delete F.keys[H]}function M(F,H){const z=H.map(G=>{const V=AD(G,"providesTags",o,p),{queryCacheKey:te}=G.meta.arg;return{queryCacheKey:te,providedTags:V}});C.caseReducers.updateProvidedBy(F,C.actions.updateProvidedBy(z))}const R=Kn({name:`${e}/subscriptions`,initialState:uf,reducers:{updateSubscriptionOptions(F,H){},unsubscribeQueryResult(F,H){},internal_getRTKQSubscriptions(){}}}),I=Kn({name:`${e}/internalSubscriptions`,initialState:uf,reducers:{subscriptionsUpdated:{reducer(F,H){return Dw(F,H.payload)},prepare:oc()}}}),N=Kn({name:`${e}/config`,initialState:{online:f9(),focused:d9(),middlewareRegistered:!1,...h},reducers:{middlewareRegistered(F,{payload:H}){F.middlewareRegistered=F.middlewareRegistered==="conflict"||l!==H?"conflict":!0}},extraReducers:F=>{F.addCase(_b,H=>{H.online=!0}).addCase(TD,H=>{H.online=!1}).addCase(vb,H=>{H.focused=!0}).addCase(ED,H=>{H.focused=!1}).addMatcher(f,H=>({...H}))}}),A=aA({queries:b.reducer,mutations:x.reducer,provided:C.reducer,subscriptions:I.reducer,config:N.reducer}),P=(F,H)=>A(y.match(H)?void 0:F,H),U={...N.actions,...b.actions,...R.actions,...I.actions,...x.actions,...C.actions,resetApiState:y};return{reducer:P,actions:U}}var cr=Symbol.for("RTKQ/skipToken"),ID={status:"uninitialized"},hT=yu(ID,()=>{}),pT=yu(ID,()=>{});function C9({serializeQueryArgs:e,reducerPath:t,createSelector:n}){const i=R=>hT,o=R=>pT;return{buildQuerySelector:v,buildInfiniteQuerySelector:b,buildMutationSelector:x,selectInvalidatedBy:D,selectCachedArgsForQuery:C,selectApiState:u,selectQueries:f,selectMutations:h,selectQueryEntry:p,selectConfig:y};function l(R){return{...R,...sT(R.status)}}function u(R){return R[t]}function f(R){return u(R)?.queries}function p(R,I){return f(R)?.[I]}function h(R){return u(R)?.mutations}function y(R){return u(R)?.config}function _(R,I,N){return A=>{if(A===cr)return n(i,N);const P=e({queryArgs:A,endpointDefinition:I,endpointName:R});return n(F=>p(F,P)??hT,N)}}function v(R,I){return _(R,I,l)}function b(R,I){const{infiniteQueryOptions:N}=I;function A(P){const U={...P,...sT(P.status)},{isLoading:F,isError:H,direction:z}=U,G=z==="forward",V=z==="backward";return{...U,hasNextPage:k(N,U.data,U.originalArgs),hasPreviousPage:M(N,U.data,U.originalArgs),isFetchingNextPage:F&&G,isFetchingPreviousPage:F&&V,isFetchNextPageError:H&&G,isFetchPreviousPageError:H&&V}}return _(R,I,A)}function x(){return R=>{let I;return typeof R=="object"?I=fu(R)??cr:I=R,n(I===cr?o:P=>u(P)?.mutations?.[I]??pT,l)}}function D(R,I){const N=R[t],A=new Set;for(const P of I.filter(Sh).map(Cv)){const U=N.provided.tags[P.type];if(!U)continue;let F=(P.id!==void 0?U[P.id]:aT(Object.values(U)))??[];for(const H of F)A.add(H)}return aT(Array.from(A.values()).map(P=>{const U=N.queries[P];return U?[{queryCacheKey:P,endpointName:U.endpointName,originalArgs:U.originalArgs}]:[]}))}function C(R,I){return Object.values(f(R)).filter(N=>N?.endpointName===I&&N.status!=="uninitialized").map(N=>N.originalArgs)}function k(R,I,N){return I?Av(R,I,N)!=null:!1}function M(R,I,N){return!I||!R.getPreviousPageParam?!1:RD(R,I,N)!=null}}var mT=WeakMap?new WeakMap:void 0,gT=({endpointName:e,queryArgs:t})=>{let n="";const i=mT?.get(t);if(typeof i=="string")n=i;else{const o=JSON.stringify(t,(l,u)=>(u=typeof u=="bigint"?{$bigint:u.toString()}:u,u=vs(u)?Object.keys(u).sort().reduce((f,p)=>(f[p]=u[p],f),{}):u,u));vs(t)&&mT?.set(t,o),n=o}return`${e}(${n})`};function DD(...e){return function(n){const i=Zf(h=>n.extractRehydrationInfo?.(h,{reducerPath:n.reducerPath??"api"})),o={reducerPath:"api",keepUnusedDataFor:60,refetchOnMountOrArgChange:!1,refetchOnFocus:!1,refetchOnReconnect:!1,invalidationBehavior:"delayed",...n,extractRehydrationInfo:i,serializeQueryArgs(h){let y=gT;if("serializeQueryArgs"in h.endpointDefinition){const _=h.endpointDefinition.serializeQueryArgs;y=v=>{const b=_(v);return typeof b=="string"?b:gT({...v,queryArgs:b})}}else n.serializeQueryArgs&&(y=n.serializeQueryArgs);return y(h)},tagTypes:[...n.tagTypes||[]]},l={endpointDefinitions:{},batch(h){h()},apiUid:__(),extractRehydrationInfo:i,hasRehydrationInfo:Zf(h=>i(h)!=null)},u={injectEndpoints:p,enhanceEndpoints({addTagTypes:h,endpoints:y}){if(h)for(const _ of h)o.tagTypes.includes(_)||o.tagTypes.push(_);if(y)for(const[_,v]of Object.entries(y))typeof v=="function"?v(l.endpointDefinitions[_]):Object.assign(l.endpointDefinitions[_]||{},v);return u}},f=e.map(h=>h.init(u,o,l));function p(h){const y=h.endpoints({query:_=>({..._,type:"query"}),mutation:_=>({..._,type:"mutation"}),infiniteQuery:_=>({..._,type:"infinitequery"})});for(const[_,v]of Object.entries(y)){if(h.overrideExisting!==!0&&_ in l.endpointDefinitions){if(h.overrideExisting==="throw")throw new Error(gr(39));continue}l.endpointDefinitions[_]=v;for(const b of f)b.injectEndpoint(_,v)}return u}return u.injectEndpoints({endpoints:n.endpoints})}}function oi(e,...t){return Object.assign(e,...t)}var R9=({api:e,queryThunk:t,internalState:n,mwApi:i})=>{const o=`${e.reducerPath}/subscriptions`;let l=null,u=null;const{updateSubscriptionOptions:f,unsubscribeQueryResult:p}=e.internalActions,h=(D,C)=>{if(f.match(C)){const{queryCacheKey:M,requestId:R,options:I}=C.payload,N=D.get(M);return N?.has(R)&&N.set(R,I),!0}if(p.match(C)){const{queryCacheKey:M,requestId:R}=C.payload,I=D.get(M);return I&&I.delete(R),!0}if(e.internalActions.removeQueryResult.match(C))return D.delete(C.payload.queryCacheKey),!0;if(t.pending.match(C)){const{meta:{arg:M,requestId:R}}=C,I=Ev(D,M.queryCacheKey,Tv);return M.subscribe&&I.set(R,M.subscriptionOptions??I.get(R)??{}),!0}let k=!1;if(t.rejected.match(C)){const{meta:{condition:M,arg:R,requestId:I}}=C;if(M&&R.subscribe){const N=Ev(D,R.queryCacheKey,Tv);N.set(I,R.subscriptionOptions??N.get(I)??{}),k=!0}}return k},y=()=>n.currentSubscriptions,b={getSubscriptions:y,getSubscriptionCount:D=>y().get(D)?.size??0,isRequestSubscribed:(D,C)=>!!y()?.get(D)?.get(C)};function x(D){return JSON.parse(JSON.stringify(Object.fromEntries([...D].map(([C,k])=>[C,Object.fromEntries(k)]))))}return(D,C)=>{if(l||(l=x(n.currentSubscriptions)),e.util.resetApiState.match(D))return l={},n.currentSubscriptions.clear(),u=null,[!0,!1];if(e.internalActions.internal_getRTKQSubscriptions.match(D))return[!1,b];const k=h(n.currentSubscriptions,D);let M=!0;if(k){u||(u=setTimeout(()=>{const N=x(n.currentSubscriptions),[,A]=pA(l,()=>N);C.next(e.internalActions.subscriptionsUpdated(A)),l=N,u=null},500));const R=typeof D.type=="string"&&!!D.type.startsWith(o),I=t.rejected.match(D)&&D.meta.condition&&!!D.meta.arg.subscribe;M=!R&&!I}return[M,!1]}},A9=2147483647/1e3-1,I9=({reducerPath:e,api:t,queryThunk:n,context:i,internalState:o,selectors:{selectQueryEntry:l,selectConfig:u},getRunningQueryThunk:f,mwApi:p})=>{const{removeQueryResult:h,unsubscribeQueryResult:y,cacheEntriesUpserted:_}=t.internalActions,v=o.runningQueries.get(p.dispatch),b=_i(y.match,n.fulfilled,n.rejected,_.match);function x(R){const I=o.currentSubscriptions.get(R);if(!I)return!1;const N=I.size>0,A=v?.[R]!==void 0;return N||A}const D={},C=(R,I,N)=>{const A=I.getState(),P=u(A);if(b(R)){let U;if(_.match(R))U=R.payload.map(F=>F.queryDescription.queryCacheKey);else{const{queryCacheKey:F}=y.match(R)?R.payload:R.meta.arg;U=[F]}k(U,I,P)}if(t.util.resetApiState.match(R))for(const[U,F]of Object.entries(D))F&&clearTimeout(F),delete D[U];if(i.hasRehydrationInfo(R)){const{queries:U}=i.extractRehydrationInfo(R);k(Object.keys(U),I,P)}};function k(R,I,N){const A=I.getState();for(const P of R){const U=l(A,P);U?.endpointName&&M(P,U.endpointName,I,N)}}function M(R,I,N,A){const U=i.endpointDefinitions[I]?.keepUnusedDataFor??A.keepUnusedDataFor;if(U===1/0)return;const F=Math.max(0,Math.min(U,A9));if(!x(R)){const H=D[R];H&&clearTimeout(H),D[R]=setTimeout(()=>{if(!x(R)){const z=l(N.getState(),R);z?.endpointName&&N.dispatch(f(z.endpointName,z.originalArgs))?.abort(),N.dispatch(h({queryCacheKey:R}))}delete D[R]},F*1e3)}}return C},yT=new Error("Promise never resolved before cacheEntryRemoved."),D9=({api:e,reducerPath:t,context:n,queryThunk:i,mutationThunk:o,internalState:l,selectors:{selectQueryEntry:u,selectApiState:f}})=>{const p=ov(i),h=ov(o),y=_s(i,o),_={};function v(k,M,R){const I=_[k];I?.valueResolved&&(I.valueResolved({data:M,meta:R}),delete I.valueResolved)}function b(k){const M=_[k];M&&(delete _[k],M.cacheEntryRemoved())}const x=(k,M,R)=>{const I=D(k);function N(A,P,U,F){const H=u(R,P),z=u(M.getState(),P);!H&&z&&C(A,F,P,M,U)}if(i.pending.match(k))N(k.meta.arg.endpointName,I,k.meta.requestId,k.meta.arg.originalArgs);else if(e.internalActions.cacheEntriesUpserted.match(k))for(const{queryDescription:A,value:P}of k.payload){const{endpointName:U,originalArgs:F,queryCacheKey:H}=A;N(U,H,k.meta.requestId,F),v(H,P,{})}else if(o.pending.match(k))M.getState()[t].mutations[I]&&C(k.meta.arg.endpointName,k.meta.arg.originalArgs,I,M,k.meta.requestId);else if(y(k))v(I,k.payload,k.meta.baseQueryMeta);else if(e.internalActions.removeQueryResult.match(k)||e.internalActions.removeMutationResult.match(k))b(I);else if(e.util.resetApiState.match(k))for(const A of Object.keys(_))b(A)};function D(k){return p(k)?k.meta.arg.queryCacheKey:h(k)?k.meta.arg.fixedCacheKey??k.meta.requestId:e.internalActions.removeQueryResult.match(k)?k.payload.queryCacheKey:e.internalActions.removeMutationResult.match(k)?fu(k.payload):""}function C(k,M,R,I,N){const A=n.endpointDefinitions[k],P=A?.onCacheEntryAdded;if(!P)return;const U={},F=new Promise(ue=>{U.cacheEntryRemoved=ue}),H=Promise.race([new Promise(ue=>{U.valueResolved=ue}),F.then(()=>{throw yT})]);H.catch(()=>{}),_[R]=U;const z=e.endpoints[k].select(xh(A)?M:R),G=I.dispatch((ue,j,X)=>X),V={...I,getCacheEntry:()=>z(I.getState()),requestId:N,extra:G,updateCachedData:xh(A)?ue=>I.dispatch(e.util.updateQueryData(k,M,ue)):void 0,cacheDataLoaded:H,cacheEntryRemoved:F},te=P(M,V);Promise.resolve(te).catch(ue=>{if(ue!==yT)throw ue})}return x},k9=({api:e,context:{apiUid:t},reducerPath:n})=>(i,o)=>{e.util.resetApiState.match(i)&&o.dispatch(e.internalActions.middlewareRegistered(t))},O9=({reducerPath:e,context:t,context:{endpointDefinitions:n},mutationThunk:i,queryThunk:o,api:l,assertTagType:u,refetchQuery:f,internalState:p})=>{const{removeQueryResult:h}=l.internalActions,y=_i(_s(i),Yh(i)),_=_i(_s(i,o),Ua(i,o));let v=[];const b=(C,k)=>{y(C)?D(AD(C,"invalidatesTags",n,u),k):_(C)?D([],k):l.util.invalidateTags.match(C)&&D(bb(C.payload,void 0,void 0,void 0,void 0,u),k)};function x(C){const{queries:k,mutations:M}=C;for(const R of[k,M])for(const I in R)if(R[I]?.status==="pending")return!0;return!1}function D(C,k){const M=k.getState(),R=M[e];if(v.push(...C),R.config.invalidationBehavior==="delayed"&&x(R))return;const I=v;if(v=[],I.length===0)return;const N=l.util.selectInvalidatedBy(M,I);t.batch(()=>{const A=Array.from(N.values());for(const{queryCacheKey:P}of A){const U=R.queries[P],F=Ev(p.currentSubscriptions,P,Tv);U&&(F.size===0?k.dispatch(h({queryCacheKey:P})):U.status!=="uninitialized"&&k.dispatch(f(U)))}})}return b},N9=({reducerPath:e,queryThunk:t,api:n,refetchQuery:i,internalState:o})=>{const{currentPolls:l,currentSubscriptions:u}=o,f=new Set;let p=null;const h=(C,k)=>{(n.internalActions.updateSubscriptionOptions.match(C)||n.internalActions.unsubscribeQueryResult.match(C))&&y(C.payload.queryCacheKey,k),(t.pending.match(C)||t.rejected.match(C)&&C.meta.condition)&&y(C.meta.arg.queryCacheKey,k),(t.fulfilled.match(C)||t.rejected.match(C)&&!C.meta.condition)&&_(C.meta.arg,k),n.util.resetApiState.match(C)&&(x(),p&&(clearTimeout(p),p=null),f.clear())};function y(C,k){f.add(C),p||(p=setTimeout(()=>{for(const M of f)v({queryCacheKey:M},k);f.clear(),p=null},0))}function _({queryCacheKey:C},k){const M=k.getState()[e],R=M.queries[C],I=u.get(C);if(!R||R.status==="uninitialized")return;const{lowestPollingInterval:N,skipPollingIfUnfocused:A}=D(I);if(!Number.isFinite(N))return;const P=l.get(C);P?.timeout&&(clearTimeout(P.timeout),P.timeout=void 0);const U=Date.now()+N;l.set(C,{nextPollTimestamp:U,pollingInterval:N,timeout:setTimeout(()=>{(M.config.focused||!A)&&k.dispatch(i(R)),_({queryCacheKey:C},k)},N)})}function v({queryCacheKey:C},k){const R=k.getState()[e].queries[C],I=u.get(C);if(!R||R.status==="uninitialized")return;const{lowestPollingInterval:N}=D(I);if(!Number.isFinite(N)){b(C);return}const A=l.get(C),P=Date.now()+N;(!A||P<A.nextPollTimestamp)&&_({queryCacheKey:C},k)}function b(C){const k=l.get(C);k?.timeout&&clearTimeout(k.timeout),l.delete(C)}function x(){for(const C of l.keys())b(C)}function D(C=new Map){let k=!1,M=Number.POSITIVE_INFINITY;for(const R of C.values())R.pollingInterval&&(M=Math.min(R.pollingInterval,M),k=R.skipPollingIfUnfocused||k);return{lowestPollingInterval:M,skipPollingIfUnfocused:k}}return h},M9=({api:e,context:t,queryThunk:n,mutationThunk:i})=>{const o=v_(n,i),l=Ua(n,i),u=_s(n,i),f={};return(h,y)=>{if(o(h)){const{requestId:_,arg:{endpointName:v,originalArgs:b}}=h.meta,x=t.endpointDefinitions[v],D=x?.onQueryStarted;if(D){const C={},k=new Promise((N,A)=>{C.resolve=N,C.reject=A});k.catch(()=>{}),f[_]=C;const M=e.endpoints[v].select(xh(x)?b:_),R=y.dispatch((N,A,P)=>P),I={...y,getCacheEntry:()=>M(y.getState()),requestId:_,extra:R,updateCachedData:xh(x)?N=>y.dispatch(e.util.updateQueryData(v,b,N)):void 0,queryFulfilled:k};D(b,I)}}else if(u(h)){const{requestId:_,baseQueryMeta:v}=h.meta;f[_]?.resolve({data:h.payload,meta:v}),delete f[_]}else if(l(h)){const{requestId:_,rejectedWithValue:v,baseQueryMeta:b}=h.meta;f[_]?.reject({error:h.payload??h.error,isUnhandledError:!v,meta:b}),delete f[_]}}},L9=({reducerPath:e,context:t,api:n,refetchQuery:i,internalState:o})=>{const{removeQueryResult:l}=n.internalActions,u=(p,h)=>{vb.match(p)&&f(h,"refetchOnFocus"),_b.match(p)&&f(h,"refetchOnReconnect")};function f(p,h){const y=p.getState()[e],_=y.queries,v=o.currentSubscriptions;t.batch(()=>{for(const b of v.keys()){const x=_[b],D=v.get(b);if(!D||!x)continue;const C=[...D.values()];(C.some(M=>M[h]===!0)||C.every(M=>M[h]===void 0)&&y.config[h])&&(D.size===0?p.dispatch(l({queryCacheKey:b})):x.status!=="uninitialized"&&p.dispatch(i(x)))}})}return u};function P9(e){const{reducerPath:t,queryThunk:n,api:i,context:o,internalState:l}=e,{apiUid:u}=o,f={invalidateTags:mr(`${t}/invalidateTags`)},p=v=>v.type.startsWith(`${t}/`),h=[k9,I9,O9,N9,D9,M9];return{middleware:v=>{let b=!1;const x={...e,internalState:l,refetchQuery:_,isThisApiSliceAction:p,mwApi:v},D=h.map(M=>M(x)),C=R9(x),k=L9(x);return M=>R=>{if(!lA(R))return M(R);b||(b=!0,v.dispatch(i.internalActions.middlewareRegistered(u)));const I={...v,next:M},N=v.getState(),[A,P]=C(R,I,N);let U;if(A?U=M(R):U=P,v.getState()[t]&&(k(R,I,N),p(R)||o.hasRehydrationInfo(R)))for(const F of D)F(R,I,N);return U}},actions:f};function _(v){return e.api.endpoints[v.endpointName].initiate(v.originalArgs,{subscribe:!1,forceRefetch:!0})}}var vT=Symbol(),kD=({createSelector:e=Ei}={})=>({name:vT,init(t,{baseQuery:n,tagTypes:i,reducerPath:o,serializeQueryArgs:l,keepUnusedDataFor:u,refetchOnMountOrArgChange:f,refetchOnFocus:p,refetchOnReconnect:h,invalidationBehavior:y,onSchemaFailure:_,catchSchemaFailure:v,skipSchemaValidation:b},x){e$();const D=pe=>pe;Object.assign(t,{reducerPath:o,endpoints:{},internalActions:{onOnline:_b,onOffline:TD,onFocus:vb,onFocusLost:ED},util:{}});const C=C9({serializeQueryArgs:l,reducerPath:o,createSelector:e}),{selectInvalidatedBy:k,selectCachedArgsForQuery:M,buildQuerySelector:R,buildInfiniteQuerySelector:I,buildMutationSelector:N}=C;oi(t.util,{selectInvalidatedBy:k,selectCachedArgsForQuery:M});const{queryThunk:A,infiniteQueryThunk:P,mutationThunk:U,patchQueryData:F,updateQueryData:H,upsertQueryData:z,prefetch:G,buildMatchThunkActions:V}=E9({baseQuery:n,reducerPath:o,context:x,api:t,serializeQueryArgs:l,assertTagType:D,selectors:C,onSchemaFailure:_,catchSchemaFailure:v,skipSchemaValidation:b}),{reducer:te,actions:ue}=T9({context:x,queryThunk:A,mutationThunk:U,serializeQueryArgs:l,reducerPath:o,assertTagType:D,config:{refetchOnFocus:p,refetchOnReconnect:h,refetchOnMountOrArgChange:f,keepUnusedDataFor:u,reducerPath:o,invalidationBehavior:y}});oi(t.util,{patchQueryData:F,updateQueryData:H,upsertQueryData:z,prefetch:G,resetApiState:ue.resetApiState,upsertQueryEntries:ue.cacheEntriesUpserted}),oi(t.internalActions,ue);const j={currentSubscriptions:new Map,currentPolls:new Map,runningQueries:new Map,runningMutations:new Map},{buildInitiateQuery:X,buildInitiateInfiniteQuery:ne,buildInitiateMutation:ae,getRunningMutationThunk:O,getRunningMutationsThunk:K,getRunningQueriesThunk:le,getRunningQueryThunk:ie}=w9({queryThunk:A,mutationThunk:U,infiniteQueryThunk:P,api:t,serializeQueryArgs:l,context:x,internalState:j});oi(t.util,{getRunningMutationThunk:O,getRunningMutationsThunk:K,getRunningQueryThunk:ie,getRunningQueriesThunk:le});const{middleware:de,actions:me}=P9({reducerPath:o,context:x,queryThunk:A,mutationThunk:U,infiniteQueryThunk:P,api:t,assertTagType:D,selectors:C,getRunningQueryThunk:ie,internalState:j});return oi(t.util,me),oi(t,{reducer:te,middleware:de}),{name:vT,injectEndpoint(pe,Ie){const be=t,ke=be.endpoints[pe]??={};dp(Ie)&&oi(ke,{name:pe,select:R(pe,Ie),initiate:X(pe,Ie)},V(A,pe)),b9(Ie)&&oi(ke,{name:pe,select:N(),initiate:ae(pe)},V(U,pe)),fp(Ie)&&oi(ke,{name:pe,select:I(pe,Ie),initiate:ne(pe,Ie)},V(A,pe))}}}});kD();function df(e){return e.replace(e[0],e[0].toUpperCase())}function j9(e){return e.type==="query"}function $9(e){return e.type==="mutation"}function OD(e){return e.type==="infinitequery"}function yc(e,...t){return Object.assign(e,...t)}var gy=Symbol();function yy(e){const t=E.useRef(e),n=E.useMemo(()=>yb(t.current,e),[e]);return E.useEffect(()=>{t.current!==n&&(t.current=n)},[n]),n}function ff(e){const t=E.useRef(e);return E.useEffect(()=>{Cc(t.current,e)||(t.current=e)},[e]),Cc(t.current,e)?t.current:e}var U9=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",z9=U9(),B9=()=>typeof navigator<"u"&&navigator.product==="ReactNative",H9=B9(),F9=()=>z9||H9?E.useLayoutEffect:E.useEffect,q9=F9(),_T=e=>e.isUninitialized?{...e,isUninitialized:!1,isFetching:!0,isLoading:e.data===void 0,status:wD.pending}:e;function vy(e,...t){const n={};return t.forEach(i=>{n[i]=e[i]}),n}var _y=["data","status","isLoading","isSuccess","isError","error"];function V9({api:e,moduleOptions:{batch:t,hooks:{useDispatch:n,useSelector:i,useStore:o},unstable__sideEffectsInRender:l,createSelector:u},serializeQueryArgs:f,context:p}){const h=l?I=>I():E.useEffect;return{buildQueryHooks:k,buildInfiniteQueryHooks:M,buildMutationHook:R,usePrefetch:v};function y(I,N,A){if(N?.endpointName&&I.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];A!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:A,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=I.isSuccess?I.data:N?.data;P===void 0&&(P=I.data);const U=P!==void 0,F=I.isLoading,H=(!N||N.isLoading||N.isUninitialized)&&!U&&F,z=I.isSuccess||U&&(F&&!N?.isError||I.isUninitialized);return{...I,data:P,currentData:I.data,isFetching:F,isLoading:H,isSuccess:z}}function _(I,N,A){if(N?.endpointName&&I.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];A!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:A,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=I.isSuccess?I.data:N?.data;P===void 0&&(P=I.data);const U=P!==void 0,F=I.isLoading,H=(!N||N.isLoading||N.isUninitialized)&&!U&&F,z=I.isSuccess||F&&U;return{...I,data:P,currentData:I.data,isFetching:F,isLoading:H,isSuccess:z}}function v(I,N){const A=n(),P=ff(N);return E.useCallback((U,F)=>A(e.util.prefetch(I,U,{...P,...F})),[I,A,P])}function b(I,N,{refetchOnReconnect:A,refetchOnFocus:P,refetchOnMountOrArgChange:U,skip:F=!1,pollingInterval:H=0,skipPollingIfUnfocused:z=!1,...G}={}){const{initiate:V}=e.endpoints[I],te=n(),ue=E.useRef(void 0);if(!ue.current){const me=te(e.internalActions.internal_getRTKQSubscriptions());ue.current=me}const j=yy(F?cr:N),X=ff({refetchOnReconnect:A,refetchOnFocus:P,pollingInterval:H,skipPollingIfUnfocused:z}),ne=G.initialPageParam,ae=ff(ne),O=E.useRef(void 0);let{queryCacheKey:K,requestId:le}=O.current||{},ie=!1;K&&le&&(ie=ue.current.isRequestSubscribed(K,le));const de=!ie&&O.current!==void 0;return h(()=>{de&&(O.current=void 0)},[de]),h(()=>{const me=O.current;if(j===cr){me?.unsubscribe(),O.current=void 0;return}const pe=O.current?.subscriptionOptions;if(!me||me.arg!==j){me?.unsubscribe();const Ie=te(V(j,{subscriptionOptions:X,forceRefetch:U,...OD(p.endpointDefinitions[I])?{initialPageParam:ae}:{}}));O.current=Ie}else X!==pe&&me.updateSubscriptionOptions(X)},[te,V,U,j,X,de,ae,I]),[O,te,V,X]}function x(I,N){return(P,{skip:U=!1,selectFromResult:F}={})=>{const{select:H}=e.endpoints[I],z=yy(U?cr:P),G=E.useRef(void 0),V=E.useMemo(()=>u([H(z),(ne,ae)=>ae,ne=>z],N,{memoizeOptions:{resultEqualityCheck:Cc}}),[H,z]),te=E.useMemo(()=>F?u([V],F,{devModeChecks:{identityFunctionCheck:"never"}}):V,[V,F]),ue=i(ne=>te(ne,G.current),Cc),j=o(),X=V(j.getState(),G.current);return q9(()=>{G.current=X},[X]),ue}}function D(I){E.useEffect(()=>()=>{I.current?.unsubscribe?.(),I.current=void 0},[I])}function C(I){if(!I.current)throw new Error(gr(38));return I.current.refetch()}function k(I){const N=(U,F={})=>{const[H]=b(I,U,F);return D(H),E.useMemo(()=>({refetch:()=>C(H)}),[H])},A=({refetchOnReconnect:U,refetchOnFocus:F,pollingInterval:H=0,skipPollingIfUnfocused:z=!1}={})=>{const{initiate:G}=e.endpoints[I],V=n(),[te,ue]=E.useState(gy),j=E.useRef(void 0),X=ff({refetchOnReconnect:U,refetchOnFocus:F,pollingInterval:H,skipPollingIfUnfocused:z});h(()=>{const K=j.current?.subscriptionOptions;X!==K&&j.current?.updateSubscriptionOptions(X)},[X]);const ne=E.useRef(X);h(()=>{ne.current=X},[X]);const ae=E.useCallback(function(K,le=!1){let ie;return t(()=>{j.current?.unsubscribe(),j.current=ie=V(G(K,{subscriptionOptions:ne.current,forceRefetch:!le})),ue(K)}),ie},[V,G]),O=E.useCallback(()=>{j.current?.queryCacheKey&&V(e.internalActions.removeQueryResult({queryCacheKey:j.current?.queryCacheKey}))},[V]);return E.useEffect(()=>()=>{j?.current?.unsubscribe()},[]),E.useEffect(()=>{te!==gy&&!j.current&&ae(te,!0)},[te,ae]),E.useMemo(()=>[ae,te,{reset:O}],[ae,te,O])},P=x(I,y);return{useQueryState:P,useQuerySubscription:N,useLazyQuerySubscription:A,useLazyQuery(U){const[F,H,{reset:z}]=A(U),G=P(H,{...U,skip:H===gy}),V=E.useMemo(()=>({lastArg:H}),[H]);return E.useMemo(()=>[F,{...G,reset:z},V],[F,G,z,V])},useQuery(U,F){const H=N(U,F),z=P(U,{selectFromResult:U===cr||F?.skip?void 0:_T,...F}),G=vy(z,..._y);return E.useDebugValue(G),E.useMemo(()=>({...z,...H}),[z,H])}}}function M(I){const N=(P,U={})=>{const[F,H,z,G]=b(I,P,U),V=E.useRef(G);h(()=>{V.current=G},[G]);const te=E.useCallback(function(X,ne){let ae;return t(()=>{F.current?.unsubscribe(),F.current=ae=H(z(X,{subscriptionOptions:V.current,direction:ne}))}),ae},[F,H,z]);D(F);const ue=yy(U.skip?cr:P),j=E.useCallback(()=>C(F),[F]);return E.useMemo(()=>({trigger:te,refetch:j,fetchNextPage:()=>te(ue,"forward"),fetchPreviousPage:()=>te(ue,"backward")}),[j,te,ue])},A=x(I,_);return{useInfiniteQueryState:A,useInfiniteQuerySubscription:N,useInfiniteQuery(P,U){const{refetch:F,fetchNextPage:H,fetchPreviousPage:z}=N(P,U),G=A(P,{selectFromResult:P===cr||U?.skip?void 0:_T,...U}),V=vy(G,..._y,"hasNextPage","hasPreviousPage");return E.useDebugValue(V),E.useMemo(()=>({...G,fetchNextPage:H,fetchPreviousPage:z,refetch:F}),[G,H,z,F])}}}function R(I){return({selectFromResult:N,fixedCacheKey:A}={})=>{const{select:P,initiate:U}=e.endpoints[I],F=n(),[H,z]=E.useState();E.useEffect(()=>()=>{H?.arg.fixedCacheKey||H?.reset()},[H]);const G=E.useCallback(function(K){const le=F(U(K,{fixedCacheKey:A}));return z(le),le},[F,U,A]),{requestId:V}=H||{},te=E.useMemo(()=>P({fixedCacheKey:A,requestId:H?.requestId}),[A,H,P]),ue=E.useMemo(()=>N?u([te],N):te,[N,te]),j=i(ue,Cc),X=A==null?H?.arg.originalArgs:void 0,ne=E.useCallback(()=>{t(()=>{H&&z(void 0),A&&F(e.internalActions.removeMutationResult({requestId:V,fixedCacheKey:A}))})},[F,A,H,V]),ae=vy(j,..._y,"endpointName");E.useDebugValue(ae);const O=E.useMemo(()=>({...j,originalArgs:X,reset:ne}),[j,X,ne]);return E.useMemo(()=>[G,O],[G,O])}}}var G9=Symbol(),W9=({batch:e=jN,hooks:t={useDispatch:hC,useSelector:pC,useStore:fC},createSelector:n=Ei,unstable__sideEffectsInRender:i=!1,...o}={})=>({name:G9,init(l,{serializeQueryArgs:u},f){const p=l,{buildQueryHooks:h,buildInfiniteQueryHooks:y,buildMutationHook:_,usePrefetch:v}=V9({api:l,moduleOptions:{batch:e,hooks:t,unstable__sideEffectsInRender:i,createSelector:n},serializeQueryArgs:u,context:f});return yc(p,{usePrefetch:v}),yc(f,{batch:e}),{injectEndpoint(b,x){if(j9(x)){const{useQuery:D,useLazyQuery:C,useLazyQuerySubscription:k,useQueryState:M,useQuerySubscription:R}=h(b);yc(p.endpoints[b],{useQuery:D,useLazyQuery:C,useLazyQuerySubscription:k,useQueryState:M,useQuerySubscription:R}),l[`use${df(b)}Query`]=D,l[`useLazy${df(b)}Query`]=C}if($9(x)){const D=_(b);yc(p.endpoints[b],{useMutation:D}),l[`use${df(b)}Mutation`]=D}else if(OD(x)){const{useInfiniteQuery:D,useInfiniteQuerySubscription:C,useInfiniteQueryState:k}=y(b);yc(p.endpoints[b],{useInfiniteQuery:D,useInfiniteQuerySubscription:C,useInfiniteQueryState:k}),l[`use${df(b)}InfiniteQuery`]=D}}}}}),Y9=DD(kD(),W9());const ND=e=>({id:String(e.id),name:e.name,imageUrl:e.picture_url,display:!0}),Q9=e=>e.results.map(ND).sort((n,i)=>n.name.localeCompare(i.name)),MD=e=>{const t=e.image.original_height||48,n=e.image.original_width||48;return{id:String(e.id),name:e.name,iconUrl:e.image.url.replace("{height}",t).replace("{width}",n)}},K9=e=>e.results.map(MD).sort((n,i)=>n.name.localeCompare(i.name)),X9=e=>{const t=e.instructors[0],n=t?ND(t):{id:"0",name:"Unknown Instructor",imageUrl:"",display:!1},i=Ce.getBookableStatus(e),o=new Date(e.starts_at),u=(new Date(e.ends_at).getTime()-o.getTime())/1e3;return Number.isNaN(u)&&t_("Computed invalid duration",{extra:{rawClass:e}}),{...e,id:String(e.id),name:e.name,start:e.starts_at,end:e.ends_at,customerUrl:e.customer_url,duration:u,discipline:MD(e.offering_type.category),instructor:n,status:i}},Z9=e=>e.results.map(X9),J9=["id","name","max_occupancy","occupancy","attending_count","starts_at","ends_at","waiting_count","active_registration_status","category.name","venue","customer_url","description"],eF=["instructors","active_registration_status","category","offering_type","offering_type.category","venue","suggested_booking_action"],Of=Y9({reducerPath:"pelotonApi",baseQuery:_9({baseUrl:`${Ce.PELOTON_CORS_PROXY}/${Ce.PELOTON_API_BASE}/`}),endpoints:e=>({getClasses:e.query({queryFn:async t=>{try{const n=Ce.getPelotonHeaders(t),i=Ce.buildEventsUrl({fields:J9,expand:eF,corsProxy:!0}),o=await Ce.fetchAllPelotonPages(i,async l=>{const u=await fetch(l,{headers:n});if(!u.ok)throw new Error(`${u.status}: ${await u.text()}`);return u.json()},!0);return{data:Z9({results:o})}}catch(n){return{error:{status:"FETCH_ERROR",error:String(n)}}}}}),getDisciplines:e.query({query:t=>({url:`offering_type_categories?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>K9(t)}),getInstructors:e.query({query:t=>({url:`instructors?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>Q9(t)})})}),{useGetClassesQuery:Sb,useGetDisciplinesQuery:xb,useGetInstructorsQuery:wb}=Of,tF=e=>{if("error"in e&&typeof e.error=="string")return e.error;if("message"in e&&typeof e.message=="string")return e.message},nF=T.label`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
...
`,iF=T.input`
  accent-color: ${e=>e.theme.colors.accent};
`,LD=({value:e,checked:t,onChange:n,label:i,icon:o})=>{const l=E.useId();return g.jsxs(nF,{$checked:t,htmlFor:l,children:[g.jsx(iF,{type:"checkbox",id:l,value:e,checked:t,onChange:n}),o,g.jsx(rF,{children:i})]})},bT=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,ST=T.legend`
...
`,sF=T.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,oF=({studioId:e,selectedInstructors:t,setSelectedInstructors:n,selectedDisciplines:i,setSelectedDisciplines:o})=>{const l=wb(e),u=xb(e),f=E.useRef(t),p=E.useRef(i);E.useEffect(()=>{const b=f.current;if(!l.currentData||!Ce.isNotEmpty(b))return;const x=new Set(l.currentData.map(C=>C.id)),D=b.filter(C=>x.has(C));D.length<b.length&&(n(D),f.current=D)},[l.currentData,n]),E.useEffect(()=>{const b=p.current;if(!u.currentData||!Ce.isNotEmpty(b))return;const x=new Set(u.currentData.map(C=>String(C.id))),D=b.filter(C=>x.has(String(C))).map(String);D.length<b.length&&(o(D),p.current=D)},[u.currentData,o]);const h=E.useCallback(b=>{if(!Ce.isNotEmpty(t))return;const x=t.includes(b);n(x?t.filter(D=>D!==b):[...t,b])},[t,n]),y=E.useCallback(b=>{if(!Ce.isNotEmpty(i))return;const x=i.includes(b);o(x?i.filter(D=>D!==b):[...i,b])},[i,o]),_=Ce.isNotEmpty(t),v=Ce.isNotEmpty(i);return g.jsxs("div",{children:[g.jsxs(bT,{children:[g.jsx(ST,{children:"Instructors"}),g.jsx(xT,{children:"Filter by specific instructors or get alerts for all of them."}),g.jsxs(wT,{children:[g.jsx(hf,{type:"button",$active:!_,onClick:()=>n(null),children:"Any instructor"}),g.jsx(hf,{type:"button",$active:_,onClick:()=>{_||n([])},children:"Specific instructors"}),_&&t.length>0&&g.jsxs(ET,{children:[t.length," selected"]})]}),_&&g.jsx(aF,{query:l,selectedIds:t,onToggle:h})]}),g.jsx(sF,{}),g.jsxs(bT,{children:[g.jsx(ST,{children:"Disciplines"}),g.jsx(xT,{children:"Filter by class type or get alerts for everything."}),g.jsxs(wT,{children:[g.jsx(hf,{type:"button",$active:!v,onClick:()=>o(null),children:"Any discipline"}),g.jsx(hf,{type:"button",$active:v,onClick:()=>{v||o([])},children:"Specific disciplines"}),v&&i.length>0&&g.jsxs(ET,{children:[i.length," selected"]})]}),v&&g.jsx(lF,{query:u,selectedIds:i,onToggle:y})]})]})},aF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(wh,{children:"Loading instructors…"}):e.error?g.jsxs(jD,{children:["Couldn't load instructors."," ",g.jsx($D,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(wh,{children:"No instructors found for this studio."}):g.jsx(PD,{role:"group","aria-label":"Instructors",children:e.currentData.map(i=>g.jsx(LD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(gb,{instructor:i,size:28})},i.id))})),lF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(wh,{children:"Loading disciplines…"}):e.error?g.jsxs(jD,{children:["Couldn't load disciplines."," ",g.jsx($D,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(wh,{children:"No disciplines found for this studio."}):g.jsx(PD,{role:"group","aria-label":"Disciplines",children:e.currentData.map(i=>g.jsx(LD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(bh,{discipline:i,size:24})},i.id))})),cF=T.div`
  display: flex;
  align-items: center;
  gap: 4px;
  padding: 0 16px;
...
`,hF=T.div`
  ...
  align-items: center;
  justify-content: center;
`,pF=({steps:e,currentStep:t,onStepClick:n})=>g.jsx(cF,{role:"navigation","aria-label":"Editor steps",children:e.map((i,o)=>{const l=o<t?"completed":o===t?"active":"upcoming";return g.jsxs(hF,{style:{flex:o<e.length-1?1:0},children:[g.jsxs("div",{style:{display:"flex",alignItems:"center",width:"100%"},children:[g.jsx(uF,{$state:l,onClick:()=>{l!=="upcoming"&&n(o)},"aria-label":`Step ${o+1}: ${i}`,"aria-current":l==="active"?"step":void 0,type:"button"}),o<e.length-1&&g.jsx(dF,{$filled:o<t})]}),g.jsx(fF,{$state:l,children:i})]},o)})}),ls=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Eh=new Array(48).fill(null).map((e,t)=>{const n=t*30,i=new Date;i.setHours(Math.floor(n/60)),i.setMinutes(n%60);const o=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"});return{minutes:n,label:o.format(i)}}),mF=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,gF=T.legend`
...
`,bF=T.span`
  ...
  background-color: ${e=>e.theme.colors.secondarySurface};
  color: ${e=>e.theme.colors.main};
`,SF=e=>{if(Ce.isAllDay(e))return"All day";const t=Eh.find(i=>i.minutes===e.startMin),n=Eh.find(i=>i.minutes===e.endMin);return!t||!n?"All day":`${t.label} – ${n.label}`},xF=e=>{switch(e){case"free":return"Open spots only";case"waitlist":return"Open spots or waitlist";case"full":return"Any status"}},wF=({name:e,studioId:t,maxStatus:n,selectedInstructors:i,selectedDisciplines:o,timeRanges:l,waitlistAlerts:u,watchedClassIds:f})=>{const p=Ce.STUDIOS[t],h=ls.filter((v,b)=>l[b]),y=l.find(Boolean),_=l.filter(Boolean).every(v=>v&&y&&v.startMin===y.startMin&&v.endMin===y.endMin);return g.jsxs(mF,{children:[g.jsx(gF,{children:"Review your alert"}),g.jsx(yF,{children:"Double-check everything looks right, then hit Save."}),g.jsxs(vF,{children:[e.trim()&&g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Name"}),g.jsx(ai,{children:e.trim()})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Studio"}),g.jsx(ai,{children:p?.location||t})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Alert on"}),g.jsx(ai,{children:xF(n)})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Instructors"}),g.jsx(ai,{children:i===null?"Any instructor":i.length===0?"None selected":`${i.length} selected`})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Disciplines"}),g.jsx(ai,{children:o===null?"Any discipline":o.length===0?"None selected":`${o.length} selected`})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Days"}),h.length===0?g.jsx(ai,{children:"No days selected"}):h.length===7?g.jsx(ai,{children:"Every day"}):g.jsx(_F,{children:h.map(v=>g.jsx(bF,{children:v.slice(0,3)},v))})]}),y&&g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Time window"}),g.jsx(ai,{children:_?SF(y):"Varies by day"})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Waitlist alerts"}),g.jsx(ai,{children:u?f===null?"On — any matching class":f.length===0?"On — no classes selected":`On — ${f.length} ${f.length===1?"class":"classes"} selected`:"Off"})]})]})]})},EF=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,TF=T.legend`
...
`,PF=({timeRanges:e,setTimeRanges:t})=>{const n=e.filter(Boolean).length,i=E.useRef(ls.map(()=>{})),o=E.useCallback(y=>{const _=[...e];_[y]=_[y]?null:Ce.DEFAULT_TIME_RANGE,t(_)},[e,t]),l=E.useCallback(y=>{const _=e[y];if(!_)return;const v=[...e];Ce.isAllDay(_)?v[y]=i.current[y]??Ce.SPECIFIC_DEFAULT_TIME_RANGE:(i.current[y]=_,v[y]=Ce.ALL_DAY_TIME_RANGE),t(v)},[e,t]),u=E.useCallback((y,_,v)=>{const b=[...e],x=b[y];x&&(_==="startMin"?b[y]={startMin:v,endMin:x.endMin===0||x.endMin>=v?x.endMin:0}:b[y]={...x,endMin:v},t(b))},[e,t]),f=E.useCallback(()=>{t(ls.map(()=>Ce.DEFAULT_TIME_RANGE))},[t]),p=E.useCallback(()=>{t(ls.map(()=>null))},[t]),h=E.useCallback(()=>{const y=e.find(Boolean);y&&t(e.map(_=>_?{...y}:null))},[e,t]);return g.jsxs(EF,{children:[g.jsx(TF,{children:"Days & times"}),g.jsx(CF,{children:"Choose which days and time windows to monitor. Alerts fire when a matching class falls within these windows (in the studio's timezone)."}),g.jsxs(LF,{children:[g.jsx(by,{type:"button",onClick:f,children:"Select all days"}),n>0&&g.jsx(by,{type:"button",onClick:p,children:"Clear all"}),n>1&&g.jsx(by,{type:"button",onClick:h,children:"Copy time to all"})]}),g.jsx(RF,{children:ls.map((y,_)=>{const v=e[_],b=!!v&&Ce.isAllDay(v);return g.jsxs(AF,{$enabled:!!v,children:[g.jsxs(IF,{htmlFor:`day-${_}`,children:[g.jsx(DF,{type:"checkbox",id:`day-${_}`,checked:!!v,onChange:()=>o(_)}),y]}),v&&g.jsxs(kF,{children:[g.jsxs(OF,{htmlFor:`allday-${_}`,children:[g.jsx(NF,{type:"checkbox",id:`allday-${_}`,checked:b,onChange:()=>l(_)}),"All day"]}),!b&&g.jsxs(g.Fragment,{children:[g.jsx(TT,{value:v.startMin,"aria-label":`${y} start time`,onChange:({target:x})=>{const D=parseInt(x.value);Number.isNaN(D)||u(_,"startMin",D)},children:Eh.map(x=>g.jsx("option",{value:x.minutes,children:x.label},x.minutes))}),g.jsx(MF,{children:"to"}),g.jsx(TT,{value:v.endMin,"aria-label":`${y} end time`,onChange:({target:x})=>{const D=parseInt(x.value);Number.isNaN(D)||u(_,"endMin",D)},children:Eh.map(x=>g.jsx("option",{value:x.minutes,disabled:x.minutes>0&&x.minutes<v.startMin,children:x.label},x.minutes))})]})]})]},y)})})]})},CT=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,RT=T.legend`
...
`,YF=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-left: auto;
`;function QF(e,t){try{const n=new Date(e),i=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),o=new Date(n.toLocaleString("en-US",{timeZone:t})),l=i.getTime()-o.getTime();return n.setTime(n.getTime()-l),{day:n.getDay(),minute:n.getHours()*60+n.getMinutes()}}catch{return null}}function KF(e,t){try{return new Date(e).toLocaleString("en-US",{timeZone:t,weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return e}}function XF(e,t,n,i,o){const l=Ce.STUDIOS[o]?.timezone,u=Date.now();return e.filter(f=>{if(new Date(f.start).getTime()<=u||t!==null&&!t.includes(f.instructor.id)||n!==null&&!n.includes(f.discipline.id))return!1;if(i&&l){const p=QF(f.start,l);if(!p)return!1;const h=i[p.day];if(!h||p.minute<h.startMin||p.minute>h.endMin)return!1}return!0})}const ZF=E.memo(({studioId:e,instructors:t,disciplines:n,timeRanges:i,selectedIds:o,onToggle:l})=>{const u=Sb(e),f=Ce.STUDIOS[e]?.timezone??"UTC";if(u.isLoading)return g.jsx(Sy,{children:"Loading classes…"});if(u.error)return g.jsxs(Sy,{children:["Couldn't load classes."," ",g.jsx(WF,{type:"button",onClick:u.refetch,children:"Try again"})]});const p=XF(u.currentData??[],t,n,i,e);return p.length===0?g.jsx(Sy,{children:"No upcoming classes match your filters."}):g.jsx(zF,{role:"group","aria-label":"Classes",children:p.map(h=>{const y=o.includes(h.id),_=KF(h.start,f),v=[h.instructor.name,h.discipline.name].filter(Boolean).join(" · "),b=h.status==="free"?"Open":h.status==="waitlist"?"Waitlist":"Full";return g.jsxs(BF,{$checked:y,htmlFor:`cls-${h.id}`,children:[g.jsx(HF,{type:"checkbox",id:`cls-${h.id}`,checked:y,onChange:()=>l(h.id)}),g.jsxs(FF,{children:[g.jsx(qF,{children:_}),v&&g.jsx(VF,{children:v})]}),g.jsx(GF,{$status:h.status,children:b})]},h.id)})})}),JF=({studioId:e,waitlistAlerts:t,onWaitlistAlertsChange:n,watchedClassIds:i,onWatchedClassIdsChange:o,selectedInstructors:l,selectedDisciplines:u,timeRanges:f})=>{const p=_=>{const v=i??[];o(v.includes(_)?v.filter(b=>b!==_):[...v,_])},h=i!==null,y=i?.length??0;return g.jsxs("div",{children:[g.jsxs(CT,{children:[g.jsx(RT,{children:"Waitlist position alerts"}),g.jsx(AT,{children:"Get a push notification whenever the waitlist count changes for a matching class. Tap the notification to open a prompt reminding you to check your email for the 2-hour acceptance window."}),g.jsxs(jF,{children:[g.jsx(vh,{name:"waitlistAlerts",value:"off",checked:!t,onChange:()=>n(!1),label:"Disabled",hint:"No waitlist count notifications"}),g.jsx(vh,{name:"waitlistAlerts",value:"on",checked:t,onChange:()=>n(!0),label:"Enabled",hint:"Notify me when the waitlist count changes"})]})]}),t&&g.jsxs(g.Fragment,{children:[g.jsx($F,{}),g.jsxs(CT,{children:[g.jsx(RT,{children:"Which classes?"}),g.jsx(AT,{children:"Notify for any class matching your filters, or pick specific ones you've already joined the waitlist for."}),g.jsxs(UF,{children:[g.jsx(IT,{type:"button",$active:!h,onClick:()=>o(null),children:"Any matching class"}),g.jsx(IT,{type:"button",$active:h,onClick:()=>{h||o([])},children:"Specific classes"}),h&&y>0&&g.jsxs(YF,{children:[y," selected"]})]}),h&&g.jsx(ZF,{studioId:e,instructors:l,disciplines:u,timeRanges:f,selectedIds:i,onToggle:p})]})]})]})},e7=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},t7="STUDIO_ID",UD=e=>{const t=e7(t7);return t===null?e:Object.keys(Ce.STUDIOS).includes(t)?t:e},Do=Ei([e=>e.studioSelector],e=>e.studioId),n7={studioId:UD(Ce.DEFAULT_STUDIO_ID)},Iv=Kn({name:"studioSelector",initialState:n7,reducers:{setStudioId(e,t){e.studioId=t.payload}}}),{setStudioId:Nf}=Iv.actions,r7=e=>{const t=ir(),n=et(Do);E.useEffect(()=>{e.studioId?t(Nf(e.studioId)):t(Nf(UD(Ce.DEFAULT_STUDIO_ID)))},[e.studioId,t]);const[i,o]=E.useState(e.name||""),[l,u]=E.useState(e.instructors||null),[f,p]=E.useState(e.disciplines||null),[h,y]=E.useState(()=>e.timeRanges||ls.map(()=>Ce.DEFAULT_TIME_RANGE)),[_,v]=E.useState(e.maxStatus||"free"),[b,x]=E.useState(e.waitlistAlerts??!1),[D,C]=E.useState(e.watchedClassIds??null),k=E.useCallback(M=>{M!==n&&(t(Nf(M)),u(R=>R&&[]),p(R=>R&&[]))},[t,n]);return{selectedStudioId:n,setSelectedStudioId:k,name:i,setName:o,selectedInstructors:l,setSelectedInstructors:u,selectedDisciplines:f,setSelectedDisciplines:p,timeRanges:h,setTimeRanges:y,maxStatus:_,setMaxStatus:v,waitlistAlerts:b,setWaitlistAlerts:x,watchedClassIds:D,setWatchedClassIds:C}},xy=["Basics","Filters","Schedule","Waitlist","Review"],i7=T.div`
  display: flex;
  flex-direction: column;
  min-height: 0;
  background-color: ${e=>e.theme.colors.mainSurface};
...
`,d7=T.span`
  ...
  ${Te`
    font-size: 12px;
  `}
`,f7=({alertToEdit:e,onSave:t,onCancel:n})=>{const i=et(_u),[o,l]=E.useState(0),[u,f]=E.useState(!1),[p,h]=E.useState(),{selectedStudioId:y,setSelectedStudioId:_,name:v,setName:b,selectedInstructors:x,setSelectedInstructors:D,selectedDisciplines:C,setSelectedDisciplines:k,timeRanges:M,setTimeRanges:R,maxStatus:I,setMaxStatus:N,waitlistAlerts:A,setWaitlistAlerts:P,watchedClassIds:U,setWatchedClassIds:F}=r7(e),H=o<xy.length-1,z=o>0,G=o===xy.length-1,V=E.useCallback(()=>{H&&l(X=>X+1)},[H]),te=E.useCallback(()=>{z&&l(X=>X-1)},[z]),ue=E.useCallback(async()=>{if(!y||!i)return;f(!0),h(void 0);const X={id:e.id||null,created:e.created||new Date().getTime(),...v.trim()?{name:v.trim()}:{},studioId:y,instructors:x,disciplines:C,timeRanges:M,maxStatus:I,waitlistAlerts:A,...A&&U!==null?{watchedClassIds:U}:{}};try{X.id?await SD(i,X):await VH(i,X),t()}catch(ne){Nr(ne),h("Something went wrong. Please try again."),f(!1)}},[e.id,e.created,v,y,i,x,C,M,I,A,U,t]),j=!!e.id;return g.jsxs(i7,{children:[g.jsxs(s7,{children:[g.jsx(o7,{children:j?"Edit alert":"New alert"}),g.jsx(a7,{children:j?"Update your alert settings below.":"Set up a new alert in a few quick steps."}),g.jsx(pF,{steps:xy,currentStep:o,onStepClick:l})]}),g.jsxs(l7,{children:[o===0&&g.jsx(i9,{name:v,onNameChange:b,studioId:y,onStudioChange:_,maxStatus:I,onStatusChange:N}),o===1&&g.jsx(oF,{studioId:y,selectedInstructors:x,setSelectedInstructors:D,selectedDisciplines:C,setSelectedDisciplines:k}),o===2&&g.jsx(PF,{timeRanges:M,setTimeRanges:R}),o===3&&g.jsx(JF,{studioId:y,waitlistAlerts:A,onWaitlistAlertsChange:P,watchedClassIds:U,onWatchedClassIdsChange:F,selectedInstructors:x,selectedDisciplines:C,timeRanges:M}),o===4&&g.jsx(wF,{name:v,studioId:y,maxStatus:I,selectedInstructors:x,selectedDisciplines:C,timeRanges:M,waitlistAlerts:A,watchedClassIds:U})]}),g.jsxs(c7,{children:[g.jsx("div",{children:z?g.jsx(vc,{type:"button",onClick:te,children:"Back"}):g.jsx(vc,{type:"button",onClick:n,children:"Cancel"})}),g.jsxs(u7,{children:[p&&g.jsx(d7,{$error:!0,children:p}),G?g.jsx(vc,{type:"button",$primary:!0,onClick:ue,disabled:u,children:u?"Saving…":"Save alert"}):g.jsxs(g.Fragment,{children:[j&&g.jsx(vc,{type:"button",onClick:ue,disabled:u,children:u?"Saving…":"Save"}),g.jsx(vc,{type:"button",$primary:!0,onClick:V,children:"Continue"})]})]})]})]})},h7=()=>{const e=Pr(),t=ws(),n=e.state||{};return g.jsx(f7,{alertToEdit:n,onSave:()=>{t(nt.ALERTS)},onCancel:()=>{t(nt.ALERTS)}})},p7={userId:null,data:{state:"idle"}},zD=Kn({name:"alerts",initialState:p7,reducers:{setAlertsLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertsData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertsFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertsLoading:m7,setAlertsData:DT,setAlertsFailed:kT}=zD.actions,g7=zD.reducer,y7={userId:null,data:{state:"idle"}},BD=Kn({name:"alertPreferences",initialState:y7,reducers:{setAlertPreferencesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertPreferencesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertPreferencesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertPreferencesLoading:v7,setAlertPreferencesData:_7,setAlertPreferencesFailed:OT}=BD.actions,b7=BD.reducer,Eb=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},Tb=(e,t)=>{try{window.localStorage.setItem(e,t)}catch(n){Nr(n)}},HD=e=>{try{window.localStorage.removeItem(e)}catch(t){Nr(t)}},FD="BOOKABLE_STATUS_FILTERS",Dv="DISCIPLINE_FILTERS",kv="INSTRUCTOR_FILTERS",S7=e=>{const t=Eb(FD);return t===null?e:t.split(";").filter(Ce.isBookableStatus)},x7=e=>{Tb(FD,e.join(";"))},w7=e=>{const t=Eb(Dv);return t===null?e:t.split(";").filter(Boolean)},wy=e=>{e.length===0?HD(Dv):Tb(Dv,e.join(";"))},E7=e=>{const t=Eb(kv);return t===null?e:t.split(";").filter(Boolean)},NT=e=>{e.length===0?HD(kv):Tb(kv,e.join(";"))},T7={selectedBookableStatuses:S7(["free","waitlist"]),selectedInstructors:E7([]),selectedDisciplines:w7([])},qD=Kn({name:"filters",initialState:T7,reducers:{toggleBookableStatus(e,t){e.selectedBookableStatuses.includes(t.payload)?e.selectedBookableStatuses=e.selectedBookableStatuses.filter(n=>n!==t.payload):e.selectedBookableStatuses=[...e.selectedBookableStatuses,t.payload],x7(e.selectedBookableStatuses)},toggleInstructor(e,t){e.selectedInstructors.includes(t.payload)?e.selectedInstructors=e.selectedInstructors.filter(n=>n!==t.payload):e.selectedInstructors=[...e.selectedInstructors,t.payload],NT(e.selectedInstructors)},resetInstructors(e){e.selectedInstructors=[],NT(e.selectedInstructors)},toggleDiscipline(e,t){e.selectedDisciplines.includes(t.payload)?e.selectedDisciplines=e.selectedDisciplines.filter(n=>n!==t.payload):e.selectedDisciplines=[...e.selectedDisciplines,t.payload],wy(e.selectedDisciplines)},setDisciplines(e,t){e.selectedDisciplines=t.payload,wy(e.selectedDisciplines)},resetDisciplines(e){e.selectedDisciplines=[],wy(e.selectedDisciplines)}}}),{toggleBookableStatus:C7,toggleInstructor:R7,resetInstructors:A7,toggleDiscipline:I7,setDisciplines:D7,resetDisciplines:k7}=qD.actions,O7=qD.reducer,N7={userId:null,data:{state:"idle"}},VD=Kn({name:"registeredDevices",initialState:N7,reducers:{setRegisteredDevicesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setRegisteredDevicesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setRegisteredDevicesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setRegisteredDevicesLoading:M7,setRegisteredDevicesData:L7,setRegisteredDevicesFailed:MT}=VD.actions,P7=VD.reducer,j7={state:"idle"},GD=Kn({name:"session",initialState:j7,reducers:{setLoading(e){return{state:"loading"}},setSession(e,t){return{state:"fulfilled",data:t.payload}},removeSession(e){return{state:"fulfilled",data:null}}}}),{setLoading:LT,setSession:$7,removeSession:PT}=GD.actions,U7=GD.reducer,hp=_$({reducer:{alerts:g7,alertPreferences:b7,filters:O7,registeredDevices:P7,session:U7,[Of.reducerPath]:Of.reducer,[Iv.name]:Iv.reducer},middleware:e=>e().concat(Of.middleware)}),WD=E.createContext({state:"idle"}),z7=({children:e,userId:t})=>{const n=ir(),i=et(l=>l.registeredDevices);E.useEffect(()=>{const l=ln;if(!l)return n(MT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().registeredDevices;(u.userId!==t||u.data.state!=="fulfilled")&&n(M7(t));const f=Mn(l,`messagingTokens/${t}`),p=Ru(f,h=>{const y=h.val();n(L7({userId:t,data:y||{}}))},h=>{n(MT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(WD.Provider,{value:o,children:e})},YD=E.createContext({state:"idle"}),B7=({children:e,userId:t})=>{const n=ir(),i=et(l=>l.alertPreferences);E.useEffect(()=>{const l=ln;if(!l)return n(OT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().alertPreferences;(u.userId!==t||u.data.state!=="fulfilled")&&n(v7(t));const f=Mn(l,Ce.PATHS.alertPreferences(t)),p=Ru(f,h=>{const y=h.val();n(_7({userId:t,data:y||{}}))},h=>{n(OT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(YD.Provider,{value:o,children:e})},H7=({children:e,userId:t})=>{const n=ir(),i=et(l=>l.alerts);E.useEffect(()=>{const l=ln;if(!l)return n(kT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().alerts;(u.userId!==t||u.data.state!=="fulfilled")&&n(m7(t));const f=Mn(l,Ce.PATHS.alerts(t)),p=Ru(f,h=>{const y=h.val();if(!y){n(DT({userId:t,data:[]}));return}const _=Object.entries(y).map(([v,b])=>({...b,timeRanges:new Array(ls.length).fill(null).map((x,D)=>b.timeRanges[D]||null),id:v}));n(DT({userId:t,data:_}))},h=>{n(kT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(mb.Provider,{value:o,children:e})},F7=T.div`
  margin: 0 auto;
  max-width: 960px;
  padding: 16px;
...
`,K7=T.p`
  ...
  padding: 32px 0;
  margin: 0;
`,X7=({children:e})=>{const t=et(el);return t.state==="loading"?g.jsx(K7,{children:"Loading…"}):t.state!=="fulfilled"||!t.data?g.jsxs(V7,{children:[g.jsx(G7,{children:"🔔"}),g.jsx(W7,{children:"Sign in to use Alerts"}),g.jsx(Y7,{children:"Track class availability and get push notifications when a spot opens up for the classes you care about."}),g.jsx(Q7,{to:nt.SIGN_IN,children:"Sign in"})]}):e(t.data.id)},Z7=e=>g.jsx(hs,{children:g.jsx(q7,{children:g.jsx(F7,{children:g.jsx(X7,{...e})})})}),J7=({userId:e})=>g.jsx(H7,{userId:e,children:g.jsx(B7,{userId:e,children:g.jsx(z7,{userId:e,children:g.jsx(p2,{})})})}),eq=()=>g.jsx(Z7,{children:e=>g.jsx(J7,{userId:e})}),jT=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");await NI(Mn(n,Ce.PATHS.alertPreferences(e)),t)},tq=T.input`
  position: absolute;
  opacity: 0;
  width: 0;
  height: 0;
...
`,FT=T.div`
  ...
  ${Te`
    padding: 12px 16px 16px;
  `}
`,kV=()=>{const e=ws();return g.jsxs(DV,{children:[g.jsx(Ty,{children:g.jsx(bV,{onAdd:()=>{e(nt.ALERTS_EDITOR,{state:{}})},onEdit:t=>{e(nt.ALERTS_EDITOR,{state:t})},onDuplicate:t=>{e(nt.ALERTS_EDITOR,{state:{...t,id:void 0,created:void 0}})}})}),g.jsxs(Ty,{children:[g.jsxs(zT,{children:[g.jsx(BT,{children:"Preferences"}),g.jsx(HT,{children:"Control how often you receive alert notifications."})]}),g.jsx(FT,{children:g.jsx(_q,{})})]}),g.jsxs(Ty,{children:[g.jsxs(zT,{children:[g.jsx(BT,{children:"Devices"}),g.jsx(HT,{children:"Devices registered to receive push notifications. Removed devices will re-register on their next visit."})]}),g.jsxs(FT,{children:[g.jsx(IV,{}),g.jsx(jq,{})]})]})]})},OV=T.button.attrs({"aria-label":"Close",type:"button"})`
  position: relative;
  width: 50px;
  height: 50px;
  font-size: 0;
...
`,NV=()=>{const e=et(i=>i.filters.selectedBookableStatuses),t=ir(),n=E.useCallback(i=>{t(C7(i))},[t]);return{bookableStatuses:e,toggleBookableStatus:n}},MV=T.button`
  cursor: pointer;
  color: ${e=>e.theme.colors.accent};
  font-size: 12px;
  background: none;
...
`,Th=T.p`
  ...
  padding: 8px 16px 16px;
  margin: 0;
`,BV=({discipline:e,checked:t,onClick:n})=>g.jsxs(XD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(ZD,{$checked:t}),g.jsx(bh,{discipline:e,size:24}),g.jsx(JD,{children:e.name})]}),HV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=xb(e),{selectedDisciplines:o,toggleDiscipline:l}=zV(),u=ir(),f=E.useRef(o);return E.useEffect(()=>{const p=f.current;if(!t||p.length===0)return;const h=new Set(t.map(_=>_.id)),y=p.filter(_=>h.has(_));y.length<p.length&&u(D7(y))},[t,u]),i&&!n?g.jsx(Th,{children:"Failed to load disciplines"}):!t||n?g.jsx(Th,{children:"Loading…"}):g.jsx(KD,{children:t.map((p,h)=>g.jsx(BV,{discipline:p,checked:o.includes(p.id),onClick:()=>l(p.id)},h))})},FV=()=>{const e=et(n=>n.filters.selectedDisciplines.length>0),t=ir();return g.jsxs("div",{children:[g.jsx(pp,{label:"Disciplines",onReset:e?()=>t(k7()):void 0}),g.jsx(HV,{})]})},qV=()=>{const e=et(i=>i.filters.selectedInstructors),t=ir(),n=E.useCallback(i=>{t(R7(i))},[t]);return{selectedInstructors:e,toggleInstructor:n}},VV=({instructor:e,checked:t,onClick:n})=>g.jsxs(XD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(ZD,{$checked:t}),g.jsx(gb,{instructor:e,size:28}),g.jsx(JD,{children:e.name})]}),GV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=wb(e),{selectedInstructors:o,toggleInstructor:l}=qV();return i&&!n?g.jsx(Th,{children:"Failed to load instructors"}):!t||n?g.jsx(Th,{children:"Loading…"}):g.jsx(KD,{children:t.map((u,f)=>g.jsx(VV,{instructor:u,checked:o.includes(u.id),onClick:()=>l(u.id)},f))})},WV=()=>{const e=et(n=>n.filters.selectedInstructors.length>0),t=ir();return g.jsxs("div",{children:[g.jsx(pp,{label:"Instructors",onReset:e?()=>t(A7()):void 0}),g.jsx(GV,{})]})},YV=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),QV=T.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
  padding: 0 16px 16px;
...
`,JV=T.span`
  font-size: 15px;
  color: ${e=>e.theme.colors.main};
`,eG=()=>{const e=ir(),t=et(Do);return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(pp,{label:"Studio"})}),g.jsx(QV,{children:YV.map(n=>{const i=t===n.id;return g.jsxs(KV,{$selected:i,htmlFor:`studio-${n.id}`,children:[g.jsx(XV,{type:"radio",id:`studio-${n.id}`,name:"studio-selected",value:n.id,checked:i,onChange:()=>{i||e(Nf(n.id))}}),g.jsx(ZV,{$selected:i}),g.jsx(JV,{children:n.label})]},n.id)})})]})},tG=T.div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,nG=T.div`
...
`,$G=T.code`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,UG=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i,fulfilledTimeStamp:o}=Sb(e,{refetchOnMountOrArgChange:!0});return i&&!n?g.jsxs(QT,{children:[g.jsx(jG,{children:"Failed to load classes"}),g.jsx($G,{children:tF(i)})]}):!t||n?g.jsx(QT,{children:g.jsx(PG,{children:"Loading classes…"})}):g.jsx(LG,{classes:t,fulfilledTimeStamp:o})},zG=T.div``,Ov=300,BG=T.aside`
  max-width: 100%;
  width: ${Ov}px;
  top: calc(${rb}px + env(safe-area-inset-top, 0px));
  bottom: 0;
...
`,Tc=T.p`
  color: ${e=>e.theme.colors.secondary};
  font-size: 14px;
`,Ch=1e3,Lf=140,Rh=12,tk=4,nk=Lf-Rh-tk;function _c(e,t){return t<=1?Ch/2:e/(t-1)*Ch}function Dy(e,t){return Rh+nk*(1-e/t)}const gW=[.25,.5,.75],yW=T.div`
  background: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 16px 16px 12px;
...
`,OW=T.div`
  ...
  pointer-events: none;
`;function tC({days:e,seriesForDay:t,legend:n}){const i=e.length,[o,l]=E.useState(null),u=e.map(t),f=Math.max(...u.flatMap(v=>v.map(b=>b.value)),1),p=u[0].length,h=Dy(0,f).toFixed(1);function y(v,b){const{left:x,width:D}=b.getBoundingClientRect(),C=(v-x)/D;return Math.max(0,Math.min(i-1,Math.round(C*(i-1))))}const _=o!==null?o/(i-1)*100:null;return g.jsxs(yW,{children:[g.jsxs(CW,{children:[o!==null&&_!==null&&g.jsxs(g.Fragment,{children:[g.jsxs(RW,{$pct:_,children:[g.jsx(AW,{children:e[o].date}),u[o].map(v=>g.jsxs(IW,{children:[g.jsx(DW,{$color:v.color}),v.label,g.jsx(kW,{children:v.value})]},v.label))]}),u[o].map((v,b)=>g.jsx(OW,{$color:v.color,style:{left:`${_}%`,top:`${Dy(v.value,f)/Lf*100}%`}},b))]}),g.jsxs(vW,{viewBox:`0 0 ${Ch} ${Lf}`,preserveAspectRatio:"none","aria-hidden":"true",style:{cursor:"crosshair",display:"block"},onMouseMove:v=>l(y(v.clientX,v.currentTarget)),onMouseLeave:()=>l(null),onTouchStart:v=>l(y(v.touches[0].clientX,v.currentTarget)),onTouchMove:v=>l(y(v.touches[0].clientX,v.currentTarget)),onTouchEnd:()=>l(null),children:[gW.map(v=>{const b=(Rh+nk*(1-v)).toFixed(1);return g.jsx("line",{x1:0,y1:b,x2:Ch,y2:b,stroke:"currentColor",strokeOpacity:.1,strokeWidth:1,vectorEffect:"non-scaling-stroke"},v)}),o!==null&&g.jsx("line",{x1:_c(o,i).toFixed(1),y1:Rh,x2:_c(o,i).toFixed(1),y2:Lf-tk,stroke:"currentColor",strokeOpacity:.2,strokeWidth:1,vectorEffect:"non-scaling-stroke"}),Array.from({length:p},(v,b)=>{const x=u[0][b].color,C=u.map((M,R)=>({x:_c(R,i),y:Dy(M[b].value,f)})).map(({x:M,y:R},I)=>`${I===0?"M":"L"}${M.toFixed(1)},${R.toFixed(1)}`).join(" "),k=[C,`L${_c(i-1,i).toFixed(1)},${h}`,`L${_c(0,i).toFixed(1)},${h}`,"Z"].join(" ");return g.jsxs("g",{children:[g.jsx("path",{d:k,fill:x,fillOpacity:.12}),g.jsx("path",{d:C,fill:"none",stroke:x,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",vectorEffect:"non-scaling-stroke"})]},b)})]})]}),g.jsx(TW,{days:e,legend:n})]})}const NW=T.div`
  overflow-x: auto;
  ${$r}
`,MW=T.table`
  width: 100%;
...
//# sourceMappingURL=index-CDWUO9m2.js.map
