...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="90e341ac-33ed-5f49-b4a5-7315298bb40f")}catch(e){}}();
...
`,lB=()=>v.jsx("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none","aria-hidden":"true",children:v.jsx("path",{d:"M3 5h14M3 10h14M3 15h14",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})}),cB=()=>{const[e,t]=C.useState(!1),n=ct(U_);return v.jsxs(v.Fragment,{children:[v.jsxs(nB,{children:[v.jsxs(rB,{to:rt.CLASS_LIST,children:[v.jsx(tI,{}),v.jsx(iB,{children:"Peloton Alerts"})]}),v.jsxs(sB,{children:[v.jsx(tf,{to:rt.CLASS_LIST,end:!0,children:"Classes"}),v.jsx(tf,{to:rt.ALERTS,children:"Alerts"}),v.jsx(tf,{to:rt.ABOUT,end:!0,children:"FAQ"}),n&&v.jsx(tf,{to:rt.STATS,children:"Stats"})]}),v.jsx(oB,{children:v.jsx(eB,{})}),v.jsx(aB,{type:"button","aria-label":"Open menu",onClick:()=>t(!0),children:v.jsx(lB,{})})]}),v.jsx(Y8,{open:e,onClose:()=>t(!1)})]})},uB=D.div`
  min-height: 100%;
  display: flex;
  flex-direction: column;
`,dB=D.div`
...
`,FB=({matchCount:e,nearMissCount:t})=>v.jsxs(HB,{children:[v.jsxs(Ox,{children:[v.jsx(Nx,{$color:"#2e7d32",children:e})," ",e===1?"class":"classes"," would have triggered"]}),v.jsxs(Ox,{children:[v.jsx(Nx,{$color:"#e65100",children:t})," near"," ",t===1?"miss":"misses"]})]}),qB=D.div`
  display: flex;
  flex-direction: column;
  gap: 0;
  ${bs}
...
`,Mx=({name:e,value:t,checked:n,onChange:i,label:o,hint:l,icon:u})=>{const f=C.useId();return v.jsxs(cH,{htmlFor:f,children:[v.jsx(hH,{type:"radio",id:f,name:e,value:t,checked:n,onChange:i}),u,v.jsxs(uH,{children:[v.jsx(dH,{children:o}),l&&v.jsx(fH,{children:l})]})]})},kx=D.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,Lx=D.legend`
...
`,_H=D.img`
  ...
  height: ${e=>ph(e.size)}px;
  display: block;
`,mh=({discipline:e,size:t=32})=>{const n=C.useMemo(()=>{const i=Object.keys($x),o=e.name.toLowerCase(),l=i.find(u=>u.toLowerCase()===o)??i.find(u=>{const f=u.toLowerCase();return f.includes(o)||o.includes(f)});if(l)return $x[l];{const u=`Received unsupported discipline ${e.name}`;return console.log(u),Lv(u),"#fafafa"}},[e.name]);return v.jsx(vH,{color:n,size:t,children:v.jsx(_H,{alt:e.name,src:e.iconUrl,size:t,color:n})})},bH=D.img`
  width: ${e=>e.size}px;
...
`,g9=D.input`
  accent-color: ${e=>e.theme.colors.accent};
`,eD=({value:e,checked:t,onChange:n,label:i,icon:o})=>{const l=C.useId();return v.jsxs(p9,{$checked:t,htmlFor:l,children:[v.jsx(g9,{type:"checkbox",id:l,value:e,checked:t,onChange:n}),o,v.jsx(m9,{children:i})]})},tT=D.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,nT=D.legend`
...
`,rb=e=>{try{return window.localStorage.getItem(e)}catch(t){return Or(t),null}},ib=(e,t)=>{try{window.localStorage.setItem(e,t)}catch(n){Or(n)}},oD=e=>{try{window.localStorage.removeItem(e)}catch(t){Or(t)}},aD="BOOKABLE_STATUS_FILTERS",fv="DISCIPLINE_FILTERS",hv="INSTRUCTOR_FILTERS",PF=e=>{const t=rb(aD);return t===null?e:t.split(";").filter(ke.isBookableStatus)},jF=e=>{ib(aD,e.join(";"))},UF=e=>{const t=rb(fv);return t===null?e:t.split(";").filter(Boolean)},hT=e=>{e.length===0?oD(fv):ib(fv,e.join(";"))},$F=e=>{const t=rb(hv);return t===null?e:t.split(";").filter(Boolean)},pT=e=>{e.length===0?oD(hv):ib(hv,e.join(";"))},zF={selectedBookableStatuses:PF(["free","waitlist"]),selectedInstructors:$F([]),selectedDisciplines:UF([])},lD=Ar({name:"filters",initialState:zF,reducers:{toggleBookableStatus(e,t){e.selectedBookableStatuses.includes(t.payload)?e.selectedBookableStatuses=e.selectedBookableStatuses.filter(n=>n!==t.payload):e.selectedBookableStatuses=[...e.selectedBookableStatuses,t.payload],jF(e.selectedBookableStatuses)},toggleInstructor(e,t){e.selectedInstructors.includes(t.payload)?e.selectedInstructors=e.selectedInstructors.filter(n=>n!==t.payload):e.selectedInstructors=[...e.selectedInstructors,t.payload],pT(e.selectedInstructors)},resetInstructors(e){e.selectedInstructors=[],pT(e.selectedInstructors)},toggleDiscipline(e,t){e.selectedDisciplines.includes(t.payload)?e.selectedDisciplines=e.selectedDisciplines.filter(n=>n!==t.payload):e.selectedDisciplines=[...e.selectedDisciplines,t.payload],hT(e.selectedDisciplines)},resetDisciplines(e){e.selectedDisciplines=[],hT(e.selectedDisciplines)}}}),{toggleBookableStatus:BF,toggleInstructor:HF,resetInstructors:FF,toggleDiscipline:qF,resetDisciplines:VF}=lD.actions,GF=lD.reducer,YF=()=>{const e=ct(i=>i.filters.selectedBookableStatuses),t=gs(),n=C.useCallback(i=>{t(BF(i))},[t]);return{bookableStatuses:e,toggleBookableStatus:n}},WF=D.button`
  cursor: pointer;
  color: ${e=>e.theme.colors.accent};
  font-size: 12px;
  background: none;
...
`,vT=D.p`
  ...
  margin: 0;
  line-height: 1.5;
`,Kq=({classes:e,fulfilledTimeStamp:t})=>{const n=ct(u=>Oq(u,e)),i=ct(Tq),o=ct(u=>u.filters.selectedBookableStatuses.includes("free")),l=C.useMemo(()=>t?new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"}).format(t):void 0,[t]);return n.length===0?v.jsxs(Wq,{children:[v.jsx(Qq,{children:"No classes found"}),i&&v.jsx(vT,{children:"Try resetting your filters or selecting more options in the sidebar."}),o&&!i&&v.jsx(vT,{children:"New classes usually open at 12:00 pm on Mondays and Thursdays in your studio's timezone."})]}):v.jsx(qq,{children:n.map((u,f)=>v.jsxs(Vq,{children:[v.jsxs(Gq,{children:[v.jsx(Yq,{children:u.formattedDate}),f===0&&l&&v.jsxs(yT,{children:["Times in studio timezone · loaded ",l]}),f===0&&!l&&v.jsx(yT,{children:"All times in studio timezone"})]}),u.classes.map((h,p)=>v.jsx(Fq,{clazz:h},p))]},f))})},_T=D.div`
  background-color: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 32px 24px;
