...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="4be8b5a4-05e3-58bb-8686-cbecfb61ca87")}catch(e){}}();
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z3=Math.log(2);class B3{constructor(t){const n=l=>parseInt(Math.log(l)/z3,10),i=l=>parseInt(Array(l+1).join("1"),2);this.count=n(t+1),this.current_=this.count-1;const o=i(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const eh=function(e,t,n,i){e.sort(t);const o=function(p,h){const y=h-p;let _,v;if(y===0)return null;if(y===1)return _=e[p],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,null,null);{const b=parseInt(y/2,10)+p,x=o(p,b),I=o(b+1,h);return _=e[b],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,x,I)}},l=function(p){let h=null,y=null,_=e.length;const v=function(x,I){const C=_-x,D=_;_-=x;const M=o(C+1,D),R=e[C],O=n?n(R):R;b(new Vt(O,R.node,I,null,M))},b=function(x){h?(h.left=x,h=x):(y=x,h=x)};for(let x=0;x<p.count;++x){const I=p.nextBitIsOne(),C=Math.pow(2,p.count-(x+1));I?v(C,Vt.BLACK):(v(C,Vt.BLACK),v(C,Vt.RED))}return y},u=new B3(e.length),f=l(u);return new Sn(i||t,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index-D80aq1ZC.js.map

//# debugId=4be8b5a4-05e3-58bb-8686-cbecfb61ca87
