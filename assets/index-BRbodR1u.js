...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="a3bf75b0-c27a-5299-97d9-c7639b495307")}catch(e){}}();
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k$=Math.log(2);class N${constructor(t){const n=l=>parseInt(Math.log(l)/k$,10),i=l=>parseInt(Array(l+1).join("1"),2);this.count=n(t+1),this.current_=this.count-1;const o=i(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const Xf=function(e,t,n,i){e.sort(t);const o=function(p,h){const y=h-p;let v,_;if(y===0)return null;if(y===1)return v=e[p],_=n?n(v):v,new Vt(_,v.node,Vt.BLACK,null,null);{const b=parseInt(y/2,10)+p,x=o(p,b),I=o(b+1,h);return v=e[b],_=n?n(v):v,new Vt(_,v.node,Vt.BLACK,x,I)}},l=function(p){let h=null,y=null,v=e.length;const _=function(x,I){const C=v-x,D=v;v-=x;const M=o(C+1,D),R=e[C],O=n?n(R):R;b(new Vt(O,R.node,I,null,M))},b=function(x){h?(h.left=x,h=x):(y=x,h=x)};for(let x=0;x<p.count;++x){const I=p.nextBitIsOne(),C=Math.pow(2,p.count-(x+1));I?_(C,Vt.BLACK):(_(C,Vt.BLACK),_(C,Vt.RED))}return y},u=new N$(e.length),f=l(u);return new bn(i||t,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,of=T.p`
  ...
  text-align: center;
  padding: 32px 0;
`,MH=()=>{const{alertId:e}=zM(),t=ws(),n=E.useContext(ub),[i,o]=E.useState("idle"),l=E.useMemo(()=>n.state!=="fulfilled"?null:n.data.find(C=>C.id===e)??null,[n,e]),u=eH(l?.studioId??null),f=l?Ce.STUDIOS[l.studioId]?.timezone??"UTC":"UTC",p=E.useMemo(()=>!l||u.state!=="fulfilled"?[]:nH(u.data,f),[l,u,f]),{matchCount:h,nearMissCount:y}=E.useMemo(()=>{if(!l||u.state!=="fulfilled")return{matchCount:0,nearMissCount:0};let C=0,D=0;for(const M of u.data){const R=Ce.classifySnapshotMatch(M,l);R.type==="match"?C++:R.type==="near-miss"&&D++}return{matchCount:C,nearMissCount:D}},[l,u]),v=n.state==="loading"||n.state==="idle"||u.state==="loading",_="Notification"in window&&"serviceWorker"in navigator,b=E.useCallback(async()=>{if(_){o("sending");try{if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){o("idle");return}const C=await navigator.serviceWorker.ready,D=l?Ce.STUDIOS[l.studioId]:null,M="Spot opened up!",R=`${l?.name??"Test alert"} — ${D?.location??"Studio"} · test notification`;await C.showNotification(M,{body:R,icon:"/icons/icon-192x192.png",badge:"/icons/icon-96x96.png",data:{classUrl:"/p/7248695-peloton-studios-new-york/e/99586855-30-min-intervals-ride/"}}),o("sent"),setTimeout(()=>o("idle"),3e3)}catch{o("error"),setTimeout(()=>o("idle"),3e3)}}},[l,_]),x=l?.name??"Alert",I=i==="sending"?"Sending…":i==="sent"?"Sent!":i==="error"?"Error":"Send test notification";return g.jsxs(CH,{children:[g.jsxs(RH,{children:[g.jsx(DH,{type:"button",onClick:()=>t(-1),children:"← Alerts"}),g.jsxs(AH,{children:[g.jsx("div",{children:g.jsxs(OH,{children:[x," — Past 7 Days"]})}),_&&g.jsx(IH,{type:"button",$sent:i==="sent",disabled:i==="sending",onClick:b,title:"Fire a test push notification to verify delivery and the notification URL",children:I})]}),g.jsx(kH,{children:l?`${Ce.STUDIOS[l.studioId]?.location??l.studioId}`:""})]}),g.jsxs(NH,{children:[v&&g.jsx(of,{children:"Loading…"}),!v&&!l&&g.jsx(of,{children:"Alert not found."}),!v&&l&&u.state==="fulfilled"&&g.jsxs(g.Fragment,{children:[g.jsx(TH,{matchCount:h,nearMissCount:y}),p.length===0&&g.jsx(of,{children:"No class history yet. History builds up as the backend detects class changes."}),p.map(({label:C,dayIndex:D,snapshots:M})=>g.jsx(wH,{label:C,dayIndex:D,snapshots:M,alert:l,timezone:f},C))]}),!v&&u.state==="failed"&&g.jsx(of,{children:"Failed to load class history."})]})]})},LH=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},PH="STUDIO_ID",fD=e=>{const t=LH(PH);return t===null?e:Object.keys(Ce.STUDIOS).includes(t)?t:e},jH={studioId:fD(Ce.DEFAULT_STUDIO_ID)},vv=Kn({name:"studioSelector",initialState:jH,reducers:{setStudioId(e,t){e.studioId=t.payload}}}),{setStudioId:ph}=vv.actions,$H=async(e,t)=>{const n=xn;if(!n)throw new Error("No Firebase database connection to use");const i=(await AU(ir(n,Ce.PATHS.alerts(e)),t)).key;if(!i)throw new Error("Missing ID from insertion operation");return{...t,id:i}},hD=async(e,t)=>{const n=xn;if(!n)throw new Error("No Firebase database connection to use");const i={...t,name:t.name??null,watchedClassIds:t.watchedClassIds??null,disabled:t.disabled??null};await EI(ir(n,Ce.PATHS.alert(e,t.id)),i)},UH=T.div`
  display: flex;
  flex-direction: column;
`,zH=T.label`
  color: ${e=>e.theme.colors.main};
...
`,Bq=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-top: 4px;
`,Hq={free:{label:"Open spots",title:"Only alerts when a class has open spots available to book"},waitlist:{label:"Waitlist",title:"Alerts when a class has open spots or waitlist availability"},full:{label:"Any",title:"Alerts regardless of availability status"}},Fq=e=>Hq[e]||{label:e,title:""},qq=E.memo(({alert:e,onDuplicate:t,onEdit:n})=>{const i=ws(),o=et(vu),l=!!e.disabled,u=E.useCallback(()=>{o&&hD(o,{...e,disabled:!l})},[o,e,l]),{data:f}=vb(e.studioId),{data:p}=yb(e.studioId),h=E.useMemo(()=>{const C=new Date(e.created).getFullYear()===new Date().getFullYear();return new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",...C?{}:{year:"numeric"}}).format(e.created)},[e.created]),y=E.useMemo(()=>new Map(f?.map(I=>[I.id,I.name])),[f]),v=E.useMemo(()=>new Map(p?.map(I=>[I.id,I.name])),[p]),_=E.useMemo(()=>{if(e.name)return e.name;const I=Ce.isNotEmpty(e.instructors)&&f?e.instructors.map(D=>y.get(D)).filter(D=>!!D):null,C=Ce.isNotEmpty(e.disciplines)&&p?e.disciplines.map(D=>v.get(D)).filter(D=>!!D):null;return Iq(C,I)},[e.name,e.instructors,e.disciplines,f,p,y,v]),b=Ce.STUDIOS[e.studioId]?.location||e.studioId||"No studio",x=Fq(e.maxStatus);return g.jsx(Dq,{$disabled:l,children:g.jsxs(Oq,{children:[g.jsxs(kq,{children:[g.jsxs(Nq,{children:[g.jsx(Mq,{children:_}),g.jsx(Lq,{$status:e.maxStatus,title:x.title,children:x.label})]}),g.jsx(Pq,{children:b}),g.jsx(jq,{children:ls.map((I,C)=>g.jsx($q,{$active:!!e.timeRanges[C],title:e.timeRanges[C]?`${I}: monitoring enabled`:`${I}: not monitored`,children:I.charAt(0)},I))}),g.jsxs(Bq,{children:["Created ",h]})]}),g.jsxs(Uq,{children:[g.jsx(zD,{id:`toggle-${e.id}`,checked:!l,onChange:u,"aria-label":l?"Enable alert":"Disable alert"}),g.jsx(Df,{type:"button",onClick:()=>i(KU(e.id)),"aria-label":"Test alert",children:"Test"}),g.jsx(Df,{type:"button",onClick:()=>n(e),"aria-label":"Edit alert",children:"Edit"}),g.jsx(Df,{type:"button",onClick:()=>t(e),"aria-label":"Duplicate alert",children:"Duplicate"}),g.jsx(zq,{type:"button",onClick:()=>o&&Aq(o,e.id),"aria-label":"Delete alert",children:"Delete"})]})]})})}),Vq=T.ul`
  list-style: none;
  padding: 0;
  margin: 0;
  display: flex;
  flex-direction: column;
  gap: 8px;
`,Gq=({alerts:e,onDuplicate:t,onEdit:n})=>g.jsx(Vq,{children:e.map(i=>g.jsx(qq,{alert:i,onDuplicate:t,onEdit:n},i.id))}),Wq=T.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 20px 24px 0;
...
`,eV=T.p`
  ...
  color: ${e=>e.theme.colors.error};
  font-size: 14px;
`,tV=({onAdd:e,onEdit:t,onDuplicate:n})=>{const i=E.useContext(ub),o=i.state==="loading"||i.state==="idle",l=i.state==="failed",u=i.state==="fulfilled"?i.data:[];return g.jsxs(g.Fragment,{children:[g.jsxs(Wq,{children:[g.jsxs(Yq,{children:[g.jsx(Qq,{children:"Alerts"}),g.jsx(Kq,{children:o?"Loading your alerts…":l?"Something went wrong":u.length===0?"You haven't created any alerts yet":`${u.length} alert${u.length===1?"":"s"}`})]}),!o&&!l&&g.jsx(Xq,{type:"button",onClick:e,children:"+ New alert"})]}),g.jsxs(Zq,{children:[o&&g.jsx(Jq,{children:"Loading…"}),l&&g.jsx(eV,{children:"Failed to load your alerts. Please refresh and try again."}),!o&&!l&&u.length===0&&g.jsx(sV,{onAdd:e}),!o&&!l&&u.length>0&&g.jsx(Gq,{alerts:u,onEdit:t,onDuplicate:n})]})]})},nV=T.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 12px;
...
`,sV=({onAdd:e})=>g.jsxs(nV,{children:[g.jsx(rV,{children:"Create your first alert to get notified when classes become available."}),g.jsx(iV,{type:"button",onClick:e,children:"Create an alert"})]}),oV=T.button`
  padding: 1.5em;
  max-width: 300px;
  width: 100%;
  line-height: 0;
...
`,jT=T.div`
  ...
  ${Te`
    padding: 12px 16px 16px;
  `}
`,fV=()=>{const e=ws();return g.jsxs(dV,{children:[g.jsx(Sy,{children:g.jsx(tV,{onAdd:()=>{e(nt.ALERTS_EDITOR,{state:{}})},onEdit:t=>{e(nt.ALERTS_EDITOR,{state:t})},onDuplicate:t=>{e(nt.ALERTS_EDITOR,{state:{...t,id:void 0,created:void 0}})}})}),g.jsxs(Sy,{children:[g.jsxs(MT,{children:[g.jsx(LT,{children:"Preferences"}),g.jsx(PT,{children:"Control how often you receive alert notifications."})]}),g.jsx(jT,{children:g.jsx(cq,{})})]}),g.jsxs(Sy,{children:[g.jsxs(MT,{children:[g.jsx(LT,{children:"Devices"}),g.jsx(PT,{children:"Devices registered to receive push notifications. Removed devices will re-register on their next visit."})]}),g.jsxs(jT,{children:[g.jsx(uV,{}),g.jsx(Rq,{})]})]})]})},hV=T.button.attrs({"aria-label":"Close",type:"button"})`
  position: relative;
  width: 50px;
  height: 50px;
  font-size: 0;
...
`,pV=()=>{const e=et(i=>i.filters.selectedBookableStatuses),t=Mn(),n=E.useCallback(i=>{t(g7(i))},[t]);return{bookableStatuses:e,toggleBookableStatus:n}},mV=T.button`
  cursor: pointer;
  color: ${e=>e.theme.colors.accent};
  font-size: 12px;
  background: none;
...
`,yV=T.h3`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin: 0;
`,dp=({label:e,onReset:t,children:n})=>g.jsxs(gV,{children:[g.jsx(yV,{children:e}),t&&g.jsx(mV,{type:"button",onClick:t,children:"Reset"}),n]}),vV=T.div`
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  padding: 0 16px 16px;
`,_V=T.button`
  ...
  ${e=>e.$active?nn`
        ...
        `}
`,bV=()=>{const{bookableStatuses:e,toggleBookableStatus:t}=pV(),n=qv(),i=[{label:"Free",status:"free",color:n.colors.status.free.text},{label:"Waitlist",status:"waitlist",color:n.colors.status.waitlist.text},{label:"Full",status:"full",color:n.colors.status.full.text}];return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(dp,{label:"Status"})}),g.jsx(vV,{children:i.map(o=>{const l=e.includes(o.status);return g.jsx(_V,{type:"button",$active:l,$color:o.color,onClick:()=>t(o.status),"aria-pressed":l,children:o.label},o.status)})})]})},SV=()=>{const e=et(i=>i.filters.selectedDisciplines),t=Mn(),n=E.useCallback(i=>{t(_7(i))},[t]);return{selectedDisciplines:e,toggleDiscipline:n}},BD=T.ul`
  list-style: none;
  margin: 0;
  padding: 0 0 8px;
`,HD=T.li`
...
`,xh=T.p`
  ...
  padding: 8px 16px 16px;
  margin: 0;
`,xV=({discipline:e,checked:t,onClick:n})=>g.jsxs(HD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(FD,{$checked:t}),g.jsx(yh,{discipline:e,size:24}),g.jsx(qD,{children:e.name})]}),wV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=yb(e),{selectedDisciplines:o,toggleDiscipline:l}=SV(),u=Mn(),f=E.useRef(o);return E.useEffect(()=>{const p=f.current;if(!t||p.length===0)return;const h=new Set(t.map(v=>v.id)),y=p.filter(v=>h.has(v));y.length<p.length&&u(b7(y))},[t,u]),i&&!n?g.jsx(xh,{children:"Failed to load disciplines"}):!t||n?g.jsx(xh,{children:"Loading…"}):g.jsx(BD,{children:t.map((p,h)=>g.jsx(xV,{discipline:p,checked:o.includes(p.id),onClick:()=>l(p.id)},h))})},EV=()=>{const e=et(n=>n.filters.selectedDisciplines.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(dp,{label:"Disciplines",onReset:e?()=>t(S7()):void 0}),g.jsx(wV,{})]})},TV=()=>{const e=et(i=>i.filters.selectedInstructors),t=Mn(),n=E.useCallback(i=>{t(y7(i))},[t]);return{selectedInstructors:e,toggleInstructor:n}},CV=({instructor:e,checked:t,onClick:n})=>g.jsxs(HD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(FD,{$checked:t}),g.jsx(db,{instructor:e,size:28}),g.jsx(qD,{children:e.name})]}),RV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=vb(e),{selectedInstructors:o,toggleInstructor:l}=TV();return i&&!n?g.jsx(xh,{children:"Failed to load instructors"}):!t||n?g.jsx(xh,{children:"Loading…"}):g.jsx(BD,{children:t.map((u,f)=>g.jsx(CV,{instructor:u,checked:o.includes(u.id),onClick:()=>l(u.id)},f))})},AV=()=>{const e=et(n=>n.filters.selectedInstructors.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(dp,{label:"Instructors",onReset:e?()=>t(v7()):void 0}),g.jsx(RV,{})]})},IV=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),DV=T.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
  padding: 0 16px 16px;
...
`,MV=T.span`
  font-size: 15px;
  color: ${e=>e.theme.colors.main};
`,LV=()=>{const e=Mn(),t=et(Do);return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(dp,{label:"Studio"})}),g.jsx(DV,{children:IV.map(n=>{const i=t===n.id;return g.jsxs(OV,{$selected:i,htmlFor:`studio-${n.id}`,children:[g.jsx(kV,{type:"radio",id:`studio-${n.id}`,name:"studio-selected",value:n.id,checked:i,onChange:()=>{i||e(ph(n.id))}}),g.jsx(NV,{$selected:i}),g.jsx(MV,{children:n.label})]},n.id)})})]})},PV=T.div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,jV=T.div`
...
`,BV=({onClose:e})=>g.jsxs(PV,{children:[g.jsxs(jV,{children:[g.jsx($V,{children:"Filters"}),g.jsx(UV,{onClick:()=>e()})]}),g.jsxs(zV,{children:[g.jsx(ff,{children:g.jsx(LV,{})}),g.jsx(ff,{children:g.jsx(bV,{})}),g.jsx(ff,{children:g.jsx(EV,{})}),g.jsx(ff,{children:g.jsx(AV,{})})]})]}),HV=()=>{const e=et(Do),{refetch:t}=gb(e);return{refresh:E.useCallback(async()=>{await t()},[t])}},$T=150,UT=60,FV=()=>document.documentElement.scrollTop||document.body.scrollTop,qV=({refresh:e})=>{const t=E.useRef(null),n=E.useRef(null),i=E.useRef(e);E.useLayoutEffect(()=>{i.current=e});const o=E.useMemo(()=>!!navigator.standalone||window.matchMedia("(display-mode: standalone)").matches||!1,[]);return E.useEffect(()=>{if(!o)return;let l=0,u=!1,f=!1,p=!1;const h=x=>{const I=n.current;I&&(I.style.transition=x?"transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease":"none",I.style.transform="",I.style.opacity="0")},y=x=>{l=x.touches[0].clientY,u=!1,f=!1},v=x=>{if(p||FV()>0)return;const I=x.touches[0].clientY-l;if(I<=0){u&&(u=!1,f=!1,h(!1));return}u=!0,f=I>=$T;const C=Math.min(I/$T,1),D=UT*(1-Math.pow(1-C,2)),M=Math.pow(C,.5),R=Math.floor(C*270),O=n.current;O&&(O.style.transition="none",O.style.transform=`translateY(${D}px) rotate(${R}deg)`,O.style.opacity=String(Math.min(M,1)))},_=()=>{if(u)if(u=!1,f&&!p){f=!1,p=!0;const x=n.current;x&&(x.classList.add("animate"),x.style.transition="none",x.style.transform=`translateY(${UT}px)`,x.style.opacity="1");let I=!1;const C=()=>{if(I)return;I=!0,p=!1;const M=n.current;M&&(M.classList.remove("animate"),h(!0))},D=setTimeout(C,1e4);i.current().finally(()=>{clearTimeout(D),C()})}else f=!1,h(!0)},b=()=>{u=!1,f=!1,h(!1)};return document.addEventListener("touchstart",y,{passive:!0}),document.addEventListener("touchmove",v,{passive:!0}),document.addEventListener("touchend",_,{passive:!0}),document.addEventListener("touchcancel",b,{passive:!0}),()=>{document.removeEventListener("touchstart",y),document.removeEventListener("touchmove",v),document.removeEventListener("touchend",_),document.removeEventListener("touchcancel",b)}},[o]),{swipeRef:t,spinnerRef:n}},VV=e=>e.filters.selectedDisciplines.length>0||e.filters.selectedInstructors.length>0,GV=e=>e.filters.selectedBookableStatuses,WV=e=>e.filters.selectedDisciplines,YV=e=>e.filters.selectedInstructors,QV=(e,t)=>t,KV=wi([GV,WV,YV,QV],(e,t,n,i)=>i.filter(o=>e.includes(o.status)).filter(o=>n.length>0?n.some(l=>l===o.instructor.id):!0).filter(o=>t.length>0?t.includes(o.discipline.id):!0)),VD=wi([Do],e=>{if(e)return Ce.STUDIOS[e]}),XV=wi([KV,VD],(e,t)=>{if(e.length===0)return[];const n=t?.timezone||"",i=[];let o=1,l=Va(e[0].start,n,!0),u=[e[0]];for(;o<e.length;){const f=e[o],p=Va(f.start,n,!0);p===l?u.push(f):(i.push({formattedDate:l,classes:u}),l=p,u=[f]),o++}return u.length>0&&i.push({formattedDate:l,classes:u}),i}),zT={free:{label:"Book"},waitlist:{label:"Waitlist"},full:{label:"Full"}},ZV=T.a`
  display: flex;
  align-items: center;
  gap: 14px;
  text-decoration: none;
...
`,lG=T.button`
  ...
  ${Te`
    ...
    padding: 5px 10px;
  `}
`,cG=E.memo(({clazz:e})=>{const t=et(VD),n=e.status,i=n==="free"||n==="waitlist",o=E.useMemo(()=>e.customerUrl?new URL(e.customerUrl,"https://schedule.studio.onepeloton.com").href:(Qv("Missing customer URL",{extra:{clazz:e}}),""),[e]),l=E.useMemo(()=>To(e.start,t?.timezone),[e.start,t?.timezone]),u=zT[n]??zT.full;return g.jsxs(ZV,{$status:n,$interactive:i,href:o,target:"_blank","aria-label":`${u.label} ${e.name} at ${l}`,children:[g.jsxs(JV,{children:[g.jsx(eG,{children:l}),g.jsxs(tG,{children:[e.duration/60," min"]})]}),g.jsxs(nG,{children:[g.jsx(db,{instructor:e.instructor,size:44}),g.jsx(yh,{discipline:e.discipline,size:36})]}),g.jsxs(rG,{children:[g.jsx(iG,{children:e.name}),g.jsxs(sG,{children:[e.instructor.name,g.jsx(oG,{children:"·"}),e.discipline.name,g.jsx(aG,{children:g.jsx(yh,{discipline:e.discipline,size:20})})]})]}),g.jsx(lG,{$status:n,disabled:!i,tabIndex:-1,children:u.label})]})}),uG=T.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
`,dG=T.div`
...
`,HT=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`,gG=({classes:e,fulfilledTimeStamp:t})=>{const n=et(u=>XV(u,e)),i=et(VV),o=et(u=>u.filters.selectedBookableStatuses.includes("free")),l=E.useMemo(()=>t?new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"}).format(t):void 0,[t]);return n.length===0?g.jsxs(pG,{children:[g.jsx(mG,{children:"No classes found"}),i&&g.jsx(HT,{children:"Try resetting your filters or selecting more options in the sidebar."}),o&&!i&&g.jsx(HT,{children:"New classes usually open at 12:00 pm on Mondays and Thursdays in your studio's timezone."})]}):g.jsx(uG,{children:n.map((u,f)=>g.jsxs(dG,{children:[g.jsxs(fG,{children:[g.jsx(hG,{children:u.formattedDate}),f===0&&l&&g.jsxs(BT,{children:["Times in studio timezone · loaded ",l]}),f===0&&!l&&g.jsx(BT,{children:"All times in studio timezone"})]}),u.classes.map((p,h)=>g.jsx(cG,{clazz:p},h))]},f))})},FT=T.div`
  background-color: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 32px 24px;
...
`,_G=T.code`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,bG=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i,fulfilledTimeStamp:o}=gb(e,{refetchOnMountOrArgChange:!0});return i&&!n?g.jsxs(FT,{children:[g.jsx(vG,{children:"Failed to load classes"}),g.jsx(_G,{children:Y9(i)})]}):!t||n?g.jsx(FT,{children:g.jsx(yG,{children:"Loading classes…"})}):g.jsx(gG,{classes:t,fulfilledTimeStamp:o})},SG=T.div``,Cv=300,xG=T.aside`
  max-width: 100%;
  width: ${Cv}px;
  top: calc(${X_}px + env(safe-area-inset-top, 0px));
  bottom: 0;
...
`,zG=()=>{const e=ws(),[t,n]=E.useState(!1),[i,o]=E.useState(""),[l,u]=E.useState(!1),[f,p]=E.useState(""),[h,y]=E.useState(""),v=E.useCallback(async b=>{if(b.preventDefault(),!(!ui||!f||!h)){n(!0),o("");try{l?await Wz(ui,f,h):await Yz(ui,f,h),e(nt.CLASS_LIST)}catch(x){console.error("Email auth error:",x);const I=x&&typeof x=="object"&&"code"in x?qT(x):"Authentication failed";o(I),Nr(x)}finally{n(!1)}}},[f,h,l,e]),_=E.useCallback(async()=>{if(ui){n(!0),o("");try{const b=new ci;await y8(ui,b),e(nt.CLASS_LIST)}catch(b){console.error("Google sign-in error:",b);const x=b&&typeof b=="object"&&"code"in b?qT(b):"Google sign-in failed";o(x),Nr(b)}finally{n(!1)}}},[e]);return g.jsxs("div",{children:[g.jsx(OG,{children:l?"Create account":"Sign in"}),g.jsx(kG,{children:"Set alerts, persist filters across devices, and access beta features."}),g.jsxs(NG,{onSubmit:v,children:[g.jsxs(VT,{children:[g.jsx(GT,{htmlFor:"signin-email",children:"Email"}),g.jsx(WT,{id:"signin-email",type:"email",placeholder:"you@example.com",value:f,onChange:b=>p(b.target.value),required:!0,disabled:t})]}),g.jsxs(VT,{children:[g.jsx(GT,{htmlFor:"signin-password",children:"Password"}),g.jsx(WT,{id:"signin-password",type:"password",placeholder:"••••••••",value:h,onChange:b=>y(b.target.value),required:!0,disabled:t})]}),i&&g.jsx(jG,{role:"alert",children:i}),g.jsx(MG,{type:"submit",disabled:t,children:t?"Loading…":l?"Create account":"Sign in"})]}),g.jsx(PG,{style:{marginTop:20,marginBottom:16},children:"or"}),g.jsx(LG,{type:"button",onClick:_,disabled:t,children:"Continue with Google"}),g.jsxs($G,{children:[l?"Already have an account?":"Don't have an account?"," ",g.jsx(UG,{type:"button",onClick:()=>{u(!l),o("")},disabled:t,children:l?"Sign in":"Create account"})]})]})},BG=wi([el],e=>e.state==="fulfilled"&&!!e.data),HG=T.div`
  padding: 32px 20px;
  display: flex;
  justify-content: center;
...
`,FG=T.div`
  ...
  ${Te`
    padding: 24px 20px;
  `}
`,qG=()=>et(BG)?g.jsx(Lv,{to:nt.CLASS_LIST}):g.jsx(hs,{children:g.jsx(HG,{children:g.jsx(FG,{children:g.jsx(zG,{})})})});function VG(e){const t=[];for(let n=e-1;n>=0;n--){const i=new Date;i.setDate(i.getDate()-n),t.push(i.toISOString().slice(0,10))}return t}function GG(e=14){const[t,n]=E.useState({state:"idle"});return E.useEffect(()=>{if(!xn){n({state:"failed",error:new Error("No database")});return}n({state:"loading"}),TI(ir(xn,"metrics")).then(i=>{const o=i.val()??{},u=VG(e).map(f=>{const p=o[f]??{},h=p.diffs??{},y={};for(const[_,b]of Object.entries(h))y[_]={added:b.added??0,changed:b.changed??0,removed:b.removed??0};const v=p.notifications??{};return{date:f,diffs:y,notifications:{sent:v.sent??0,failed:v.failed??0,usersReached:v.usersReached??0}}});n({state:"fulfilled",data:u})}).catch(i=>{n({state:"failed",error:i})})},[e]),t}const xy=T.div`
  padding: 32px 24px;
  max-width: 900px;
  margin: 0 auto;
...
`,KT=T.p`
  color: ${e=>e.theme.colors.secondary};
  font-size: 14px;
`,wh=1e3,Of=140,Eh=12,GD=4,WD=Of-Eh-GD;function _c(e,t){return t<=1?wh/2:e/(t-1)*wh}function Ey(e,t){return Eh+WD*(1-e/t)}const YG=[.25,.5,.75],QG=T.div`
  background: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 16px 16px 12px;
...
`,tW=T.div`
  ...
  background-color: ${e=>e.$color};
  flex-shrink: 0;
`;function nW(e){const[,t,n]=e.split("-");return`${parseInt(t)}/${parseInt(n)}`}function rW({days:e,legend:t}){return g.jsxs(g.Fragment,{children:[g.jsx(XG,{children:e.map(n=>g.jsx(ZG,{children:nW(n.date)},n.date))}),g.jsx(JG,{children:t.map(n=>g.jsxs(eW,{children:[g.jsx(tW,{$color:n.color}),n.label]},n.label))})]})}const iW=T.div`
  position: relative;
`,sW=T.div`
  position: absolute;
  top: 6px;
...
`,uW=T.div`
  ...
  pointer-events: none;
`;function XT({days:e,seriesForDay:t,legend:n}){const i=e.length,[o,l]=E.useState(null),u=e.map(t),f=Math.max(...u.flatMap(_=>_.map(b=>b.value)),1),p=u[0].length,h=Ey(0,f).toFixed(1);function y(_,b){const{left:x,width:I}=b.getBoundingClientRect(),C=(_-x)/I;return Math.max(0,Math.min(i-1,Math.round(C*(i-1))))}const v=o!==null?o/(i-1)*100:null;return g.jsxs(QG,{children:[g.jsxs(iW,{children:[o!==null&&v!==null&&g.jsxs(g.Fragment,{children:[g.jsxs(sW,{$pct:v,children:[g.jsx(oW,{children:e[o].date}),u[o].map(_=>g.jsxs(aW,{children:[g.jsx(lW,{$color:_.color}),_.label,g.jsx(cW,{children:_.value})]},_.label))]}),u[o].map((_,b)=>g.jsx(uW,{$color:_.color,style:{left:`${v}%`,top:`${Ey(_.value,f)/Of*100}%`}},b))]}),g.jsxs(KG,{viewBox:`0 0 ${wh} ${Of}`,preserveAspectRatio:"none","aria-hidden":"true",style:{cursor:"crosshair",display:"block"},onMouseMove:_=>l(y(_.clientX,_.currentTarget)),onMouseLeave:()=>l(null),onTouchStart:_=>l(y(_.touches[0].clientX,_.currentTarget)),onTouchMove:_=>l(y(_.touches[0].clientX,_.currentTarget)),onTouchEnd:()=>l(null),children:[YG.map(_=>{const b=(Eh+WD*(1-_)).toFixed(1);return g.jsx("line",{x1:0,y1:b,x2:wh,y2:b,stroke:"currentColor",strokeOpacity:.1,strokeWidth:1,vectorEffect:"non-scaling-stroke"},_)}),o!==null&&g.jsx("line",{x1:_c(o,i).toFixed(1),y1:Eh,x2:_c(o,i).toFixed(1),y2:Of-GD,stroke:"currentColor",strokeOpacity:.2,strokeWidth:1,vectorEffect:"non-scaling-stroke"}),Array.from({length:p},(_,b)=>{const x=u[0][b].color,C=u.map((M,R)=>({x:_c(R,i),y:Ey(M[b].value,f)})).map(({x:M,y:R},O)=>`${O===0?"M":"L"}${M.toFixed(1)},${R.toFixed(1)}`).join(" "),D=[C,`L${_c(i-1,i).toFixed(1)},${h}`,`L${_c(0,i).toFixed(1)},${h}`,"Z"].join(" ");return g.jsxs("g",{children:[g.jsx("path",{d:D,fill:x,fillOpacity:.12}),g.jsx("path",{d:C,fill:"none",stroke:x,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",vectorEffect:"non-scaling-stroke"})]},b)})]})]}),g.jsx(rW,{days:e,legend:n})]})}const Wn={added:"#4ade80",changed:"#facc15",removed:"#f87171",sent:"#60a5fa",failed:"#f87171",usersReached:"#a78bfa"},dW=()=>{const e=GG(14);if(e.state==="idle"||e.state==="loading")return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsx(KT,{children:"Loading…"})]})});if(e.state==="failed")return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsxs(KT,{children:["Failed to load metrics: ",e.error.message??"unknown error"]})]})});const t=e.data,n=t.reduce((o,l)=>{o.sent+=l.notifications.sent,o.failed+=l.notifications.failed,o.usersReached+=l.notifications.usersReached;for(const u of Object.values(l.diffs))o.added+=u.added,o.changed+=u.changed,o.removed+=u.removed;return o},{sent:0,failed:0,usersReached:0,added:0,changed:0,removed:0}),i=[...new Set(t.flatMap(o=>Object.keys(o.diffs)))];return g.jsx(hs,{children:g.jsxs(xy,{children:[g.jsx(wy,{children:"Stats"}),g.jsxs(WG,{children:[g.jsxs(ya,{children:[g.jsx(va,{children:"Notifications sent (14d)"}),g.jsx(_a,{children:n.sent.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Users reached (14d)"}),g.jsx(_a,{children:n.usersReached.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Delivery failures (14d)"}),g.jsx(_a,{children:n.failed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes added (14d)"}),g.jsx(_a,{children:n.added.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes changed (14d)"}),g.jsx(_a,{children:n.changed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes removed (14d)"}),g.jsx(_a,{children:n.removed.toLocaleString()})]})]}),g.jsxs(YT,{children:[g.jsx(QT,{children:"Push notifications (14 days)"}),g.jsx(XT,{days:t,seriesForDay:o=>[{value:o.notifications.sent,color:Wn.sent,label:"Sent"},{value:o.notifications.failed,color:Wn.failed,label:"Failed"},{value:o.notifications.usersReached,color:Wn.usersReached,label:"Users reached"}],legend:[{color:Wn.sent,label:"Sent"},{color:Wn.failed,label:"Failed"},{color:Wn.usersReached,label:"Users reached"}]})]}),i.map(o=>g.jsxs(YT,{children:[g.jsxs(QT,{children:["Schedule changes — ",Ce.STUDIOS[o]?.location??o," (14 days)"]}),g.jsx(XT,{days:t,seriesForDay:l=>{const u=l.diffs[o]??{added:0,changed:0,removed:0};return[{value:u.added,color:Wn.added,label:"Added"},{value:u.changed,color:Wn.changed,label:"Changed"},{value:u.removed,color:Wn.removed,label:"Removed"}]},legend:[{color:Wn.added,label:"Added"},{color:Wn.changed,label:"Changed"},{color:Wn.removed,label:"Removed"}]})]},o))]})})},fW=T.div`
  max-width: 480px;
  margin: 0 auto;
  padding: 40px 20px;
  display: flex;
...
`,vW=T.p`
  ...
  font-size: 13px;
  color: ${e=>e.theme.colors.secondary};
`;function _W(e,t){if(!e)return null;try{const n=Ce.STUDIOS[t]?.timezone;return new Date(e).toLocaleString("en-US",{timeZone:n??"UTC",weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",timeZoneName:"short"})}catch{return null}}const bW=()=>{const[e]=j2(),t=e.get("studioId")??"",n=e.get("startsAt")??"",i=e.get("waitingCount"),o=Ce.STUDIOS[t],l=_W(n,t),u=i!==null?parseInt(i,10):null;return g.jsx(hs,{children:g.jsxs(fW,{children:[g.jsx(hW,{children:"📬"}),g.jsx(pW,{children:"Waitlist count changed"}),g.jsxs(mW,{children:["The number of people on the waitlist just changed",u!==null?` — there ${u===1?"is now 1 person":`are now ${u} people`} ahead`:"",". If you joined this waitlist, check your email — Peloton sends a message when it's your turn, and you'll have a 2-hour window to accept."]}),(l||o)&&g.jsxs(gW,{children:[o&&g.jsxs(g.Fragment,{children:[g.jsx(ZT,{children:"Studio"}),g.jsx(JT,{children:o.location})]}),l&&g.jsxs(g.Fragment,{children:[g.jsx(ZT,{style:{marginTop:o?8:0},children:"Class time"}),g.jsx(JT,{children:l})]})]}),g.jsx(yW,{href:"mailto:",children:"Open Mail App"}),g.jsx(vW,{children:"Opens your device's default mail app."})]})})},SW=O2(a2(g.jsxs(Yn,{children:[g.jsx(Yn,{path:nt.CLASS_LIST,element:g.jsx(IG,{})}),g.jsxs(Yn,{path:nt.ALERTS,element:g.jsx(q7,{}),children:[g.jsx(Yn,{index:!0,element:g.jsx(fV,{})}),g.jsx(Yn,{path:"edit",element:g.jsx(r7,{})}),g.jsx(Yn,{path:":alertId/test",element:g.jsx(MH,{})})]}),g.jsx(Yn,{path:nt.WAITLIST_ALERT,element:g.jsx(bW,{})}),g.jsx(Yn,{path:nt.SIGN_IN,element:g.jsx(qG,{})}),g.jsx(Yn,{path:nt.ABOUT,element:g.jsx(ZB,{})}),g.jsx(Yn,{path:nt.STATS,element:g.jsx(DG,{children:g.jsx(dW,{})})}),g.jsx(Yn,{path:"*",element:g.jsx(Lv,{to:nt.CLASS_LIST,replace:!0})})]}))),xW=(e,t)=>({id:e.uid,displayName:e.displayName||e.email||"",isAdmin:t}),wW=({children:e})=>{const t=Mn();return E.useEffect(()=>{if(t(IT()),!ui)return t(DT()),()=>{};const n=Xz(ui,async i=>{if(t(IT()),i){let o=!1;try{o=(xn?await TI(ir(xn,`admins/${i.uid}`)):null)?.val()===!0}catch{}t(A7(xW(i,o)))}else t(DT())});return()=>n()},[t]),g.jsx(g.Fragment,{children:e})},EW={mode:"light",borderRadius:"8px",borderColor:"#d1d1d1",colors:{main:"#494f59",secondary:"#514e60",mainSurface:"#fff",secondarySurface:"#ededed",accent:"#cb3449",error:"#d93025",hoverSurface:"rgba(0, 0, 0, 0.05)",status:{free:{bg:"#e8f5e9",text:"#2e7d32"},waitlist:{bg:"#fff3e0",text:"#e65100"},full:{text:"#9e9e9e"}}},widths:{tablet:1024,mobile:560}},TW={mode:"dark",borderRadius:"8px",borderColor:"#2e2f45",colors:{main:"#e2e4eb",secondary:"#9b98b0",mainSurface:"#1c1d2e",secondarySurface:"#13141f",accent:"#cb3449",error:"#ef5350",hoverSurface:"rgba(255, 255, 255, 0.08)",status:{free:{bg:"rgba(46, 125, 50, 0.15)",text:"#81c784"},waitlist:{bg:"rgba(230, 81, 0, 0.15)",text:"#ffb74d"},full:{text:"#757575"}}},widths:{tablet:1024,mobile:560}},CW=GL`
  html {
...
`,Rv="theme-mode";function RW(){const e=localStorage.getItem(Rv);return e!==null?e==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches}function AW(){const[e,t]=E.useState(RW),n=E.useCallback(()=>{t(i=>{const o=!i;return localStorage.setItem(Rv,o?"dark":"light"),o})},[]);return E.useEffect(()=>{const i=window.matchMedia("(prefers-color-scheme: dark)"),o=l=>{localStorage.getItem(Rv)===null&&t(l.matches)};return i.addEventListener("change",o),()=>i.removeEventListener("change",o)},[]),{isDark:e,toggle:n}}function IW(){const{isDark:e,toggle:t}=AW();return E.useEffect(()=>{const i=new URLSearchParams(window.location.search).get("classUrl");i&&(window.history.replaceState(null,"",window.location.pathname+window.location.hash),window.location.assign(new URL(i,"https://schedule.studio.onepeloton.com").href))},[]),g.jsx(cD.Provider,{value:{isDark:e,toggle:t},children:g.jsxs(FL,{theme:e?TW:EW,children:[g.jsx(CW,{}),g.jsx(EN,{store:up,children:g.jsx(wW,{children:g.jsx(QU,{children:g.jsx(q2,{router:SW})})})})]})})}lN.createRoot(document.getElementById("root")).render(g.jsx(E.StrictMode,{children:g.jsx(IW,{})}));
//# sourceMappingURL=index-BRbodR1u.js.map

//# debugId=a3bf75b0-c27a-5299-97d9-c7639b495307
