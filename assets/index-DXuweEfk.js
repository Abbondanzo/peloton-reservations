...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ea97794f-026c-5bfa-83ad-e942482a6b52")}catch(e){}}();
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z3=Math.log(2);class B3{constructor(t){const n=l=>parseInt(Math.log(l)/z3,10),i=l=>parseInt(Array(l+1).join("1"),2);this.count=n(t+1),this.current_=this.count-1;const o=i(this.count);this.bits_=t+1&o}nextBitIsOne(){const t=!(this.bits_&1<<this.current_);return this.current_--,t}}const th=function(e,t,n,i){e.sort(t);const o=function(p,h){const y=h-p;let _,v;if(y===0)return null;if(y===1)return _=e[p],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,null,null);{const b=parseInt(y/2,10)+p,x=o(p,b),I=o(b+1,h);return _=e[b],v=n?n(_):_,new Vt(v,_.node,Vt.BLACK,x,I)}},l=function(p){let h=null,y=null,_=e.length;const v=function(x,I){const C=_-x,k=_;_-=x;const M=o(C+1,k),R=e[C],D=n?n(R):R;b(new Vt(D,R.node,I,null,M))},b=function(x){h?(h.left=x,h=x):(y=x,h=x)};for(let x=0;x<p.count;++x){const I=p.nextBitIsOne(),C=Math.pow(2,p.count-(x+1));I?v(C,Vt.BLACK):(v(C,Vt.BLACK),v(C,Vt.RED))}return y},u=new B3(e.length),f=l(u);return new Sn(i||t,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,oV=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-top: 4px;
`,aV={free:{label:"Open spots",title:"Only alerts when a class has open spots available to book"},waitlist:{label:"Waitlist",title:"Alerts when a class has open spots or waitlist availability"},full:{label:"Any",title:"Alerts regardless of availability status"}},lV=e=>aV[e]||{label:e,title:""},cV=E.memo(({alert:e,onDuplicate:t,onEdit:n})=>{const i=ws(),o=et(_u),l=!!e.disabled,[u,f]=E.useState(!1),[p,h]=E.useState(!1),[y,_]=E.useState({top:0,right:0}),v=E.useRef(null),b=E.useRef(null),x=E.useCallback(()=>{o&&SD(o,{...e,disabled:!l})},[o,e,l]),I=E.useCallback(()=>{f(!1),h(!1)},[]);E.useLayoutEffect(()=>{if(!u||!v.current)return;const U=v.current.getBoundingClientRect();_({top:U.bottom+4,right:window.innerWidth-U.right})},[u]),E.useEffect(()=>{if(!u)return;const U=z=>{z.key==="Escape"&&I()},F=z=>{if(!(z.target instanceof Node))return I();!v.current?.contains(z.target)&&!b.current?.contains(z.target)&&I()},H=setTimeout(()=>{document.addEventListener("keydown",U),document.addEventListener("click",F,!0)},0);return()=>{clearTimeout(H),document.removeEventListener("keydown",U),document.removeEventListener("click",F,!0)}},[u,I]);const{data:C}=wb(e.studioId),{data:k}=xb(e.studioId),M=E.useMemo(()=>{const F=new Date(e.created).getFullYear()===new Date().getFullYear();return new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",...F?{}:{year:"numeric"}}).format(e.created)},[e.created]),R=E.useMemo(()=>new Map(C?.map(U=>[U.id,U.name])),[C]),D=E.useMemo(()=>new Map(k?.map(U=>[U.id,U.name])),[k]),N=E.useMemo(()=>{if(e.name)return e.name;const U=Ce.isNotEmpty(e.instructors)&&C?e.instructors.map(H=>R.get(H)).filter(H=>!!H):null,F=Ce.isNotEmpty(e.disciplines)&&k?e.disciplines.map(H=>D.get(H)).filter(H=>!!H):null;return Uq(F,U)},[e.name,e.instructors,e.disciplines,C,k,R,D]),A=Ce.STUDIOS[e.studioId]?.location||e.studioId||"No studio",P=lV(e.maxStatus);return g.jsx(zq,{$disabled:l,children:g.jsxs(Bq,{children:[g.jsxs(Hq,{children:[g.jsxs(Fq,{children:[g.jsx(qq,{children:N}),g.jsx(Vq,{$status:e.maxStatus,title:P.title,children:P.label})]}),g.jsx(Gq,{children:A}),g.jsx(Wq,{children:ls.map((U,F)=>g.jsx(Yq,{$active:!!e.timeRanges[F],title:e.timeRanges[F]?`${U}: monitoring enabled`:`${U}: not monitored`,children:U.charAt(0)},U))}),g.jsxs(oV,{children:["Created ",M]})]}),g.jsxs(Qq,{children:[g.jsx(QD,{id:`toggle-${e.id}`,checked:!l,onChange:x,"aria-label":l?"Enable alert":"Disable alert"}),g.jsxs(Kq,{children:[g.jsx(Xq,{ref:v,type:"button","aria-label":"More options","aria-expanded":u,"aria-haspopup":"menu",onClick:()=>f(U=>!U),children:g.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[g.jsx("circle",{cx:"8",cy:"3",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"13",r:"1.5"})]})}),u&&UC.createPortal(g.jsxs(Zq,{ref:b,role:"menu",$top:y.top,$right:y.right,children:[g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{I(),i(sz(e.id))},children:"Test"})}),g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{I(),n(e)},children:"Edit"})}),g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{I(),t(e)},children:"Duplicate"})}),g.jsx(eV,{}),p?g.jsx("li",{children:g.jsxs(tV,{children:[g.jsx(nV,{children:"Delete this alert?"}),g.jsxs(rV,{children:[g.jsx(iV,{type:"button",onClick:()=>h(!1),children:"Cancel"}),g.jsx(sV,{type:"button",onClick:()=>{I(),o&&$q(o,e.id)},children:"Delete"})]})]})}):g.jsx("li",{children:g.jsx(Jq,{type:"button",role:"menuitem",onClick:()=>h(!0),children:"Delete"})})]}),document.body)]})]})]})})}),uV=T.ul`
  list-style: none;
  padding: 0;
  margin: 0;
  display: flex;
...
//# sourceMappingURL=index-DXuweEfk.js.map

//# debugId=ea97794f-026c-5bfa-83ad-e942482a6b52
