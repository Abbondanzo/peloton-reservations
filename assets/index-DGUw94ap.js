...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="eb0e5ade-1507-5141-92b9-dcfcff6bafe3")}catch(e){}}();
 ...
 */var i1;function cN(){if(i1)return tc;i1=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(i,o,l){var u=null;if(l!==void 0&&(u=""+l),o.key!==void 0&&(u=""+o.key),"key"in o){l={};for(var f in o)f!=="key"&&(l[f]=o[f])}else l=o;return o=l.ref,{$$typeof:e,type:i,key:u,ref:o!==void 0?o:null,props:l}}return tc.Fragment=t,tc.jsx=n,tc.jsxs=n,tc}var s1;function uN(){return s1||(s1=1,_g.exports=cN()),_g.exports}var g=uN(),bg={exports:{}},je={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IR=function(e){let t={},n={},i={},o="";try{const l=e.split(".");t=Vc(qf(l[0])||""),n=Vc(qf(l[1])||""),o=l[2],i=n.d||{},delete n.d}catch{}return{header:t,claims:n,data:i,signature:o}},WP=function(e){const t=IR(e),n=t.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},YP=function(e){const t=IR(e).claims;return typeof t=="object"&&t.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JP=function(e){const t=[];let n=0;for(let i=0;i<e.length;i++){let o=e.charCodeAt(i);if(o>=55296&&o<=56319){const l=o-55296;i++,he(i<e.length,"Surrogate pair missing trail surrogate.");const u=e.charCodeAt(i)-56320;o=65536+(l<<10)+u}o<128?t[n++]=o:o<2048?(t[n++]=o>>6|192,t[n++]=o&63|128):o<65536?(t[n++]=o>>12|224,t[n++]=o>>6&63|128,t[n++]=o&63|128):(t[n++]=o>>18|240,t[n++]=o>>12&63|128,t[n++]=o>>6&63|128,t[n++]=o&63|128)}return t},Bh=function(e){let t=0;for(let n=0;n<e.length;n++){const i=e.charCodeAt(n);i<128?t++:i<2048?t+=2:i>=55296&&i<=56319?(t+=4,n++):t+=3}return t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vj{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(_j(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function _j(e){return e.getComponent()?.type==="VERSION"}const Ky="@firebase/app",uw="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e4=1024,t4=30;class n4{constructor(t){this.container=t,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new i4(n),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=hw();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:n}),this._heartbeatsCache.heartbeats.length>t4){const o=s4(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){vi.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=hw(),{heartbeatsToSend:n,unsentEntries:i}=r4(this._heartbeatsCache.heartbeats),o=Ff(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return vi.warn(t),""}}}function hw(){return new Date().toISOString().substring(0,10)}function r4(e,t=e4){const n=[];let i=e.slice();for(const o of e){const l=n.find(u=>u.agent===o.agent);if(l){if(l.dates.push(o.date),pw(n)>t){l.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),pw(n)>t){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class i4{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return RR()?AR().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await Jj(this.app);return n?.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return fw(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return fw(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...t.heartbeats]})}else return}}function pw(e){return Ff(JSON.stringify({version:2,heartbeats:e})).length}function s4(e){if(e.length===0)return-1;let t=0,n=e[0].date;for(let i=1;i<e.length;i++)e[i].date<n&&(n=e[i].date,t=i);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function o4(e){Mr(new _r("platform-logger",t=>new vj(t),"PRIVATE")),Mr(new _r("heartbeat",t=>new n4(t),"PRIVATE")),Jn(Ky,uw,e),Jn(Ky,uw,"esm2020"),Jn("fire-js","")}o4("");const LR="@firebase/installations",l_="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w4="firebase-installations-database",E4=1,yo="firebase-installations-store";let Hg=null;function c_(){return Hg||(Hg=Hh(w4,E4,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(yo)}}})),Hg}async function Wf(e,t){const n=Fh(e),o=(await c_()).transaction(yo,"readwrite"),l=o.objectStore(yo),u=await l.get(n);return await l.put(t,n),await o.done,(!u||u.fid!==t.fid)&&WR(e,t.fid),t}async function QR(e){const t=Fh(e),i=(await c_()).transaction(yo,"readwrite");await i.objectStore(yo).delete(t),await i.done}async function qh(e,t){const n=Fh(e),o=(await c_()).transaction(yo,"readwrite"),l=o.objectStore(yo),u=await l.get(n),f=t(u);return f===void 0?await l.delete(n):await l.put(f,n),await o.done,f&&(!u||u.fid!==f.fid)&&WR(e,f.fid),f}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function u_(e){let t;const n=await qh(e.appConfig,i=>{const o=T4(i),l=C4(e,o);return t=l.registrationPromise,l.installationEntry});return n.fid===Jy?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function T4(e){const t=e||{fid:v4(),registrationStatus:0};return KR(t)}function C4(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(go.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=R4(e,n);return{installationEntry:n,registrationPromise:i}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:A4(e)}:{installationEntry:t}}async function R4(e,t){try{const n=await m4(e,t);return Wf(e.appConfig,n)}catch(n){throw UR(n)&&n.customData.serverCode===409?await QR(e.appConfig):await Wf(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function A4(e){let t=await mw(e.appConfig);for(;t.registrationStatus===1;)await VR(100),t=await mw(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await u_(e);return i||n}return t}function mw(e){return qh(e,t=>{if(!t)throw go.create("installation-not-found");return KR(t)})}function KR(e){return I4(e)?{fid:e.fid,registrationStatus:0}:e}function I4(e){return e.registrationStatus===1&&e.registrationTime+PR<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function d_(e,t=!1){let n;const i=await qh(e.appConfig,l=>{if(!XR(l))throw go.create("not-registered");const u=l.authToken;if(!t&&M4(u))return l;if(u.requestStatus===1)return n=k4(e,t),l;{if(!navigator.onLine)throw go.create("app-offline");const f=P4(l);return n=N4(e,f),f}});return n?await n:i.authToken}async function k4(e,t){let n=await gw(e.appConfig);for(;n.authToken.requestStatus===1;)await VR(100),n=await gw(e.appConfig);const i=n.authToken;return i.requestStatus===0?d_(e,t):i}function gw(e){return qh(e,t=>{if(!XR(t))throw go.create("not-registered");const n=t.authToken;return j4(n)?{...t,authToken:{requestStatus:0}}:t})}async function N4(e,t){try{const n=await D4(e,t),i={...t,authToken:n};return await Wf(e.appConfig,i),n}catch(n){if(UR(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await QR(e.appConfig);else{const i={...t,authToken:{requestStatus:0}};await Wf(e.appConfig,i)}throw n}}function XR(e){return e!==void 0&&e.registrationStatus===2}function M4(e){return e.requestStatus===2&&!L4(e)}function L4(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+l4}function P4(e){const t={requestStatus:1,requestTime:Date.now()};return{...e,authToken:t}}function j4(e){return e.requestStatus===1&&e.requestTime+PR<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G4="/firebase-messaging-sw.js",W4="/firebase-cloud-messaging-push-scope",JR="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Y4="https://fcmregistrations.googleapis.com/v1",eA="google.c.a.c_id",Q4="google.c.a.c_l",K4="google.c.a.ts",X4="google.c.a.e",yw=1e4;var vw;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(vw||(vw={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c6=10080*60*1e3;async function u6(e){const t=await f6(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:ci(t.getKey("auth")),p256dh:ci(t.getKey("p256dh"))},i=await i6(e.firebaseDependencies);if(i){if(h6(i.subscriptionOptions,n))return Date.now()>=i.createTime+c6?d6(e,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await l6(e.firebaseDependencies,i.token)}catch(o){console.warn(o)}return bw(e.firebaseDependencies,n)}else return bw(e.firebaseDependencies,n)}async function d6(e,t){try{const n=await a6(e.firebaseDependencies,t),i={...t,token:n,createTime:Date.now()};return await f_(e.firebaseDependencies,i),n}catch(n){throw n}}async function bw(e,t){const i={token:await o6(e,t),createTime:Date.now(),subscriptionOptions:t};return await f_(e,i),i.token}async function f6(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Z4(t)})}function h6(e,t){const n=t.vapidKey===e.vapidKey,i=t.endpoint===e.endpoint,o=t.auth===e.auth,l=t.p256dh===e.p256dh;return n&&i&&o&&l}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function C6(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===Wc.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Sw(n)):e.onMessageHandler.next(Sw(n)));const i=n.data;y6(i)&&i[X4]==="1"&&await E6(e,n.messageType,i)}const xw="@firebase/messaging",ww="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function k6(e=a_()){return D6().then(t=>{if(!t)throw an.create("unsupported-browser")},t=>{throw an.create("indexed-db-unsupported")}),Xa(Wt(e),"messaging").getImmediate()}async function N6(e,t){return e=Wt(e),iA(e,t)}function M6(e,t){return e=Wt(e),O6(e,t)}I6();const Vh=e=>{try{return e()}catch(t){throw t}};var L6="firebase",P6="12.2.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kh{getCompare(){return this.compare.bind(this)}indexedValueChanged(t,n){const i=new Ve(za,t),o=new Ve(za,n);return this.compare(i,o)!==0}minPost(){return Ve.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let WA,YA;function j3(e){WA=e}function $3(e){YA=e}class U3 extends Kh{compare(t,n){const i=t.node.getPriority(),o=n.node.getPriority(),l=i.compareTo(o);return l===0?Ao(t.name,n.name):l}isDefinedOn(t){return!t.getPriority().isEmpty()}indexedValueChanged(t,n){return!t.getPriority().equals(n.getPriority())}minPost(){return Ve.MIN}maxPost(){return new Ve(bo,new Ft("[PRIORITY-POST]",YA))}makePost(t,n){const i=WA(t);return new Ve(n,new Ft("[PRIORITY-POST]",i))}toString(){return".priority"}}const It=new U3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class V3 extends Kh{compare(t,n){const i=t.node.compareTo(n.node);return i===0?Ao(t.name,n.name):i}isDefinedOn(t){return!0}indexedValueChanged(t,n){return!t.equals(n)}minPost(){return Ve.MIN}maxPost(){return Ve.MAX}makePost(t,n){const i=$t(t);return new Ve(n,i)}toString(){return".value"}}const G3=new V3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nh extends zA{reportStats(t){throw new Error("Method not implemented.")}static getListenId_(t,n){return n!==void 0?"tag$"+n:(he(t._queryParams.isDefault(),"should have a tag if it's not a default query."),t._path.toString())}constructor(t,n,i,o){super(),this.repoInfo_=t,this.onDataUpdate_=n,this.authTokenProvider_=i,this.appCheckTokenProvider_=o,this.log_=xu("p:rest:"),this.listens_={}}listen(t,n,i,o){const l=t._path.toString();this.log_("Listen called for "+l+" "+t._queryIdentifier);const u=nh.getListenId_(t,i),f={};this.listens_[u]=f;const p=nE(t._queryParams);this.restRequest_(l+".json",p,(h,y)=>{let _=y;if(h===404&&(_=null,h=null),h===null&&this.onDataUpdate_(l,_,!1,i),ja(this.listens_,u)===f){let v;h?h===401?v="permission_denied":v="rest_error:"+h:v="ok",o(v,null)}})}unlisten(t,n){const i=nh.getListenId_(t,n);delete this.listens_[i]}get(t){const n=nE(t._queryParams),i=t._path.toString(),o=new mu;return this.restRequest_(i+".json",n,(l,u)=>{let f=u;l===404&&(f=null,l=null),l===null?(this.onDataUpdate_(i,f,!1,null),o.resolve(f)):o.reject(new Error(f))}),o.promise}refreshAuthToken(t){}restRequest_(t,n={},i){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([o,l])=>{o&&o.accessToken&&(n.auth=o.accessToken),l&&l.token&&(n.ac=l.token);const u=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+t+"?ns="+this.repoInfo_.namespace+Ka(n);this.log_("Sending REST request for "+u);const f=new XMLHttpRequest;f.onreadystatechange=()=>{if(i&&f.readyState===4){this.log_("REST Response for "+u+" received. status:",f.status,"response:",f.responseText);let p=null;if(f.status>=200&&f.status<300){try{p=Vc(f.responseText)}catch{fn("Failed to parse JSON response for "+u+": "+f.responseText)}i(null,p)}else f.status!==401&&f.status!==404&&fn("Got unsuccessful REST response for "+u+" Status: "+f.status),i(f.status);i=null}},f.open("GET",u,!0),f.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(){return{value:null,children:new Map}}function KA(e,t,n){if(Ye(t))e.value=n,e.children.clear();else if(e.value!==null)e.value=e.value.updateChild(t,n);else{const i=qe(t);e.children.has(i)||e.children.set(i,rh());const o=e.children.get(i);t=pt(t),KA(o,t,n)}}function uv(e,t,n){e.value!==null?n(t,e.value):X3(e,(i,o)=>{const l=new ut(t.toString()+"/"+i);uv(o,l,n)})}function X3(e,t){e.children.forEach((n,i)=>{t(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iE=10*1e3,J3=30*1e3,e5=300*1e3;class t5{constructor(t,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Z3(t);const i=iE+(J3-iE)*Math.random();Lc(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const t=this.statsListener_.get(),n={};let i=!1;rn(t,(o,l)=>{l>0&&jr(this.statsToReport_,o)&&(n[o]=l,i=!0)}),i&&this.server_.reportStats(n),Lc(this.reportStats_.bind(this),Math.floor(Math.random()*2*e5))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ih{constructor(t,n,i){this.path=t,this.affectedTree=n,this.revert=i,this.type=fr.ACK_USER_WRITE,this.source=O_()}operationForChild(t){if(Ye(this.path)){if(this.affectedTree.value!=null)return he(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ut(t));return new ih(Xe(),n,this.revert)}}else return he(qe(this.path)===t,"operationForChild called for unrelated child."),new ih(pt(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(e,t){return{eventCache:e,serverCache:t}}function Pc(e,t,n,i){return Xh(new Ss(t,n,i),e.serverCache)}function XA(e,t,n,i){return Xh(e.eventCache,new Ss(t,n,i))}function sh(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function xo(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w5(e){return{filter:e}}function E5(e,t){he(t.eventCache.getNode().isIndexed(e.filter.getIndex()),"Event snap not indexed"),he(t.serverCache.getNode().isIndexed(e.filter.getIndex()),"Server snap not indexed")}function T5(e,t,n,i,o){const l=new S5;let u,f;if(n.type===fr.OVERWRITE){const h=n;h.source.fromUser?u=pv(e,t,h.path,h.snap,i,o,l):(he(h.source.fromServer,"Unknown source."),f=h.source.tagged||t.serverCache.isFiltered()&&!Ye(h.path),u=lh(e,t,h.path,h.snap,i,o,f,l))}else if(n.type===fr.MERGE){const h=n;h.source.fromUser?u=R5(e,t,h.path,h.children,i,o,l):(he(h.source.fromServer,"Unknown source."),f=h.source.tagged||t.serverCache.isFiltered(),u=mv(e,t,h.path,h.children,i,o,f,l))}else if(n.type===fr.ACK_USER_WRITE){const h=n;h.revert?u=D5(e,t,h.path,i,o,l):u=A5(e,t,h.path,h.affectedTree,i,o,l)}else if(n.type===fr.LISTEN_COMPLETE)u=I5(e,t,n.path,i,l);else throw Ya("Unknown operation type: "+n.type);const p=l.getChanges();return C5(t,u,p),{viewCache:u,changes:p}}function C5(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const o=i.getNode().isLeafNode()||i.getNode().isEmpty(),l=sh(e);(n.length>0||!e.eventCache.isFullyInitialized()||o&&!i.getNode().equals(l)||!i.getNode().getPriority().equals(l.getPriority()))&&n.push(QA(sh(t)))}}function iI(e,t,n,i,o,l){const u=t.eventCache;if(ah(i,n)!=null)return t;{let f,p;if(Ye(n))if(he(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const h=xo(t),y=h instanceof Ne?h:Ne.EMPTY_NODE,_=M_(i,y);f=e.filter.updateFullNode(t.eventCache.getNode(),_,l)}else{const h=oh(i,xo(t));f=e.filter.updateFullNode(t.eventCache.getNode(),h,l)}else{const h=qe(n);if(h===".priority"){he(bs(n)===1,"Can't have a priority with additional path components");const y=u.getNode();p=t.serverCache.getNode();const _=aE(i,n,y,p);_!=null?f=e.filter.updatePriority(y,_):f=u.getNode()}else{const y=pt(n);let _;if(u.isCompleteForChild(h)){p=t.serverCache.getNode();const v=aE(i,n,u.getNode(),p);v!=null?_=u.getNode().getImmediateChild(h).updateChild(y,v):_=u.getNode().getImmediateChild(h)}else _=L_(i,h,t.serverCache);_!=null?f=e.filter.updateChild(u.getNode(),h,_,y,o,l):f=u.getNode()}}return Pc(t,f,u.isFullyInitialized()||Ye(n),e.filter.filtersNodes())}}function lh(e,t,n,i,o,l,u,f){const p=t.serverCache;let h;const y=u?e.filter:e.filter.getIndexedFilter();if(Ye(n))h=y.updateFullNode(p.getNode(),i,null);else if(y.filtersNodes()&&!p.isFiltered()){const b=p.getNode().updateChild(n,i);h=y.updateFullNode(p.getNode(),b,null)}else{const b=qe(n);if(!p.isCompleteForPath(n)&&bs(n)>1)return t;const x=pt(n),C=p.getNode().getImmediateChild(b).updateChild(x,i);b===".priority"?h=y.updatePriority(p.getNode(),C):h=y.updateChild(p.getNode(),b,C,x,rI,null)}const _=XA(t,h,p.isFullyInitialized()||Ye(n),y.filtersNodes()),v=new P_(o,_,l);return iI(e,_,n,o,v,f)}function pv(e,t,n,i,o,l,u){const f=t.eventCache;let p,h;const y=new P_(o,t,l);if(Ye(n))h=e.filter.updateFullNode(t.eventCache.getNode(),i,u),p=Pc(t,h,!0,e.filter.filtersNodes());else{const _=qe(n);if(_===".priority")h=e.filter.updatePriority(t.eventCache.getNode(),i),p=Pc(t,h,f.isFullyInitialized(),f.isFiltered());else{const v=pt(n),b=f.getNode().getImmediateChild(_);let x;if(Ye(v))x=i;else{const O=y.getCompleteChild(_);O!=null?T_(v)===".priority"&&O.getChild(HA(v)).isEmpty()?x=O:x=O.updateChild(v,i):x=Ne.EMPTY_NODE}if(b.equals(x))p=t;else{const O=e.filter.updateChild(f.getNode(),_,x,v,y,u);p=Pc(t,O,f.isFullyInitialized(),e.filter.filtersNodes())}}}return p}function lE(e,t){return e.eventCache.isCompleteForChild(t)}function R5(e,t,n,i,o,l,u){let f=t;return i.foreach((p,h)=>{const y=At(n,p);lE(t,qe(y))&&(f=pv(e,f,y,h,o,l,u))}),i.foreach((p,h)=>{const y=At(n,p);lE(t,qe(y))||(f=pv(e,f,y,h,o,l,u))}),f}function cE(e,t,n){return n.foreach((i,o)=>{t=t.updateChild(i,o)}),t}function mv(e,t,n,i,o,l,u,f){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let p=t,h;Ye(n)?h=i:h=new ht(null).setTree(n,i);const y=t.serverCache.getNode();return h.children.inorderTraversal((_,v)=>{if(y.hasChild(_)){const b=t.serverCache.getNode().getImmediateChild(_),x=cE(e,b,v);p=lh(e,p,new ut(_),x,o,l,u,f)}}),h.children.inorderTraversal((_,v)=>{const b=!t.serverCache.isCompleteForChild(_)&&v.value===null;if(!y.hasChild(_)&&!b){const x=t.serverCache.getNode().getImmediateChild(_),O=cE(e,x,v);p=lh(e,p,new ut(_),O,o,l,u,f)}}),p}function A5(e,t,n,i,o,l,u){if(ah(o,n)!=null)return t;const f=t.serverCache.isFiltered(),p=t.serverCache;if(i.value!=null){if(Ye(n)&&p.isFullyInitialized()||p.isCompleteForPath(n))return lh(e,t,n,p.getNode().getChild(n),o,l,f,u);if(Ye(n)){let h=new ht(null);return p.getNode().forEachChild(Ra,(y,_)=>{h=h.set(new ut(y),_)}),mv(e,t,n,h,o,l,f,u)}else return t}else{let h=new ht(null);return i.foreach((y,_)=>{const v=At(n,y);p.isCompleteForPath(v)&&(h=h.set(y,p.getNode().getChild(v)))}),mv(e,t,n,h,o,l,f,u)}}function I5(e,t,n,i,o){const l=t.serverCache,u=XA(t,l.getNode(),l.isFullyInitialized()||Ye(n),l.isFiltered());return iI(e,u,n,i,rI,o)}function D5(e,t,n,i,o,l){let u;if(ah(i,n)!=null)return t;{const f=new P_(i,t,o),p=t.eventCache.getNode();let h;if(Ye(n)||qe(n)===".priority"){let y;if(t.serverCache.isFullyInitialized())y=oh(i,xo(t));else{const _=t.serverCache.getNode();he(_ instanceof Ne,"serverChildren would be complete if leaf node"),y=M_(i,_)}y=y,h=e.filter.updateFullNode(p,y,l)}else{const y=qe(n);let _=L_(i,y,t.serverCache);_==null&&t.serverCache.isCompleteForChild(y)&&(_=p.getImmediateChild(y)),_!=null?h=e.filter.updateChild(p,y,_,pt(n),f,l):t.eventCache.getNode().hasChild(y)?h=e.filter.updateChild(p,y,Ne.EMPTY_NODE,pt(n),f,l):h=p,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(u=oh(i,xo(t)),u.isLeafNode()&&(h=e.filter.updateFullNode(h,u,l)))}return u=t.serverCache.isFullyInitialized()||ah(i,Xe())!=null,Pc(t,h,u,e.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O5{constructor(t,n){this.query_=t,this.eventRegistrations_=[];const i=this.query_._queryParams,o=new I_(i.getIndex()),l=Q3(i);this.processor_=w5(l);const u=n.serverCache,f=n.eventCache,p=o.updateFullNode(Ne.EMPTY_NODE,u.getNode(),null),h=l.updateFullNode(Ne.EMPTY_NODE,f.getNode(),null),y=new Ss(p,u.isFullyInitialized(),o.filtersNodes()),_=new Ss(h,f.isFullyInitialized(),l.filtersNodes());this.viewCache_=Xh(_,y),this.eventGenerator_=new n5(this.query_)}get query(){return this.query_}}function k5(e){return e.viewCache_.serverCache.getNode()}function N5(e){return sh(e.viewCache_)}function M5(e,t){const n=xo(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Ye(t)&&!n.getImmediateChild(qe(t)).isEmpty())?n.getChild(t):null}function uE(e){return e.eventRegistrations_.length===0}function L5(e,t){e.eventRegistrations_.push(t)}function dE(e,t,n){const i=[];if(n){he(t==null,"A cancel should cancel all event registrations.");const o=e.query._path;e.eventRegistrations_.forEach(l=>{const u=l.createCancelEvent(n,o);u&&i.push(u)})}if(t){let o=[];for(let l=0;l<e.eventRegistrations_.length;++l){const u=e.eventRegistrations_[l];if(!u.matches(t))o.push(u);else if(t.hasAnyCallback()){o=o.concat(e.eventRegistrations_.slice(l+1));break}}e.eventRegistrations_=o}else e.eventRegistrations_=[];return i}function fE(e,t,n,i){t.type===fr.MERGE&&t.source.queryId!==null&&(he(xo(e.viewCache_),"We should always have a full cache before handling merges"),he(sh(e.viewCache_),"Missing event cache, even though we have a server cache"));const o=e.viewCache_,l=T5(e.processor_,o,t,n,i);return E5(e.processor_,l.viewCache),he(l.viewCache.serverCache.isFullyInitialized()||!o.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=l.viewCache,sI(e,l.changes,l.viewCache.eventCache.getNode(),null)}function P5(e,t){const n=e.viewCache_.eventCache,i=[];return n.getNode().isLeafNode()||n.getNode().forEachChild(It,(l,u)=>{i.push(Ba(l,u))}),n.isFullyInitialized()&&i.push(QA(n.getNode())),sI(e,i,n.getNode(),t)}function sI(e,t,n,i){const o=i?[i]:e.eventRegistrations_;return r5(e.eventGenerator_,t,n,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ch;class oI{constructor(){this.views=new Map}}function j5(e){he(!ch,"__referenceConstructor has already been defined"),ch=e}function $5(){return he(ch,"Reference.ts has not been loaded"),ch}function U5(e){return e.views.size===0}function j_(e,t,n,i){const o=t.source.queryId;if(o!==null){const l=e.views.get(o);return he(l!=null,"SyncTree gave us an op for an invalid query."),fE(l,t,n,i)}else{let l=[];for(const u of e.views.values())l=l.concat(fE(u,t,n,i));return l}}function aI(e,t,n,i,o){const l=t._queryIdentifier,u=e.views.get(l);if(!u){let f=oh(n,o?i:null),p=!1;f?p=!0:i instanceof Ne?(f=M_(n,i),p=!1):(f=Ne.EMPTY_NODE,p=!1);const h=Xh(new Ss(f,p,!1),new Ss(i,o,!1));return new O5(t,h)}return u}function z5(e,t,n,i,o,l){const u=aI(e,t,i,o,l);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,u),L5(u,n),P5(u,n)}function B5(e,t,n,i){const o=t._queryIdentifier,l=[];let u=[];const f=xs(e);if(o==="default")for(const[p,h]of e.views.entries())u=u.concat(dE(h,n,i)),uE(h)&&(e.views.delete(p),h.query._queryParams.loadsAllData()||l.push(h.query));else{const p=e.views.get(o);p&&(u=u.concat(dE(p,n,i)),uE(p)&&(e.views.delete(o),p.query._queryParams.loadsAllData()||l.push(p.query)))}return f&&!xs(e)&&l.push(new($5())(t._repo,t._path)),{removed:l,events:u}}function lI(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function fs(e,t){let n=null;for(const i of e.views.values())n=n||M5(i,t);return n}function cI(e,t){if(t._queryParams.loadsAllData())return Jh(e);{const i=t._queryIdentifier;return e.views.get(i)}}function uI(e,t){return cI(e,t)!=null}function xs(e){return Jh(e)!=null}function Jh(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let uh;function H5(e){he(!uh,"__referenceConstructor has already been defined"),uh=e}function F5(){return he(uh,"Reference.ts has not been loaded"),uh}let q5=1;class hE{constructor(t){this.listenProvider_=t,this.syncPointTree_=new ht(null),this.pendingWriteTree_=_5(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function dI(e,t,n,i,o){return a5(e.pendingWriteTree_,t,n,i,o),o?nl(e,new So(O_(),t,n)):[]}function V5(e,t,n,i){l5(e.pendingWriteTree_,t,n,i);const o=ht.fromObject(n);return nl(e,new Ha(O_(),t,o))}function as(e,t,n=!1){const i=c5(e.pendingWriteTree_,t);if(u5(e.pendingWriteTree_,t)){let l=new ht(null);return i.snap!=null?l=l.set(Xe(),!0):rn(i.children,u=>{l=l.set(new ut(u),!0)}),nl(e,new ih(i.path,l,n))}else return[]}function Eu(e,t,n){return nl(e,new So(k_(),t,n))}function G5(e,t,n){const i=ht.fromObject(n);return nl(e,new Ha(k_(),t,i))}function W5(e,t){return nl(e,new su(k_(),t))}function Y5(e,t,n){const i=U_(e,n);if(i){const o=z_(i),l=o.path,u=o.queryId,f=dn(l,t),p=new su(N_(u),f);return B_(e,l,p)}else return[]}function dh(e,t,n,i,o=!1){const l=t._path,u=e.syncPointTree_.get(l);let f=[];if(u&&(t._queryIdentifier==="default"||uI(u,t))){const p=B5(u,t,n,i);U5(u)&&(e.syncPointTree_=e.syncPointTree_.remove(l));const h=p.removed;if(f=p.events,!o){const y=h.findIndex(v=>v._queryParams.loadsAllData())!==-1,_=e.syncPointTree_.findOnPath(l,(v,b)=>xs(b));if(y&&!_){const v=e.syncPointTree_.subtree(l);if(!v.isEmpty()){const b=X5(v);for(let x=0;x<b.length;++x){const O=b[x],C=O.query,I=mI(e,O);e.listenProvider_.startListening($c(C),ou(e,C),I.hashFn,I.onComplete)}}}!_&&h.length>0&&!i&&(y?e.listenProvider_.stopListening($c(t),null):h.forEach(v=>{const b=e.queryToTagMap.get(ep(v));e.listenProvider_.stopListening($c(v),b)}))}Z5(e,h)}return f}function fI(e,t,n,i){const o=U_(e,i);if(o!=null){const l=z_(o),u=l.path,f=l.queryId,p=dn(u,t),h=new So(N_(f),p,n);return B_(e,u,h)}else return[]}function Q5(e,t,n,i){const o=U_(e,i);if(o){const l=z_(o),u=l.path,f=l.queryId,p=dn(u,t),h=ht.fromObject(n),y=new Ha(N_(f),p,h);return B_(e,u,y)}else return[]}function gv(e,t,n,i=!1){const o=t._path;let l=null,u=!1;e.syncPointTree_.foreachOnPath(o,(v,b)=>{const x=dn(v,o);l=l||fs(b,x),u=u||xs(b)});let f=e.syncPointTree_.get(o);f?(u=u||xs(f),l=l||fs(f,Xe())):(f=new oI,e.syncPointTree_=e.syncPointTree_.set(o,f));let p;l!=null?p=!0:(p=!1,l=Ne.EMPTY_NODE,e.syncPointTree_.subtree(o).foreachChild((b,x)=>{const O=fs(x,Xe());O&&(l=l.updateImmediateChild(b,O))}));const h=uI(f,t);if(!h&&!t._queryParams.loadsAllData()){const v=ep(t);he(!e.queryToTagMap.has(v),"View does not exist, but we have a tag");const b=J5();e.queryToTagMap.set(v,b),e.tagToQueryMap.set(b,v)}const y=Zh(e.pendingWriteTree_,o);let _=z5(f,t,n,y,l,p);if(!h&&!u&&!i){const v=cI(f,t);_=_.concat(eU(e,t,v))}return _}function $_(e,t,n){const o=e.pendingWriteTree_,l=e.syncPointTree_.findOnPath(t,(u,f)=>{const p=dn(u,t),h=fs(f,p);if(h)return h});return eI(o,t,l,n,!0)}function K5(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,(h,y)=>{const _=dn(h,n);i=i||fs(y,_)});let o=e.syncPointTree_.get(n);o?i=i||fs(o,Xe()):(o=new oI,e.syncPointTree_=e.syncPointTree_.set(n,o));const l=i!=null,u=l?new Ss(i,!0,!1):null,f=Zh(e.pendingWriteTree_,t._path),p=aI(o,t,f,l?u.getNode():Ne.EMPTY_NODE,l);return N5(p)}function nl(e,t){return hI(t,e.syncPointTree_,null,Zh(e.pendingWriteTree_,Xe()))}function hI(e,t,n,i){if(Ye(e.path))return pI(e,t,n,i);{const o=t.get(Xe());n==null&&o!=null&&(n=fs(o,Xe()));let l=[];const u=qe(e.path),f=e.operationForChild(u),p=t.children.get(u);if(p&&f){const h=n?n.getImmediateChild(u):null,y=tI(i,u);l=l.concat(hI(f,p,h,y))}return o&&(l=l.concat(j_(o,e,i,n))),l}}function pI(e,t,n,i){const o=t.get(Xe());n==null&&o!=null&&(n=fs(o,Xe()));let l=[];return t.children.inorderTraversal((u,f)=>{const p=n?n.getImmediateChild(u):null,h=tI(i,u),y=e.operationForChild(u);y&&(l=l.concat(pI(y,f,p,h)))}),o&&(l=l.concat(j_(o,e,i,n))),l}function mI(e,t){const n=t.query,i=ou(e,n);return{hashFn:()=>(k5(t)||Ne.EMPTY_NODE).hash(),onComplete:o=>{if(o==="ok")return i?Y5(e,n._path,i):W5(e,n._path);{const l=W$(o,n);return dh(e,n,null,l)}}}}function ou(e,t){const n=ep(t);return e.queryToTagMap.get(n)}function ep(e){return e._path.toString()+"$"+e._queryIdentifier}function U_(e,t){return e.tagToQueryMap.get(t)}function z_(e){const t=e.indexOf("$");return he(t!==-1&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new ut(e.substr(0,t))}}function B_(e,t,n){const i=e.syncPointTree_.get(t);he(i,"Missing sync point for query tag that we're tracking");const o=Zh(e.pendingWriteTree_,t);return j_(i,n,o,null)}function X5(e){return e.fold((t,n,i)=>{if(n&&xs(n))return[Jh(n)];{let o=[];return n&&(o=lI(n)),rn(i,(l,u)=>{o=o.concat(u)}),o}})}function $c(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(F5())(e._repo,e._path):e}function Z5(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const o=ep(i),l=e.queryToTagMap.get(o);e.queryToTagMap.delete(o),e.tagToQueryMap.delete(l)}}}function J5(){return q5++}function eU(e,t,n){const i=t._path,o=ou(e,t),l=mI(e,n),u=e.listenProvider_.startListening($c(t),o,l.hashFn,l.onComplete),f=e.syncPointTree_.subtree(i);if(o)he(!xs(f.value),"If we're adding a query, it shouldn't be shadowed");else{const p=f.fold((h,y,_)=>{if(!Ye(h)&&y&&xs(y))return[Jh(y).query];{let v=[];return y&&(v=v.concat(lI(y).map(b=>b.query))),rn(_,(b,x)=>{v=v.concat(x)}),v}});for(let h=0;h<p.length;++h){const y=p[h];e.listenProvider_.stopListening($c(y),ou(e,y))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aU=/[\[\].#$\/\u0000-\u001F\u007F]/,lU=/[\[\].#$\u0000-\u001F\u007F]/,iy=10*1024*1024,W_=function(e){return typeof e=="string"&&e.length!==0&&!aU.test(e)},SI=function(e){return typeof e=="string"&&e.length!==0&&!lU.test(e)},cU=function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),SI(e)},uU=function(e){return e===null||typeof e=="string"||typeof e=="number"&&!b_(e)||e&&typeof e=="object"&&jr(e,".sv")},xI=function(e,t,n,i){i&&t===void 0||np(zh(e,"value"),t,n)},np=function(e,t,n){const i=n instanceof ut?new R3(n,e):n;if(t===void 0)throw new Error(e+"contains undefined "+so(i));if(typeof t=="function")throw new Error(e+"contains a function "+so(i)+" with contents = "+t.toString());if(b_(t))throw new Error(e+"contains "+t.toString()+" "+so(i));if(typeof t=="string"&&t.length>iy/3&&Bh(t)>iy)throw new Error(e+"contains a string greater than "+iy+" utf8 bytes "+so(i)+" ('"+t.substring(0,50)+"...')");if(t&&typeof t=="object"){let o=!1,l=!1;if(rn(t,(u,f)=>{if(u===".value")o=!0;else if(u!==".priority"&&u!==".sv"&&(l=!0,!W_(u)))throw new Error(e+" contains an invalid key ("+u+") "+so(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);A3(i,u),np(e,f,i),I3(i)}),o&&l)throw new Error(e+' contains ".value" child '+so(i)+" in addition to actual children.")}},dU=function(e,t){let n,i;for(n=0;n<t.length;n++){i=t[n];const l=tu(i);for(let u=0;u<l.length;u++)if(!(l[u]===".priority"&&u===l.length-1)){if(!W_(l[u]))throw new Error(e+"contains an invalid key ("+l[u]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}t.sort(C3);let o=null;for(n=0;n<t.length;n++){if(i=t[n],o!==null&&Zn(o,i))throw new Error(e+"contains a path "+o.toString()+" that is ancestor of another path "+i.toString());o=i}},fU=function(e,t,n,i){const o=zh(e,"values");if(!(t&&typeof t=="object")||Array.isArray(t))throw new Error(o+" must be an object containing the children to replace.");const l=[];rn(t,(u,f)=>{const p=new ut(u);if(np(o,f,At(n,p)),T_(p)===".priority"&&!uU(f))throw new Error(o+"contains an invalid value for '"+p.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");l.push(p)}),dU(o,l)},wI=function(e,t,n,i){if(!SI(n))throw new Error(zh(e,t)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},hU=function(e,t,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),wI(e,t,n)},Y_=function(e,t){if(qe(t)===".info")throw new Error(e+" failed = Can't modify data under /.info/")},pU=function(e,t){const n=t.path.toString();if(typeof t.repoInfo.host!="string"||t.repoInfo.host.length===0||!W_(t.repoInfo.namespace)&&t.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!cU(n))throw new Error(zh(e,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mU{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function rp(e,t){let n=null;for(let i=0;i<t.length;i++){const o=t[i],l=o.getPath();n!==null&&!C_(l,n.path)&&(e.eventLists_.push(n),n=null),n===null&&(n={events:[],path:l}),n.events.push(o)}n&&e.eventLists_.push(n)}function EI(e,t,n){rp(e,n),TI(e,i=>C_(i,t))}function nr(e,t,n){rp(e,n),TI(e,i=>Zn(i,t)||Zn(t,i))}function TI(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const o=e.eventLists_[i];if(o){const l=o.path;t(l)?(gU(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function gU(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(n!==null){e.events[t]=null;const i=n.getEventRunner();Mc&&en("event: "+n.toString()),tl(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yU="repo_interrupt",vU=25;class _U{constructor(t,n,i,o){this.repoInfo_=t,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=o,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new mU,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=rh(),this.transactionQueueTree_=new V_,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function bU(e,t,n){if(e.stats_=w_(e.repoInfo_),e.forceRestClient_||X$())e.server_=new nh(e.repoInfo_,(i,o,l,u)=>{mE(e,i,o,l,u)},e.authTokenProvider_,e.appCheckProvider_),setTimeout(()=>gE(e,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ut(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}e.persistentConnection_=new gi(e.repoInfo_,t,(i,o,l,u)=>{mE(e,i,o,l,u)},i=>{gE(e,i)},i=>{SU(e,i)},e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener(i=>{e.server_.refreshAuthToken(i)}),e.appCheckProvider_.addTokenChangeListener(i=>{e.server_.refreshAppCheckToken(i.token)}),e.statsReporter_=n3(e.repoInfo_,()=>new t5(e.stats_,e.server_)),e.infoData_=new K3,e.infoSyncTree_=new hE({startListening:(i,o,l,u)=>{let f=[];const p=e.infoData_.getNode(i._path);return p.isEmpty()||(f=Eu(e.infoSyncTree_,i._path,p),setTimeout(()=>{u("ok")},0)),f},stopListening:()=>{}}),Q_(e,"connected",!1),e.serverSyncTree_=new hE({startListening:(i,o,l,u)=>(e.server_.listen(i,l,o,(f,p)=>{const h=u(f,p);nr(e.eventQueue_,i._path,h)}),[]),stopListening:(i,o)=>{e.server_.unlisten(i,o)}})}function CI(e){const n=e.infoData_.getNode(new ut(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function ip(e){return tU({timestamp:CI(e)})}function mE(e,t,n,i,o){e.dataUpdateCount++;const l=new ut(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let u=[];if(o)if(i){const p=Vf(n,h=>$t(h));u=Q5(e.serverSyncTree_,l,p,o)}else{const p=$t(n);u=fI(e.serverSyncTree_,l,p,o)}else if(i){const p=Vf(n,h=>$t(h));u=G5(e.serverSyncTree_,l,p)}else{const p=$t(n);u=Eu(e.serverSyncTree_,l,p)}let f=l;u.length>0&&(f=qa(e,l)),nr(e.eventQueue_,f,u)}function gE(e,t){Q_(e,"connected",t),t===!1&&TU(e)}function SU(e,t){rn(t,(n,i)=>{Q_(e,n,i)})}function Q_(e,t,n){const i=new ut("/.info/"+t),o=$t(n);e.infoData_.updateSnapshot(i,o);const l=Eu(e.infoSyncTree_,i,o);nr(e.eventQueue_,i,l)}function K_(e){return e.nextWriteId_++}function xU(e,t,n){const i=K5(e.serverSyncTree_,t);return i!=null?Promise.resolve(i):e.server_.get(t).then(o=>{const l=$t(o).withIndex(t._queryParams.getIndex());gv(e.serverSyncTree_,t,n,!0);let u;if(t._queryParams.loadsAllData())u=Eu(e.serverSyncTree_,t._path,l);else{const f=ou(e.serverSyncTree_,t);u=fI(e.serverSyncTree_,t._path,l,f)}return nr(e.eventQueue_,t._path,u),dh(e.serverSyncTree_,t,n,null,!0),l},o=>(Cu(e,"get for query "+Ut(t)+" failed: "+o),Promise.reject(new Error(o))))}function wU(e,t,n,i,o){Cu(e,"set",{path:t.toString(),value:n,priority:i});const l=ip(e),u=$t(n,i),f=$_(e.serverSyncTree_,t),p=yI(u,f,l),h=K_(e),y=dI(e.serverSyncTree_,t,p,h,!0);rp(e.eventQueue_,y),e.server_.put(t.toString(),u.val(!0),(v,b)=>{const x=v==="ok";x||fn("set at "+t+" failed: "+v);const O=as(e.serverSyncTree_,h,!x);nr(e.eventQueue_,t,O),vv(e,o,v,b)});const _=Z_(e,t);qa(e,_),nr(e.eventQueue_,_,[])}function EU(e,t,n,i){Cu(e,"update",{path:t.toString(),value:n});let o=!0;const l=ip(e),u={};if(rn(n,(f,p)=>{o=!1,u[f]=gI(At(t,f),$t(p),e.serverSyncTree_,l)}),o)en("update() called with empty data.  Don't do anything."),vv(e,i,"ok",void 0);else{const f=K_(e),p=V5(e.serverSyncTree_,t,u,f);rp(e.eventQueue_,p),e.server_.merge(t.toString(),n,(h,y)=>{const _=h==="ok";_||fn("update at "+t+" failed: "+h);const v=as(e.serverSyncTree_,f,!_),b=v.length>0?qa(e,t):t;nr(e.eventQueue_,b,v),vv(e,i,h,y)}),rn(n,h=>{const y=Z_(e,At(t,h));qa(e,y)}),nr(e.eventQueue_,t,[])}}function TU(e){Cu(e,"onDisconnectEvents");const t=ip(e),n=rh();uv(e.onDisconnect_,Xe(),(o,l)=>{const u=gI(o,l,e.serverSyncTree_,t);KA(n,o,u)});let i=[];uv(n,Xe(),(o,l)=>{i=i.concat(Eu(e.serverSyncTree_,o,l));const u=Z_(e,o);qa(e,u)}),e.onDisconnect_=rh(),nr(e.eventQueue_,Xe(),i)}function CU(e,t,n){let i;qe(t._path)===".info"?i=gv(e.infoSyncTree_,t,n):i=gv(e.serverSyncTree_,t,n),EI(e.eventQueue_,t._path,i)}function yE(e,t,n){let i;qe(t._path)===".info"?i=dh(e.infoSyncTree_,t,n):i=dh(e.serverSyncTree_,t,n),EI(e.eventQueue_,t._path,i)}function RU(e){e.persistentConnection_&&e.persistentConnection_.interrupt(yU)}function Cu(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),en(n,...t)}function vv(e,t,n,i){t&&tl(()=>{if(n==="ok")t(null);else{const o=(n||"error").toUpperCase();let l=o;i&&(l+=": "+i);const u=new Error(l);u.code=o,t(u)}})}function RI(e,t,n){return $_(e.serverSyncTree_,t,n)||Ne.EMPTY_NODE}function X_(e,t=e.transactionQueueTree_){if(t||sp(e,t),rl(t)){const n=II(e,t);he(n.length>0,"Sending zero length transaction queue"),n.every(o=>o.status===0)&&AU(e,Tu(t),n)}else _I(t)&&tp(t,n=>{X_(e,n)})}function AU(e,t,n){const i=n.map(h=>h.currentWriteId),o=RI(e,t,i);let l=o;const u=o.hash();for(let h=0;h<n.length;h++){const y=n[h];he(y.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),y.status=1,y.retryCount++;const _=dn(t,y.path);l=l.updateChild(_,y.currentOutputSnapshotRaw)}const f=l.val(!0),p=t;e.server_.put(p.toString(),f,h=>{Cu(e,"transaction put response",{path:p.toString(),status:h});let y=[];if(h==="ok"){const _=[];for(let v=0;v<n.length;v++)n[v].status=2,y=y.concat(as(e.serverSyncTree_,n[v].currentWriteId)),n[v].onComplete&&_.push(()=>n[v].onComplete(null,!0,n[v].currentOutputSnapshotResolved)),n[v].unwatcher();sp(e,G_(e.transactionQueueTree_,t)),X_(e,e.transactionQueueTree_),nr(e.eventQueue_,t,y);for(let v=0;v<_.length;v++)tl(_[v])}else{if(h==="datastale")for(let _=0;_<n.length;_++)n[_].status===3?n[_].status=4:n[_].status=0;else{fn("transaction at "+p.toString()+" failed: "+h);for(let _=0;_<n.length;_++)n[_].status=4,n[_].abortReason=h}qa(e,t)}},u)}function qa(e,t){const n=AI(e,t),i=Tu(n),o=II(e,n);return IU(e,o,i),i}function IU(e,t,n){if(t.length===0)return;const i=[];let o=[];const u=t.filter(f=>f.status===0).map(f=>f.currentWriteId);for(let f=0;f<t.length;f++){const p=t[f],h=dn(n,p.path);let y=!1,_;if(he(h!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),p.status===4)y=!0,_=p.abortReason,o=o.concat(as(e.serverSyncTree_,p.currentWriteId,!0));else if(p.status===0)if(p.retryCount>=vU)y=!0,_="maxretry",o=o.concat(as(e.serverSyncTree_,p.currentWriteId,!0));else{const v=RI(e,p.path,u);p.currentInputSnapshot=v;const b=t[f].update(v.val());if(b!==void 0){np("transaction failed: Data returned ",b,p.path);let x=$t(b);typeof b=="object"&&b!=null&&jr(b,".priority")||(x=x.updatePriority(v.getPriority()));const C=p.currentWriteId,I=ip(e),M=yI(x,v,I);p.currentOutputSnapshotRaw=x,p.currentOutputSnapshotResolved=M,p.currentWriteId=K_(e),u.splice(u.indexOf(C),1),o=o.concat(dI(e.serverSyncTree_,p.path,M,p.currentWriteId,p.applyLocally)),o=o.concat(as(e.serverSyncTree_,C,!0))}else y=!0,_="nodata",o=o.concat(as(e.serverSyncTree_,p.currentWriteId,!0))}nr(e.eventQueue_,n,o),o=[],y&&(t[f].status=2,(function(v){setTimeout(v,Math.floor(0))})(t[f].unwatcher),t[f].onComplete&&(_==="nodata"?i.push(()=>t[f].onComplete(null,!1,t[f].currentInputSnapshot)):i.push(()=>t[f].onComplete(new Error(_),!1,null))))}sp(e,e.transactionQueueTree_);for(let f=0;f<i.length;f++)tl(i[f]);X_(e,e.transactionQueueTree_)}function AI(e,t){let n,i=e.transactionQueueTree_;for(n=qe(t);n!==null&&rl(i)===void 0;)i=G_(i,n),t=pt(t),n=qe(t);return i}function II(e,t){const n=[];return DI(e,t,n),n.sort((i,o)=>i.order-o.order),n}function DI(e,t,n){const i=rl(t);if(i)for(let o=0;o<i.length;o++)n.push(i[o]);tp(t,o=>{DI(e,o,n)})}function sp(e,t){const n=rl(t);if(n){let i=0;for(let o=0;o<n.length;o++)n[o].status!==2&&(n[i]=n[o],i++);n.length=i,vI(t,n.length>0?n:void 0)}tp(t,i=>{sp(e,i)})}function Z_(e,t){const n=Tu(AI(e,t)),i=G_(e.transactionQueueTree_,t);return sU(i,o=>{sy(e,o)}),sy(e,i),bI(i,o=>{sy(e,o)}),n}function sy(e,t){const n=rl(t);if(n){const i=[];let o=[],l=-1;for(let u=0;u<n.length;u++)n[u].status===3||(n[u].status===1?(he(l===u-1,"All SENT items should be at beginning of queue."),l=u,n[u].status=3,n[u].abortReason="set"):(he(n[u].status===0,"Unexpected transaction status in abort"),n[u].unwatcher(),o=o.concat(as(e.serverSyncTree_,n[u].currentWriteId,!0)),n[u].onComplete&&i.push(n[u].onComplete.bind(null,new Error("set"),!1,null))));l===-1?vI(t,void 0):n.length=l+1,nr(e.eventQueue_,Tu(t),o);for(let u=0;u<i.length;u++)tl(i[u])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _E="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",NU=(function(){let e=0;const t=[];return function(n){const i=n===e;e=n;let o;const l=new Array(8);for(o=7;o>=0;o--)l[o]=_E.charAt(n%64),n=Math.floor(n/64);he(n===0,"Cannot push at time == 0");let u=l.join("");if(i){for(o=11;o>=0&&t[o]===63;o--)t[o]=0;t[o]++}else for(o=0;o<12;o++)t[o]=Math.floor(Math.random()*64);for(o=0;o<12;o++)u+=_E.charAt(t[o]);return he(u.length===20,"nextPushId: Length should be 20."),u}})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J_{constructor(t,n,i,o){this._repo=t,this._path=n,this._queryParams=i,this._orderByCalled=o}get key(){return Ye(this._path)?null:T_(this._path)}get ref(){return new Ti(this._repo,this._path)}get _queryIdentifier(){const t=rE(this._queryParams),n=S_(t);return n==="{}"?"default":n}get _queryObject(){return rE(this._queryParams)}isEqual(t){if(t=Wt(t),!(t instanceof J_))return!1;const n=this._repo===t._repo,i=C_(this._path,t._path),o=this._queryIdentifier===t._queryIdentifier;return n&&i&&o}toJSON(){return this.toString()}toString(){return this._repo.toString()+T3(this._path)}}class Ti extends J_{constructor(t,n){super(t,n,new D_,!1)}get parent(){const t=HA(this._path);return t===null?null:new Ti(this._repo,t)}get root(){let t=this;for(;t.parent!==null;)t=t.parent;return t}}class au{constructor(t,n,i){this._node=t,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(t){const n=new ut(t),i=lu(this.ref,t);return new au(this._node.getChild(n),i,It)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(t){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,o)=>t(new au(o,lu(this.ref,i),It)))}hasChild(t){const n=new ut(t);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ln(e,t){return e=Wt(e),e._checkNotDeleted("ref"),t!==void 0?lu(e._root,t):e._root}function lu(e,t){return e=Wt(e),qe(e._path)===null?hU("child","path",t):wI("child","path",t),new Ti(e._repo,At(e._path,t))}function PU(e,t){e=Wt(e),Y_("push",e._path),xI("push",t,e._path,!0);const n=CI(e._repo),i=NU(n),o=lu(e,i),l=lu(e,i);let u;return t!=null?u=eb(l,t).then(()=>l):u=Promise.resolve(l),o.then=u.then.bind(u),o.catch=u.then.bind(u,void 0),o}function kI(e){return Y_("remove",e._path),eb(e,null)}function eb(e,t){e=Wt(e),Y_("set",e._path),xI("set",t,e._path,!1);const n=new mu;return wU(e._repo,e._path,t,null,n.wrapCallback(()=>{})),n.promise}function NI(e,t){fU("update",t,e._path);const n=new mu;return EU(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise}function MI(e){e=Wt(e);const t=new OI(()=>{}),n=new op(t);return xU(e._repo,e,n).then(i=>new au(i,new Ti(e._repo,e._path),e._queryParams.getIndex()))}class op{constructor(t){this.callbackContext=t}respondsTo(t){return t==="value"}createEvent(t,n){const i=n._queryParams.getIndex();return new MU("value",this,new au(t.snapshotNode,new Ti(n._repo,n._path),i))}getEventRunner(t){return t.getEventType()==="cancel"?()=>this.callbackContext.onCancel(t.error):()=>this.callbackContext.onValue(t.snapshot,null)}createCancelEvent(t,n){return this.callbackContext.hasCancelCallback?new LU(this,t,n):null}matches(t){return t instanceof op?!t.callbackContext||!this.callbackContext?!0:t.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function jU(e,t,n,i,o){let l;if(typeof i=="object"&&(l=void 0,o=i),typeof i=="function"&&(l=i),o&&o.onlyOnce){const p=n,h=(y,_)=>{yE(e._repo,e,f),p(y,_)};h.userCallback=n.userCallback,h.context=n.context,n=h}const u=new OI(n,l||void 0),f=new op(u);return CU(e._repo,e,f),()=>yE(e._repo,e,f)}function Ru(e,t,n,i){return jU(e,"value",t,n,i)}j5(Ti);H5(Ti);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fh=new s_("@firebase/auth");function oz(e,...t){fh.logLevel<=ct.WARN&&fh.warn(`Auth (${Za}): ${e}`,...t)}function If(e,...t){fh.logLevel<=ct.ERROR&&fh.error(`Auth (${Za}): ${e}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bv(){return typeof self<"u"&&self.location?.href||""}function lz(){return NE()==="http:"||NE()==="https:"}function NE(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vz(e,t){return Cs(e,"POST","/v1/accounts:delete",t)}async function hh(e,t){return Cs(e,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function _z(e,t=!1){const n=Wt(e),i=await n.getIdToken(t),o=lb(i);ke(o&&o.exp&&o.auth_time&&o.iat,n.auth,"internal-error");const l=typeof o.firebase=="object"?o.firebase:void 0,u=l?.sign_in_provider;return{claims:o,token:i,authTime:Uc(hy(o.auth_time)),issuedAtTime:Uc(hy(o.iat)),expirationTime:Uc(hy(o.exp)),signInProvider:u||null,signInSecondFactor:l?.sign_in_second_factor||null}}function hy(e){return Number(e)*1e3}function lb(e){const[t,n,i]=e.split(".");if(t===void 0||n===void 0||i===void 0)return If("JWT malformed, contained fewer than 3 sections"),null;try{const o=qf(n);return o?JSON.parse(o):(If("Failed to decode base64 JWT payload"),null)}catch(o){return If("Caught error parsing JWT payload as JSON",o?.toString()),null}}function LE(e){const t=lb(e);return ke(t,"internal-error"),ke(typeof t.exp<"u","internal-error"),ke(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ph(e){const t=e.auth,n=await e.getIdToken(),i=await cu(e,hh(t,{idToken:n}));ke(i?.users.length,t,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const l=o.providerUserInfo?.length?FI(o.providerUserInfo):[],u=wz(e.providerData,l),f=e.isAnonymous,p=!(e.email&&o.passwordHash)&&!u?.length,h=f?p:!1,y={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:u,metadata:new Sv(o.createdAt,o.lastLoginAt),isAnonymous:h};Object.assign(e,y)}async function xz(e){const t=Wt(e);await ph(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function wz(e,t){return[...e.filter(i=>!t.some(o=>o.providerId===i.providerId)),...t]}function FI(e){return e.map(({providerId:t,...n})=>({providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PE=new Map;function pi(e){Si(e instanceof Function,"Expected a class definition");let t=PE.get(e);return t?(Si(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,PE.set(e,t),t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qI{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(t,n){this.storage[t]=n}async _get(t){const n=this.storage[t];return n===void 0?null:n}async _remove(t){delete this.storage[t]}_addListener(t,n){}_removeListener(t,n){}}qI.type="NONE";const jE=qI;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Df(e,t,n){return`firebase:${e}:${t}:${n}`}class Ia{constructor(t,n,i){this.persistence=t,this.auth=n,this.userKey=i;const{config:o,name:l}=this.auth;this.fullUserKey=Df(this.userKey,o.apiKey,l),this.fullPersistenceKey=Df("persistence",o.apiKey,l),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(t){return this.persistence._set(this.fullUserKey,t.toJSON())}async getCurrentUser(){const t=await this.persistence._get(this.fullUserKey);if(!t)return null;if(typeof t=="string"){const n=await hh(this.auth,{idToken:t}).catch(()=>{});return n?hr._fromGetAccountInfoResponse(this.auth,n,t):null}return hr._fromJSON(this.auth,t)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(t){if(this.persistence===t)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=t,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(t,n,i="authUser"){if(!n.length)return new Ia(pi(jE),t,i);const o=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let l=o[0]||pi(jE);const u=Df(i,t.config.apiKey,t.name);let f=null;for(const h of n)try{const y=await h._get(u);if(y){let _;if(typeof y=="string"){const v=await hh(t,{idToken:y}).catch(()=>{});if(!v)break;_=await hr._fromGetAccountInfoResponse(t,v,y)}else _=hr._fromJSON(t,y);h!==l&&(f=_),l=h;break}}catch{}const p=o.filter(h=>h._shouldAllowMigration);return!l._shouldAllowMigration||!p.length?new Ia(l,t,i):(l=p[0],f&&await l._set(u,f.toJSON()),await Promise.all(n.map(async h=>{if(h!==l)try{await h._remove(u)}catch{}})),new Ia(l,t,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JI(e,t=[]){let n;switch(e){case"Browser":n=$E(hn());break;case"Worker":n=`${$E(hn())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Za}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ap={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Nz(e){ap=e}function eD(e){return ap.loadJS(e)}function Mz(){return ap.recaptchaEnterpriseScript}function Lz(){return ap.gapiScript}function Pz(e){return`__${e}${Math.floor(Math.random()*1e6)}`}class jz{constructor(){this.enterprise=new $z}ready(t){t()}execute(t,n){return Promise.resolve("token")}render(t,n){return""}}class $z{ready(t){t()}execute(t,n){return Promise.resolve("token")}render(t,n){return""}}const Uz="recaptcha-enterprise",tD="NO_RECAPTCHA";class zz{constructor(t){this.type=Uz,this.auth=Rs(t)}async verify(t="verify",n=!1){async function i(l){if(!n){if(l.tenantId==null&&l._agentRecaptchaConfig!=null)return l._agentRecaptchaConfig.siteKey;if(l.tenantId!=null&&l._tenantRecaptchaConfigs[l.tenantId]!==void 0)return l._tenantRecaptchaConfigs[l.tenantId].siteKey}return new Promise(async(u,f)=>{yz(l,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(p=>{if(p.recaptchaKey===void 0)f(new Error("recaptcha Enterprise site key undefined"));else{const h=new gz(p);return l.tenantId==null?l._agentRecaptchaConfig=h:l._tenantRecaptchaConfigs[l.tenantId]=h,u(h.siteKey)}}).catch(p=>{f(p)})})}function o(l,u,f){const p=window.grecaptcha;ME(p)?p.enterprise.ready(()=>{p.enterprise.execute(l,{action:t}).then(h=>{u(h)}).catch(()=>{u(tD)})}):f(Error("No reCAPTCHA enterprise script loaded."))}return this.auth.settings.appVerificationDisabledForTesting?new jz().execute("siteKey",{action:"verify"}):new Promise((l,u)=>{i(this.auth).then(f=>{if(!n&&ME(window.grecaptcha))o(f,l,u);else{if(typeof window>"u"){u(new Error("RecaptchaVerifier is only supported in browser"));return}let p=Mz();p.length!==0&&(p+=f),eD(p).then(()=>{o(f,l,u)}).catch(h=>{u(h)})}}).catch(f=>{u(f)})})}}async function zE(e,t,n,i=!1,o=!1){const l=new zz(e);let u;if(o)u=tD;else try{u=await l.verify(n)}catch{u=await l.verify(n,!0)}const f={...t};if(n==="mfaSmsEnrollment"||n==="mfaSmsSignIn"){if("phoneEnrollmentInfo"in f){const p=f.phoneEnrollmentInfo.phoneNumber,h=f.phoneEnrollmentInfo.recaptchaToken;Object.assign(f,{phoneEnrollmentInfo:{phoneNumber:p,recaptchaToken:h,captchaResponse:u,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}else if("phoneSignInInfo"in f){const p=f.phoneSignInInfo.recaptchaToken;Object.assign(f,{phoneSignInInfo:{recaptchaToken:p,captchaResponse:u,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}return f}return i?Object.assign(f,{captchaResp:u}):Object.assign(f,{captchaResponse:u}),Object.assign(f,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(f,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),f}async function xv(e,t,n,i,o){if(e._getRecaptchaConfig()?.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")){const l=await zE(e,t,n,n==="getOobCode");return i(e,l)}else return i(e,t).catch(async l=>{if(l.code==="auth/missing-recaptcha-token"){console.log(`${n} is protected by reCAPTCHA Enterprise for this project. Automatically triggering the reCAPTCHA flow and restarting the flow.`);const u=await zE(e,t,n,n==="getOobCode");return i(e,u)}else return Promise.reject(l)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{constructor(t){this.user=t.user,this.providerId=t.providerId,this._tokenResponse=t._tokenResponse,this.operationType=t.operationType}static async _fromIdTokenResponse(t,n,i,o=!1){const l=await hr._fromIdTokenResponse(t,i,o),u=HE(i);return new Eo({user:l,providerId:u,_tokenResponse:i,operationType:n})}static async _forOperation(t,n,i){await t._updateTokensIfNecessary(i,!0);const o=HE(i);return new Eo({user:t,providerId:o,_tokenResponse:i,operationType:n})}}function HE(e){return e.providerId?e.providerId:"phoneNumber"in e?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mh extends wi{constructor(t,n,i,o){super(n.code,n.message),this.operationType=i,this.user=o,Object.setPrototypeOf(this,mh.prototype),this.customData={appName:t.name,tenantId:t.tenantId??void 0,_serverResponse:n.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(t,n,i,o){return new mh(t,n,i,o)}}function iD(e,t,n,i){return(t==="reauthenticate"?n._getReauthenticationResolver(e):n._getIdTokenResponse(e)).catch(l=>{throw l.code==="auth/multi-factor-auth-required"?mh._fromErrorAndOperation(e,l,t,i):l})}async function Jz(e,t,n=!1){const i=await cu(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Eo._forOperation(e,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R8="pendingRedirect",Of=new Map;class A8 extends gD{constructor(t,n,i=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let t=Of.get(this.auth._key());if(!t){try{const i=await I8(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(i)}catch(n){t=()=>Promise.reject(n)}Of.set(this.auth._key(),t)}return this.bypassAuthState||Of.set(this.auth._key(),()=>Promise.resolve(null)),t()}async onAuthEvent(t){if(t.type==="signInViaRedirect")return super.onAuthEvent(t);if(t.type==="unknown"){this.resolve(null);return}if(t.eventId){const n=await this.auth._redirectUserForId(t.eventId);if(n)return this.user=n,super.onAuthEvent(t);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function I8(e,t){const n=k8(t),i=O8(e);if(!await i._isAvailable())return!1;const o=await i._get(n)==="true";return await i._remove(n),o}function D8(e,t){Of.set(e._key(),t)}function O8(e){return pi(e._redirectPersistence)}function k8(e){return Df(R8,e.config.apiKey,e.name)}async function N8(e,t,n=!1){if(Nn(e.app))return Promise.reject(yi(e));const i=Rs(e),o=mD(i,t),u=await new A8(i,o,n).execute();return u&&!n&&(delete u.user._redirectEventId,await i._persistUserIfCurrent(u.user),await i._setRedirectUser(null,t)),u}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H8=new Au(3e4,6e4);function GE(){const e=kr().___jsl;if(e?.H){for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}}function F8(e){return new Promise((t,n)=>{function i(){GE(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{GE(),n(vr(e,"network-request-failed"))},timeout:H8.get()})}if(kr().gapi?.iframes?.Iframe)t(gapi.iframes.getContext());else if(kr().gapi?.load)i();else{const o=Pz("iframefcb");return kr()[o]=()=>{gapi.load?i():n(vr(e,"network-request-failed"))},eD(`${Lz()}?onload=${o}`).catch(l=>n(l))}}).catch(t=>{throw kf=null,t})}let kf=null;function q8(e){return kf=kf||F8(e),kf}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z8={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},J8=500,eB=600,tB="_blank",nB="http://localhost";class WE{constructor(t){this.window=t,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function rB(e,t,n,i=J8,o=eB){const l=Math.max((window.screen.availHeight-o)/2,0).toString(),u=Math.max((window.screen.availWidth-i)/2,0).toString();let f="";const p={...Z8,width:i.toString(),height:o.toString(),top:l,left:u},h=hn().toLowerCase();n&&(f=WI(h)?tB:n),VI(h)&&(t=t||nB,p.scrollbars="yes");const y=Object.entries(p).reduce((v,[b,x])=>`${v}${b}=${x},`,"");if(Cz(h)&&f!=="_self")return iB(t||"",f),new WE(null);const _=window.open(t||"",f,y);ke(_,e,"popup-blocked");try{_.focus()}catch{}return new WE(_)}function iB(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pB=300,mB=wR("authIdTokenMaxAge")||pB;let XE=null;const gB=e=>async t=>{const n=t&&await t.getIdTokenResult(),i=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(i&&i>mB)return;const o=n?.token;XE!==o&&(XE=o,await fetch(e,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function yB(e=a_()){const t=Xa(e,"auth");if(t.isInitialized())return t.getImmediate();const n=nD(e,{popupRedirectResolver:uB,persistence:[S8,c8,uD]}),i=wR("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(i,location.origin);if(location.origin===l.origin){const u=gB(l.toString());s8(n,u,()=>u(n.currentUser)),i8(n,f=>u(f))}}const o=SR("auth");return o&&Hz(n,`http://${o}`),n}function vB(){return document.getElementsByTagName("head")?.[0]??document}Nz({loadJS(e){return new Promise((t,n)=>{const i=document.createElement("script");i.setAttribute("src",e),i.onload=t,i.onerror=o=>{const l=vr("internal-error");l.customData=o,n(l)},i.type="text/javascript",i.charset="UTF-8",vB().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});hB("Browser");const _B=$I,di=Vh(()=>{if(!Oc)throw new Error("Firebase app not initialized");try{return yB(Oc)}catch{return nD(Oc,{errorMap:_B})}}),vD=E.createContext({isDark:!1,toggle:()=>{}}),bB=T.button`
  display: flex;
  align-items: center;
...
`,VB=()=>{const e=et(el),[t,n]=E.useState(!1),{deleteToken:i}=E.useContext(bu),o=E.useCallback(async()=>{await i(),await di?.signOut()},[i]);if(e.state!=="fulfilled"||!e.data){const l=e.state==="loading";return g.jsx(zB,{to:nt.SIGN_IN,$disabled:l,"aria-disabled":l,tabIndex:l?-1:void 0,children:"Sign in"})}return g.jsxs(HB,{children:[g.jsx(BB,{type:"button",onClick:()=>n(!0),"aria-expanded":t,"aria-haspopup":"dialog",children:e.data.displayName}),g.jsxs(UB,{open:t,onClose:()=>n(!1),children:[g.jsx(_D,{}),g.jsx(FB,{}),g.jsx(qB,{type:"button",onClick:o,children:"Sign out"})]})]})},GB="#181a2f",up=680,WB=T.nav`
  height: inherit;
  background-color: ${GB};
  color: #fff;
  display: flex;
  ...
  @media only screen and (min-width: ${up+1}px) {
    display: grid;
...
`,KB=T.div`
  ...
  @media only screen and (max-width: ${up}px) {
    display: none;
  }
`,af=T(qv)`
  font-size: 15px;
...
`;const gb=E.createContext({state:"idle"}),lH=e=>{if(!e||typeof e!="object")return!1;const t=e;return typeof t.snapshotAt=="number"&&typeof t.starts_at=="string"&&Array.isArray(t.instructors)&&typeof t.disciplineId=="string"&&typeof t.occupancy=="number"&&typeof t.maxOccupancy=="number"&&typeof t.waitingCount=="number"&&typeof t.status=="string"},cH=e=>{const[t,n]=E.useState({state:"loading"});return E.useEffect(()=>{if(!e){n({state:"fulfilled",data:[]});return}n({state:"loading"});const i=ln;if(!i){n({state:"failed",error:new Error("No database connection")});return}const o=Ln(i,Ce.PATHS.classHistory(e)),l=Ru(o,u=>{const f=u.val();if(!f){n({state:"fulfilled",data:[]});return}const p=[];for(const[h,y]of Object.entries(f))if(!(!y||typeof y!="object"))for(const _ of Object.values(y))lH(_)&&p.push({..._,classId:h});p.sort((h,y)=>y.snapshotAt-h.snapshotAt),n({state:"fulfilled",data:p})},u=>{n({state:"failed",error:u})});return()=>l()},[e]),t},Va=(e,t,n)=>{const i=new Date(e),o=new Intl.DateTimeFormat(void 0,{month:n?"long":"short",timeZone:t}).format(i),l=new Intl.DateTimeFormat(void 0,{day:"numeric",timeZone:t}).format(i);return n?`${new Intl.DateTimeFormat(void 0,{weekday:"long",timeZone:t}).format(i)}, ${o} ${l}`:`${o} ${l}`},uH=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],dH=(e,t)=>{const n=new Map;for(const i of e){const o=new Date(i.snapshotAt),l=Va(o.toISOString(),t,!0);if(!n.has(l)){const u=new Intl.DateTimeFormat("en-US",{weekday:"long",timeZone:t}).format(o);n.set(l,{dayIndex:uH.indexOf(u),snapshots:[]})}n.get(l).snapshots.push(i)}return Array.from(n.entries()).map(([i,{dayIndex:o,snapshots:l}])=>({label:i,dayIndex:o,snapshots:l}))},To=(e,t)=>new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric",timeZone:t}).format(new Date(e)),fH=T.div`
...
`,gH=T.div`
  ...
  opacity: 0.6;
  margin-top: 2px;
`,yH=({snapshot:e,timezone:t})=>{const n=Va(e.starts_at,t,!1),i=To(e.starts_at,t),o=To(new Date(e.snapshotAt).toISOString(),t),l=e.instructors[0]?.name??"Unknown instructor",u=e.maxOccupancy-e.occupancy;return g.jsxs(fH,{children:[g.jsx(hH,{children:"● Would have triggered"}),g.jsxs(pH,{children:[n," ",i,e.name?` · ${e.name}`:""," · ",l]}),g.jsx(mH,{children:e.status==="free"?`Free · ${u} spot${u===1?"":"s"} available`:e.status==="waitlist"?`Waitlist · ${e.waitingCount} waiting`:"Full"}),g.jsxs(gH,{children:["detected at ",o]})]})},vH=T.div`
...
`,SH=T.div`
  ...
  opacity: 0.6;
  margin-top: 2px;
`,xH={instructor:"wrong instructor",time:"outside your time range",discipline:"wrong discipline",status:"class not bookable"},wH=({snapshot:e,reason:t,timezone:n})=>{const i=Va(e.starts_at,n,!1),o=To(e.starts_at,n),l=To(new Date(e.snapshotAt).toISOString(),n),u=e.instructors[0]?.name??"Unknown instructor";return g.jsxs(vH,{children:[g.jsxs(_H,{children:["◌ Near miss — ",xH[t]]}),g.jsxs(bH,{children:[i," ",o,e.name?` · ${e.name}`:""," · ",u]}),g.jsxs(SH,{children:["detected at ",l]})]})},EH=T.button`
  background: none;
  border: none;
  padding: 4px 0;
  font-family: inherit;
...
`,RH=T.span`
  font-size: 11px;
  opacity: 0.6;
`,AH=({snapshots:e,timezone:t})=>{const[n,i]=E.useState(!1),o=e.length;return g.jsxs("div",{children:[g.jsxs(EH,{type:"button",onClick:()=>i(l=>!l),children:[g.jsx("span",{children:n?"▾":"▸"}),o," class",o===1?"":"es"," skipped"]}),n&&g.jsx(TH,{children:e.map((l,u)=>{const f=Va(l.starts_at,t,!1),p=To(l.starts_at,t),h=To(new Date(l.snapshotAt).toISOString(),t);return g.jsxs(CH,{children:[g.jsxs("span",{children:[f," ",p,l.name?` · ${l.name}`:"",l.instructors[0]?` · ${l.instructors[0].name}`:""]}),g.jsxs(RH,{children:["detected at ",h]})]},u)})})]})},IH=T.section`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,DH=T.h3`
...
`,OH=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  opacity: 0.6;
`,kH=({label:e,dayIndex:t,snapshots:n,alert:i,timezone:o})=>{const l=!!i.timeRanges[t],u=[],f=[],p=[];for(const h of n){const y=Ce.classifySnapshotMatch(h,i);y.type==="match"?u.push(h):y.type==="near-miss"?f.push({snapshot:h,reason:y.reason}):p.push(h)}return g.jsxs(IH,{children:[g.jsxs(DH,{children:[e,!l&&g.jsx(OH,{children:"not monitored"})]}),u.map((h,y)=>g.jsx(yH,{snapshot:h,timezone:o},y)),f.map(({snapshot:h,reason:y},_)=>g.jsx(wH,{snapshot:h,reason:y,timezone:o},_)),p.length>0&&g.jsx(AH,{snapshots:p,timezone:o})]})},NH=T.div`
  display: flex;
  gap: 16px;
  padding: 12px 0;
  border-bottom: 1px solid ${e=>e.theme.borderColor};
...
`,MH=({matchCount:e,nearMissCount:t})=>{const n=Kv();return g.jsxs(NH,{children:[g.jsxs(ZE,{children:[g.jsx(JE,{$color:n.colors.status.free.text,children:e})," ",e===1?"class":"classes"," would have triggered"]}),g.jsxs(ZE,{children:[g.jsx(JE,{$color:n.colors.status.waitlist.text,children:t})," ","near ",t===1?"miss":"misses"]})]})},LH=T.div`
  display: flex;
  flex-direction: column;
  gap: 0;
  ${$r}
...
`,lf=T.p`
  ...
  text-align: center;
  padding: 32px 0;
`,FH=()=>{const{alertId:e}=QM(),t=ws(),n=E.useContext(gb),[i,o]=E.useState("idle"),l=E.useMemo(()=>n.state!=="fulfilled"?null:n.data.find(C=>C.id===e)??null,[n,e]),u=cH(l?.studioId??null),f=l?Ce.STUDIOS[l.studioId]?.timezone??"UTC":"UTC",p=E.useMemo(()=>!l||u.state!=="fulfilled"?[]:dH(u.data,f),[l,u,f]),{matchCount:h,nearMissCount:y}=E.useMemo(()=>{if(!l||u.state!=="fulfilled")return{matchCount:0,nearMissCount:0};let C=0,I=0;for(const M of u.data){const R=Ce.classifySnapshotMatch(M,l);R.type==="match"?C++:R.type==="near-miss"&&I++}return{matchCount:C,nearMissCount:I}},[l,u]),_=n.state==="loading"||n.state==="idle"||u.state==="loading",v="Notification"in window&&"serviceWorker"in navigator,b=E.useCallback(async()=>{if(v){o("sending");try{if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){o("idle");return}const C=await navigator.serviceWorker.ready,I=l?Ce.STUDIOS[l.studioId]:null,M="Spot opened up!",R=`${l?.name??"Test alert"} — ${I?.location??"Studio"} · test notification`;await C.showNotification(M,{body:R,icon:"/icons/icon-192x192.png",badge:"/icons/icon-96x96.png",data:{classUrl:"/p/7248695-peloton-studios-new-york/e/99586855-30-min-intervals-ride/"}}),o("sent"),setTimeout(()=>o("idle"),3e3)}catch{o("error"),setTimeout(()=>o("idle"),3e3)}}},[l,v]),x=l?.name??"Alert",O=i==="sending"?"Sending…":i==="sent"?"Sent!":i==="error"?"Error":"Send test notification";return g.jsxs(LH,{children:[g.jsxs(PH,{children:[g.jsx(UH,{type:"button",onClick:()=>t(-1),children:"← Alerts"}),g.jsxs(jH,{children:[g.jsx("div",{children:g.jsxs(zH,{children:[x," — Past 7 Days"]})}),v&&g.jsx($H,{type:"button",$sent:i==="sent",disabled:i==="sending",onClick:b,title:"Fire a test push notification to verify delivery and the notification URL",children:O})]}),g.jsx(BH,{children:l?`${Ce.STUDIOS[l.studioId]?.location??l.studioId}`:""})]}),g.jsxs(HH,{children:[_&&g.jsx(lf,{children:"Loading…"}),!_&&!l&&g.jsx(lf,{children:"Alert not found."}),!_&&l&&u.state==="fulfilled"&&g.jsxs(g.Fragment,{children:[g.jsx(MH,{matchCount:h,nearMissCount:y}),p.length===0&&g.jsx(lf,{children:"No class history yet. History builds up as the backend detects class changes."}),p.map(({label:C,dayIndex:I,snapshots:M})=>g.jsx(kH,{label:C,dayIndex:I,snapshots:M,alert:l,timezone:f},C))]}),!_&&u.state==="failed"&&g.jsx(lf,{children:"Failed to load class history."})]})]})},qH=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},VH="STUDIO_ID",SD=e=>{const t=qH(VH);return t===null?e:Object.keys(Ce.STUDIOS).includes(t)?t:e},GH={studioId:SD(Ce.DEFAULT_STUDIO_ID)},Ev=Xn({name:"studioSelector",initialState:GH,reducers:{setStudioId(e,t){e.studioId=t.payload}}}),{setStudioId:vh}=Ev.actions,WH=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");const i=(await PU(Ln(n,Ce.PATHS.alerts(e)),t)).key;if(!i)throw new Error("Missing ID from insertion operation");return{...t,id:i}},xD=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");const i={...t,name:t.name??null,watchedClassIds:t.watchedClassIds??null,disabled:t.disabled??null};await NI(Ln(n,Ce.PATHS.alert(e,t.id)),i)},YH=T.div`
  display: flex;
  flex-direction: column;
`,QH=T.label`
  color: ${e=>e.theme.colors.main};
...
`,XH=T.span`
  ...
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,ZH=({label:e,hint:t,placeholder:n,value:i,onChange:o})=>{const l=E.useId();return g.jsxs(YH,{children:[g.jsx(QH,{htmlFor:l,children:e}),g.jsx(KH,{id:l,placeholder:n,value:i,"aria-describedby":t?`${l}-hint`:void 0,onChange:({target:u})=>o(u.value)}),t&&g.jsx(XH,{id:`${l}-hint`,children:t})]})},JH=T.label`
  ${$r}
  ${mb}
  display: flex;
  align-items: center;
...
`,_h=({name:e,value:t,checked:n,onChange:i,label:o,hint:l,icon:u})=>{const f=E.useId();return g.jsxs(JH,{htmlFor:f,children:[g.jsx(r9,{type:"radio",id:f,name:e,value:t,checked:n,onChange:i}),u,g.jsxs(e9,{children:[g.jsx(t9,{children:o}),l&&g.jsx(n9,{children:l})]})]})},eT=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,tT=T.legend`
...
`,iT=T.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,i9=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),s9=[{status:"free",label:"Open spots only",hint:"Alert me when a class has available spots"},{status:"waitlist",label:"Open spots or waitlist",hint:"Alert me even if I'd join the waitlist"}],o9=({name:e,onNameChange:t,studioId:n,onStudioChange:i,maxStatus:o,onStatusChange:l})=>g.jsxs("div",{children:[g.jsx(ZH,{label:"Alert name (optional)",hint:"Leave blank to auto-generate a name from your filters",placeholder:"e.g. Morning Cycling with Cody",value:e,onChange:t}),g.jsx(iT,{}),g.jsxs(eT,{children:[g.jsx(tT,{children:"Which studio?"}),g.jsx(nT,{children:"Pick the Peloton studio you want to monitor."}),g.jsx(rT,{children:i9.map(u=>g.jsx(_h,{name:"studio",value:u.id,checked:n===u.id,onChange:()=>i(u.id),label:u.label},u.id))})]}),g.jsx(iT,{}),g.jsxs(eT,{children:[g.jsx(tT,{children:"When should we alert you?"}),g.jsx(nT,{children:"Choose whether to include waitlisted classes."}),g.jsx(rT,{children:s9.map(u=>g.jsx(_h,{name:"status",value:u.status,checked:o===u.status,onChange:()=>l(u.status),label:u.label,hint:u.hint},u.status))})]})]}),sT={Cardio:"#d8ec43",Cycling:"#bbd4f4",Meditation:"#e6d4ff",Rowing:"#cbf293","Outdoor Run":"#a8e6cf","Outdoor Run/Walk":"#94f3d0",Running:"#fde987",Strength:"#ffc0d5",Tread:"#fdbe9f",Walking:"#ffa8a9",Yoga:"#ceffdc"},wD=.2,bh=e=>Math.round(e*(1-wD*2)),a9=e=>Math.round(e*wD),l9=T.div`
  width: ${e=>bh(e.size)}px;
  height: ${e=>bh(e.size)}px;
  border-radius: ${e=>e.size}px;
  background-color: ${e=>e.color};
  padding: ${e=>a9(e.size)}px;
  flex-shrink: 0;
`,c9=T.img`
  width: ${e=>bh(e.size)}px;
  height: ${e=>bh(e.size)}px;
  display: block;
`,Sh=({discipline:e,size:t=32})=>{const n=Kv(),i=E.useMemo(()=>{const o=Object.keys(sT),l=e.name.toLowerCase(),u=o.find(f=>f.toLowerCase()===l)??o.find(f=>{const p=f.toLowerCase();return p.includes(l)||l.includes(p)});if(u)return sT[u];{const f=`Received unsupported discipline ${e.name}`;return console.log(f),t_(f),n.colors.secondarySurface}},[e.name,n.colors.secondarySurface]);return g.jsx(l9,{color:i,size:t,children:g.jsx(c9,{alt:e.name,src:e.iconUrl,size:t,color:i})})},u9=T.img`
  width: ${e=>e.size}px;
  ...
  border-radius: 50%;
  color: ${e=>e.theme.colors.secondary};
`,yb=({instructor:e,size:t=32})=>g.jsx(u9,{src:e.imageUrl,alt:`Profile of ${e.name}`,size:t});var d9=class extends Error{issues;constructor(e){super(e[0].message),this.name="SchemaError",this.issues=e}},ED=(e=>(e.uninitialized="uninitialized",e.pending="pending",e.fulfilled="fulfilled",e.rejected="rejected",e))(ED||{});function oT(e){return{status:e,isUninitialized:e==="uninitialized",isLoading:e==="pending",isSuccess:e==="fulfilled",isError:e==="rejected"}}var aT=vs;function vb(e,t){if(e===t||!(aT(e)&&aT(t)||Array.isArray(e)&&Array.isArray(t)))return t;const n=Object.keys(t),i=Object.keys(e);let o=n.length===i.length;const l=Array.isArray(t)?[]:{};for(const u of n)l[u]=vb(e[u],t[u]),o&&(o=e[u]===l[u]);return o?e:l}function my(e){let t=0;for(const n in e)t++;return t}var lT=e=>[].concat(...e);function f9(e){return new RegExp("(^|:)//").test(e)}function h9(){return typeof document>"u"?!0:document.visibilityState!=="hidden"}function xh(e){return e!=null}function p9(){return typeof navigator>"u"||navigator.onLine===void 0?!0:navigator.onLine}var m9=e=>e.replace(/\/$/,""),g9=e=>e.replace(/^\//,"");function y9(e,t){if(!e)return t;if(!t)return e;if(f9(t))return t;const n=e.endsWith("/")||!t.startsWith("?")?"/":"";return e=m9(e),t=g9(t),`${e}${n}${t}`}function v9(e,t,n){return e.has(t)?e.get(t):e.set(t,n).get(t)}function Tv(e,t,n){return e.has(t)?e.get(t):e.set(t,n(t)).get(t)}var Cv=()=>new Map,cT=(...e)=>fetch(...e),_9=e=>e.status>=200&&e.status<=299,b9=e=>/ion\/(vnd\.api\+)?json/.test(e.get("content-type")||"");function uT(e){if(!vs(e))return e;const t={...e};for(const[n,i]of Object.entries(t))i===void 0&&delete t[n];return t}function S9({baseUrl:e,prepareHeaders:t=_=>_,fetchFn:n=cT,paramsSerializer:i,isJsonContentType:o=b9,jsonContentType:l="application/json",jsonReplacer:u,timeout:f,responseHandler:p,validateStatus:h,...y}={}){return typeof fetch>"u"&&n===cT&&console.warn("Warning: `fetch` is not available. Please supply a custom `fetchFn` property to use `fetchBaseQuery` on SSR environments."),async(v,b,x)=>{const{getState:O,extra:C,endpoint:I,forced:M,type:R}=b;let D,{url:N,headers:A=new Headers(y.headers),params:P=void 0,responseHandler:U=p??"json",validateStatus:F=h??_9,timeout:H=f,...z}=typeof v=="string"?{url:v}:v,G,V=b.signal;H&&(G=new AbortController,b.signal.addEventListener("abort",G.abort),V=G.signal);let te={...y,signal:V,...z};A=new Headers(uT(A)),te.headers=await t(A,{getState:O,arg:v,extra:C,endpoint:I,forced:M,type:R,extraOptions:x})||A;const ue=de=>typeof de=="object"&&(vs(de)||Array.isArray(de)||typeof de.toJSON=="function");if(!te.headers.has("content-type")&&ue(te.body)&&te.headers.set("content-type",l),ue(te.body)&&o(te.headers)&&(te.body=JSON.stringify(te.body,u)),P){const de=~N.indexOf("?")?"&":"?",me=i?i(P):new URLSearchParams(uT(P));N+=de+me}N=y9(e,N);const j=new Request(N,te);D={request:new Request(N,te)};let ne,ae=!1,k=G&&setTimeout(()=>{ae=!0,G.abort()},H);try{ne=await n(j)}catch(de){return{error:{status:ae?"TIMEOUT_ERROR":"FETCH_ERROR",error:String(de)},meta:D}}finally{k&&clearTimeout(k),G?.signal.removeEventListener("abort",G.abort)}const X=ne.clone();D.response=X;let le,ie="";try{let de;if(await Promise.all([_(ne,U).then(me=>le=me,me=>de=me),X.text().then(me=>ie=me,()=>{})]),de)throw de}catch(de){return{error:{status:"PARSING_ERROR",originalStatus:ne.status,data:ie,error:String(de)},meta:D}}return F(ne,le)?{data:le,meta:D}:{error:{status:ne.status,data:le},meta:D}};async function _(v,b){if(typeof b=="function")return b(v);if(b==="content-type"&&(b=o(v.headers)?"json":"text"),b==="json"){const x=await v.text();return x.length?JSON.parse(x):null}return v.text()}}var dT=class{constructor(e,t=void 0){this.value=e,this.meta=t}},_b=mr("__rtkq/focused"),TD=mr("__rtkq/unfocused"),bb=mr("__rtkq/online"),CD=mr("__rtkq/offline");function dp(e){return e.type==="query"}function x9(e){return e.type==="mutation"}function fp(e){return e.type==="infinitequery"}function wh(e){return dp(e)||fp(e)}function Sb(e,t,n,i,o,l){return w9(e)?e(t,n,i,o).filter(xh).map(Rv).map(l):Array.isArray(e)?e.map(Rv).map(l):[]}function w9(e){return typeof e=="function"}function Rv(e){return typeof e=="string"?{type:e}:e}function E9(e,t){return e.catch(t)}var du=Symbol("forceQueryFn"),Av=e=>typeof e[du]=="function";function T9({serializeQueryArgs:e,queryThunk:t,infiniteQueryThunk:n,mutationThunk:i,api:o,context:l,internalState:u}){const{runningQueries:f,runningMutations:p}=u,{unsubscribeQueryResult:h,removeMutationResult:y,updateSubscriptionOptions:_}=o.internalActions;return{buildInitiateQuery:I,buildInitiateInfiniteQuery:M,buildInitiateMutation:R,getRunningQueryThunk:v,getRunningMutationThunk:b,getRunningQueriesThunk:x,getRunningMutationsThunk:O};function v(D,N){return A=>{const P=l.endpointDefinitions[D],U=e({queryArgs:N,endpointDefinition:P,endpointName:D});return f.get(A)?.[U]}}function b(D,N){return A=>p.get(A)?.[N]}function x(){return D=>Object.values(f.get(D)||{}).filter(xh)}function O(){return D=>Object.values(p.get(D)||{}).filter(xh)}function C(D,N){const A=(P,{subscribe:U=!0,forceRefetch:F,subscriptionOptions:H,[du]:z,...G}={})=>(V,te)=>{const ue=e({queryArgs:P,endpointDefinition:N,endpointName:D});let j;const K={...G,type:"query",subscribe:U,forceRefetch:F,subscriptionOptions:H,endpointName:D,originalArgs:P,queryCacheKey:ue,[du]:z};if(dp(N))j=t(K);else{const{direction:Ie,initialPageParam:be}=G;j=n({...K,direction:Ie,initialPageParam:be})}const ne=o.endpoints[D].select(P),ae=V(j),k=ne(te()),{requestId:X,abort:le}=ae,ie=k.requestId!==X,de=f.get(V)?.[ue],me=()=>ne(te()),pe=Object.assign(z?ae.then(me):ie&&!de?Promise.resolve(k):Promise.all([de,ae]).then(me),{arg:P,requestId:X,subscriptionOptions:H,queryCacheKey:ue,abort:le,async unwrap(){const Ie=await pe;if(Ie.isError)throw Ie.error;return Ie.data},refetch:()=>V(A(P,{subscribe:!1,forceRefetch:!0})),unsubscribe(){U&&V(h({queryCacheKey:ue,requestId:X}))},updateSubscriptionOptions(Ie){pe.subscriptionOptions=Ie,V(_({endpointName:D,requestId:X,queryCacheKey:ue,options:Ie}))}});if(!de&&!ie&&!z){const Ie=v9(f,V,{});Ie[ue]=pe,pe.then(()=>{delete Ie[ue],my(Ie)||f.delete(V)})}return pe};return A}function I(D,N){return C(D,N)}function M(D,N){return C(D,N)}function R(D){return(N,{track:A=!0,fixedCacheKey:P}={})=>(U,F)=>{const H=i({type:"mutation",endpointName:D,originalArgs:N,track:A,fixedCacheKey:P}),z=U(H),{requestId:G,abort:V,unwrap:te}=z,ue=E9(z.unwrap().then(ae=>({data:ae})),ae=>({error:ae})),j=()=>{U(y({requestId:G,fixedCacheKey:P}))},K=Object.assign(ue,{arg:z.arg,requestId:G,abort:V,unwrap:te,reset:j}),ne=p.get(U)||{};return p.set(U,ne),ne[G]=K,K.then(()=>{delete ne[G],my(ne)||p.delete(U)}),P&&(ne[P]=K,K.then(()=>{ne[P]===K&&(delete ne[P],my(ne)||p.delete(U))})),K}}}var RD=class extends d9{constructor(e,t,n,i){super(e),this.value=t,this.schemaName=n,this._bqMeta=i}},to=(e,t)=>Array.isArray(e)?e.includes(t):!!e;async function no(e,t,n,i){const o=await e["~standard"].validate(t);if(o.issues)throw new RD(o.issues,t,n,i);return o.value}function fT(e){return e}var gc=(e={})=>({...e,[Wh]:!0});function C9({reducerPath:e,baseQuery:t,context:{endpointDefinitions:n},serializeQueryArgs:i,api:o,assertTagType:l,selectors:u,onSchemaFailure:f,catchSchemaFailure:p,skipSchemaValidation:h}){const y=(z,G,V,te)=>(ue,j)=>{const K=n[z],ne=i({queryArgs:G,endpointDefinition:K,endpointName:z});if(ue(o.internalActions.queryResultPatched({queryCacheKey:ne,patches:V})),!te)return;const ae=o.endpoints[z].select(G)(j()),k=Sb(K.providesTags,ae.data,void 0,G,{},l);ue(o.internalActions.updateProvidedBy([{queryCacheKey:ne,providedTags:k}]))};function _(z,G,V=0){const te=[G,...z];return V&&te.length>V?te.slice(0,-1):te}function v(z,G,V=0){const te=[...z,G];return V&&te.length>V?te.slice(1):te}const b=(z,G,V,te=!0)=>(ue,j)=>{const ne=o.endpoints[z].select(G)(j()),ae={patches:[],inversePatches:[],undo:()=>ue(o.util.patchQueryData(z,G,ae.inversePatches,te))};if(ne.status==="uninitialized")return ae;let k;if("data"in ne)if(br(ne.data)){const[X,le,ie]=pA(ne.data,V);ae.patches.push(...le),ae.inversePatches.push(...ie),k=X}else k=V(ne.data),ae.patches.push({op:"replace",path:[],value:k}),ae.inversePatches.push({op:"replace",path:[],value:ne.data});return ae.patches.length===0||ue(o.util.patchQueryData(z,G,ae.patches,te)),ae},x=(z,G,V)=>te=>te(o.endpoints[z].initiate(G,{subscribe:!1,forceRefetch:!0,[du]:()=>({data:V})})),O=(z,G)=>z.query&&z[G]?z[G]:fT,C=async(z,{signal:G,abort:V,rejectWithValue:te,fulfillWithValue:ue,dispatch:j,getState:K,extra:ne})=>{const ae=n[z.endpointName],{metaSchema:k,skipSchemaValidation:X=h}=ae;try{let le=fT;const ie={signal:G,abort:V,dispatch:j,getState:K,extra:ne,endpoint:z.endpointName,type:z.type,forced:z.type==="query"?I(z,K()):void 0,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0},de=z.type==="query"?z[du]:void 0;let me;const pe=async(be,Oe,Ue,_t)=>{if(Oe==null&&be.pages.length)return Promise.resolve({data:be});const gt={queryArg:z.originalArgs,pageParam:Oe},Pn=await Ie(gt),Et=_t?_:v;return{data:{pages:Et(be.pages,Pn.data,Ue),pageParams:Et(be.pageParams,Oe,Ue)},meta:Pn.meta}};async function Ie(be){let Oe;const{extraOptions:Ue,argSchema:_t,rawResponseSchema:gt,responseSchema:Pn}=ae;if(_t&&!to(X,"arg")&&(be=await no(_t,be,"argSchema",{})),de?Oe=de():ae.query?(le=O(ae,"transformResponse"),Oe=await t(ae.query(be),ie,Ue)):Oe=await ae.queryFn(be,ie,Ue,Ur=>t(Ur,ie,Ue)),typeof process<"u",Oe.error)throw new dT(Oe.error,Oe.meta);let{data:Et}=Oe;gt&&!to(X,"rawResponse")&&(Et=await no(gt,Oe.data,"rawResponseSchema",Oe.meta));let jn=await le(Et,Oe.meta,be);return Pn&&!to(X,"response")&&(jn=await no(Pn,jn,"responseSchema",Oe.meta)),{...Oe,data:jn}}if(z.type==="query"&&"infiniteQueryOptions"in ae){const{infiniteQueryOptions:be}=ae,{maxPages:Oe=1/0}=be;let Ue;const _t={pages:[],pageParams:[]},gt=u.selectQueryEntry(K(),z.queryCacheKey)?.data,Et=I(z,K())&&!z.direction||!gt?_t:gt;if("direction"in z&&z.direction&&Et.pages.length){const jn=z.direction==="backward",Yt=(jn?AD:Iv)(be,Et,z.originalArgs);Ue=await pe(Et,Yt,Oe,jn)}else{const{initialPageParam:jn=be.initialPageParam}=z,Ur=gt?.pageParams??[],Yt=Ur[0]??jn,sl=Ur.length;Ue=await pe(Et,Yt,Oe),de&&(Ue={data:Ue.data.pages[0]});for(let As=1;As<sl;As++){const Oo=Iv(be,Ue.data,z.originalArgs);Ue=await pe(Ue.data,Oo,Oe)}}me=Ue}else me=await Ie(z.originalArgs);return k&&!to(X,"meta")&&me.meta&&(me.meta=await no(k,me.meta,"metaSchema",me.meta)),ue(me.data,gc({fulfilledTimeStamp:Date.now(),baseQueryMeta:me.meta}))}catch(le){let ie=le;if(ie instanceof dT){let de=O(ae,"transformErrorResponse");const{rawErrorResponseSchema:me,errorResponseSchema:pe}=ae;let{value:Ie,meta:be}=ie;try{me&&!to(X,"rawErrorResponse")&&(Ie=await no(me,Ie,"rawErrorResponseSchema",be)),k&&!to(X,"meta")&&(be=await no(k,be,"metaSchema",be));let Oe=await de(Ie,be,z.originalArgs);return pe&&!to(X,"errorResponse")&&(Oe=await no(pe,Oe,"errorResponseSchema",be)),te(Oe,gc({baseQueryMeta:be}))}catch(Oe){ie=Oe}}try{if(ie instanceof RD){const de={endpoint:z.endpointName,arg:z.originalArgs,type:z.type,queryCacheKey:z.type==="query"?z.queryCacheKey:void 0};ae.onSchemaFailure?.(ie,de),f?.(ie,de);const{catchSchemaFailure:me=p}=ae;if(me)return te(me(ie,de),gc({baseQueryMeta:ie._bqMeta}))}}catch(de){ie=de}throw console.error(ie),ie}};function I(z,G){const V=u.selectQueryEntry(G,z.queryCacheKey),te=u.selectConfig(G).refetchOnMountOrArgChange,ue=V?.fulfilledTimeStamp,j=z.forceRefetch??(z.subscribe&&te);return j?j===!0||(Number(new Date)-Number(ue))/1e3>=j:!1}const M=()=>$w(`${e}/executeQuery`,C,{getPendingMeta({arg:G}){const V=n[G.endpointName];return gc({startedTimeStamp:Date.now(),...fp(V)?{direction:G.direction}:{}})},condition(G,{getState:V}){const te=V(),ue=u.selectQueryEntry(te,G.queryCacheKey),j=ue?.fulfilledTimeStamp,K=G.originalArgs,ne=ue?.originalArgs,ae=n[G.endpointName],k=G.direction;return Av(G)?!0:ue?.status==="pending"?!1:I(G,te)||dp(ae)&&ae?.forceRefetch?.({currentArg:K,previousArg:ne,endpointState:ue,state:te})?!0:!(j&&!k)},dispatchConditionRejection:!0}),R=M(),D=M(),N=$w(`${e}/executeMutation`,C,{getPendingMeta(){return gc({startedTimeStamp:Date.now()})}}),A=z=>"force"in z,P=z=>"ifOlderThan"in z,U=(z,G,V)=>(te,ue)=>{const j=A(V)&&V.force,K=P(V)&&V.ifOlderThan,ne=(k=!0)=>{const X={forceRefetch:k,isPrefetch:!0};return o.endpoints[z].initiate(G,X)},ae=o.endpoints[z].select(G)(ue());if(j)te(ne());else if(K){const k=ae?.fulfilledTimeStamp;if(!k){te(ne());return}(Number(new Date)-Number(new Date(k)))/1e3>=K&&te(ne())}else te(ne(!1))};function F(z){return G=>G?.meta?.arg?.endpointName===z}function H(z,G){return{matchPending:Nc(v_(z),F(G)),matchFulfilled:Nc(_s(z),F(G)),matchRejected:Nc(Ua(z),F(G))}}return{queryThunk:R,mutationThunk:N,infiniteQueryThunk:D,prefetch:U,updateQueryData:b,upsertQueryData:x,patchQueryData:y,buildMatchThunkActions:H}}function Iv(e,{pages:t,pageParams:n},i){const o=t.length-1;return e.getNextPageParam(t[o],t,n[o],n,i)}function AD(e,{pages:t,pageParams:n},i){return e.getPreviousPageParam?.(t[0],t,n[0],n,i)}function ID(e,t,n,i){return Sb(n[e.meta.arg.endpointName][t],_s(e)?e.payload:void 0,Qh(e)?e.payload:void 0,e.meta.arg.originalArgs,"baseQueryMeta"in e.meta?e.meta.baseQueryMeta:void 0,i)}function cf(e,t,n){const i=e[t];i&&n(i)}function fu(e){return("arg"in e?e.arg.fixedCacheKey:e.fixedCacheKey)??e.requestId}function hT(e,t,n){const i=e[fu(t)];i&&n(i)}var uf={};function R9({reducerPath:e,queryThunk:t,mutationThunk:n,serializeQueryArgs:i,context:{endpointDefinitions:o,apiUid:l,extractRehydrationInfo:u,hasRehydrationInfo:f},assertTagType:p,config:h}){const y=mr(`${e}/resetApiState`);function _(F,H,z,G){F[H.queryCacheKey]??={status:"uninitialized",endpointName:H.endpointName},cf(F,H.queryCacheKey,V=>{V.status="pending",V.requestId=z&&V.requestId?V.requestId:G.requestId,H.originalArgs!==void 0&&(V.originalArgs=H.originalArgs),V.startedTimeStamp=G.startedTimeStamp;const te=o[G.arg.endpointName];fp(te)&&"direction"in H&&(V.direction=H.direction)})}function v(F,H,z,G){cf(F,H.arg.queryCacheKey,V=>{if(V.requestId!==H.requestId&&!G)return;const{merge:te}=o[H.arg.endpointName];if(V.status="fulfilled",te)if(V.data!==void 0){const{fulfilledTimeStamp:ue,arg:j,baseQueryMeta:K,requestId:ne}=H;let ae=yu(V.data,k=>te(k,z,{arg:j.originalArgs,baseQueryMeta:K,fulfilledTimeStamp:ue,requestId:ne}));V.data=ae}else V.data=z;else V.data=o[H.arg.endpointName].structuralSharing??!0?vb(Lr(V.data)?q6(V.data):V.data,z):z;delete V.error,V.fulfilledTimeStamp=H.fulfilledTimeStamp})}const b=Xn({name:`${e}/queries`,initialState:uf,reducers:{removeQueryResult:{reducer(F,{payload:{queryCacheKey:H}}){delete F[H]},prepare:oc()},cacheEntriesUpserted:{reducer(F,H){for(const z of H.payload){const{queryDescription:G,value:V}=z;_(F,G,!0,{arg:G,requestId:H.meta.requestId,startedTimeStamp:H.meta.timestamp}),v(F,{arg:G,requestId:H.meta.requestId,fulfilledTimeStamp:H.meta.timestamp,baseQueryMeta:{}},V,!0)}},prepare:F=>({payload:F.map(G=>{const{endpointName:V,arg:te,value:ue}=G,j=o[V];return{queryDescription:{type:"query",endpointName:V,originalArgs:G.arg,queryCacheKey:i({queryArgs:te,endpointDefinition:j,endpointName:V})},value:ue}}),meta:{[Wh]:!0,requestId:__(),timestamp:Date.now()}})},queryResultPatched:{reducer(F,{payload:{queryCacheKey:H,patches:z}}){cf(F,H,G=>{G.data=Ow(G.data,z.concat())})},prepare:oc()}},extraReducers(F){F.addCase(t.pending,(H,{meta:z,meta:{arg:G}})=>{const V=Av(G);_(H,G,V,z)}).addCase(t.fulfilled,(H,{meta:z,payload:G})=>{const V=Av(z.arg);v(H,z,G,V)}).addCase(t.rejected,(H,{meta:{condition:z,arg:G,requestId:V},error:te,payload:ue})=>{cf(H,G.queryCacheKey,j=>{if(!z){if(j.requestId!==V)return;j.status="rejected",j.error=ue??te}})}).addMatcher(f,(H,z)=>{const{queries:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&(H[V]=te)})}}),x=Xn({name:`${e}/mutations`,initialState:uf,reducers:{removeMutationResult:{reducer(F,{payload:H}){const z=fu(H);z in F&&delete F[z]},prepare:oc()}},extraReducers(F){F.addCase(n.pending,(H,{meta:z,meta:{requestId:G,arg:V,startedTimeStamp:te}})=>{V.track&&(H[fu(z)]={requestId:G,status:"pending",endpointName:V.endpointName,startedTimeStamp:te})}).addCase(n.fulfilled,(H,{payload:z,meta:G})=>{G.arg.track&&hT(H,G,V=>{V.requestId===G.requestId&&(V.status="fulfilled",V.data=z,V.fulfilledTimeStamp=G.fulfilledTimeStamp)})}).addCase(n.rejected,(H,{payload:z,error:G,meta:V})=>{V.arg.track&&hT(H,V,te=>{te.requestId===V.requestId&&(te.status="rejected",te.error=z??G)})}).addMatcher(f,(H,z)=>{const{mutations:G}=u(z);for(const[V,te]of Object.entries(G))(te?.status==="fulfilled"||te?.status==="rejected")&&V!==te?.requestId&&(H[V]=te)})}}),O={tags:{},keys:{}},C=Xn({name:`${e}/invalidation`,initialState:O,reducers:{updateProvidedBy:{reducer(F,H){for(const{queryCacheKey:z,providedTags:G}of H.payload){I(F,z);for(const{type:V,id:te}of G){const ue=(F.tags[V]??={})[te||"__internal_without_id"]??=[];ue.includes(z)||ue.push(z)}F.keys[z]=G}},prepare:oc()}},extraReducers(F){F.addCase(b.actions.removeQueryResult,(H,{payload:{queryCacheKey:z}})=>{I(H,z)}).addMatcher(f,(H,z)=>{const{provided:G}=u(z);for(const[V,te]of Object.entries(G.tags??{}))for(const[ue,j]of Object.entries(te)){const K=(H.tags[V]??={})[ue||"__internal_without_id"]??=[];for(const ne of j)K.includes(ne)||K.push(ne),H.keys[ne]=G.keys[ne]}}).addMatcher(_i(_s(t),Qh(t)),(H,z)=>{M(H,[z])}).addMatcher(b.actions.cacheEntriesUpserted.match,(H,z)=>{const G=z.payload.map(({queryDescription:V,value:te})=>({type:"UNKNOWN",payload:te,meta:{requestStatus:"fulfilled",requestId:"UNKNOWN",arg:V}}));M(H,G)})}});function I(F,H){const z=F.keys[H]??[];for(const G of z){const V=G.type,te=G.id??"__internal_without_id",ue=F.tags[V]?.[te];ue&&(F.tags[V][te]=ue.filter(j=>j!==H))}delete F.keys[H]}function M(F,H){const z=H.map(G=>{const V=ID(G,"providesTags",o,p),{queryCacheKey:te}=G.meta.arg;return{queryCacheKey:te,providedTags:V}});C.caseReducers.updateProvidedBy(F,C.actions.updateProvidedBy(z))}const R=Xn({name:`${e}/subscriptions`,initialState:uf,reducers:{updateSubscriptionOptions(F,H){},unsubscribeQueryResult(F,H){},internal_getRTKQSubscriptions(){}}}),D=Xn({name:`${e}/internalSubscriptions`,initialState:uf,reducers:{subscriptionsUpdated:{reducer(F,H){return Ow(F,H.payload)},prepare:oc()}}}),N=Xn({name:`${e}/config`,initialState:{online:p9(),focused:h9(),middlewareRegistered:!1,...h},reducers:{middlewareRegistered(F,{payload:H}){F.middlewareRegistered=F.middlewareRegistered==="conflict"||l!==H?"conflict":!0}},extraReducers:F=>{F.addCase(bb,H=>{H.online=!0}).addCase(CD,H=>{H.online=!1}).addCase(_b,H=>{H.focused=!0}).addCase(TD,H=>{H.focused=!1}).addMatcher(f,H=>({...H}))}}),A=aA({queries:b.reducer,mutations:x.reducer,provided:C.reducer,subscriptions:D.reducer,config:N.reducer}),P=(F,H)=>A(y.match(H)?void 0:F,H),U={...N.actions,...b.actions,...R.actions,...D.actions,...x.actions,...C.actions,resetApiState:y};return{reducer:P,actions:U}}var cr=Symbol.for("RTKQ/skipToken"),DD={status:"uninitialized"},pT=yu(DD,()=>{}),mT=yu(DD,()=>{});function A9({serializeQueryArgs:e,reducerPath:t,createSelector:n}){const i=R=>pT,o=R=>mT;return{buildQuerySelector:v,buildInfiniteQuerySelector:b,buildMutationSelector:x,selectInvalidatedBy:O,selectCachedArgsForQuery:C,selectApiState:u,selectQueries:f,selectMutations:h,selectQueryEntry:p,selectConfig:y};function l(R){return{...R,...oT(R.status)}}function u(R){return R[t]}function f(R){return u(R)?.queries}function p(R,D){return f(R)?.[D]}function h(R){return u(R)?.mutations}function y(R){return u(R)?.config}function _(R,D,N){return A=>{if(A===cr)return n(i,N);const P=e({queryArgs:A,endpointDefinition:D,endpointName:R});return n(F=>p(F,P)??pT,N)}}function v(R,D){return _(R,D,l)}function b(R,D){const{infiniteQueryOptions:N}=D;function A(P){const U={...P,...oT(P.status)},{isLoading:F,isError:H,direction:z}=U,G=z==="forward",V=z==="backward";return{...U,hasNextPage:I(N,U.data,U.originalArgs),hasPreviousPage:M(N,U.data,U.originalArgs),isFetchingNextPage:F&&G,isFetchingPreviousPage:F&&V,isFetchNextPageError:H&&G,isFetchPreviousPageError:H&&V}}return _(R,D,A)}function x(){return R=>{let D;return typeof R=="object"?D=fu(R)??cr:D=R,n(D===cr?o:P=>u(P)?.mutations?.[D]??mT,l)}}function O(R,D){const N=R[t],A=new Set;for(const P of D.filter(xh).map(Rv)){const U=N.provided.tags[P.type];if(!U)continue;let F=(P.id!==void 0?U[P.id]:lT(Object.values(U)))??[];for(const H of F)A.add(H)}return lT(Array.from(A.values()).map(P=>{const U=N.queries[P];return U?[{queryCacheKey:P,endpointName:U.endpointName,originalArgs:U.originalArgs}]:[]}))}function C(R,D){return Object.values(f(R)).filter(N=>N?.endpointName===D&&N.status!=="uninitialized").map(N=>N.originalArgs)}function I(R,D,N){return D?Iv(R,D,N)!=null:!1}function M(R,D,N){return!D||!R.getPreviousPageParam?!1:AD(R,D,N)!=null}}var gT=WeakMap?new WeakMap:void 0,yT=({endpointName:e,queryArgs:t})=>{let n="";const i=gT?.get(t);if(typeof i=="string")n=i;else{const o=JSON.stringify(t,(l,u)=>(u=typeof u=="bigint"?{$bigint:u.toString()}:u,u=vs(u)?Object.keys(u).sort().reduce((f,p)=>(f[p]=u[p],f),{}):u,u));vs(t)&&gT?.set(t,o),n=o}return`${e}(${n})`};function OD(...e){return function(n){const i=Zf(h=>n.extractRehydrationInfo?.(h,{reducerPath:n.reducerPath??"api"})),o={reducerPath:"api",keepUnusedDataFor:60,refetchOnMountOrArgChange:!1,refetchOnFocus:!1,refetchOnReconnect:!1,invalidationBehavior:"delayed",...n,extractRehydrationInfo:i,serializeQueryArgs(h){let y=yT;if("serializeQueryArgs"in h.endpointDefinition){const _=h.endpointDefinition.serializeQueryArgs;y=v=>{const b=_(v);return typeof b=="string"?b:yT({...v,queryArgs:b})}}else n.serializeQueryArgs&&(y=n.serializeQueryArgs);return y(h)},tagTypes:[...n.tagTypes||[]]},l={endpointDefinitions:{},batch(h){h()},apiUid:__(),extractRehydrationInfo:i,hasRehydrationInfo:Zf(h=>i(h)!=null)},u={injectEndpoints:p,enhanceEndpoints({addTagTypes:h,endpoints:y}){if(h)for(const _ of h)o.tagTypes.includes(_)||o.tagTypes.push(_);if(y)for(const[_,v]of Object.entries(y))typeof v=="function"?v(l.endpointDefinitions[_]):Object.assign(l.endpointDefinitions[_]||{},v);return u}},f=e.map(h=>h.init(u,o,l));function p(h){const y=h.endpoints({query:_=>({..._,type:"query"}),mutation:_=>({..._,type:"mutation"}),infiniteQuery:_=>({..._,type:"infinitequery"})});for(const[_,v]of Object.entries(y)){if(h.overrideExisting!==!0&&_ in l.endpointDefinitions){if(h.overrideExisting==="throw")throw new Error(gr(39));continue}l.endpointDefinitions[_]=v;for(const b of f)b.injectEndpoint(_,v)}return u}return u.injectEndpoints({endpoints:n.endpoints})}}function oi(e,...t){return Object.assign(e,...t)}var I9=({api:e,queryThunk:t,internalState:n,mwApi:i})=>{const o=`${e.reducerPath}/subscriptions`;let l=null,u=null;const{updateSubscriptionOptions:f,unsubscribeQueryResult:p}=e.internalActions,h=(O,C)=>{if(f.match(C)){const{queryCacheKey:M,requestId:R,options:D}=C.payload,N=O.get(M);return N?.has(R)&&N.set(R,D),!0}if(p.match(C)){const{queryCacheKey:M,requestId:R}=C.payload,D=O.get(M);return D&&D.delete(R),!0}if(e.internalActions.removeQueryResult.match(C))return O.delete(C.payload.queryCacheKey),!0;if(t.pending.match(C)){const{meta:{arg:M,requestId:R}}=C,D=Tv(O,M.queryCacheKey,Cv);return M.subscribe&&D.set(R,M.subscriptionOptions??D.get(R)??{}),!0}let I=!1;if(t.rejected.match(C)){const{meta:{condition:M,arg:R,requestId:D}}=C;if(M&&R.subscribe){const N=Tv(O,R.queryCacheKey,Cv);N.set(D,R.subscriptionOptions??N.get(D)??{}),I=!0}}return I},y=()=>n.currentSubscriptions,b={getSubscriptions:y,getSubscriptionCount:O=>y().get(O)?.size??0,isRequestSubscribed:(O,C)=>!!y()?.get(O)?.get(C)};function x(O){return JSON.parse(JSON.stringify(Object.fromEntries([...O].map(([C,I])=>[C,Object.fromEntries(I)]))))}return(O,C)=>{if(l||(l=x(n.currentSubscriptions)),e.util.resetApiState.match(O))return l={},n.currentSubscriptions.clear(),u=null,[!0,!1];if(e.internalActions.internal_getRTKQSubscriptions.match(O))return[!1,b];const I=h(n.currentSubscriptions,O);let M=!0;if(I){u||(u=setTimeout(()=>{const N=x(n.currentSubscriptions),[,A]=pA(l,()=>N);C.next(e.internalActions.subscriptionsUpdated(A)),l=N,u=null},500));const R=typeof O.type=="string"&&!!O.type.startsWith(o),D=t.rejected.match(O)&&O.meta.condition&&!!O.meta.arg.subscribe;M=!R&&!D}return[M,!1]}},D9=2147483647/1e3-1,O9=({reducerPath:e,api:t,queryThunk:n,context:i,internalState:o,selectors:{selectQueryEntry:l,selectConfig:u},getRunningQueryThunk:f,mwApi:p})=>{const{removeQueryResult:h,unsubscribeQueryResult:y,cacheEntriesUpserted:_}=t.internalActions,v=o.runningQueries.get(p.dispatch),b=_i(y.match,n.fulfilled,n.rejected,_.match);function x(R){const D=o.currentSubscriptions.get(R);if(!D)return!1;const N=D.size>0,A=v?.[R]!==void 0;return N||A}const O={},C=(R,D,N)=>{const A=D.getState(),P=u(A);if(b(R)){let U;if(_.match(R))U=R.payload.map(F=>F.queryDescription.queryCacheKey);else{const{queryCacheKey:F}=y.match(R)?R.payload:R.meta.arg;U=[F]}I(U,D,P)}if(t.util.resetApiState.match(R))for(const[U,F]of Object.entries(O))F&&clearTimeout(F),delete O[U];if(i.hasRehydrationInfo(R)){const{queries:U}=i.extractRehydrationInfo(R);I(Object.keys(U),D,P)}};function I(R,D,N){const A=D.getState();for(const P of R){const U=l(A,P);U?.endpointName&&M(P,U.endpointName,D,N)}}function M(R,D,N,A){const U=i.endpointDefinitions[D]?.keepUnusedDataFor??A.keepUnusedDataFor;if(U===1/0)return;const F=Math.max(0,Math.min(U,D9));if(!x(R)){const H=O[R];H&&clearTimeout(H),O[R]=setTimeout(()=>{if(!x(R)){const z=l(N.getState(),R);z?.endpointName&&N.dispatch(f(z.endpointName,z.originalArgs))?.abort(),N.dispatch(h({queryCacheKey:R}))}delete O[R]},F*1e3)}}return C},vT=new Error("Promise never resolved before cacheEntryRemoved."),k9=({api:e,reducerPath:t,context:n,queryThunk:i,mutationThunk:o,internalState:l,selectors:{selectQueryEntry:u,selectApiState:f}})=>{const p=ov(i),h=ov(o),y=_s(i,o),_={};function v(I,M,R){const D=_[I];D?.valueResolved&&(D.valueResolved({data:M,meta:R}),delete D.valueResolved)}function b(I){const M=_[I];M&&(delete _[I],M.cacheEntryRemoved())}const x=(I,M,R)=>{const D=O(I);function N(A,P,U,F){const H=u(R,P),z=u(M.getState(),P);!H&&z&&C(A,F,P,M,U)}if(i.pending.match(I))N(I.meta.arg.endpointName,D,I.meta.requestId,I.meta.arg.originalArgs);else if(e.internalActions.cacheEntriesUpserted.match(I))for(const{queryDescription:A,value:P}of I.payload){const{endpointName:U,originalArgs:F,queryCacheKey:H}=A;N(U,H,I.meta.requestId,F),v(H,P,{})}else if(o.pending.match(I))M.getState()[t].mutations[D]&&C(I.meta.arg.endpointName,I.meta.arg.originalArgs,D,M,I.meta.requestId);else if(y(I))v(D,I.payload,I.meta.baseQueryMeta);else if(e.internalActions.removeQueryResult.match(I)||e.internalActions.removeMutationResult.match(I))b(D);else if(e.util.resetApiState.match(I))for(const A of Object.keys(_))b(A)};function O(I){return p(I)?I.meta.arg.queryCacheKey:h(I)?I.meta.arg.fixedCacheKey??I.meta.requestId:e.internalActions.removeQueryResult.match(I)?I.payload.queryCacheKey:e.internalActions.removeMutationResult.match(I)?fu(I.payload):""}function C(I,M,R,D,N){const A=n.endpointDefinitions[I],P=A?.onCacheEntryAdded;if(!P)return;const U={},F=new Promise(ue=>{U.cacheEntryRemoved=ue}),H=Promise.race([new Promise(ue=>{U.valueResolved=ue}),F.then(()=>{throw vT})]);H.catch(()=>{}),_[R]=U;const z=e.endpoints[I].select(wh(A)?M:R),G=D.dispatch((ue,j,K)=>K),V={...D,getCacheEntry:()=>z(D.getState()),requestId:N,extra:G,updateCachedData:wh(A)?ue=>D.dispatch(e.util.updateQueryData(I,M,ue)):void 0,cacheDataLoaded:H,cacheEntryRemoved:F},te=P(M,V);Promise.resolve(te).catch(ue=>{if(ue!==vT)throw ue})}return x},N9=({api:e,context:{apiUid:t},reducerPath:n})=>(i,o)=>{e.util.resetApiState.match(i)&&o.dispatch(e.internalActions.middlewareRegistered(t))},M9=({reducerPath:e,context:t,context:{endpointDefinitions:n},mutationThunk:i,queryThunk:o,api:l,assertTagType:u,refetchQuery:f,internalState:p})=>{const{removeQueryResult:h}=l.internalActions,y=_i(_s(i),Qh(i)),_=_i(_s(i,o),Ua(i,o));let v=[];const b=(C,I)=>{y(C)?O(ID(C,"invalidatesTags",n,u),I):_(C)?O([],I):l.util.invalidateTags.match(C)&&O(Sb(C.payload,void 0,void 0,void 0,void 0,u),I)};function x(C){const{queries:I,mutations:M}=C;for(const R of[I,M])for(const D in R)if(R[D]?.status==="pending")return!0;return!1}function O(C,I){const M=I.getState(),R=M[e];if(v.push(...C),R.config.invalidationBehavior==="delayed"&&x(R))return;const D=v;if(v=[],D.length===0)return;const N=l.util.selectInvalidatedBy(M,D);t.batch(()=>{const A=Array.from(N.values());for(const{queryCacheKey:P}of A){const U=R.queries[P],F=Tv(p.currentSubscriptions,P,Cv);U&&(F.size===0?I.dispatch(h({queryCacheKey:P})):U.status!=="uninitialized"&&I.dispatch(f(U)))}})}return b},L9=({reducerPath:e,queryThunk:t,api:n,refetchQuery:i,internalState:o})=>{const{currentPolls:l,currentSubscriptions:u}=o,f=new Set;let p=null;const h=(C,I)=>{(n.internalActions.updateSubscriptionOptions.match(C)||n.internalActions.unsubscribeQueryResult.match(C))&&y(C.payload.queryCacheKey,I),(t.pending.match(C)||t.rejected.match(C)&&C.meta.condition)&&y(C.meta.arg.queryCacheKey,I),(t.fulfilled.match(C)||t.rejected.match(C)&&!C.meta.condition)&&_(C.meta.arg,I),n.util.resetApiState.match(C)&&(x(),p&&(clearTimeout(p),p=null),f.clear())};function y(C,I){f.add(C),p||(p=setTimeout(()=>{for(const M of f)v({queryCacheKey:M},I);f.clear(),p=null},0))}function _({queryCacheKey:C},I){const M=I.getState()[e],R=M.queries[C],D=u.get(C);if(!R||R.status==="uninitialized")return;const{lowestPollingInterval:N,skipPollingIfUnfocused:A}=O(D);if(!Number.isFinite(N))return;const P=l.get(C);P?.timeout&&(clearTimeout(P.timeout),P.timeout=void 0);const U=Date.now()+N;l.set(C,{nextPollTimestamp:U,pollingInterval:N,timeout:setTimeout(()=>{(M.config.focused||!A)&&I.dispatch(i(R)),_({queryCacheKey:C},I)},N)})}function v({queryCacheKey:C},I){const R=I.getState()[e].queries[C],D=u.get(C);if(!R||R.status==="uninitialized")return;const{lowestPollingInterval:N}=O(D);if(!Number.isFinite(N)){b(C);return}const A=l.get(C),P=Date.now()+N;(!A||P<A.nextPollTimestamp)&&_({queryCacheKey:C},I)}function b(C){const I=l.get(C);I?.timeout&&clearTimeout(I.timeout),l.delete(C)}function x(){for(const C of l.keys())b(C)}function O(C=new Map){let I=!1,M=Number.POSITIVE_INFINITY;for(const R of C.values())R.pollingInterval&&(M=Math.min(R.pollingInterval,M),I=R.skipPollingIfUnfocused||I);return{lowestPollingInterval:M,skipPollingIfUnfocused:I}}return h},P9=({api:e,context:t,queryThunk:n,mutationThunk:i})=>{const o=v_(n,i),l=Ua(n,i),u=_s(n,i),f={};return(h,y)=>{if(o(h)){const{requestId:_,arg:{endpointName:v,originalArgs:b}}=h.meta,x=t.endpointDefinitions[v],O=x?.onQueryStarted;if(O){const C={},I=new Promise((N,A)=>{C.resolve=N,C.reject=A});I.catch(()=>{}),f[_]=C;const M=e.endpoints[v].select(wh(x)?b:_),R=y.dispatch((N,A,P)=>P),D={...y,getCacheEntry:()=>M(y.getState()),requestId:_,extra:R,updateCachedData:wh(x)?N=>y.dispatch(e.util.updateQueryData(v,b,N)):void 0,queryFulfilled:I};O(b,D)}}else if(u(h)){const{requestId:_,baseQueryMeta:v}=h.meta;f[_]?.resolve({data:h.payload,meta:v}),delete f[_]}else if(l(h)){const{requestId:_,rejectedWithValue:v,baseQueryMeta:b}=h.meta;f[_]?.reject({error:h.payload??h.error,isUnhandledError:!v,meta:b}),delete f[_]}}},j9=({reducerPath:e,context:t,api:n,refetchQuery:i,internalState:o})=>{const{removeQueryResult:l}=n.internalActions,u=(p,h)=>{_b.match(p)&&f(h,"refetchOnFocus"),bb.match(p)&&f(h,"refetchOnReconnect")};function f(p,h){const y=p.getState()[e],_=y.queries,v=o.currentSubscriptions;t.batch(()=>{for(const b of v.keys()){const x=_[b],O=v.get(b);if(!O||!x)continue;const C=[...O.values()];(C.some(M=>M[h]===!0)||C.every(M=>M[h]===void 0)&&y.config[h])&&(O.size===0?p.dispatch(l({queryCacheKey:b})):x.status!=="uninitialized"&&p.dispatch(i(x)))}})}return u};function $9(e){const{reducerPath:t,queryThunk:n,api:i,context:o,internalState:l}=e,{apiUid:u}=o,f={invalidateTags:mr(`${t}/invalidateTags`)},p=v=>v.type.startsWith(`${t}/`),h=[N9,O9,M9,L9,k9,P9];return{middleware:v=>{let b=!1;const x={...e,internalState:l,refetchQuery:_,isThisApiSliceAction:p,mwApi:v},O=h.map(M=>M(x)),C=I9(x),I=j9(x);return M=>R=>{if(!lA(R))return M(R);b||(b=!0,v.dispatch(i.internalActions.middlewareRegistered(u)));const D={...v,next:M},N=v.getState(),[A,P]=C(R,D,N);let U;if(A?U=M(R):U=P,v.getState()[t]&&(I(R,D,N),p(R)||o.hasRehydrationInfo(R)))for(const F of O)F(R,D,N);return U}},actions:f};function _(v){return e.api.endpoints[v.endpointName].initiate(v.originalArgs,{subscribe:!1,forceRefetch:!0})}}var _T=Symbol(),kD=({createSelector:e=Ei}={})=>({name:_T,init(t,{baseQuery:n,tagTypes:i,reducerPath:o,serializeQueryArgs:l,keepUnusedDataFor:u,refetchOnMountOrArgChange:f,refetchOnFocus:p,refetchOnReconnect:h,invalidationBehavior:y,onSchemaFailure:_,catchSchemaFailure:v,skipSchemaValidation:b},x){e$();const O=pe=>pe;Object.assign(t,{reducerPath:o,endpoints:{},internalActions:{onOnline:bb,onOffline:CD,onFocus:_b,onFocusLost:TD},util:{}});const C=A9({serializeQueryArgs:l,reducerPath:o,createSelector:e}),{selectInvalidatedBy:I,selectCachedArgsForQuery:M,buildQuerySelector:R,buildInfiniteQuerySelector:D,buildMutationSelector:N}=C;oi(t.util,{selectInvalidatedBy:I,selectCachedArgsForQuery:M});const{queryThunk:A,infiniteQueryThunk:P,mutationThunk:U,patchQueryData:F,updateQueryData:H,upsertQueryData:z,prefetch:G,buildMatchThunkActions:V}=C9({baseQuery:n,reducerPath:o,context:x,api:t,serializeQueryArgs:l,assertTagType:O,selectors:C,onSchemaFailure:_,catchSchemaFailure:v,skipSchemaValidation:b}),{reducer:te,actions:ue}=R9({context:x,queryThunk:A,mutationThunk:U,serializeQueryArgs:l,reducerPath:o,assertTagType:O,config:{refetchOnFocus:p,refetchOnReconnect:h,refetchOnMountOrArgChange:f,keepUnusedDataFor:u,reducerPath:o,invalidationBehavior:y}});oi(t.util,{patchQueryData:F,updateQueryData:H,upsertQueryData:z,prefetch:G,resetApiState:ue.resetApiState,upsertQueryEntries:ue.cacheEntriesUpserted}),oi(t.internalActions,ue);const j={currentSubscriptions:new Map,currentPolls:new Map,runningQueries:new Map,runningMutations:new Map},{buildInitiateQuery:K,buildInitiateInfiniteQuery:ne,buildInitiateMutation:ae,getRunningMutationThunk:k,getRunningMutationsThunk:X,getRunningQueriesThunk:le,getRunningQueryThunk:ie}=T9({queryThunk:A,mutationThunk:U,infiniteQueryThunk:P,api:t,serializeQueryArgs:l,context:x,internalState:j});oi(t.util,{getRunningMutationThunk:k,getRunningMutationsThunk:X,getRunningQueryThunk:ie,getRunningQueriesThunk:le});const{middleware:de,actions:me}=$9({reducerPath:o,context:x,queryThunk:A,mutationThunk:U,infiniteQueryThunk:P,api:t,assertTagType:O,selectors:C,getRunningQueryThunk:ie,internalState:j});return oi(t.util,me),oi(t,{reducer:te,middleware:de}),{name:_T,injectEndpoint(pe,Ie){const be=t,Oe=be.endpoints[pe]??={};dp(Ie)&&oi(Oe,{name:pe,select:R(pe,Ie),initiate:K(pe,Ie)},V(A,pe)),x9(Ie)&&oi(Oe,{name:pe,select:N(),initiate:ae(pe)},V(U,pe)),fp(Ie)&&oi(Oe,{name:pe,select:D(pe,Ie),initiate:ne(pe,Ie)},V(A,pe))}}}});kD();function df(e){return e.replace(e[0],e[0].toUpperCase())}function U9(e){return e.type==="query"}function z9(e){return e.type==="mutation"}function ND(e){return e.type==="infinitequery"}function yc(e,...t){return Object.assign(e,...t)}var gy=Symbol();function yy(e){const t=E.useRef(e),n=E.useMemo(()=>vb(t.current,e),[e]);return E.useEffect(()=>{t.current!==n&&(t.current=n)},[n]),n}function ff(e){const t=E.useRef(e);return E.useEffect(()=>{Cc(t.current,e)||(t.current=e)},[e]),Cc(t.current,e)?t.current:e}var B9=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",H9=B9(),F9=()=>typeof navigator<"u"&&navigator.product==="ReactNative",q9=F9(),V9=()=>H9||q9?E.useLayoutEffect:E.useEffect,G9=V9(),bT=e=>e.isUninitialized?{...e,isUninitialized:!1,isFetching:!0,isLoading:e.data===void 0,status:ED.pending}:e;function vy(e,...t){const n={};return t.forEach(i=>{n[i]=e[i]}),n}var _y=["data","status","isLoading","isSuccess","isError","error"];function W9({api:e,moduleOptions:{batch:t,hooks:{useDispatch:n,useSelector:i,useStore:o},unstable__sideEffectsInRender:l,createSelector:u},serializeQueryArgs:f,context:p}){const h=l?D=>D():E.useEffect;return{buildQueryHooks:I,buildInfiniteQueryHooks:M,buildMutationHook:R,usePrefetch:v};function y(D,N,A){if(N?.endpointName&&D.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];A!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:A,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=D.isSuccess?D.data:N?.data;P===void 0&&(P=D.data);const U=P!==void 0,F=D.isLoading,H=(!N||N.isLoading||N.isUninitialized)&&!U&&F,z=D.isSuccess||U&&(F&&!N?.isError||D.isUninitialized);return{...D,data:P,currentData:D.data,isFetching:F,isLoading:H,isSuccess:z}}function _(D,N,A){if(N?.endpointName&&D.isUninitialized){const{endpointName:G}=N,V=p.endpointDefinitions[G];A!==cr&&f({queryArgs:N.originalArgs,endpointDefinition:V,endpointName:G})===f({queryArgs:A,endpointDefinition:V,endpointName:G})&&(N=void 0)}let P=D.isSuccess?D.data:N?.data;P===void 0&&(P=D.data);const U=P!==void 0,F=D.isLoading,H=(!N||N.isLoading||N.isUninitialized)&&!U&&F,z=D.isSuccess||F&&U;return{...D,data:P,currentData:D.data,isFetching:F,isLoading:H,isSuccess:z}}function v(D,N){const A=n(),P=ff(N);return E.useCallback((U,F)=>A(e.util.prefetch(D,U,{...P,...F})),[D,A,P])}function b(D,N,{refetchOnReconnect:A,refetchOnFocus:P,refetchOnMountOrArgChange:U,skip:F=!1,pollingInterval:H=0,skipPollingIfUnfocused:z=!1,...G}={}){const{initiate:V}=e.endpoints[D],te=n(),ue=E.useRef(void 0);if(!ue.current){const me=te(e.internalActions.internal_getRTKQSubscriptions());ue.current=me}const j=yy(F?cr:N),K=ff({refetchOnReconnect:A,refetchOnFocus:P,pollingInterval:H,skipPollingIfUnfocused:z}),ne=G.initialPageParam,ae=ff(ne),k=E.useRef(void 0);let{queryCacheKey:X,requestId:le}=k.current||{},ie=!1;X&&le&&(ie=ue.current.isRequestSubscribed(X,le));const de=!ie&&k.current!==void 0;return h(()=>{de&&(k.current=void 0)},[de]),h(()=>{const me=k.current;if(j===cr){me?.unsubscribe(),k.current=void 0;return}const pe=k.current?.subscriptionOptions;if(!me||me.arg!==j){me?.unsubscribe();const Ie=te(V(j,{subscriptionOptions:K,forceRefetch:U,...ND(p.endpointDefinitions[D])?{initialPageParam:ae}:{}}));k.current=Ie}else K!==pe&&me.updateSubscriptionOptions(K)},[te,V,U,j,K,de,ae,D]),[k,te,V,K]}function x(D,N){return(P,{skip:U=!1,selectFromResult:F}={})=>{const{select:H}=e.endpoints[D],z=yy(U?cr:P),G=E.useRef(void 0),V=E.useMemo(()=>u([H(z),(ne,ae)=>ae,ne=>z],N,{memoizeOptions:{resultEqualityCheck:Cc}}),[H,z]),te=E.useMemo(()=>F?u([V],F,{devModeChecks:{identityFunctionCheck:"never"}}):V,[V,F]),ue=i(ne=>te(ne,G.current),Cc),j=o(),K=V(j.getState(),G.current);return G9(()=>{G.current=K},[K]),ue}}function O(D){E.useEffect(()=>()=>{D.current?.unsubscribe?.(),D.current=void 0},[D])}function C(D){if(!D.current)throw new Error(gr(38));return D.current.refetch()}function I(D){const N=(U,F={})=>{const[H]=b(D,U,F);return O(H),E.useMemo(()=>({refetch:()=>C(H)}),[H])},A=({refetchOnReconnect:U,refetchOnFocus:F,pollingInterval:H=0,skipPollingIfUnfocused:z=!1}={})=>{const{initiate:G}=e.endpoints[D],V=n(),[te,ue]=E.useState(gy),j=E.useRef(void 0),K=ff({refetchOnReconnect:U,refetchOnFocus:F,pollingInterval:H,skipPollingIfUnfocused:z});h(()=>{const X=j.current?.subscriptionOptions;K!==X&&j.current?.updateSubscriptionOptions(K)},[K]);const ne=E.useRef(K);h(()=>{ne.current=K},[K]);const ae=E.useCallback(function(X,le=!1){let ie;return t(()=>{j.current?.unsubscribe(),j.current=ie=V(G(X,{subscriptionOptions:ne.current,forceRefetch:!le})),ue(X)}),ie},[V,G]),k=E.useCallback(()=>{j.current?.queryCacheKey&&V(e.internalActions.removeQueryResult({queryCacheKey:j.current?.queryCacheKey}))},[V]);return E.useEffect(()=>()=>{j?.current?.unsubscribe()},[]),E.useEffect(()=>{te!==gy&&!j.current&&ae(te,!0)},[te,ae]),E.useMemo(()=>[ae,te,{reset:k}],[ae,te,k])},P=x(D,y);return{useQueryState:P,useQuerySubscription:N,useLazyQuerySubscription:A,useLazyQuery(U){const[F,H,{reset:z}]=A(U),G=P(H,{...U,skip:H===gy}),V=E.useMemo(()=>({lastArg:H}),[H]);return E.useMemo(()=>[F,{...G,reset:z},V],[F,G,z,V])},useQuery(U,F){const H=N(U,F),z=P(U,{selectFromResult:U===cr||F?.skip?void 0:bT,...F}),G=vy(z,..._y);return E.useDebugValue(G),E.useMemo(()=>({...z,...H}),[z,H])}}}function M(D){const N=(P,U={})=>{const[F,H,z,G]=b(D,P,U),V=E.useRef(G);h(()=>{V.current=G},[G]);const te=E.useCallback(function(K,ne){let ae;return t(()=>{F.current?.unsubscribe(),F.current=ae=H(z(K,{subscriptionOptions:V.current,direction:ne}))}),ae},[F,H,z]);O(F);const ue=yy(U.skip?cr:P),j=E.useCallback(()=>C(F),[F]);return E.useMemo(()=>({trigger:te,refetch:j,fetchNextPage:()=>te(ue,"forward"),fetchPreviousPage:()=>te(ue,"backward")}),[j,te,ue])},A=x(D,_);return{useInfiniteQueryState:A,useInfiniteQuerySubscription:N,useInfiniteQuery(P,U){const{refetch:F,fetchNextPage:H,fetchPreviousPage:z}=N(P,U),G=A(P,{selectFromResult:P===cr||U?.skip?void 0:bT,...U}),V=vy(G,..._y,"hasNextPage","hasPreviousPage");return E.useDebugValue(V),E.useMemo(()=>({...G,fetchNextPage:H,fetchPreviousPage:z,refetch:F}),[G,H,z,F])}}}function R(D){return({selectFromResult:N,fixedCacheKey:A}={})=>{const{select:P,initiate:U}=e.endpoints[D],F=n(),[H,z]=E.useState();E.useEffect(()=>()=>{H?.arg.fixedCacheKey||H?.reset()},[H]);const G=E.useCallback(function(X){const le=F(U(X,{fixedCacheKey:A}));return z(le),le},[F,U,A]),{requestId:V}=H||{},te=E.useMemo(()=>P({fixedCacheKey:A,requestId:H?.requestId}),[A,H,P]),ue=E.useMemo(()=>N?u([te],N):te,[N,te]),j=i(ue,Cc),K=A==null?H?.arg.originalArgs:void 0,ne=E.useCallback(()=>{t(()=>{H&&z(void 0),A&&F(e.internalActions.removeMutationResult({requestId:V,fixedCacheKey:A}))})},[F,A,H,V]),ae=vy(j,..._y,"endpointName");E.useDebugValue(ae);const k=E.useMemo(()=>({...j,originalArgs:K,reset:ne}),[j,K,ne]);return E.useMemo(()=>[G,k],[G,k])}}}var Y9=Symbol(),Q9=({batch:e=jN,hooks:t={useDispatch:hC,useSelector:pC,useStore:fC},createSelector:n=Ei,unstable__sideEffectsInRender:i=!1,...o}={})=>({name:Y9,init(l,{serializeQueryArgs:u},f){const p=l,{buildQueryHooks:h,buildInfiniteQueryHooks:y,buildMutationHook:_,usePrefetch:v}=W9({api:l,moduleOptions:{batch:e,hooks:t,unstable__sideEffectsInRender:i,createSelector:n},serializeQueryArgs:u,context:f});return yc(p,{usePrefetch:v}),yc(f,{batch:e}),{injectEndpoint(b,x){if(U9(x)){const{useQuery:O,useLazyQuery:C,useLazyQuerySubscription:I,useQueryState:M,useQuerySubscription:R}=h(b);yc(p.endpoints[b],{useQuery:O,useLazyQuery:C,useLazyQuerySubscription:I,useQueryState:M,useQuerySubscription:R}),l[`use${df(b)}Query`]=O,l[`useLazy${df(b)}Query`]=C}if(z9(x)){const O=_(b);yc(p.endpoints[b],{useMutation:O}),l[`use${df(b)}Mutation`]=O}else if(ND(x)){const{useInfiniteQuery:O,useInfiniteQuerySubscription:C,useInfiniteQueryState:I}=y(b);yc(p.endpoints[b],{useInfiniteQuery:O,useInfiniteQuerySubscription:C,useInfiniteQueryState:I}),l[`use${df(b)}InfiniteQuery`]=O}}}}}),K9=OD(kD(),Q9());const MD=e=>({id:String(e.id),name:e.name,imageUrl:e.picture_url,display:!0}),X9=e=>e.results.map(MD).sort((n,i)=>n.name.localeCompare(i.name)),LD=e=>{const t=e.image.original_height||48,n=e.image.original_width||48;return{id:String(e.id),name:e.name,iconUrl:e.image.url.replace("{height}",t).replace("{width}",n)}},Z9=e=>e.results.map(LD).sort((n,i)=>n.name.localeCompare(i.name)),J9=e=>{const t=e.instructors[0],n=t?MD(t):{id:"0",name:"Unknown Instructor",imageUrl:"",display:!1},i=Ce.getBookableStatus(e),o=new Date(e.starts_at),u=(new Date(e.ends_at).getTime()-o.getTime())/1e3;return Number.isNaN(u)&&t_("Computed invalid duration",{extra:{rawClass:e}}),{...e,id:String(e.id),name:e.name,start:e.starts_at,end:e.ends_at,customerUrl:e.customer_url,duration:u,discipline:LD(e.offering_type.category),instructor:n,status:i}},eF=e=>e.results.map(J9),tF=["id","name","max_occupancy","occupancy","attending_count","starts_at","ends_at","waiting_count","active_registration_status","category.name","venue","customer_url","description"],nF=["instructors","active_registration_status","category","offering_type","offering_type.category","venue","suggested_booking_action"],Nf=K9({reducerPath:"pelotonApi",baseQuery:S9({baseUrl:`${Ce.PELOTON_CORS_PROXY}/${Ce.PELOTON_API_BASE}/`}),endpoints:e=>({getClasses:e.query({queryFn:async t=>{try{const n=Ce.getPelotonHeaders(t),i=Ce.buildEventsUrl({fields:tF,expand:nF,corsProxy:!0}),o=await Ce.fetchAllPelotonPages(i,async l=>{const u=await fetch(l,{headers:n});if(!u.ok)throw new Error(`${u.status}: ${await u.text()}`);return u.json()},!0);return{data:eF({results:o})}}catch(n){return{error:{status:"FETCH_ERROR",error:String(n)}}}}}),getDisciplines:e.query({query:t=>({url:`offering_type_categories?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>Z9(t)}),getInstructors:e.query({query:t=>({url:`instructors?${new URLSearchParams({sort:"name"})}`,method:"GET",headers:Ce.getPelotonHeaders(t)}),transformResponse:t=>X9(t)})})}),{useGetClassesQuery:xb,useGetDisciplinesQuery:wb,useGetInstructorsQuery:Eb}=Nf,rF=e=>{if("error"in e&&typeof e.error=="string")return e.error;if("message"in e&&typeof e.message=="string")return e.message},iF=T.label`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
...
`,oF=T.input`
  accent-color: ${e=>e.theme.colors.accent};
`,PD=({value:e,checked:t,onChange:n,label:i,icon:o})=>{const l=E.useId();return g.jsxs(iF,{$checked:t,htmlFor:l,children:[g.jsx(oF,{type:"checkbox",id:l,value:e,checked:t,onChange:n}),o,g.jsx(sF,{children:i})]})},ST=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,xT=T.legend`
...
`,aF=T.div`
  ...
  ${Te`
    margin-top: 24px;
  `}
`,lF=({studioId:e,selectedInstructors:t,setSelectedInstructors:n,selectedDisciplines:i,setSelectedDisciplines:o})=>{const l=Eb(e),u=wb(e),f=E.useRef(t),p=E.useRef(i);E.useEffect(()=>{const b=f.current;if(!l.currentData||!Ce.isNotEmpty(b))return;const x=new Set(l.currentData.map(C=>C.id)),O=b.filter(C=>x.has(C));O.length<b.length&&(n(O),f.current=O)},[l.currentData,n]),E.useEffect(()=>{const b=p.current;if(!u.currentData||!Ce.isNotEmpty(b))return;const x=new Set(u.currentData.map(C=>String(C.id))),O=b.filter(C=>x.has(String(C))).map(String);O.length<b.length&&(o(O),p.current=O)},[u.currentData,o]);const h=E.useCallback(b=>{if(!Ce.isNotEmpty(t))return;const x=t.includes(b);n(x?t.filter(O=>O!==b):[...t,b])},[t,n]),y=E.useCallback(b=>{if(!Ce.isNotEmpty(i))return;const x=i.includes(b);o(x?i.filter(O=>O!==b):[...i,b])},[i,o]),_=Ce.isNotEmpty(t),v=Ce.isNotEmpty(i);return g.jsxs("div",{children:[g.jsxs(ST,{children:[g.jsx(xT,{children:"Instructors"}),g.jsx(wT,{children:"Filter by specific instructors or get alerts for all of them."}),g.jsxs(ET,{children:[g.jsx(hf,{type:"button",$active:!_,onClick:()=>n(null),children:"Any instructor"}),g.jsx(hf,{type:"button",$active:_,onClick:()=>{_||n([])},children:"Specific instructors"}),_&&t.length>0&&g.jsxs(TT,{children:[t.length," selected"]})]}),_&&g.jsx(cF,{query:l,selectedIds:t,onToggle:h})]}),g.jsx(aF,{}),g.jsxs(ST,{children:[g.jsx(xT,{children:"Disciplines"}),g.jsx(wT,{children:"Filter by class type or get alerts for everything."}),g.jsxs(ET,{children:[g.jsx(hf,{type:"button",$active:!v,onClick:()=>o(null),children:"Any discipline"}),g.jsx(hf,{type:"button",$active:v,onClick:()=>{v||o([])},children:"Specific disciplines"}),v&&i.length>0&&g.jsxs(TT,{children:[i.length," selected"]})]}),v&&g.jsx(uF,{query:u,selectedIds:i,onToggle:y})]})]})},cF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(Eh,{children:"Loading instructors…"}):e.error?g.jsxs($D,{children:["Couldn't load instructors."," ",g.jsx(UD,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(Eh,{children:"No instructors found for this studio."}):g.jsx(jD,{role:"group","aria-label":"Instructors",children:e.currentData.map(i=>g.jsx(PD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(yb,{instructor:i,size:28})},i.id))})),uF=E.memo(({query:e,selectedIds:t,onToggle:n})=>e.isLoading?g.jsx(Eh,{children:"Loading disciplines…"}):e.error?g.jsxs($D,{children:["Couldn't load disciplines."," ",g.jsx(UD,{type:"button",onClick:e.refetch,children:"Try again"})]}):!e.currentData||e.currentData.length===0?g.jsx(Eh,{children:"No disciplines found for this studio."}):g.jsx(jD,{role:"group","aria-label":"Disciplines",children:e.currentData.map(i=>g.jsx(PD,{value:i.id,checked:t.includes(i.id),onChange:()=>n(i.id),label:i.name,icon:g.jsx(Sh,{discipline:i,size:24})},i.id))})),dF=T.div`
  display: flex;
  align-items: center;
  gap: 4px;
  padding: 0 16px;
...
`,mF=T.div`
  ...
  align-items: center;
  justify-content: center;
`,gF=({steps:e,currentStep:t,onStepClick:n})=>g.jsx(dF,{role:"navigation","aria-label":"Editor steps",children:e.map((i,o)=>{const l=o<t?"completed":o===t?"active":"upcoming";return g.jsxs(mF,{style:{flex:o<e.length-1?1:0},children:[g.jsxs("div",{style:{display:"flex",alignItems:"center",width:"100%"},children:[g.jsx(fF,{$state:l,onClick:()=>{l!=="upcoming"&&n(o)},"aria-label":`Step ${o+1}: ${i}`,"aria-current":l==="active"?"step":void 0,type:"button"}),o<e.length-1&&g.jsx(hF,{$filled:o<t})]}),g.jsx(pF,{$state:l,children:i})]},o)})}),ls=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Th=new Array(48).fill(null).map((e,t)=>{const n=t*30,i=new Date;i.setHours(Math.floor(n/60)),i.setMinutes(n%60);const o=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"});return{minutes:n,label:o.format(i)}}),yF=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,vF=T.legend`
...
`,xF=T.span`
  ...
  background-color: ${e=>e.theme.colors.secondarySurface};
  color: ${e=>e.theme.colors.main};
`,wF=e=>{if(Ce.isAllDay(e))return"All day";const t=Th.find(i=>i.minutes===e.startMin),n=Th.find(i=>i.minutes===e.endMin);return!t||!n?"All day":`${t.label} – ${n.label}`},EF=e=>{switch(e){case"free":return"Open spots only";case"waitlist":return"Open spots or waitlist";case"full":return"Any status"}},TF=({name:e,studioId:t,maxStatus:n,selectedInstructors:i,selectedDisciplines:o,timeRanges:l,waitlistAlerts:u,watchedClassIds:f})=>{const p=Ce.STUDIOS[t],h=ls.filter((v,b)=>l[b]),y=l.find(Boolean),_=l.filter(Boolean).every(v=>v&&y&&v.startMin===y.startMin&&v.endMin===y.endMin);return g.jsxs(yF,{children:[g.jsx(vF,{children:"Review your alert"}),g.jsx(_F,{children:"Double-check everything looks right, then hit Save."}),g.jsxs(bF,{children:[e.trim()&&g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Name"}),g.jsx(ai,{children:e.trim()})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Studio"}),g.jsx(ai,{children:p?.location||t})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Alert on"}),g.jsx(ai,{children:EF(n)})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Instructors"}),g.jsx(ai,{children:i===null?"Any instructor":i.length===0?"None selected":`${i.length} selected`})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Disciplines"}),g.jsx(ai,{children:o===null?"Any discipline":o.length===0?"None selected":`${o.length} selected`})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Days"}),h.length===0?g.jsx(ai,{children:"No days selected"}):h.length===7?g.jsx(ai,{children:"Every day"}):g.jsx(SF,{children:h.map(v=>g.jsx(xF,{children:v.slice(0,3)},v))})]}),y&&g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Time window"}),g.jsx(ai,{children:_?wF(y):"Varies by day"})]}),g.jsxs(Zi,{children:[g.jsx(Ji,{children:"Waitlist alerts"}),g.jsx(ai,{children:u?f===null?"On — any matching class":f.length===0?"On — no classes selected":`On — ${f.length} ${f.length===1?"class":"classes"} selected`:"Off"})]})]})]})},CF=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,RF=T.legend`
...
`,$F=({timeRanges:e,setTimeRanges:t})=>{const n=e.filter(Boolean).length,i=E.useRef(ls.map(()=>{})),o=E.useCallback(y=>{const _=[...e];_[y]=_[y]?null:Ce.DEFAULT_TIME_RANGE,t(_)},[e,t]),l=E.useCallback(y=>{const _=e[y];if(!_)return;const v=[...e];Ce.isAllDay(_)?v[y]=i.current[y]??Ce.SPECIFIC_DEFAULT_TIME_RANGE:(i.current[y]=_,v[y]=Ce.ALL_DAY_TIME_RANGE),t(v)},[e,t]),u=E.useCallback((y,_,v)=>{const b=[...e],x=b[y];x&&(_==="startMin"?b[y]={startMin:v,endMin:x.endMin===0||x.endMin>=v?x.endMin:0}:b[y]={...x,endMin:v},t(b))},[e,t]),f=E.useCallback(()=>{t(ls.map(()=>Ce.DEFAULT_TIME_RANGE))},[t]),p=E.useCallback(()=>{t(ls.map(()=>null))},[t]),h=E.useCallback(()=>{const y=e.find(Boolean);y&&t(e.map(_=>_?{...y}:null))},[e,t]);return g.jsxs(CF,{children:[g.jsx(RF,{children:"Days & times"}),g.jsx(AF,{children:"Choose which days and time windows to monitor. Alerts fire when a matching class falls within these windows (in the studio's timezone)."}),g.jsxs(jF,{children:[g.jsx(by,{type:"button",onClick:f,children:"Select all days"}),n>0&&g.jsx(by,{type:"button",onClick:p,children:"Clear all"}),n>1&&g.jsx(by,{type:"button",onClick:h,children:"Copy time to all"})]}),g.jsx(IF,{children:ls.map((y,_)=>{const v=e[_],b=!!v&&Ce.isAllDay(v);return g.jsxs(DF,{$enabled:!!v,children:[g.jsxs(OF,{htmlFor:`day-${_}`,children:[g.jsx(kF,{type:"checkbox",id:`day-${_}`,checked:!!v,onChange:()=>o(_)}),y]}),v&&g.jsxs(NF,{children:[g.jsxs(MF,{htmlFor:`allday-${_}`,children:[g.jsx(LF,{type:"checkbox",id:`allday-${_}`,checked:b,onChange:()=>l(_)}),"All day"]}),!b&&g.jsxs(g.Fragment,{children:[g.jsx(CT,{value:v.startMin,"aria-label":`${y} start time`,onChange:({target:x})=>{const O=parseInt(x.value);Number.isNaN(O)||u(_,"startMin",O)},children:Th.map(x=>g.jsx("option",{value:x.minutes,children:x.label},x.minutes))}),g.jsx(PF,{children:"to"}),g.jsx(CT,{value:v.endMin,"aria-label":`${y} end time`,onChange:({target:x})=>{const O=parseInt(x.value);Number.isNaN(O)||u(_,"endMin",O)},children:Th.map(x=>g.jsx("option",{value:x.minutes,disabled:x.minutes>0&&x.minutes<v.startMin,children:x.label},x.minutes))})]})]})]},y)})})]})},RT=T.fieldset`
  border: none;
  margin: 0;
  padding: 0;
`,AT=T.legend`
...
`,KF=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-left: auto;
`;function XF(e,t){try{const n=new Date(e),i=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),o=new Date(n.toLocaleString("en-US",{timeZone:t})),l=i.getTime()-o.getTime();return n.setTime(n.getTime()-l),{day:n.getDay(),minute:n.getHours()*60+n.getMinutes()}}catch{return null}}function ZF(e,t){try{return new Date(e).toLocaleString("en-US",{timeZone:t,weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return e}}function JF(e,t,n,i,o){const l=Ce.STUDIOS[o]?.timezone,u=Date.now();return e.filter(f=>{if(new Date(f.start).getTime()<=u||t!==null&&!t.includes(f.instructor.id)||n!==null&&!n.includes(f.discipline.id))return!1;if(i&&l){const p=XF(f.start,l);if(!p)return!1;const h=i[p.day];if(!h||p.minute<h.startMin||p.minute>h.endMin)return!1}return!0})}const e7=E.memo(({studioId:e,instructors:t,disciplines:n,timeRanges:i,selectedIds:o,onToggle:l})=>{const u=xb(e),f=Ce.STUDIOS[e]?.timezone??"UTC";if(u.isLoading)return g.jsx(Sy,{children:"Loading classes…"});if(u.error)return g.jsxs(Sy,{children:["Couldn't load classes."," ",g.jsx(QF,{type:"button",onClick:u.refetch,children:"Try again"})]});const p=JF(u.currentData??[],t,n,i,e);return p.length===0?g.jsx(Sy,{children:"No upcoming classes match your filters."}):g.jsx(HF,{role:"group","aria-label":"Classes",children:p.map(h=>{const y=o.includes(h.id),_=ZF(h.start,f),v=[h.instructor.name,h.discipline.name].filter(Boolean).join(" · "),b=h.status==="free"?"Open":h.status==="waitlist"?"Waitlist":"Full";return g.jsxs(FF,{$checked:y,htmlFor:`cls-${h.id}`,children:[g.jsx(qF,{type:"checkbox",id:`cls-${h.id}`,checked:y,onChange:()=>l(h.id)}),g.jsxs(VF,{children:[g.jsx(GF,{children:_}),v&&g.jsx(WF,{children:v})]}),g.jsx(YF,{$status:h.status,children:b})]},h.id)})})}),t7=({studioId:e,waitlistAlerts:t,onWaitlistAlertsChange:n,watchedClassIds:i,onWatchedClassIdsChange:o,selectedInstructors:l,selectedDisciplines:u,timeRanges:f})=>{const p=_=>{const v=i??[];o(v.includes(_)?v.filter(b=>b!==_):[...v,_])},h=i!==null,y=i?.length??0;return g.jsxs("div",{children:[g.jsxs(RT,{children:[g.jsx(AT,{children:"Waitlist position alerts"}),g.jsx(IT,{children:"Get a push notification whenever the waitlist count changes for a matching class. Tap the notification to open a prompt reminding you to check your email for the 2-hour acceptance window."}),g.jsxs(UF,{children:[g.jsx(_h,{name:"waitlistAlerts",value:"off",checked:!t,onChange:()=>n(!1),label:"Disabled",hint:"No waitlist count notifications"}),g.jsx(_h,{name:"waitlistAlerts",value:"on",checked:t,onChange:()=>n(!0),label:"Enabled",hint:"Notify me when the waitlist count changes"})]})]}),t&&g.jsxs(g.Fragment,{children:[g.jsx(zF,{}),g.jsxs(RT,{children:[g.jsx(AT,{children:"Which classes?"}),g.jsx(IT,{children:"Notify for any class matching your filters, or pick specific ones you've already joined the waitlist for."}),g.jsxs(BF,{children:[g.jsx(DT,{type:"button",$active:!h,onClick:()=>o(null),children:"Any matching class"}),g.jsx(DT,{type:"button",$active:h,onClick:()=>{h||o([])},children:"Specific classes"}),h&&y>0&&g.jsxs(KF,{children:[y," selected"]})]}),h&&g.jsx(e7,{studioId:e,instructors:l,disciplines:u,timeRanges:f,selectedIds:i,onToggle:p})]})]})]})},Do=Ei([e=>e.studioSelector],e=>e.studioId),n7=e=>{const t=Mn(),n=et(Do);E.useEffect(()=>{e.studioId?t(vh(e.studioId)):t(vh(SD(Ce.DEFAULT_STUDIO_ID)))},[e.studioId,t]);const[i,o]=E.useState(e.name||""),[l,u]=E.useState(e.instructors||null),[f,p]=E.useState(e.disciplines||null),[h,y]=E.useState(()=>e.timeRanges||ls.map(()=>Ce.DEFAULT_TIME_RANGE)),[_,v]=E.useState(e.maxStatus||"free"),[b,x]=E.useState(e.waitlistAlerts??!1),[O,C]=E.useState(e.watchedClassIds??null),I=E.useRef(e.studioId);return E.useEffect(()=>{n&&I.current&&n!==I.current&&(u(M=>M&&[]),p(M=>M&&[])),I.current=n},[n]),{selectedStudioId:n,name:i,setName:o,selectedInstructors:l,setSelectedInstructors:u,selectedDisciplines:f,setSelectedDisciplines:p,timeRanges:h,setTimeRanges:y,maxStatus:_,setMaxStatus:v,waitlistAlerts:b,setWaitlistAlerts:x,watchedClassIds:O,setWatchedClassIds:C}},xy=["Basics","Filters","Schedule","Waitlist","Review"],r7=T.div`
  display: flex;
  flex-direction: column;
  min-height: 0;
  background-color: ${e=>e.theme.colors.mainSurface};
...
`,u7=T.span`
  ...
  ${Te`
    font-size: 12px;
  `}
`,d7=({alertToEdit:e,onSave:t,onCancel:n})=>{const i=Mn(),o=et(_u),[l,u]=E.useState(0),[f,p]=E.useState(!1),[h,y]=E.useState(),{selectedStudioId:_,name:v,setName:b,selectedInstructors:x,setSelectedInstructors:O,selectedDisciplines:C,setSelectedDisciplines:I,timeRanges:M,setTimeRanges:R,maxStatus:D,setMaxStatus:N,waitlistAlerts:A,setWaitlistAlerts:P,watchedClassIds:U,setWatchedClassIds:F}=n7(e),H=l<xy.length-1,z=l>0,G=l===xy.length-1,V=E.useCallback(()=>{H&&u(K=>K+1)},[H]),te=E.useCallback(()=>{z&&u(K=>K-1)},[z]),ue=E.useCallback(async()=>{if(!_||!o)return;p(!0),y(void 0);const K={id:e.id||null,created:e.created||new Date().getTime(),...v.trim()?{name:v.trim()}:{},studioId:_,instructors:x,disciplines:C,timeRanges:M,maxStatus:D,waitlistAlerts:A,...A&&U!==null?{watchedClassIds:U}:{}};try{K.id?await xD(o,K):await WH(o,K),t()}catch(ne){Nr(ne),y("Something went wrong. Please try again."),p(!1)}},[e.id,e.created,v,_,o,x,C,M,D,A,U,t]),j=!!e.id;return g.jsxs(r7,{children:[g.jsxs(i7,{children:[g.jsx(s7,{children:j?"Edit alert":"New alert"}),g.jsx(o7,{children:j?"Update your alert settings below.":"Set up a new alert in a few quick steps."}),g.jsx(gF,{steps:xy,currentStep:l,onStepClick:u})]}),g.jsxs(a7,{children:[l===0&&g.jsx(o9,{name:v,onNameChange:b,studioId:_,onStudioChange:K=>i(vh(K)),maxStatus:D,onStatusChange:N}),l===1&&g.jsx(lF,{studioId:_,selectedInstructors:x,setSelectedInstructors:O,selectedDisciplines:C,setSelectedDisciplines:I}),l===2&&g.jsx($F,{timeRanges:M,setTimeRanges:R}),l===3&&g.jsx(t7,{studioId:_,waitlistAlerts:A,onWaitlistAlertsChange:P,watchedClassIds:U,onWatchedClassIdsChange:F,selectedInstructors:x,selectedDisciplines:C,timeRanges:M}),l===4&&g.jsx(TF,{name:v,studioId:_,maxStatus:D,selectedInstructors:x,selectedDisciplines:C,timeRanges:M,waitlistAlerts:A,watchedClassIds:U})]}),g.jsxs(l7,{children:[g.jsx("div",{children:z?g.jsx(vc,{type:"button",onClick:te,children:"Back"}):g.jsx(vc,{type:"button",onClick:n,children:"Cancel"})}),g.jsxs(c7,{children:[h&&g.jsx(u7,{$error:!0,children:h}),G?g.jsx(vc,{type:"button",$primary:!0,onClick:ue,disabled:f,children:f?"Saving…":"Save alert"}):g.jsxs(g.Fragment,{children:[j&&g.jsx(vc,{type:"button",onClick:ue,disabled:f,children:f?"Saving…":"Save"}),g.jsx(vc,{type:"button",$primary:!0,onClick:V,children:"Continue"})]})]})]})]})},f7=()=>{const e=Pr(),t=ws(),n=e.state||{};return g.jsx(d7,{alertToEdit:n,onSave:()=>{t(nt.ALERTS)},onCancel:()=>{t(nt.ALERTS)}})},h7={userId:null,data:{state:"idle"}},zD=Xn({name:"alerts",initialState:h7,reducers:{setAlertsLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertsData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertsFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertsLoading:p7,setAlertsData:OT,setAlertsFailed:kT}=zD.actions,m7=zD.reducer,g7={userId:null,data:{state:"idle"}},BD=Xn({name:"alertPreferences",initialState:g7,reducers:{setAlertPreferencesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setAlertPreferencesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setAlertPreferencesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setAlertPreferencesLoading:y7,setAlertPreferencesData:v7,setAlertPreferencesFailed:NT}=BD.actions,_7=BD.reducer,Tb=e=>{try{return window.localStorage.getItem(e)}catch(t){return Nr(t),null}},Cb=(e,t)=>{try{window.localStorage.setItem(e,t)}catch(n){Nr(n)}},HD=e=>{try{window.localStorage.removeItem(e)}catch(t){Nr(t)}},FD="BOOKABLE_STATUS_FILTERS",Dv="DISCIPLINE_FILTERS",Ov="INSTRUCTOR_FILTERS",b7=e=>{const t=Tb(FD);return t===null?e:t.split(";").filter(Ce.isBookableStatus)},S7=e=>{Cb(FD,e.join(";"))},x7=e=>{const t=Tb(Dv);return t===null?e:t.split(";").filter(Boolean)},wy=e=>{e.length===0?HD(Dv):Cb(Dv,e.join(";"))},w7=e=>{const t=Tb(Ov);return t===null?e:t.split(";").filter(Boolean)},MT=e=>{e.length===0?HD(Ov):Cb(Ov,e.join(";"))},E7={selectedBookableStatuses:b7(["free","waitlist"]),selectedInstructors:w7([]),selectedDisciplines:x7([])},qD=Xn({name:"filters",initialState:E7,reducers:{toggleBookableStatus(e,t){e.selectedBookableStatuses.includes(t.payload)?e.selectedBookableStatuses=e.selectedBookableStatuses.filter(n=>n!==t.payload):e.selectedBookableStatuses=[...e.selectedBookableStatuses,t.payload],S7(e.selectedBookableStatuses)},toggleInstructor(e,t){e.selectedInstructors.includes(t.payload)?e.selectedInstructors=e.selectedInstructors.filter(n=>n!==t.payload):e.selectedInstructors=[...e.selectedInstructors,t.payload],MT(e.selectedInstructors)},resetInstructors(e){e.selectedInstructors=[],MT(e.selectedInstructors)},toggleDiscipline(e,t){e.selectedDisciplines.includes(t.payload)?e.selectedDisciplines=e.selectedDisciplines.filter(n=>n!==t.payload):e.selectedDisciplines=[...e.selectedDisciplines,t.payload],wy(e.selectedDisciplines)},setDisciplines(e,t){e.selectedDisciplines=t.payload,wy(e.selectedDisciplines)},resetDisciplines(e){e.selectedDisciplines=[],wy(e.selectedDisciplines)}}}),{toggleBookableStatus:T7,toggleInstructor:C7,resetInstructors:R7,toggleDiscipline:A7,setDisciplines:I7,resetDisciplines:D7}=qD.actions,O7=qD.reducer,k7={userId:null,data:{state:"idle"}},VD=Xn({name:"registeredDevices",initialState:k7,reducers:{setRegisteredDevicesLoading(e,t){return{userId:t.payload,data:{state:"loading"}}},setRegisteredDevicesData(e,t){return{userId:t.payload.userId,data:{state:"fulfilled",data:t.payload.data}}},setRegisteredDevicesFailed(e,t){return{userId:t.payload.userId,data:{state:"failed",error:t.payload.error}}}}}),{setRegisteredDevicesLoading:N7,setRegisteredDevicesData:M7,setRegisteredDevicesFailed:LT}=VD.actions,L7=VD.reducer,P7={state:"idle"},GD=Xn({name:"session",initialState:P7,reducers:{setLoading(e){return{state:"loading"}},setSession(e,t){return{state:"fulfilled",data:t.payload}},removeSession(e){return{state:"fulfilled",data:null}}}}),{setLoading:PT,setSession:j7,removeSession:jT}=GD.actions,$7=GD.reducer,hp=_$({reducer:{alerts:m7,alertPreferences:_7,filters:O7,registeredDevices:L7,session:$7,[Nf.reducerPath]:Nf.reducer,[Ev.name]:Ev.reducer},middleware:e=>e().concat(Nf.middleware)}),WD=E.createContext({state:"idle"}),U7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.registeredDevices);E.useEffect(()=>{const l=ln;if(!l)return n(LT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().registeredDevices;(u.userId!==t||u.data.state!=="fulfilled")&&n(N7(t));const f=Ln(l,`messagingTokens/${t}`),p=Ru(f,h=>{const y=h.val();n(M7({userId:t,data:y||{}}))},h=>{n(LT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(WD.Provider,{value:o,children:e})},YD=E.createContext({state:"idle"}),z7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.alertPreferences);E.useEffect(()=>{const l=ln;if(!l)return n(NT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().alertPreferences;(u.userId!==t||u.data.state!=="fulfilled")&&n(y7(t));const f=Ln(l,Ce.PATHS.alertPreferences(t)),p=Ru(f,h=>{const y=h.val();n(v7({userId:t,data:y||{}}))},h=>{n(NT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(YD.Provider,{value:o,children:e})},B7=({children:e,userId:t})=>{const n=Mn(),i=et(l=>l.alerts);E.useEffect(()=>{const l=ln;if(!l)return n(kT({userId:t,error:{message:"No database set up"}})),()=>{};const u=hp.getState().alerts;(u.userId!==t||u.data.state!=="fulfilled")&&n(p7(t));const f=Ln(l,Ce.PATHS.alerts(t)),p=Ru(f,h=>{const y=h.val();if(!y){n(OT({userId:t,data:[]}));return}const _=Object.entries(y).map(([v,b])=>({...b,timeRanges:new Array(ls.length).fill(null).map((x,O)=>b.timeRanges[O]||null),id:v}));n(OT({userId:t,data:_}))},h=>{n(kT({userId:t,error:{message:h.message}}))});return()=>p()},[t,n]);const o=i.userId===t?i.data:{state:"loading"};return g.jsx(gb.Provider,{value:o,children:e})},H7=T.div`
  margin: 0 auto;
  max-width: 960px;
  padding: 16px;
...
`,Q7=T.p`
  ...
  padding: 32px 0;
  margin: 0;
`,K7=({children:e})=>{const t=et(el);return t.state==="loading"?g.jsx(Q7,{children:"Loading…"}):t.state!=="fulfilled"||!t.data?g.jsxs(q7,{children:[g.jsx(V7,{children:"🔔"}),g.jsx(G7,{children:"Sign in to use Alerts"}),g.jsx(W7,{children:"Track class availability and get push notifications when a spot opens up for the classes you care about."}),g.jsx(Y7,{to:nt.SIGN_IN,children:"Sign in"})]}):e(t.data.id)},X7=e=>g.jsx(hs,{children:g.jsx(F7,{children:g.jsx(H7,{children:g.jsx(K7,{...e})})})}),Z7=({userId:e})=>g.jsx(B7,{userId:e,children:g.jsx(z7,{userId:e,children:g.jsx(U7,{userId:e,children:g.jsx(p2,{})})})}),J7=()=>g.jsx(X7,{children:e=>g.jsx(Z7,{userId:e})}),$T=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");await NI(Ln(n,Ce.PATHS.alertPreferences(e)),t)},eq=T.input`
  position: absolute;
  opacity: 0;
  width: 0;
  height: 0;
...
`,rq=T.label`
  ...
  cursor: pointer;
  position: relative;
`,QD=({id:e,checked:t,onChange:n,label:i,"aria-label":o})=>g.jsxs(rq,{htmlFor:e,children:[g.jsx(eq,{id:e,type:"checkbox",checked:t,"aria-label":o??i,onChange:l=>n(l.target.checked)}),g.jsx(tq,{$checked:t,children:g.jsx(nq,{$checked:t})}),i&&g.jsx("span",{children:i})]}),iq=T.form`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,sq=T.div`
...
`,gq=T.span`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,yq=({alertPreferences:e})=>{const t=et(_u),[n,i]=E.useState(e.notificationDelayMin||5),[o,l]=E.useState(!1),[u,f]=E.useState(!1),p=!!e.pauseAll,h=E.useCallback(async _=>{if(_.preventDefault(),!!t){l(!0),f(!1);try{await $T(t,{lastUpdated:new Date().getTime(),notificationDelayMin:n}),f(!0),setTimeout(()=>f(!1),2e3)}catch{}finally{l(!1)}}},[t,n]),y=E.useCallback(async _=>{t&&await $T(t,{pauseAll:!_})},[t]);return g.jsxs(g.Fragment,{children:[g.jsxs(hq,{children:[g.jsxs(pq,{children:[g.jsx(mq,{children:"Enable all notifications"}),g.jsx(gq,{children:"Globally pause or resume notifications for all alerts"})]}),g.jsx(QD,{id:"pause-all-toggle",checked:!p,onChange:y,"aria-label":p?"Resume all notifications":"Pause all notifications"})]}),g.jsxs(iq,{onSubmit:h,children:[g.jsxs(oq,{children:[g.jsx(aq,{htmlFor:"delay-input",children:"Cooldown (minutes)"}),g.jsx(cq,{children:"Minimum delay between consecutive alert notifications"})]}),g.jsxs(sq,{children:[g.jsx(lq,{id:"delay-input",type:"number",min:0,value:n,onChange:_=>{const v=parseInt(_.target.value,10);Number.isNaN(v)||i(v)}}),g.jsx(uq,{type:"submit",disabled:o,$saved:u,children:o?"Saving…":u?"Saved ✓":"Save"})]})]})]})},vq=()=>{const e=E.useContext(YD);return e.state==="idle"||e.state==="loading"?g.jsx(dq,{children:"Loading preferences…"}):e.state==="failed"?g.jsx(fq,{children:"Failed to load preferences."}):g.jsx(yq,{alertPreferences:e.data},e.data.lastUpdated)},_q=e=>{if(!e)return"Unknown device";const t=bq(e),n=Sq(e);return t&&n?`${t} on ${n}`:t||n||"Unknown device"},bq=e=>{if(e.includes("Edg/"))return"Edge";if(e.includes("OPR/")||e.includes("Opera"))return"Opera";if(e.includes("CriOS"))return"Chrome";if(e.includes("FxiOS"))return"Firefox";if(e.includes("Chrome/")&&!e.includes("Chromium"))return"Chrome";if(e.includes("Firefox/"))return"Firefox";if(e.includes("Safari/")&&!e.includes("Chrome"))return"Safari"},Sq=e=>{if(/iPhone/.test(e))return"iPhone";if(/iPad/.test(e))return"iPad";if(/iPod/.test(e))return"iPod";if(/Android/.test(e))return"Android";if(/CrOS/.test(e))return"ChromeOS";if(/Mac OS X|Macintosh/.test(e))return"macOS";if(/Windows/.test(e))return"Windows";if(/Linux/.test(e))return"Linux"},xq=T.ul`
  list-style: none;
  padding: 0;
  margin: 0;
  display: flex;
...
`,kq=T.p`
  ...
  text-align: center;
  padding: 16px;
`,Nq=e=>e?/iPhone|iPad|iPod/i.test(e)||/Android/i.test(e)?"📱":/Windows/i.test(e)||/Macintosh|Mac OS/i.test(e)?"💻":/Linux/i.test(e)?"🖥️":"💻":"💻",Mq=E.memo(({deviceToken:e,device:t,isCurrentDevice:n,onDelete:i})=>{const o=E.useMemo(()=>{const f=new Date(t.timestamp).getFullYear()===new Date().getFullYear();return new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"numeric",minute:"numeric",...f?{}:{year:"numeric"}}).format(t.timestamp)},[t.timestamp]),l=_q(t.userAgent);return g.jsxs(wq,{children:[g.jsx(Eq,{children:Nq(t.userAgent)}),g.jsxs(Tq,{children:[g.jsxs(Cq,{children:[l,n&&g.jsx(Rq,{children:"This device"})]}),g.jsxs(Aq,{children:["Last active ",o]})]}),g.jsx(Iq,{type:"button",onClick:()=>i(e),"aria-label":`Remove ${l}`,children:"Remove"})]})}),Lq=({devices:e})=>{const n=E.useContext(bu).token,i=et(_u),o=E.useCallback(l=>{i&&LI(i,l).catch(console.error)},[i]);return e.length===0?g.jsx(Dq,{children:"No devices registered for push notifications yet."}):g.jsx(xq,{children:e.map(([l,u])=>g.jsx(Mq,{deviceToken:l,device:u,isCurrentDevice:n!==void 0?l===n:u.userAgent!==void 0&&u.userAgent===navigator.userAgent,onDelete:o},l))})},Pq=()=>{const e=E.useContext(WD),t=E.useMemo(()=>e.state==="fulfilled"?Object.entries(e.data).sort(([,n],[,i])=>i.timestamp-n.timestamp):[],[e]);return e.state==="idle"||e.state==="loading"?g.jsx(Oq,{children:"Loading devices…"}):e.state==="failed"?g.jsx(kq,{children:"Failed to load devices. Please try again."}):g.jsx(Lq,{devices:t})},jq=async(e,t)=>{const n=ln;if(!n)throw new Error("No Firebase database connection to use");await kI(Ln(n,Ce.PATHS.alert(e,t)))},UT=(e,t,n)=>!e||e.length===0?t:e.length===1?e[0]:e.length===2?`${e[0]} or ${e[1]}`:`${e.length} ${n}`,$q=(e,t)=>{const n=UT(e,"Any Class","Disciplines"),i=UT(t,"Any Instructor","Instructors");return`${n} with ${i}`},Uq=T.li`
  ${$r}
  padding: 16px;
  transition: box-shadow 0.15s;
...
`,sV=T.span`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin-top: 4px;
`,oV={free:{label:"Open spots",title:"Only alerts when a class has open spots available to book"},waitlist:{label:"Waitlist",title:"Alerts when a class has open spots or waitlist availability"},full:{label:"Any",title:"Alerts regardless of availability status"}},aV=e=>oV[e]||{label:e,title:""},lV=E.memo(({alert:e,onDuplicate:t,onEdit:n})=>{const i=ws(),o=et(_u),l=!!e.disabled,[u,f]=E.useState(!1),[p,h]=E.useState(!1),[y,_]=E.useState({top:0,right:0}),v=E.useRef(null),b=E.useRef(null),x=E.useCallback(()=>{o&&xD(o,{...e,disabled:!l})},[o,e,l]),O=E.useCallback(()=>{f(!1),h(!1)},[]);E.useLayoutEffect(()=>{if(!u||!v.current)return;const U=v.current.getBoundingClientRect();_({top:U.bottom+4,right:window.innerWidth-U.right})},[u]),E.useEffect(()=>{if(!u)return;const U=z=>{z.key==="Escape"&&O()},F=z=>{if(!(z.target instanceof Node))return O();!v.current?.contains(z.target)&&!b.current?.contains(z.target)&&O()},H=setTimeout(()=>{document.addEventListener("keydown",U),document.addEventListener("click",F,!0)},0);return()=>{clearTimeout(H),document.removeEventListener("keydown",U),document.removeEventListener("click",F,!0)}},[u]);const{data:C}=Eb(e.studioId),{data:I}=wb(e.studioId),M=E.useMemo(()=>{const F=new Date(e.created).getFullYear()===new Date().getFullYear();return new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",...F?{}:{year:"numeric"}}).format(e.created)},[e.created]),R=E.useMemo(()=>new Map(C?.map(U=>[U.id,U.name])),[C]),D=E.useMemo(()=>new Map(I?.map(U=>[U.id,U.name])),[I]),N=E.useMemo(()=>{if(e.name)return e.name;const U=Ce.isNotEmpty(e.instructors)&&C?e.instructors.map(H=>R.get(H)).filter(H=>!!H):null,F=Ce.isNotEmpty(e.disciplines)&&I?e.disciplines.map(H=>D.get(H)).filter(H=>!!H):null;return $q(F,U)},[e.name,e.instructors,e.disciplines,C,I,R,D]),A=Ce.STUDIOS[e.studioId]?.location||e.studioId||"No studio",P=aV(e.maxStatus);return g.jsx(Uq,{$disabled:l,children:g.jsxs(zq,{children:[g.jsxs(Bq,{children:[g.jsxs(Hq,{children:[g.jsx(Fq,{children:N}),g.jsx(qq,{$status:e.maxStatus,title:P.title,children:P.label})]}),g.jsx(Vq,{children:A}),g.jsx(Gq,{children:ls.map((U,F)=>g.jsx(Wq,{$active:!!e.timeRanges[F],title:e.timeRanges[F]?`${U}: monitoring enabled`:`${U}: not monitored`,children:U.charAt(0)},U))}),g.jsxs(sV,{children:["Created ",M]})]}),g.jsxs(Yq,{children:[g.jsx(QD,{id:`toggle-${e.id}`,checked:!l,onChange:x,"aria-label":l?"Enable alert":"Disable alert"}),g.jsxs(Qq,{children:[g.jsx(Kq,{ref:v,type:"button","aria-label":"More options","aria-expanded":u,"aria-haspopup":"menu",onClick:()=>f(U=>!U),children:g.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[g.jsx("circle",{cx:"8",cy:"3",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),g.jsx("circle",{cx:"8",cy:"13",r:"1.5"})]})}),u&&UC.createPortal(g.jsxs(Xq,{ref:b,role:"menu",$top:y.top,$right:y.right,children:[g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{O(),i(sz(e.id))},children:"Test"})}),g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{O(),n(e)},children:"Edit"})}),g.jsx("li",{children:g.jsx(Mf,{type:"button",role:"menuitem",onClick:()=>{O(),t(e)},children:"Duplicate"})}),g.jsx(Jq,{}),p?g.jsx("li",{children:g.jsxs(eV,{children:[g.jsx(tV,{children:"Delete this alert?"}),g.jsxs(nV,{children:[g.jsx(rV,{type:"button",onClick:()=>h(!1),children:"Cancel"}),g.jsx(iV,{type:"button",onClick:()=>{O(),o&&jq(o,e.id)},children:"Delete"})]})]})}):g.jsx("li",{children:g.jsx(Zq,{type:"button",role:"menuitem",onClick:()=>h(!0),children:"Delete"})})]}),document.body)]})]})]})})}),cV=T.ul`
  list-style: none;
  padding: 0;
  margin: 0;
  display: flex;
  flex-direction: column;
  gap: 8px;
`,uV=({alerts:e,onDuplicate:t,onEdit:n})=>g.jsx(cV,{children:e.map(i=>g.jsx(lV,{alert:i,onDuplicate:t,onEdit:n},i.id))}),dV=T.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 20px 24px 0;
...
`,vV=T.p`
  ...
  color: ${e=>e.theme.colors.error};
  font-size: 14px;
`,_V=({onAdd:e,onEdit:t,onDuplicate:n})=>{const i=E.useContext(gb),o=i.state==="loading"||i.state==="idle",l=i.state==="failed",u=i.state==="fulfilled"?i.data:[];return g.jsxs(g.Fragment,{children:[g.jsxs(dV,{children:[g.jsxs(fV,{children:[g.jsx(hV,{children:"Alerts"}),g.jsx(pV,{children:o?"Loading your alerts…":l?"Something went wrong":u.length===0?"You haven't created any alerts yet":`${u.length} alert${u.length===1?"":"s"}`})]}),!o&&!l&&g.jsx(mV,{type:"button",onClick:e,children:"+ New alert"})]}),g.jsxs(gV,{children:[o&&g.jsx(yV,{children:"Loading…"}),l&&g.jsx(vV,{children:"Failed to load your alerts. Please refresh and try again."}),!o&&!l&&u.length===0&&g.jsx(wV,{onAdd:e}),!o&&!l&&u.length>0&&g.jsx(uV,{alerts:u,onEdit:t,onDuplicate:n})]})]})},bV=T.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 12px;
...
`,wV=({onAdd:e})=>g.jsxs(bV,{children:[g.jsx(SV,{children:"Create your first alert to get notified when classes become available."}),g.jsx(xV,{type:"button",onClick:e,children:"Create an alert"})]}),EV=T.button`
  padding: 1.5em;
  max-width: 300px;
  width: 100%;
  line-height: 0;
...
`;const TV=T.div`
  ...
  border-radius: ${e=>e.theme.borderRadius};
  padding: 16px;
`,CV=()=>["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"].includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document||/iPad|iPhone|iPod/.test(navigator.userAgent),Ey=T(TV)`
  margin-bottom: 1em;
`,RV=T(EV)`
  margin-top: 1em;
`,zT=T.h2`
  color: ${e=>e.theme.colors.accent};
`,AV=()=>{const[e,t]=E.useState(window.Notification?window.Notification.permission:void 0),{refreshToken:n}=E.useContext(bu),i=CV(),o=!!navigator.standalone||window.matchMedia("(display-mode: standalone)").matches,l=E.useCallback(()=>{window.Notification&&typeof window.Notification.requestPermission=="function"&&window.Notification.requestPermission().then(u=>{t(u),u==="granted"&&n()}).catch(u=>{console.error(u),Nr(u)})},[n]);return i&&!o?g.jsxs(Ey,{children:[g.jsx(zT,{children:"Installation Required"}),g.jsx("p",{children:"To receive notifications on iOS, you must first add this app to your home screen. Tap the share button in Safari and select “Add to Home Screen”, then open the app from there."})]}):e===void 0||!("serviceWorker"in navigator)?g.jsxs(Ey,{children:[g.jsx(zT,{children:"Unsupported Browser"}),g.jsx("p",{children:"This browser does not support sending you notifications in the background. Alerts for new classes will only display if you keep this tab open."})]}):e!=="granted"?g.jsxs(Ey,{children:[g.jsx("h2",{children:"Grant notification permissions"}),g.jsx("p",{children:"In order to get notified when any of your alerts trigger, you need to grant permission to send notifications"}),g.jsx(RV,{type:"button",onClick:l,children:"Grant Permission"})]}):null},IV=T.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,qT=T.div`
  ...
  ${Te`
    padding: 12px 16px 16px;
  `}
`,DV=()=>{const e=ws();return g.jsxs(IV,{children:[g.jsx(Ty,{children:g.jsx(_V,{onAdd:()=>{e(nt.ALERTS_EDITOR,{state:{}})},onEdit:t=>{e(nt.ALERTS_EDITOR,{state:t})},onDuplicate:t=>{e(nt.ALERTS_EDITOR,{state:{...t,id:void 0,created:void 0}})}})}),g.jsxs(Ty,{children:[g.jsxs(BT,{children:[g.jsx(HT,{children:"Preferences"}),g.jsx(FT,{children:"Control how often you receive alert notifications."})]}),g.jsx(qT,{children:g.jsx(vq,{})})]}),g.jsxs(Ty,{children:[g.jsxs(BT,{children:[g.jsx(HT,{children:"Devices"}),g.jsx(FT,{children:"Devices registered to receive push notifications. Removed devices will re-register on their next visit."})]}),g.jsxs(qT,{children:[g.jsx(AV,{}),g.jsx(Pq,{})]})]})]})},OV=T.button.attrs({"aria-label":"Close",type:"button"})`
  position: relative;
  width: 50px;
  height: 50px;
  font-size: 0;
...
`,kV=()=>{const e=et(i=>i.filters.selectedBookableStatuses),t=Mn(),n=E.useCallback(i=>{t(T7(i))},[t]);return{bookableStatuses:e,toggleBookableStatus:n}},NV=T.button`
  cursor: pointer;
  color: ${e=>e.theme.colors.accent};
  font-size: 12px;
  background: none;
...
`,LV=T.h3`
  ...
  color: ${e=>e.theme.colors.secondary};
  margin: 0;
`,pp=({label:e,onReset:t,children:n})=>g.jsxs(MV,{children:[g.jsx(LV,{children:e}),t&&g.jsx(NV,{type:"button",onClick:t,children:"Reset"}),n]}),PV=T.div`
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  padding: 0 16px 16px;
`,jV=T.button`
  ...
  ${e=>e.$active?nn`
        ...
        `}
`,$V=()=>{const{bookableStatuses:e,toggleBookableStatus:t}=kV(),n=Kv(),i=[{label:"Free",status:"free",color:n.colors.status.free.text},{label:"Waitlist",status:"waitlist",color:n.colors.status.waitlist.text},{label:"Full",status:"full",color:n.colors.status.full.text}];return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(pp,{label:"Status"})}),g.jsx(PV,{children:i.map(o=>{const l=e.includes(o.status);return g.jsx(jV,{type:"button",$active:l,$color:o.color,onClick:()=>t(o.status),"aria-pressed":l,children:o.label},o.status)})})]})},UV=()=>{const e=et(i=>i.filters.selectedDisciplines),t=Mn(),n=E.useCallback(i=>{t(A7(i))},[t]);return{selectedDisciplines:e,toggleDiscipline:n}},KD=T.ul`
  list-style: none;
  margin: 0;
  padding: 0 0 8px;
`,XD=T.li`
...
`,Ch=T.p`
  ...
  padding: 8px 16px 16px;
  margin: 0;
`,zV=({discipline:e,checked:t,onClick:n})=>g.jsxs(XD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(ZD,{$checked:t}),g.jsx(Sh,{discipline:e,size:24}),g.jsx(JD,{children:e.name})]}),BV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=wb(e),{selectedDisciplines:o,toggleDiscipline:l}=UV(),u=Mn(),f=E.useRef(o);return E.useEffect(()=>{const p=f.current;if(!t||p.length===0)return;const h=new Set(t.map(_=>_.id)),y=p.filter(_=>h.has(_));y.length<p.length&&u(I7(y))},[t,u]),i&&!n?g.jsx(Ch,{children:"Failed to load disciplines"}):!t||n?g.jsx(Ch,{children:"Loading…"}):g.jsx(KD,{children:t.map((p,h)=>g.jsx(zV,{discipline:p,checked:o.includes(p.id),onClick:()=>l(p.id)},h))})},HV=()=>{const e=et(n=>n.filters.selectedDisciplines.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(pp,{label:"Disciplines",onReset:e?()=>t(D7()):void 0}),g.jsx(BV,{})]})},FV=()=>{const e=et(i=>i.filters.selectedInstructors),t=Mn(),n=E.useCallback(i=>{t(C7(i))},[t]);return{selectedInstructors:e,toggleInstructor:n}},qV=({instructor:e,checked:t,onClick:n})=>g.jsxs(XD,{$checked:t,onClick:n,role:"checkbox","aria-checked":t,children:[g.jsx(ZD,{$checked:t}),g.jsx(yb,{instructor:e,size:28}),g.jsx(JD,{children:e.name})]}),VV=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i}=Eb(e),{selectedInstructors:o,toggleInstructor:l}=FV();return i&&!n?g.jsx(Ch,{children:"Failed to load instructors"}):!t||n?g.jsx(Ch,{children:"Loading…"}):g.jsx(KD,{children:t.map((u,f)=>g.jsx(qV,{instructor:u,checked:o.includes(u.id),onClick:()=>l(u.id)},f))})},GV=()=>{const e=et(n=>n.filters.selectedInstructors.length>0),t=Mn();return g.jsxs("div",{children:[g.jsx(pp,{label:"Instructors",onReset:e?()=>t(R7()):void 0}),g.jsx(VV,{})]})},WV=Object.entries(Ce.STUDIOS).map(([e,t])=>({id:e,label:t.location})),YV=T.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
  padding: 0 16px 16px;
...
`,ZV=T.span`
  font-size: 15px;
  color: ${e=>e.theme.colors.main};
`,JV=()=>{const e=Mn(),t=et(Do);return g.jsxs("fieldset",{style:{border:"none",margin:0,padding:0},children:[g.jsx("legend",{style:{padding:0,width:"100%"},children:g.jsx(pp,{label:"Studio"})}),g.jsx(YV,{children:WV.map(n=>{const i=t===n.id;return g.jsxs(QV,{$selected:i,htmlFor:`studio-${n.id}`,children:[g.jsx(KV,{type:"radio",id:`studio-${n.id}`,name:"studio-selected",value:n.id,checked:i,onChange:()=>{i||e(vh(n.id))}}),g.jsx(XV,{$selected:i}),g.jsx(ZV,{children:n.label})]},n.id)})})]})},eG=T.div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,tG=T.div`
...
`,sG=({onClose:e})=>g.jsxs(eG,{children:[g.jsxs(tG,{children:[g.jsx(nG,{children:"Filters"}),g.jsx(rG,{onClick:()=>e()})]}),g.jsxs(iG,{children:[g.jsx(pf,{children:g.jsx(JV,{})}),g.jsx(pf,{children:g.jsx($V,{})}),g.jsx(pf,{children:g.jsx(HV,{})}),g.jsx(pf,{children:g.jsx(GV,{})})]})]}),oG=()=>{const e=et(Do),{refetch:t}=xb(e);return{refresh:E.useCallback(async()=>{await t()},[t])}},VT=150,GT=60,aG=()=>document.documentElement.scrollTop||document.body.scrollTop,lG=({refresh:e})=>{const t=E.useRef(null),n=E.useRef(null),i=E.useRef(e);E.useLayoutEffect(()=>{i.current=e});const o=E.useMemo(()=>!!navigator.standalone||window.matchMedia("(display-mode: standalone)").matches||!1,[]);return E.useEffect(()=>{if(!o)return;let l=0,u=!1,f=!1,p=!1;const h=x=>{const O=n.current;O&&(O.style.transition=x?"transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease":"none",O.style.transform="",O.style.opacity="0")},y=x=>{l=x.touches[0].clientY,u=!1,f=!1},_=x=>{if(p||aG()>0)return;const O=x.touches[0].clientY-l;if(O<=0){u&&(u=!1,f=!1,h(!1));return}u=!0,f=O>=VT;const C=Math.min(O/VT,1),I=GT*(1-Math.pow(1-C,2)),M=Math.pow(C,.5),R=Math.floor(C*270),D=n.current;D&&(D.style.transition="none",D.style.transform=`translateY(${I}px) rotate(${R}deg)`,D.style.opacity=String(Math.min(M,1)))},v=()=>{if(u)if(u=!1,f&&!p){f=!1,p=!0;const x=n.current;x&&(x.classList.add("animate"),x.style.transition="none",x.style.transform=`translateY(${GT}px)`,x.style.opacity="1");let O=!1;const C=()=>{if(O)return;O=!0,p=!1;const M=n.current;M&&(M.classList.remove("animate"),h(!0))},I=setTimeout(C,1e4);i.current().finally(()=>{clearTimeout(I),C()})}else f=!1,h(!0)},b=()=>{u=!1,f=!1,h(!1)};return document.addEventListener("touchstart",y,{passive:!0}),document.addEventListener("touchmove",_,{passive:!0}),document.addEventListener("touchend",v,{passive:!0}),document.addEventListener("touchcancel",b,{passive:!0}),()=>{document.removeEventListener("touchstart",y),document.removeEventListener("touchmove",_),document.removeEventListener("touchend",v),document.removeEventListener("touchcancel",b)}},[o]),{swipeRef:t,spinnerRef:n}},cG=e=>e.filters.selectedDisciplines.length>0||e.filters.selectedInstructors.length>0,uG=e=>e.filters.selectedBookableStatuses,dG=e=>e.filters.selectedDisciplines,fG=e=>e.filters.selectedInstructors,hG=(e,t)=>t,pG=Ei([uG,dG,fG,hG],(e,t,n,i)=>i.filter(o=>e.includes(o.status)).filter(o=>n.length>0?n.some(l=>l===o.instructor.id):!0).filter(o=>t.length>0?t.includes(o.discipline.id):!0)),eO=Ei([Do],e=>{if(e)return Ce.STUDIOS[e]}),mG=Ei([pG,eO],(e,t)=>{if(e.length===0)return[];const n=t?.timezone||"",i=[];let o=1,l=Va(e[0].start,n,!0),u=[e[0]];for(;o<e.length;){const f=e[o],p=Va(f.start,n,!0);p===l?u.push(f):(i.push({formattedDate:l,classes:u}),l=p,u=[f]),o++}return u.length>0&&i.push({formattedDate:l,classes:u}),i}),WT={free:{label:"Book"},waitlist:{label:"Waitlist"},full:{label:"Full"}},gG=T.a`
  display: flex;
  align-items: center;
  gap: 14px;
  text-decoration: none;
...
`,CG=T.button`
  ...
  ${Te`
    ...
    padding: 5px 10px;
  `}
`,RG=E.memo(({clazz:e})=>{const t=et(eO),n=e.status,i=n==="free"||n==="waitlist",o=E.useMemo(()=>e.customerUrl?new URL(e.customerUrl,"https://schedule.studio.onepeloton.com").href:(t_("Missing customer URL",{extra:{clazz:e}}),""),[e]),l=E.useCallback(p=>{o&&(p.preventDefault(),window.open(o,"_blank","noopener,noreferrer"))},[o]),u=E.useMemo(()=>To(e.start,t?.timezone),[e.start,t?.timezone]),f=WT[n]??WT.full;return g.jsxs(gG,{$status:n,$interactive:i,href:o,target:"_blank",rel:"noopener noreferrer",onClick:l,"aria-label":`${f.label} ${e.name} at ${u}`,children:[g.jsxs(yG,{children:[g.jsx(vG,{children:u}),g.jsxs(_G,{children:[e.duration/60," min"]})]}),g.jsxs(bG,{children:[g.jsx(yb,{instructor:e.instructor,size:44}),g.jsx(Sh,{discipline:e.discipline,size:36})]}),g.jsxs(SG,{children:[g.jsx(xG,{children:e.name}),g.jsxs(wG,{children:[e.instructor.name,g.jsx(EG,{children:"·"}),e.discipline.name,g.jsx(TG,{children:g.jsx(Sh,{discipline:e.discipline,size:20})})]})]}),g.jsx(CG,{$status:n,disabled:!i,tabIndex:-1,children:f.label})]})}),AG=T.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
`,IG=T.div`
...
`,QT=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`,MG=({classes:e,fulfilledTimeStamp:t})=>{const n=et(u=>mG(u,e)),i=et(cG),o=et(u=>u.filters.selectedBookableStatuses.includes("free")),l=E.useMemo(()=>t?new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"numeric"}).format(t):void 0,[t]);return n.length===0?g.jsxs(kG,{children:[g.jsx(NG,{children:"No classes found"}),i&&g.jsx(QT,{children:"Try resetting your filters or selecting more options in the sidebar."}),o&&!i&&g.jsx(QT,{children:"New classes usually open at 12:00 pm on Mondays and Thursdays in your studio's timezone."})]}):g.jsx(AG,{children:n.map((u,f)=>g.jsxs(IG,{children:[g.jsxs(DG,{children:[g.jsx(OG,{children:u.formattedDate}),f===0&&l&&g.jsxs(YT,{children:["Times in studio timezone · loaded ",l]}),f===0&&!l&&g.jsx(YT,{children:"All times in studio timezone"})]}),u.classes.map((p,h)=>g.jsx(RG,{clazz:p},h))]},f))})},KT=T.div`
  background-color: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 32px 24px;
...
`,jG=T.code`
  font-size: 12px;
  color: ${e=>e.theme.colors.secondary};
`,$G=()=>{const e=et(Do),{currentData:t,isLoading:n,error:i,fulfilledTimeStamp:o}=xb(e,{refetchOnMountOrArgChange:!0});return i&&!n?g.jsxs(KT,{children:[g.jsx(PG,{children:"Failed to load classes"}),g.jsx(jG,{children:rF(i)})]}):!t||n?g.jsx(KT,{children:g.jsx(LG,{children:"Loading classes…"})}):g.jsx(MG,{classes:t,fulfilledTimeStamp:o})},UG=T.div``,kv=300,zG=T.aside`
  max-width: 100%;
  width: ${kv}px;
  top: calc(${rb}px + env(safe-area-inset-top, 0px));
  bottom: 0;
...
`,iW=()=>{const e=ws(),[t,n]=E.useState(!1),[i,o]=E.useState(""),[l,u]=E.useState(!1),[f,p]=E.useState(""),[h,y]=E.useState(""),_=E.useCallback(async b=>{if(b.preventDefault(),!(!di||!f||!h)){n(!0),o("");try{l?await n8(di,f,h):await r8(di,f,h),e(nt.CLASS_LIST)}catch(x){console.error("Email auth error:",x);const O=x&&typeof x=="object"&&"code"in x?XT(x):"Authentication failed";o(O),Nr(x)}finally{n(!1)}}},[f,h,l,e]),v=E.useCallback(async()=>{if(di){n(!0),o("");try{const b=new ui;await C8(di,b),e(nt.CLASS_LIST)}catch(b){console.error("Google sign-in error:",b);const x=b&&typeof b=="object"&&"code"in b?XT(b):"Google sign-in failed";o(x),Nr(b)}finally{n(!1)}}},[e]);return g.jsxs("div",{children:[g.jsx(QG,{children:l?"Create account":"Sign in"}),g.jsx(KG,{children:"Set alerts, persist filters across devices, and access beta features."}),g.jsxs(XG,{onSubmit:_,children:[g.jsxs(ZT,{children:[g.jsx(JT,{htmlFor:"signin-email",children:"Email"}),g.jsx(eC,{id:"signin-email",type:"email",placeholder:"you@example.com",value:f,onChange:b=>p(b.target.value),required:!0,disabled:t})]}),g.jsxs(ZT,{children:[g.jsx(JT,{htmlFor:"signin-password",children:"Password"}),g.jsx(eC,{id:"signin-password",type:"password",placeholder:"••••••••",value:h,onChange:b=>y(b.target.value),required:!0,disabled:t})]}),i&&g.jsx(tW,{role:"alert",children:i}),g.jsx(ZG,{type:"submit",disabled:t,children:t?"Loading…":l?"Create account":"Sign in"})]}),g.jsx(eW,{style:{marginTop:20,marginBottom:16},children:"or"}),g.jsx(JG,{type:"button",onClick:v,disabled:t,children:"Continue with Google"}),g.jsxs(nW,{children:[l?"Already have an account?":"Don't have an account?"," ",g.jsx(rW,{type:"button",onClick:()=>{u(!l),o("")},disabled:t,children:l?"Sign in":"Create account"})]})]})},sW=Ei([el],e=>e.state==="fulfilled"&&!!e.data),oW=T.div`
  padding: 32px 20px;
  display: flex;
  justify-content: center;
...
`,aW=T.div`
  ...
  ${Te`
    padding: 24px 20px;
  `}
`,lW=()=>et(sW)?g.jsx(Bv,{to:nt.CLASS_LIST}):g.jsx(hs,{children:g.jsx(oW,{children:g.jsx(aW,{children:g.jsx(iW,{})})})});function cW(e){const t=[];for(let n=e-1;n>=0;n--){const i=new Date;i.setDate(i.getDate()-n),t.push(i.toISOString().slice(0,10))}return t}function uW(e=14){const[t,n]=E.useState({state:"idle"});return E.useEffect(()=>{if(!ln){n({state:"failed",error:new Error("No database")});return}n({state:"loading"}),MI(Ln(ln,"metrics")).then(i=>{const o=i.val()??{},u=cW(e).map(f=>{const p=o[f]??{},h=p.diffs??{},y={};for(const[v,b]of Object.entries(h))y[v]={added:b.added??0,changed:b.changed??0,removed:b.removed??0};const _=p.notifications??{};return{date:f,diffs:y,notifications:{sent:_.sent??0,failed:_.failed??0,usersReached:_.usersReached??0}}});n({state:"fulfilled",data:u})}).catch(i=>{n({state:"failed",error:i})})},[e]),t}function tC(e){if(e.length===0)return null;const t=[...e].sort((i,o)=>i-o),n=Math.floor(t.length/2);return t.length%2===0?(t[n-1]+t[n])/2:t[n]}const dW=e=>{if(!e||typeof e!="object")return!1;const t=e;return typeof t.classId=="string"&&typeof t.instructorName=="string"&&typeof t.addedAt=="number"};function fW(){const[e,t]=E.useState({state:"idle"});return E.useEffect(()=>{if(!ln){t({state:"failed",error:new Error("No database")});return}t({state:"loading"});const n=Ln(ln,"selloutStats"),i=Ru(n,o=>{const l=o.val()??{},u=[];for(const[f,p]of Object.entries(l)){if(!p||typeof p!="object")continue;const h=Object.values(p).filter(dW);if(h.length===0)continue;const y=h.map(v=>v.timeToWaitlistMs).filter(v=>v!=null),_=h.map(v=>v.timeToFullMs).filter(v=>v!=null);u.push({instructorId:f,instructorName:h[0].instructorName,classCount:h.length,medianTimeToWaitlistMs:tC(y),waitlistSampleSize:y.length,medianTimeToFullMs:tC(_),fullSampleSize:_.length})}t({state:"fulfilled",data:u})},o=>{t({state:"failed",error:o})});return()=>i()},[]),e}function hW(e){const t=Math.round(e/6e4),n=Math.floor(t/1440),i=Math.floor(t%1440/60),o=t%60;return n>0?`${n}d ${i}h`:i>0?`${i}h ${o}m`:`${o}m`}const Cy=T.div`
  padding: 32px 24px;
  max-width: 900px;
  margin: 0 auto;
...
`,Tc=T.p`
  color: ${e=>e.theme.colors.secondary};
  font-size: 14px;
`,Rh=1e3,Lf=140,Ah=12,tO=4,nO=Lf-Ah-tO;function _c(e,t){return t<=1?Rh/2:e/(t-1)*Rh}function Dy(e,t){return Ah+nO*(1-e/t)}const mW=[.25,.5,.75],gW=T.div`
  background: ${e=>e.theme.colors.mainSurface};
  border: 1px solid ${e=>e.theme.borderColor};
  border-radius: ${e=>e.theme.borderRadius};
  padding: 16px 16px 12px;
...
`,xW=T.div`
  ...
  background-color: ${e=>e.$color};
  flex-shrink: 0;
`;function wW(e){const[,t,n]=e.split("-");return`${parseInt(t)}/${parseInt(n)}`}function EW({days:e,legend:t}){return g.jsxs(g.Fragment,{children:[g.jsx(vW,{children:e.map(n=>g.jsx(_W,{children:wW(n.date)},n.date))}),g.jsx(bW,{children:t.map(n=>g.jsxs(SW,{children:[g.jsx(xW,{$color:n.color}),n.label]},n.label))})]})}const TW=T.div`
  position: relative;
`,CW=T.div`
  position: absolute;
  top: 6px;
...
`,OW=T.div`
  ...
  pointer-events: none;
`;function nC({days:e,seriesForDay:t,legend:n}){const i=e.length,[o,l]=E.useState(null),u=e.map(t),f=Math.max(...u.flatMap(v=>v.map(b=>b.value)),1),p=u[0].length,h=Dy(0,f).toFixed(1);function y(v,b){const{left:x,width:O}=b.getBoundingClientRect(),C=(v-x)/O;return Math.max(0,Math.min(i-1,Math.round(C*(i-1))))}const _=o!==null?o/(i-1)*100:null;return g.jsxs(gW,{children:[g.jsxs(TW,{children:[o!==null&&_!==null&&g.jsxs(g.Fragment,{children:[g.jsxs(CW,{$pct:_,children:[g.jsx(RW,{children:e[o].date}),u[o].map(v=>g.jsxs(AW,{children:[g.jsx(IW,{$color:v.color}),v.label,g.jsx(DW,{children:v.value})]},v.label))]}),u[o].map((v,b)=>g.jsx(OW,{$color:v.color,style:{left:`${_}%`,top:`${Dy(v.value,f)/Lf*100}%`}},b))]}),g.jsxs(yW,{viewBox:`0 0 ${Rh} ${Lf}`,preserveAspectRatio:"none","aria-hidden":"true",style:{cursor:"crosshair",display:"block"},onMouseMove:v=>l(y(v.clientX,v.currentTarget)),onMouseLeave:()=>l(null),onTouchStart:v=>l(y(v.touches[0].clientX,v.currentTarget)),onTouchMove:v=>l(y(v.touches[0].clientX,v.currentTarget)),onTouchEnd:()=>l(null),children:[mW.map(v=>{const b=(Ah+nO*(1-v)).toFixed(1);return g.jsx("line",{x1:0,y1:b,x2:Rh,y2:b,stroke:"currentColor",strokeOpacity:.1,strokeWidth:1,vectorEffect:"non-scaling-stroke"},v)}),o!==null&&g.jsx("line",{x1:_c(o,i).toFixed(1),y1:Ah,x2:_c(o,i).toFixed(1),y2:Lf-tO,stroke:"currentColor",strokeOpacity:.2,strokeWidth:1,vectorEffect:"non-scaling-stroke"}),Array.from({length:p},(v,b)=>{const x=u[0][b].color,C=u.map((M,R)=>({x:_c(R,i),y:Dy(M[b].value,f)})).map(({x:M,y:R},D)=>`${D===0?"M":"L"}${M.toFixed(1)},${R.toFixed(1)}`).join(" "),I=[C,`L${_c(i-1,i).toFixed(1)},${h}`,`L${_c(0,i).toFixed(1)},${h}`,"Z"].join(" ");return g.jsxs("g",{children:[g.jsx("path",{d:I,fill:x,fillOpacity:.12}),g.jsx("path",{d:C,fill:"none",stroke:x,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",vectorEffect:"non-scaling-stroke"})]},b)})]})]}),g.jsx(EW,{days:e,legend:n})]})}const kW=T.div`
  overflow-x: auto;
  ${$r}
`,NW=T.table`
  width: 100%;
...
`,iC=T.span`
  ...
  font-size: 11px;
  margin-left: 4px;
`;function sC(e,t){return e===null?g.jsx(iC,{children:"—"}):g.jsxs(g.Fragment,{children:[hW(e),g.jsxs(iC,{children:["(n=",t,")"]})]})}function MW({stats:e}){if(e.length===0)return g.jsx(Tc,{children:"No sellout data recorded yet."});const t=[...e].sort((n,i)=>n.medianTimeToWaitlistMs===null&&i.medianTimeToWaitlistMs===null?n.instructorName.localeCompare(i.instructorName):n.medianTimeToWaitlistMs===null?1:i.medianTimeToWaitlistMs===null?-1:n.medianTimeToWaitlistMs-i.medianTimeToWaitlistMs);return g.jsx(kW,{children:g.jsxs(NW,{children:[g.jsx("thead",{children:g.jsxs(rC,{children:[g.jsx(gf,{children:"Instructor"}),g.jsx(gf,{children:"Classes tracked"}),g.jsx(gf,{children:"Median time to waitlist"}),g.jsx(gf,{children:"Median time to waitlist full"})]})}),g.jsx("tbody",{children:t.map(n=>g.jsxs(rC,{children:[g.jsx(yf,{children:n.instructorName}),g.jsx(yf,{children:n.classCount}),g.jsx(yf,{children:sC(n.medianTimeToWaitlistMs,n.waitlistSampleSize)}),g.jsx(yf,{children:sC(n.medianTimeToFullMs,n.fullSampleSize)})]},n.instructorId))})]})})}const Yn={added:"#4ade80",changed:"#facc15",removed:"#f87171",sent:"#60a5fa",failed:"#f87171",usersReached:"#a78bfa"},LW=()=>{const e=uW(14),t=fW();if(e.state==="idle"||e.state==="loading")return g.jsx(hs,{children:g.jsxs(Cy,{children:[g.jsx(Ry,{children:"Stats"}),g.jsx(Tc,{children:"Loading…"})]})});if(e.state==="failed")return g.jsx(hs,{children:g.jsxs(Cy,{children:[g.jsx(Ry,{children:"Stats"}),g.jsxs(Tc,{children:["Failed to load metrics: ",e.error.message??"unknown error"]})]})});const n=e.data,i=n.reduce((l,u)=>{l.sent+=u.notifications.sent,l.failed+=u.notifications.failed,l.usersReached+=u.notifications.usersReached;for(const f of Object.values(u.diffs))l.added+=f.added,l.changed+=f.changed,l.removed+=f.removed;return l},{sent:0,failed:0,usersReached:0,added:0,changed:0,removed:0}),o=[...new Set(n.flatMap(l=>Object.keys(l.diffs)))];return g.jsx(hs,{children:g.jsxs(Cy,{children:[g.jsx(Ry,{children:"Stats"}),g.jsxs(pW,{children:[g.jsxs(ya,{children:[g.jsx(va,{children:"Notifications sent (14d)"}),g.jsx(_a,{children:i.sent.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Users reached (14d)"}),g.jsx(_a,{children:i.usersReached.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Delivery failures (14d)"}),g.jsx(_a,{children:i.failed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes added (14d)"}),g.jsx(_a,{children:i.added.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes changed (14d)"}),g.jsx(_a,{children:i.changed.toLocaleString()})]}),g.jsxs(ya,{children:[g.jsx(va,{children:"Classes removed (14d)"}),g.jsx(_a,{children:i.removed.toLocaleString()})]})]}),g.jsxs(Ay,{children:[g.jsx(Iy,{children:"Push notifications (14 days)"}),g.jsx(nC,{days:n,seriesForDay:l=>[{value:l.notifications.sent,color:Yn.sent,label:"Sent"},{value:l.notifications.failed,color:Yn.failed,label:"Failed"},{value:l.notifications.usersReached,color:Yn.usersReached,label:"Users reached"}],legend:[{color:Yn.sent,label:"Sent"},{color:Yn.failed,label:"Failed"},{color:Yn.usersReached,label:"Users reached"}]})]}),g.jsxs(Ay,{children:[g.jsx(Iy,{children:"Class sellout speed by instructor"}),t.state==="idle"||t.state==="loading"?g.jsx(Tc,{children:"Loading…"}):t.state==="failed"?g.jsxs(Tc,{children:["Failed to load sellout stats:"," ",t.error.message??"unknown error"]}):g.jsx(MW,{stats:t.data})]}),o.map(l=>g.jsxs(Ay,{children:[g.jsxs(Iy,{children:["Schedule changes — ",Ce.STUDIOS[l]?.location??l," (14 days)"]}),g.jsx(nC,{days:n,seriesForDay:u=>{const f=u.diffs[l]??{added:0,changed:0,removed:0};return[{value:f.added,color:Yn.added,label:"Added"},{value:f.changed,color:Yn.changed,label:"Changed"},{value:f.removed,color:Yn.removed,label:"Removed"}]},legend:[{color:Yn.added,label:"Added"},{color:Yn.changed,label:"Changed"},{color:Yn.removed,label:"Removed"}]})]},l))]})})},PW=T.div`
  max-width: 480px;
  margin: 0 auto;
  padding: 40px 20px;
  display: flex;
...
`,HW=T.p`
  ...
  font-size: 13px;
  color: ${e=>e.theme.colors.secondary};
`;function FW(e,t){if(!e)return null;try{const n=Ce.STUDIOS[t]?.timezone;return new Date(e).toLocaleString("en-US",{timeZone:n??"UTC",weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",timeZoneName:"short"})}catch{return null}}const qW=()=>{const[e]=G2(),t=e.get("studioId")??"",n=e.get("startsAt")??"",i=e.get("waitingCount"),o=Ce.STUDIOS[t],l=FW(n,t),u=i!==null?parseInt(i,10):null;return g.jsx(hs,{children:g.jsxs(PW,{children:[g.jsx(jW,{children:"📬"}),g.jsx($W,{children:"Waitlist count changed"}),g.jsxs(UW,{children:["The number of people on the waitlist just changed",u!==null?` — there ${u===1?"is now 1 person":`are now ${u} people`} ahead`:"",". If you joined this waitlist, check your email — Peloton sends a message when it's your turn, and you'll have a 2-hour window to accept."]}),(l||o)&&g.jsxs(zW,{children:[o&&g.jsxs(g.Fragment,{children:[g.jsx(oC,{children:"Studio"}),g.jsx(aC,{children:o.location})]}),l&&g.jsxs(g.Fragment,{children:[g.jsx(oC,{style:{marginTop:o?8:0},children:"Class time"}),g.jsx(aC,{children:l})]})]}),g.jsx(BW,{href:"mailto:",children:"Open Mail App"}),g.jsx(HW,{children:"Opens your device's default mail app."})]})})},VW=z2(g2(g.jsxs(Qn,{children:[g.jsx(Qn,{path:nt.CLASS_LIST,element:g.jsx(WG,{})}),g.jsxs(Qn,{path:nt.ALERTS,element:g.jsx(J7,{}),children:[g.jsx(Qn,{index:!0,element:g.jsx(DV,{})}),g.jsx(Qn,{path:"edit",element:g.jsx(f7,{})}),g.jsx(Qn,{path:":alertId/test",element:g.jsx(FH,{})})]}),g.jsx(Qn,{path:nt.WAITLIST_ALERT,element:g.jsx(qW,{})}),g.jsx(Qn,{path:nt.SIGN_IN,element:g.jsx(lW,{})}),g.jsx(Qn,{path:nt.ABOUT,element:g.jsx(aH,{})}),g.jsx(Qn,{path:nt.STATS,element:g.jsx(YG,{children:g.jsx(LW,{})})}),g.jsx(Qn,{path:"*",element:g.jsx(Bv,{to:nt.CLASS_LIST,replace:!0})})]}))),GW=(e,t)=>({id:e.uid,displayName:e.displayName||e.email||"",isAdmin:t}),WW=({children:e})=>{const t=Mn();return E.useEffect(()=>{if(t(PT()),!di)return t(jT()),()=>{};const n=o8(di,async i=>{if(t(PT()),i){let o=!1;try{o=(ln?await MI(Ln(ln,`admins/${i.uid}`)):null)?.val()===!0}catch{}t(j7(GW(i,o)))}else t(jT())});return()=>n()},[t]),g.jsx(g.Fragment,{children:e})},YW={mode:"light",borderRadius:"8px",borderColor:"#d1d1d1",colors:{main:"#494f59",secondary:"#514e60",mainSurface:"#fff",secondarySurface:"#ededed",accent:"#cb3449",error:"#d93025",hoverSurface:"rgba(0, 0, 0, 0.05)",status:{free:{bg:"#e8f5e9",text:"#2e7d32"},waitlist:{bg:"#fff3e0",text:"#e65100"},full:{text:"#9e9e9e"}}},widths:{tablet:1024,mobile:560}},QW={mode:"dark",borderRadius:"8px",borderColor:"#2e2f45",colors:{main:"#e2e4eb",secondary:"#9b98b0",mainSurface:"#1c1d2e",secondarySurface:"#13141f",accent:"#cb3449",error:"#ef5350",hoverSurface:"rgba(255, 255, 255, 0.08)",status:{free:{bg:"rgba(46, 125, 50, 0.15)",text:"#81c784"},waitlist:{bg:"rgba(230, 81, 0, 0.15)",text:"#ffb74d"},full:{text:"#757575"}}},widths:{tablet:1024,mobile:560}},KW=eP`
  html {
...
`,Nv="theme-mode";function XW(){const e=localStorage.getItem(Nv);return e!==null?e==="dark":window.matchMedia("(prefers-color-scheme: dark)").matches}function ZW(){const[e,t]=E.useState(XW),n=E.useCallback(()=>{t(i=>{const o=!i;return localStorage.setItem(Nv,o?"dark":"light"),o})},[]);return E.useEffect(()=>{const i=window.matchMedia("(prefers-color-scheme: dark)"),o=l=>{localStorage.getItem(Nv)===null&&t(l.matches)};return i.addEventListener("change",o),()=>i.removeEventListener("change",o)},[]),{isDark:e,toggle:n}}function JW(){const{isDark:e,toggle:t}=ZW();return E.useEffect(()=>{const i=new URLSearchParams(window.location.search).get("classUrl");i&&(window.history.replaceState(null,"",window.location.pathname+window.location.hash),window.location.assign(new URL(i,"https://schedule.studio.onepeloton.com").href))},[]),g.jsx(vD.Provider,{value:{isDark:e,toggle:t},children:g.jsxs(XL,{theme:e?QW:YW,children:[g.jsx(KW,{}),g.jsx(NN,{store:hp,children:g.jsx(WW,{children:g.jsx(iz,{children:g.jsx(Z2,{router:VW})})})})]})})}yN.createRoot(document.getElementById("root")).render(g.jsx(E.StrictMode,{children:g.jsx(JW,{})}));
//# sourceMappingURL=index-DGUw94ap.js.map

//# debugId=eb0e5ade-1507-5141-92b9-dcfcff6bafe3
